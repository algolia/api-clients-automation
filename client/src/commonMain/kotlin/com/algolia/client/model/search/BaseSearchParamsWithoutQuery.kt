...
data class BaseSearchParamsWithoutQuery (
    ...
    @SerialName(value = "restrictSearchableAttributes") val restrictSearchableAttributes: kotlin.collections.List<String>? = arrayListOf(),

    /* Returns [facets](https://www.algolia.com/doc/guides/managing-results/refine-results/faceting/#contextual-facet-values-and-counts), their facet values, and the number of matching facet values. */
    @SerialName(value = "facets") val facets: kotlin.collections.List<String>? = arrayListOf(),
    ...
    @SerialName(value = "naturalLanguages") val naturalLanguages: kotlin.collections.List<String>? = arrayListOf(),

    /* Assigns [rule contexts](https://www.algolia.com/doc/guides/managing-results/rules/rules-overview/how-to/customize-search-results-by-platform/#whats-a-context) to search queries. */
    @SerialName(value = "ruleContexts") val ruleContexts: kotlin.collections.List<String>? = arrayListOf(),
    ...
    @SerialName(value = "explain") val explain: kotlin.collections.List<String>? = arrayListOf(),
    ...
    @SerialName(value = "analyticsTags") val analyticsTags: kotlin.collections.List<String>? = arrayListOf(),
