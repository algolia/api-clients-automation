...
data class BaseIndexSettings (
    ...
    @SerialName(value = "replicas") val replicas: kotlin.collections.List<String>? = arrayListOf(),

    /* Maximum number of hits accessible through pagination. */
    @SerialName(value = "paginationLimitedTo") val paginationLimitedTo: Int? = 1000,

    /* Attributes that can't be retrieved at query time. */
    @SerialName(value = "unretrievableAttributes") val unretrievableAttributes: kotlin.collections.List<String>? = arrayListOf(),
    ...
    @SerialName(value = "disableTypoToleranceOnWords") val disableTypoToleranceOnWords: kotlin.collections.List<String>? = arrayListOf(),
    ...
    @SerialName(value = "camelCaseAttributes") val camelCaseAttributes: kotlin.collections.List<String>? = arrayListOf(),
    ...
    @SerialName(value = "indexLanguages") val indexLanguages: kotlin.collections.List<String>? = arrayListOf(),
    ...
    @SerialName(value = "disablePrefixOnAttributes") val disablePrefixOnAttributes: kotlin.collections.List<String>? = arrayListOf(),
    ...
    @SerialName(value = "numericAttributesForFiltering") val numericAttributesForFiltering: kotlin.collections.List<String>? = arrayListOf(),
    ...
    @SerialName(value = "searchableAttributes") val searchableAttributes: kotlin.collections.List<String>? = arrayListOf(),
