...
def snippet_for_delete_user_profile():
    ...
    # Skip deserialization
    raw_response = client.delete_user_profile_with_http_info(
        user_token="UserToken",
    )
...
def snippet_for_get_personalization_strategy():
    ...
    # Skip deserialization
    raw_response = client.get_personalization_strategy_with_http_info()
...
def snippet_for_get_user_token_profile():
    ...
    # Skip deserialization
    raw_response = client.get_user_token_profile_with_http_info(
        user_token="UserToken",
    )
...
def snippet_for_set_personalization_strategy():
    ...
    # Skip deserialization
    raw_response = client.set_personalization_strategy_with_http_info(
        personalization_strategy_params={
            "eventScoring": [
                {
                    "score": 42,
