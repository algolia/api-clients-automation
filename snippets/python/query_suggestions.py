...
def snippet_for_create_config():
    ...
    raw_response = client.create_config_with_http_info(
        configuration_with_index={
            "indexName": "<YOUR_INDEX_NAME>",
            "sourceIndices": [
                {
...
def snippet_for_delete_config():
    ...
    # Skip deserialization
    raw_response = client.delete_config_with_http_info(
        index_name="<YOUR_INDEX_NAME>",
    )
...
def snippet_for_get_all_configs():
    ...
    # Skip deserialization
    raw_response = client.get_all_configs_with_http_info()
...
def snippet_for_get_config():
    ...
    # Skip deserialization
    raw_response = client.get_config_with_http_info(
        index_name="<YOUR_INDEX_NAME>",
    )
...
def snippet_for_get_config_status():
    ...
    # Skip deserialization
    raw_response = client.get_config_status_with_http_info(
        index_name="<YOUR_INDEX_NAME>",
    )
...
def snippet_for_get_log_file():
    ...
    # Skip deserialization
    raw_response = client.get_log_file_with_http_info(
        index_name="<YOUR_INDEX_NAME>",
    )
...
def snippet_for_update_config():
    ...
    # Skip deserialization
    raw_response = client.update_config_with_http_info(
        index_name="<YOUR_INDEX_NAME>",
        configuration={
            "sourceIndices": [
                {
