...
final class IngestionClientSnippet {
    ...
    func snippetForCreateAuthentication() async throws {
        ...
        // Call the API
        _ = try await client.createAuthentication(authenticationCreate: AuthenticationCreate(type: AuthenticationType.oauth,
                                                                                             name: "authName",
    ...
    func snippetForCreateDestination() async throws {
        ...
        // Call the API
        _ = try await client.createDestination(destinationCreate: DestinationCreate(type: DestinationType.search,
    ...
    func snippetForCreateSource() async throws {
        ...
        // Call the API
        _ = try await client.createSource(sourceCreate: SourceCreate(type: SourceType.commercetools,
                                                                     name: "sourceName",
    ...
    func snippetForCreateTask() async throws {
        ...
        // Call the API
        _ = try await client.createTask(taskCreate: TaskCreate(sourceID: "search",
    ...
    func snippetForEnableTask() async throws {
        ...
        // Call the API
        _ = try await client.enableTask(taskID: "6c02aeb1-775e-418e-870b-1faccd4b2c0f"
        )
    }
    ...
    func snippetForGetEvent() async throws {
        ...
        // Call the API
        _ = try await client.getEvent(runID: "6c02aeb1-775e-418e-870b-1faccd4b2c0f",
    ...
    func snippetForGetSource() async throws {
        ...
        // Call the API
        _ = try await client.getSource(sourceID: "6c02aeb1-775e-418e-870b-1faccd4b2c0f"
        )
    }
    ...
    func snippetForSearchAuthentications() async throws {
        ...
        // Call the API
        _ = try await client.searchAuthentications(authenticationSearch: AuthenticationSearch(authenticationIDs: ["6c02aeb1-775e-418e-870b-1faccd4b2c0f",
    ...
    func snippetForSearchDestinations() async throws {
        ...
        // Call the API
        _ = try await client.searchDestinations(destinationSearch: DestinationSearch(destinationIDs: ["6c02aeb1-775e-418e-870b-1faccd4b2c0f",
                                                                                                      "947ac9c4-7e58-4c87-b1e7-14a68e99699a"]
            )
        )
    }
    ...
    func snippetForSearchSources() async throws {
        ...
        // Call the API
        _ = try await client.searchSources(sourceSearch: SourceSearch(sourceIDs: ["6c02aeb1-775e-418e-870b-1faccd4b2c0f",
                                                                                  "947ac9c4-7e58-4c87-b1e7-14a68e99699a"]
            )
        )
    }
    ...
    func snippetForSearchTasks() async throws {
        ...
        // Call the API
        _ = try await client.searchTasks(taskSearch: TaskSearch(taskIDs: ["6c02aeb1-775e-418e-870b-1faccd4b2c0f",
                                                                          "947ac9c4-7e58-4c87-b1e7-14a68e99699a"]
            )
        )
    }
    ...
    func snippetForUpdateAuthentication() async throws {
        ...
        // Call the API
        _ = try await client.updateAuthentication(authenticationID: "6c02aeb1-775e-418e-870b-1faccd4b2c0f",
    ...
    func snippetForUpdateDestination() async throws {
        ...
        // Call the API
        _ = try await client.updateDestination(destinationID: "6c02aeb1-775e-418e-870b-1faccd4b2c0f",
    ...
    func snippetForUpdateSource() async throws {
        ...
        // Call the API
        _ = try await client.updateSource(sourceID: "6c02aeb1-775e-418e-870b-1faccd4b2c0f",
    ...
    func snippetForUpdateTask() async throws {
        ...
        // Call the API
        _ = try await client.updateTask(taskID: "6c02aeb1-775e-418e-870b-1faccd4b2c0f",
