...
final class InsightsClientSnippet {
    ...
    func snippetForPushEvents() async throws {
        ...
        // Call the API
        _ = try await client.pushEvents(insightsEvents: InsightsEvents(events: [EventsItems.clickedObjectIDsAfterSearch(ClickedObjectIDsAfterSearch(eventName: "Product Clicked",
