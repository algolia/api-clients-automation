...
final class QuerySuggestionsClientSnippet {
    ...
    func snippetForCreateConfig() async throws {
        ...
        // Call the API
        _ = try await client.createConfig(querySuggestionsConfigurationWithIndex: QuerySuggestionsConfigurationWithIndex(indexName: "theIndexName",
    ...
    func snippetForGetConfig() async throws {
        ...
        // Call the API
        _ = try await client.getConfig(indexName: "theIndexName"
        )
    }
    ...
    func snippetForUpdateConfig() async throws {
        ...
        // Call the API
        _ = try await client.updateConfig(indexName: "theIndexName",
