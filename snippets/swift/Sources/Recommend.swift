...
final class RecommendClientSnippet {
    ...
    func snippetForDeleteRecommendRule() async throws {
        ...
        // Call the API
        _ = try await client.deleteRecommendRule(indexName: "indexName",
    ...
    func snippetForGetRecommendRule() async throws {
        ...
        // Call the API
        _ = try await client.getRecommendRule(indexName: "indexName",
                                              model: RecommendModels.relatedProducts,
                                              objectID: "objectID")
    }
    ...
    func snippetForGetRecommendStatus() async throws {
        ...
        // Call the API
        _ = try await client.getRecommendStatus(indexName: "indexName",
                                                model: RecommendModels.relatedProducts,
                                                taskID: Int64(12345))
    }
    ...
    func snippetForGetRecommendations() async throws {
        ...
        // Call the API
        _ = try await client.getRecommendations(getRecommendationsParams: GetRecommendationsParams(requests: [RecommendationsRequest.recommendationsQuery(RecommendationsQuery(indexName: "indexName",
                                                                                                                                                                               threshold: 42,
    ...
    func snippetForSearchRecommendRules() async throws {
        ...
        // Call the API
        _ = try await client.searchRecommendRules(indexName: "indexName",
                                                  model: RecommendModels.relatedProducts)
    }
}
