...
class SnippetAgentStudioClient {
  ...
  void snippetForGetConversation() throws Exception {
    ...
    // Call the API
    ConversationFullResponse response = client.getConversation("test-conversation-id", "785b14e4-61a8-4c03-8028-bf2ba3ae85ff");
    // >LOG
    // print the response
    System.out.println(response);
    // SEPARATOR<
  ...
  void snippetForGetConversation1() throws Exception {
    ...
    // Call the API
    ConversationFullResponse response = client.getConversation(
  ...
  void snippetForGetSecretKey1() throws Exception {
    ...
    // Call the API
    SecretKeyResponse response = client.getSecretKey("f730dda4-9649-4cfb-9d88-b7e992fb89c9");
    // >LOG
    // print the response
    System.out.println(response);
    // SEPARATOR<
  ...
  void snippetForListAgentAllowedDomains() throws Exception {
    ...
    // Call the API
    AllowedDomainListResponse response = client.listAgentAllowedDomains("785b14e4-61a8-4c03-8028-bf2ba3ae85ff");
    // >LOG
    // print the response
    System.out.println(response);
    // SEPARATOR<
