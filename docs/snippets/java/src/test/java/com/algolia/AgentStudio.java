...
class SnippetAgentStudioClient {
  ...
  void snippetForBulkCreateAllowedDomains() throws Exception {
    ...
    // Call the API
    AllowedDomainListResponse response = client.bulkCreateAllowedDomains(
  ...
  void snippetForBulkDeleteAllowedDomains() throws Exception {
  ...
  void snippetForCreateAgentAllowedDomain() throws Exception {
    // >SEPARATOR createAgentAllowedDomain default
    // Initialize the client
    AgentStudioClient client = new AgentStudioClient("ALGOLIA_APPLICATION_ID", "ALGOLIA_API_KEY");

    // Call the API
    AllowedDomainResponse response = client.createAgentAllowedDomain(
      "76710f1b-8231-42e5-b0d1-f43aac618e15",
  ...
  void snippetForCreateFeedback() throws Exception {
  ...
  void snippetForCreateFeedback1() throws Exception {
  ...
  void snippetForCreateSecretKey() throws Exception {
    // >SEPARATOR createSecretKey createSecretKey with minimal parameters
    // Initialize the client
    AgentStudioClient client = new AgentStudioClient("ALGOLIA_APPLICATION_ID", "ALGOLIA_API_KEY");

    // Call the API
    SecretKeyResponse response = client.createSecretKey(new SecretKeyCreate().setName("my-secret-key"));
    // >LOG
    // print the response
    System.out.println(response);
    // SEPARATOR<
  ...
  void snippetForCreateSecretKey1() throws Exception {
    // >SEPARATOR createSecretKey createSecretKey with agent IDs
    // Initialize the client
    AgentStudioClient client = new AgentStudioClient("ALGOLIA_APPLICATION_ID", "ALGOLIA_API_KEY");

    // Call the API
    SecretKeyResponse response = client.createSecretKey(
  ...
  //
  // deleteAllowedDomain
  void snippetForDeleteAllowedDomain() throws Exception {
  ...
  //
  // deleteSecretKey
  void snippetForDeleteSecretKey() throws Exception {
  ...
  void snippetForExportConversations() throws Exception {
    ...
    // Call the API
    List response = client.exportConversations("76710f1b-8231-42e5-b0d1-f43aac618e15");
    // >LOG
    // print the response
    System.out.println(response);
    // SEPARATOR<
  ...
  void snippetForExportConversations1() throws Exception {
    ...
    // Call the API
    List response = client.exportConversations("76710f1b-8231-42e5-b0d1-f43aac618e15", "2024-01-01", "2024-12-31");
    // >LOG
    // print the response
    System.out.println(response);
    // SEPARATOR<
  ...
  void snippetForExportConversations2() throws Exception {
  ...
  void snippetForGetAgent() throws Exception {
    ...
    // Call the API
    AgentWithVersionResponse response = client.getAgent("76710f1b-8231-42e5-b0d1-f43aac618e15");
    // >LOG
    // print the response
    System.out.println(response);
    // SEPARATOR<
  ...
  //
  // getAllowedDomain
  void snippetForGetAllowedDomain() throws Exception {
    // >SEPARATOR getAllowedDomain getAllowedDomain
    // Initialize the client
    AgentStudioClient client = new AgentStudioClient("ALGOLIA_APPLICATION_ID", "ALGOLIA_API_KEY");

    // Call the API
    AllowedDomainResponse response = client.getAllowedDomain(
  ...
  void snippetForGetAllowedDomain1() throws Exception {
  ...
  //
  // getConfiguration
  void snippetForGetConfiguration() throws Exception {
    // >SEPARATOR getConfiguration getConfiguration
    // Initialize the client
    AgentStudioClient client = new AgentStudioClient("ALGOLIA_APPLICATION_ID", "ALGOLIA_API_KEY");

    // Call the API
    ApplicationConfigResponse response = client.getConfiguration();
    // >LOG
    // print the response
    System.out.println(response);
    // SEPARATOR<
  ...
  void snippetForGetConfiguration1() throws Exception {
  ...
  void snippetForGetConversation() throws Exception {
    ...
    // Call the API
    ConversationFullResponse response = client.getConversation("test-conversation-id", "76710f1b-8231-42e5-b0d1-f43aac618e15");
    // >LOG
    // print the response
    System.out.println(response);
    // SEPARATOR<
  ...
  void snippetForGetConversation1() throws Exception {
    // >SEPARATOR getConversation e2e get conversation
    // Initialize the client
    AgentStudioClient client = new AgentStudioClient("ALGOLIA_APPLICATION_ID", "ALGOLIA_API_KEY");

    // Call the API
    ConversationFullResponse response = client.getConversation("alg_cnv_miss_yqcZtaOSPTF8bJsJ", "76710f1b-8231-42e5-b0d1-f43aac618e15");
    // >LOG
    // print the response
    System.out.println(response);
    // SEPARATOR<
  ...
  void snippetForGetProvider() throws Exception {
    ...
    // Call the API
    ProviderAuthenticationResponse response = client.getProvider("c2905529-b933-4b69-87ec-75f9829d5f59");
    // >LOG
    // print the response
    System.out.println(response);
    // SEPARATOR<
  ...
  //
  // getSecretKey
  void snippetForGetSecretKey() throws Exception {
    // >SEPARATOR getSecretKey getSecretKey
    // Initialize the client
    AgentStudioClient client = new AgentStudioClient("ALGOLIA_APPLICATION_ID", "ALGOLIA_API_KEY");

    // Call the API
    SecretKeyResponse response = client.getSecretKey("a1b2c3d4-5678-90ab-cdef-123456789abc");
    // >LOG
    // print the response
    System.out.println(response);
    // SEPARATOR<
  ...
  //
  // e2e get secret key
  void snippetForGetSecretKey1() throws Exception {
    // >SEPARATOR getSecretKey e2e get secret key
    // Initialize the client
    AgentStudioClient client = new AgentStudioClient("ALGOLIA_APPLICATION_ID", "ALGOLIA_API_KEY");

    // Call the API
    SecretKeyResponse response = client.getSecretKey("c110e615-7d5a-4103-865f-c5062c0d6f4d");
    // >LOG
    // print the response
    System.out.println(response);
    // SEPARATOR<
  ...
  void snippetForListAgentAllowedDomains() throws Exception {
    // >SEPARATOR listAgentAllowedDomains listAgentAllowed-Domains
    // Initialize the client
    AgentStudioClient client = new AgentStudioClient("ALGOLIA_APPLICATION_ID", "ALGOLIA_API_KEY");

    // Call the API
    AllowedDomainListResponse response = client.listAgentAllowedDomains("76710f1b-8231-42e5-b0d1-f43aac618e15");
    // >LOG
    // print the response
    System.out.println(response);
    // SEPARATOR<
  ...
  void snippetForListAgentAllowedDomains1() throws Exception {
  ...
  void snippetForListAgentConversations() throws Exception {
    ...
    // Call the API
    PaginatedConversationsResponse response = client.listAgentConversations("76710f1b-8231-42e5-b0d1-f43aac618e15");
    // >LOG
    // print the response
    System.out.println(response);
    // SEPARATOR<
  ...
  void snippetForListAgentConversations2() throws Exception {
  ...
  void snippetForListAgents1() throws Exception {
    ...
    // Call the API
    PaginatedAgentsResponse response = client.listAgents(2, 5, "c2905529-b933-4b69-87ec-75f9829d5f59");
    // >LOG
    // print the response
    System.out.println(response);
    // SEPARATOR<
  ...
  void snippetForListProviderModels() throws Exception {
    ...
    // Call the API
    List response = client.listProviderModels("c2905529-b933-4b69-87ec-75f9829d5f59");
    // >LOG
    // print the response
    System.out.println(response);
    // SEPARATOR<
  ...
  void snippetForListProviderModels1() throws Exception {
  ...
  void snippetForListSecretKeys() throws Exception {
    // >SEPARATOR listSecretKeys listSecretKeys with no params
    // Initialize the client
    AgentStudioClient client = new AgentStudioClient("ALGOLIA_APPLICATION_ID", "ALGOLIA_API_KEY");

    // Call the API
    PaginatedSecretKeysResponse response = client.listSecretKeys();
    // >LOG
    // print the response
    System.out.println(response);
    // SEPARATOR<
  ...
  void snippetForListSecretKeys1() throws Exception {
    // >SEPARATOR listSecretKeys listSecretKeys with pagination
    // Initialize the client
    AgentStudioClient client = new AgentStudioClient("ALGOLIA_APPLICATION_ID", "ALGOLIA_API_KEY");

    // Call the API
    PaginatedSecretKeysResponse response = client.listSecretKeys(2, 5);
    // >LOG
    // print the response
    System.out.println(response);
    // SEPARATOR<
  ...
  void snippetForListSecretKeys2() throws Exception {
    // >SEPARATOR listSecretKeys e2e list secret keys
    // Initialize the client
    AgentStudioClient client = new AgentStudioClient("ALGOLIA_APPLICATION_ID", "ALGOLIA_API_KEY");

    // Call the API
    PaginatedSecretKeysResponse response = client.listSecretKeys(1, 10);
    // >LOG
    // print the response
    System.out.println(response);
    // SEPARATOR<
  ...
  void snippetForPublishAgent() throws Exception {
    ...
    // Call the API
    AgentWithVersionResponse response = client.publishAgent("76710f1b-8231-42e5-b0d1-f43aac618e15");
    // >LOG
    // print the response
    System.out.println(response);
    // SEPARATOR<
  ...
  void snippetForUnpublishAgent() throws Exception {
    ...
    // Call the API
    AgentWithVersionResponse response = client.unpublishAgent("76710f1b-8231-42e5-b0d1-f43aac618e15");
    // >LOG
    // print the response
    System.out.println(response);
    // SEPARATOR<
  ...
  //
  // updateSecretKey
  void snippetForUpdateSecretKey() throws Exception {
