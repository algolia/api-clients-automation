...
export async function snippetForBulkCreateAllowedDomains(): Promise<void> {
  // >SEPARATOR bulkCreateAllowedDomains default
  // Initialize the client
  const client = agentStudioClient('ALGOLIA_APPLICATION_ID', 'ALGOLIA_API_KEY');

  // Call the API
  const response = await client.bulkCreateAllowedDomains({
...
export async function snippetForBulkDeleteAllowedDomains(): Promise<void> {
...
export async function snippetForCreateAgentAllowedDomain(): Promise<void> {
  // >SEPARATOR createAgentAllowedDomain default
  // Initialize the client
  const client = agentStudioClient('ALGOLIA_APPLICATION_ID', 'ALGOLIA_API_KEY');

  // Call the API
  const response = await client.createAgentAllowedDomain({
    agentId: '785b14e4-61a8-4c03-8028-bf2ba3ae85ff',
...
export async function snippetForCreateAgentCompletion3(): Promise<void> {
...
export async function snippetForCreateFeedback(): Promise<void> {
...
export async function snippetForCreateFeedback1(): Promise<void> {
...
export async function snippetForCreateSecretKey(): Promise<void> {
  // >SEPARATOR createSecretKey createSecretKey with minimal parameters
  // Initialize the client
  const client = agentStudioClient('ALGOLIA_APPLICATION_ID', 'ALGOLIA_API_KEY');

  // Call the API
  const response = await client.createSecretKey({ name: 'my-secret-key' });
...
export async function snippetForCreateSecretKey1(): Promise<void> {
  // >SEPARATOR createSecretKey createSecretKey with agent IDs
  // Initialize the client
  const client = agentStudioClient('ALGOLIA_APPLICATION_ID', 'ALGOLIA_API_KEY');

  // Call the API
  const response = await client.createSecretKey({
    name: 'scoped-key',
...
//
// deleteAllowedDomain
export async function snippetForDeleteAllowedDomain(): Promise<void> {
...
//
// deleteSecretKey
export async function snippetForDeleteSecretKey(): Promise<void> {
  // >SEPARATOR deleteSecretKey default
  // Initialize the client
  const client = agentStudioClient('ALGOLIA_APPLICATION_ID', 'ALGOLIA_API_KEY');

  // Call the API
  await client.deleteSecretKey({ secretKeyId: 'a1b2c3d4-5678-90ab-cdef-123456789abc' });
...
export async function snippetForExportConversations2(): Promise<void> {
...
//
// getAllowedDomain
export async function snippetForGetAllowedDomain(): Promise<void> {
  // >SEPARATOR getAllowedDomain getAllowedDomain
  // Initialize the client
  const client = agentStudioClient('ALGOLIA_APPLICATION_ID', 'ALGOLIA_API_KEY');

  // Call the API
  const response = await client.getAllowedDomain({
    domainId: 'a1b2c3d4-5678-90ab-cdef-123456789abc',
    agentId: '785b14e4-61a8-4c03-8028-bf2ba3ae85ff',
  });
...
export async function snippetForGetAllowedDomain1(): Promise<void> {
...
//
// getConfiguration
export async function snippetForGetConfiguration(): Promise<void> {
...
export async function snippetForGetConfiguration1(): Promise<void> {
...
//
// getSecretKey
export async function snippetForGetSecretKey(): Promise<void> {
  // >SEPARATOR getSecretKey getSecretKey
  // Initialize the client
  const client = agentStudioClient('ALGOLIA_APPLICATION_ID', 'ALGOLIA_API_KEY');

  // Call the API
  const response = await client.getSecretKey({ secretKeyId: 'a1b2c3d4-5678-90ab-cdef-123456789abc' });
...
//
// e2e get secret key
export async function snippetForGetSecretKey1(): Promise<void> {
  // >SEPARATOR getSecretKey e2e get secret key
  // Initialize the client
  const client = agentStudioClient('ALGOLIA_APPLICATION_ID', 'ALGOLIA_API_KEY');

  // Call the API
  const response = await client.getSecretKey({ secretKeyId: 'f730dda4-9649-4cfb-9d88-b7e992fb89c9' });
...
export async function snippetForListAgentAllowedDomains(): Promise<void> {
  // >SEPARATOR listAgentAllowedDomains listAgentAllowed-Domains
  // Initialize the client
  const client = agentStudioClient('ALGOLIA_APPLICATION_ID', 'ALGOLIA_API_KEY');

  // Call the API
  const response = await client.listAgentAllowedDomains({ agentId: '785b14e4-61a8-4c03-8028-bf2ba3ae85ff' });
...
export async function snippetForListAgentAllowedDomains1(): Promise<void> {
...
export async function snippetForListAgentConversations2(): Promise<void> {
...
export async function snippetForListProviderModels1(): Promise<void> {
...
export async function snippetForListSecretKeys(): Promise<void> {
  // >SEPARATOR listSecretKeys listSecretKeys with no params
  // Initialize the client
  const client = agentStudioClient('ALGOLIA_APPLICATION_ID', 'ALGOLIA_API_KEY');

  // Call the API
  const response = await client.listSecretKeys();
...
export async function snippetForListSecretKeys1(): Promise<void> {
  // >SEPARATOR listSecretKeys listSecretKeys with pagination
  // Initialize the client
  const client = agentStudioClient('ALGOLIA_APPLICATION_ID', 'ALGOLIA_API_KEY');

  // Call the API
  const response = await client.listSecretKeys({ page: 2, limit: 5 });
...
export async function snippetForListSecretKeys2(): Promise<void> {
  // >SEPARATOR listSecretKeys e2e list secret keys
  // Initialize the client
  const client = agentStudioClient('ALGOLIA_APPLICATION_ID', 'ALGOLIA_API_KEY');

  // Call the API
  const response = await client.listSecretKeys({ page: 1, limit: 10 });
...
//
// updateSecretKey
export async function snippetForUpdateSecretKey(): Promise<void> {
