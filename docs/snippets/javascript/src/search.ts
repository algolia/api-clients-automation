...
// >IMPORT
import { algoliasearch, type BatchResponse } from 'algoliasearch';
// IMPORT<
...
export async function snippetForDeleteObjects(): Promise<void> {
  ...
  // Call the API
  const response: BatchResponse[] = await client.deleteObjects({
...
export async function snippetForPartialUpdateObjects(): Promise<void> {
  ...
  // Call the API
  const response: BatchResponse[] = await client.partialUpdateObjects({
...
export async function snippetForSaveObjects(): Promise<void> {
  ...
  // Call the API
  const response: BatchResponse[] = await client.saveObjects({
...
export async function snippetForSaveObjects5(): Promise<void> {
...
export async function snippetForSaveObjectsWithTransformation1(): Promise<void> {
...
export async function snippetForSearchRules1(): Promise<void> {
