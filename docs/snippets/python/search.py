...
from algoliasearch.search.models import BatchResponse
...
def snippet_for_delete_objects():
    ...
    # Call the API
    response: list[BatchResponse] = client.delete_objects(
        index_name="<YOUR_INDEX_NAME>",
        object_ids=[
            "1",
            "2",
...
def snippet_for_partial_update_objects():
    ...
    # Call the API
    response: list[BatchResponse] = client.partial_update_objects(
        index_name="<YOUR_INDEX_NAME>",
        objects=[
            {
                "objectID": "1",
...
def snippet_for_save_objects():
    ...
    # Call the API
    response: list[BatchResponse] = client.save_objects(
        index_name="<YOUR_INDEX_NAME>",
        objects=[
            {
                "objectID": "1",
