...
final class AgentStudioClientSnippet {
    ...
    func snippetForCreateAgentCompletion() async throws {
        ...
        let response = try await client.createAgentCompletion(
            ...
            agentCompletionRequest: AgentCompletionRequest(messages: MessagesNullableUnionUnion
    ...
    func snippetForCreateProvider() async throws {
        ...
        let response = try await client.createProvider(providerAuthenticationCreate: ProviderAuthenticationCreate(
            ...
            input: ProviderInput.openAIProviderInputInput(OpenAIProviderInputInput(apiKey: "sk-test-key-1234"))
        ))
        // >LOG
        // print the response
        print(response)
    ...
    func snippetForCreateProvider1() async throws {
        ...
        let response = try await client.createProvider(providerAuthenticationCreate: ProviderAuthenticationCreate(
            ...
            input: ProviderInput.azureOpenAIProviderInputInput(AzureOpenAIProviderInputInput(
    ...
    func snippetForCreateSecretKey1() async throws {
        ...
        let response = try await client.createSecretKey(secretKeyCreate: SecretKeyCreate(
            name: "scoped-key",
            agentIds: ["785b14e4-61a8-4c03-8028-bf2ba3ae85ff"]
        ))
        // >LOG
        // print the response
        print(response)
    ...
    func snippetForGetSecretKey1() async throws {
        ...
        // Call the API
        let response = try await client.getSecretKey(secretKeyId: "f730dda4-9649-4cfb-9d88-b7e992fb89c9")
        // >LOG
        // print the response
        print(response)
        // SEPARATOR<
    ...
    func snippetForListAgentAllowedDomains() async throws {
        ...
        // Call the API
        let response = try await client.listAgentAllowedDomains(agentId: "785b14e4-61a8-4c03-8028-bf2ba3ae85ff")
        // >LOG
        // print the response
        print(response)
        // SEPARATOR<
        ...
        let response = try await client.updateProvider(
            ...
            providerAuthenticationPatch: ProviderAuthenticationPatch(
                ...
                input: ProviderInputNullable
                    .openAIProviderInputInput(OpenAIProviderInputInput(apiKey: "sk-new-key-5678"))
            )
        )
        // >LOG
        // print the response
    ...
    func snippetForUpdateSecretKey() async throws {
        ...
        let response = try await client.updateSecretKey(
            ...
            secretKeyPatch: SecretKeyPatch(name: "renamed-key", agentIds: ["785b14e4-61a8-4c03-8028-bf2ba3ae85ff"])
        )
        // >LOG
        // print the response
        print(response)
