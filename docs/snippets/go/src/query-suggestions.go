...
func SnippetForCreateConfigOfSuggestions() {
	...
	*/
	...
	// Call the API
	response, err := client.CreateConfig(context.Background(),
...
func SnippetForCustomGetOfSuggestions2() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomGet(context.Background(), "test/all", map[string]any{"query": "to be overriden"}, suggestions.WithQueryParam("query", "parameters with space"), suggestions.WithQueryParam("and an array",
...
func SnippetForCustomPostOfSuggestions1() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomPost(context.Background(), "test/all", suggestions.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"body": "parameters"}))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForCustomPostOfSuggestions2() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomPost(context.Background(), "test/requestOptions", suggestions.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), suggestions.WithQueryParam("query", "myQueryParameter"))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForCustomPostOfSuggestions3() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomPost(context.Background(), "test/requestOptions", suggestions.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), suggestions.WithQueryParam("query2", "myQueryParameter"))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForCustomPostOfSuggestions4() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomPost(context.Background(), "test/requestOptions", suggestions.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), suggestions.WithHeaderParam("x-algolia-api-key", "ALGOLIA_API_KEY"))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForCustomPostOfSuggestions6() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomPost(context.Background(), "test/requestOptions", suggestions.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), suggestions.WithQueryParam("isItWorking", true))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForCustomPostOfSuggestions7() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomPost(context.Background(), "test/requestOptions", suggestions.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), suggestions.WithQueryParam("myParam", 2))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForCustomPostOfSuggestions8() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomPost(context.Background(), "test/requestOptions", suggestions.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), suggestions.WithQueryParam("myParam",
		[]string{"b and c", "d"}))
	if err != nil {
		// handle the eventual error
		panic(err)
...
func SnippetForCustomPutOfSuggestions1() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomPut(context.Background(), "test/all", suggestions.NewCustomPutOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"body": "parameters"}))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForDeleteConfigOfSuggestions() {
	...
	*/
	...
	// Call the API
	response, err := client.DeleteConfig(context.Background(), "<YOUR_INDEX_NAME>")
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForGetAllConfigsOfSuggestions() {
	...
	*/
	...
	// Call the API
	response, err := client.GetAllConfigs(context.Background())
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForGetConfigOfSuggestions() {
	...
	*/
	...
	// Call the API
	response, err := client.GetConfig(context.Background(), "<YOUR_INDEX_NAME>")
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForGetConfigStatusOfSuggestions() {
	...
	*/
	...
	// Call the API
	response, err := client.GetConfigStatus(context.Background(), "<YOUR_INDEX_NAME>")
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForGetLogFileOfSuggestions() {
	...
	*/
	...
	// Call the API
	response, err := client.GetLogFile(context.Background(), "<YOUR_INDEX_NAME>")
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForUpdateConfigOfSuggestions() {
	...
	*/
	...
	// Call the API
	response, err := client.UpdateConfig(context.Background(), "<YOUR_INDEX_NAME>",
		[]suggestions.SourceIndex{*suggestions.NewEmptySourceIndex().SetIndexName("<YOUR_INDEX_NAME>").SetFacets(
			[]suggestions.Facet{*suggestions.NewEmptyFacet().SetAttribute("test")}).SetGenerate(
			[][]string{
				[]string{"facetA", "facetB"},
