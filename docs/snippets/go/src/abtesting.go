...
func SnippetForCustomGetOfAbtesting2() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomGet(context.Background(), "test/all", map[string]any{"query": "to be overriden"}, abtesting.WithQueryParam("query", "parameters with space"), abtesting.WithQueryParam("and an array",
...
func SnippetForCustomPostOfAbtesting1() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomPost(context.Background(), "test/all", abtesting.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"body": "parameters"}))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForCustomPostOfAbtesting2() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomPost(context.Background(), "test/requestOptions", abtesting.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), abtesting.WithQueryParam("query", "myQueryParameter"))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForCustomPostOfAbtesting3() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomPost(context.Background(), "test/requestOptions", abtesting.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), abtesting.WithQueryParam("query2", "myQueryParameter"))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForCustomPostOfAbtesting4() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomPost(context.Background(), "test/requestOptions", abtesting.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), abtesting.WithHeaderParam("x-algolia-api-key", "ALGOLIA_API_KEY"))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForCustomPostOfAbtesting6() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomPost(context.Background(), "test/requestOptions", abtesting.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), abtesting.WithQueryParam("isItWorking", true))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForCustomPostOfAbtesting7() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomPost(context.Background(), "test/requestOptions", abtesting.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), abtesting.WithQueryParam("myParam", 2))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForCustomPostOfAbtesting8() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomPost(context.Background(), "test/requestOptions", abtesting.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), abtesting.WithQueryParam("myParam",
		[]string{"b and c", "d"}))
	if err != nil {
		// handle the eventual error
		panic(err)
...
func SnippetForCustomPutOfAbtesting1() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomPut(context.Background(), "test/all", abtesting.NewCustomPutOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"body": "parameters"}))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForListABTestsOfAbtesting1() {
	...
	*/
	...
	// Call the API
	response, err := client.ListABTests(context.Background(), abtesting.NewListABTestsOptions().WithOffset(0).WithLimit(21).WithIndexPrefix("cts_e2e ab").WithIndexSuffix("t"))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
