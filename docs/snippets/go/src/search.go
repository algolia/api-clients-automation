...
func SnippetForCustomGetOfSearch2() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomGet("test/all", map[string]any{"query": "to be overriden"}, search.WithQueryParam("query", "parameters with space"), search.WithQueryParam("and an array",
...
func SnippetForCustomPostOfSearch1() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomPost("test/all", search.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"body": "parameters"}))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForCustomPostOfSearch2() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomPost("test/requestOptions", search.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), search.WithQueryParam("query", "myQueryParameter"))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForCustomPostOfSearch3() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomPost("test/requestOptions", search.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), search.WithQueryParam("query2", "myQueryParameter"))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForCustomPostOfSearch4() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomPost("test/requestOptions", search.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), search.WithHeaderParam("x-algolia-api-key", "ALGOLIA_API_KEY"))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForCustomPostOfSearch6() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomPost("test/requestOptions", search.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), search.WithQueryParam("isItWorking", true))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForCustomPostOfSearch7() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomPost("test/requestOptions", search.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), search.WithQueryParam("myParam", 2))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForCustomPostOfSearch8() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomPost("test/requestOptions", search.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), search.WithQueryParam("myParam",
		[]string{"b and c", "d"}))
	if err != nil {
		// handle the eventual error
		panic(err)
...
func SnippetForCustomPutOfSearch1() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomPut("test/all", search.NewCustomPutOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"body": "parameters"}))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForGetLogsOfSearch1() {
	...
	*/
	...
	// Call the API
	response, err := client.GetLogs(search.NewGetLogsOptions().WithOffset(5).WithLength(10).WithIndexName("<YOUR_INDEX_NAME>").WithType(search.LOG_TYPE_ALL))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForPartialUpdateObjectOfSearch4() {
	...
	*/
	...
	// Call the API
	response, err := client.PartialUpdateObject("<YOUR_INDEX_NAME>", "uniqueID", map[string]any{"attributeId": map[string]any{"nested": "value"}}, nil)
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForPartialUpdateObjectOfSearch5() {
	...
	*/
	...
	// Call the API
	response, err := client.PartialUpdateObject("<YOUR_INDEX_NAME>", "uniqueID", map[string]any{"visible_by": []string{"Angela", "group/Finance", "group/Shareholders"}}, nil)
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForPartialUpdateObjectOfSearch6() {
	...
	*/
	...
	// Call the API
	response, err := client.PartialUpdateObject("<YOUR_INDEX_NAME>", "productId", map[string]any{"categoryPageId": map[string]any{"_operation": "Add", "value": "men-clothing-pants"}}, nil)
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForPartialUpdateObjectOfSearch7() {
	...
	*/
	...
	// Call the API
	response, err := client.PartialUpdateObject("<YOUR_INDEX_NAME>", "productId", map[string]any{"categoryPageId": map[string]any{"_operation": "Remove", "value": "men-clothing-pants"}}, nil)
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForSaveObjectOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.SaveObject("<YOUR_INDEX_NAME>", map[string]any{"name": "Black T-shirt", "color": "#000000||black", "availableIn": "https://source.unsplash.com/100x100/?paris||Paris", "objectID": "myID"})
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForSearchDictionaryEntriesOfSearch1() {
	...
	*/
	...
	// Call the API
	response, err := client.SearchDictionaryEntries(search.DICTIONARY_TYPE_COMPOUNDS, "foo", search.NewSearchDictionaryEntriesOptions().WithPage(4).WithHitsPerPage(2).WithLanguage(search.SUPPORTED_LANGUAGE_FR))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForSearchForFacetValuesOfSearch1() {
	...
	*/
	...
	// Call the API
	response, err := client.SearchForFacetValues("<YOUR_INDEX_NAME>", "facetName", search.NewSearchForFacetValuesOptions().WithParams("query=foo&facetFilters=['bar']").WithFacetQuery("foo").WithMaxFacetHits(42))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForSearchSynonymsOfSearch1() {
	...
	*/
	...
	// Call the API
	response, err := client.SearchSynonyms("<YOUR_INDEX_NAME>", search.NewSearchSynonymsOptions().WithQuery("myQuery").WithType(search.SYNONYM_TYPE_ALTCORRECTION1).WithPage(10).WithHitsPerPage(10))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForUpdateApiKeyOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.UpdateApiKey("ALGOLIA_API_KEY",
