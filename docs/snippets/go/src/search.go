...
func SnippetForAddApiKeyOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.AddApiKey(context.Background(),
...
func SnippetForAddApiKeyOfSearch1() {
	...
	*/
	...
	// Call the API
	response, err := client.AddApiKey(
		context.Background(),
		[]search.Acl{
			search.ACL_SEARCH,
			search.ACL_ADD_OBJECT,
		},
		search.NewAddApiKeyOptions().WithDescription("my new api key").WithValidity(300).WithMaxQueriesPerIPPerHour(100).WithMaxHitsPerQuery(20),
	)
	if err != nil {
		// handle the eventual error
		panic(err)
...
func SnippetForAddOrUpdateObjectOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.AddOrUpdateObject(context.Background(), "<YOUR_INDEX_NAME>", "uniqueID", map[string]any{"key": "value"})
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForAppendSourceOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.AppendSource(context.Background(), "theSource", utils.ToPtr("theDescription"))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForAssignUserIdOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.AssignUserId(context.Background(), "user42", "d4242-eu")
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForAssignUserIdOfSearch1() {
	...
	*/
	...
	// Call the API
	response, err := client.AssignUserId(context.Background(), "user id with spaces", "cluster with spaces")
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForBatchOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.Batch(
		context.Background(),
		"<YOUR_INDEX_NAME>",
		[]search.BatchRequest{
			*search.NewEmptyBatchRequest().SetAction(search.ACTION_ADD_OBJECT).SetBody(map[string]any{"key": "bar", "foo": "1"}),
			*search.NewEmptyBatchRequest().SetAction(search.ACTION_ADD_OBJECT).SetBody(map[string]any{"key": "baz", "foo": "2"}),
		},
	)
	if err != nil {
		// handle the eventual error
...
func SnippetForBatchOfSearch1() {
	...
	*/
	...
	// Call the API
	response, err := client.Batch(context.Background(), "<YOUR_INDEX_NAME>",
...
func SnippetForBatchOfSearch5() {
	...
	*/
	...
	response, err := client.Batch(
		...
		"<YOUR_INDEX_NAME>",
		[]search.BatchRequest{
			*search.NewEmptyBatchRequest().SetAction(search.ACTION_PARTIAL_UPDATE_OBJECT_NO_CREATE).SetBody(map[string]any{"key": "value"}),
		},
	)
	if err != nil {
		// handle the eventual error
...
func SnippetForBatchAssignUserIdsOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.BatchAssignUserIds(context.Background(), "userID", "theCluster",
		[]string{"user1", "user2"})
	if err != nil {
		// handle the eventual error
		panic(err)
...
func SnippetForBatchDictionaryEntriesOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.BatchDictionaryEntries(context.Background(), search.DICTIONARY_TYPE_PLURALS,
...
func SnippetForBatchDictionaryEntriesOfSearch1() {
	...
	*/
	...
	// Call the API
	response, err := client.BatchDictionaryEntries(
		context.Background(),
		search.DICTIONARY_TYPE_PLURALS,
		[]search.BatchDictionaryEntriesRequest{
			*search.NewEmptyBatchDictionaryEntriesRequest().SetAction(search.DICTIONARY_ACTION_DELETE_ENTRY).SetBody(
...
func SnippetForBatchDictionaryEntriesOfSearch2() {
	...
	*/
	...
	// Call the API
	response, err := client.BatchDictionaryEntries(context.Background(), search.DICTIONARY_TYPE_STOPWORDS,
		[]search.BatchDictionaryEntriesRequest{*search.NewEmptyBatchDictionaryEntriesRequest().SetAction(search.DICTIONARY_ACTION_ADD_ENTRY).SetBody(
...
func SnippetForBrowseOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.Browse(context.Background(), "<YOUR_INDEX_NAME>", nil)
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForBrowseOfSearch1() {
	...
	*/
	...
	// Call the API
	response, err := client.Browse(context.Background(), "<YOUR_INDEX_NAME>", search.BrowseParamsObjectAsBrowseParams(
...
func SnippetForClearObjectsOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.ClearObjects(context.Background(), "<YOUR_INDEX_NAME>")
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForClearRulesOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.ClearRules(context.Background(), "<YOUR_INDEX_NAME>", nil)
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForClearSynonymsOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.ClearSynonyms(context.Background(), "<YOUR_INDEX_NAME>", nil)
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForCustomGetOfSearch2() {
	...
	*/
	...
	response, err := client.CustomGet(
		...
		search.WithQueryParam("query", "parameters with space"),
		search.WithQueryParam("and an array",
			[]string{"array", "with spaces"}),
		search.WithHeaderParam("x-header-1", "spaces are left alone"),
	)
	if err != nil {
		// handle the eventual error
		panic(err)
...
func SnippetForCustomPostOfSearch1() {
	...
	*/
	...
	response, err := client.CustomPost(
		context.Background(),
		"test/all",
		search.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"body": "parameters"}),
	)
	if err != nil {
		// handle the eventual error
		panic(err)
...
func SnippetForCustomPostOfSearch2() {
	...
	*/
	...
	response, err := client.CustomPost(
		context.Background(),
		"test/requestOptions",
		search.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}),
...
func SnippetForCustomPutOfSearch1() {
	...
	*/
	...
	response, err := client.CustomPut(
		context.Background(),
		"test/all",
		search.NewCustomPutOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"body": "parameters"}),
	)
	if err != nil {
		// handle the eventual error
		panic(err)
...
func SnippetForDeleteApiKeyOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.DeleteApiKey(context.Background(), "myTestApiKey")
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForDeleteByOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.DeleteBy(context.Background(), "<YOUR_INDEX_NAME>", search.NewDeleteByOptions().WithFilters("brand:brandName"))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForDeleteIndexOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.DeleteIndex(context.Background(), "<YOUR_INDEX_NAME>")
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForDeleteObjectOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.DeleteObject(context.Background(), "<YOUR_INDEX_NAME>", "uniqueID")
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForDeleteObjectsOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.DeleteObjects(context.Background(), "<YOUR_INDEX_NAME>",
		[]string{"1", "2"})
	if err != nil {
		// handle the eventual error
		panic(err)
...
func SnippetForDeleteRuleOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.DeleteRule(context.Background(), "<YOUR_INDEX_NAME>", "id1", nil)
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForDeleteRuleOfSearch1() {
	...
	*/
	...
	// Call the API
	response, err := client.DeleteRule(context.Background(), "<YOUR_INDEX_NAME>", "test/with/slash", nil)
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForDeleteSourceOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.DeleteSource(context.Background(), "theSource")
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForDeleteSynonymOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.DeleteSynonym(context.Background(), "<YOUR_INDEX_NAME>", "id1", nil)
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForGenerateSecuredApiKeyOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.GenerateSecuredApiKey("2640659426d5107b6e47d75db9cbaef8",
	...
	response, err := client.GenerateSecuredApiKey("2640659426d5107b6e47d75db9cbaef8",
		search.NewEmptySecuredApiKeyRestrictions().SetValidUntil(2524604400).SetRestrictIndices(
			...
			search.NewEmptySearchParamsObject().
				SetQuery("batman").
				SetTypoTolerance(search.TypoToleranceEnumAsTypoTolerance(search.TYPO_TOLERANCE_ENUM_STRICT)).
				SetAroundRadius(search.AroundRadiusAllAsAroundRadius(search.AROUND_RADIUS_ALL_ALL)).
				SetMode(search.MODE_NEURAL_SEARCH).
				SetHitsPerPage(10).
...
func SnippetForGenerateSecuredApiKeyOfSearch5() {
	...
	*/
	...
	// Call the API
	response, err := client.GenerateSecuredApiKey("YourSearchOnlyApiKey",
...
func SnippetForGetApiKeyOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.GetApiKey(context.Background(), "myTestApiKey")
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForGetAppTaskOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.GetAppTask(context.Background(), 123)
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForGetDictionaryLanguagesOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.GetDictionaryLanguages(context.Background())
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForGetDictionarySettingsOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.GetDictionarySettings(context.Background())
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForGetLogsOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.GetLogs(context.Background(), nil)
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForGetLogsOfSearch1() {
	...
	*/
	...
	response, err := client.GetLogs(
		context.Background(),
		search.NewGetLogsOptions().WithOffset(5).WithLength(10).WithIndexName("<YOUR_INDEX_NAME>").WithType(search.LOG_TYPE_ALL),
	)
	if err != nil {
		// handle the eventual error
		panic(err)
...
func SnippetForGetObjectOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.GetObject(context.Background(), "<YOUR_INDEX_NAME>", "uniqueID", utils.ToPtr(
		[]string{"attr1", "attr2"}))
	if err != nil {
		// handle the eventual error
		panic(err)
...
func SnippetForGetObjectOfSearch1() {
	...
	*/
	...
	// Call the API
	response, err := client.GetObject(context.Background(), "<YOUR_INDEX_NAME>", "Batman and Robin", nil)
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForGetObjectsOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.GetObjects(context.Background(),
...
func SnippetForGetObjectsOfSearch1() {
	...
	*/
	...
	// Call the API
	response, err := client.GetObjects(
		context.Background(),
...
func SnippetForGetRuleOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.GetRule(context.Background(), "<YOUR_INDEX_NAME>", "qr-1725004648916")
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForGetSettingsOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.GetSettings(context.Background(), "<YOUR_INDEX_NAME>", utils.ToPtr(2))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForGetSourcesOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.GetSources(context.Background())
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForGetSynonymOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.GetSynonym(context.Background(), "<YOUR_INDEX_NAME>", "id1")
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForGetTaskOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.GetTask(context.Background(), "<YOUR_INDEX_NAME>", 123)
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForGetTopUserIdsOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.GetTopUserIds(context.Background())
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForGetUserIdOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.GetUserId(context.Background(), "uniqueID")
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForHasPendingMappingsOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.HasPendingMappings(context.Background(), nil)
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForHasPendingMappingsOfSearch1() {
	...
	*/
	...
	// Call the API
	response, err := client.HasPendingMappings(context.Background(), utils.ToPtr(true))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForIndexExistsOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.IndexExists(context.Background(), "<YOUR_INDEX_NAME>")
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForListApiKeysOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.ListApiKeys(context.Background())
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForListClustersOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.ListClusters(context.Background())
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForListIndicesOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.ListIndices(context.Background(), nil)
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForListIndicesOfSearch1() {
	...
	*/
	...
	// Call the API
	response, err := client.ListIndices(context.Background(), search.NewListIndicesOptions().WithPage(8).WithHitsPerPage(3))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForListUserIdsOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.ListUserIds(context.Background(), nil)
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForListUserIdsOfSearch1() {
	...
	*/
	...
	// Call the API
	response, err := client.ListUserIds(context.Background(), search.NewListUserIdsOptions().WithPage(8).WithHitsPerPage(100))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForMultipleBatchOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.MultipleBatch(
		context.Background(),
		[]search.MultipleBatchRequest{
			*search.NewEmptyMultipleBatchRequest().SetAction(search.ACTION_ADD_OBJECT).SetBody(map[string]any{"key": "value"}).SetIndexName("<YOUR_INDEX_NAME>"),
		},
	)
	if err != nil {
		// handle the eventual error
...
func SnippetForOperationIndexOfSearch1() {
	...
	*/
	...
	// Call the API
	response, err := client.OperationIndex(context.Background(), "<SOURCE_INDEX_NAME>", search.OPERATION_TYPE_COPY, "<DESTINATION_INDEX_NAME>", nil)
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForOperationIndexOfSearch2() {
	...
	*/
	...
	// Call the API
	response, err := client.OperationIndex(context.Background(), "<SOURCE_INDEX_NAME>", search.OPERATION_TYPE_MOVE, "<DESTINATION_INDEX_NAME>", nil)
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForPartialUpdateObjectOfSearch() {
	...
	*/
	...
	response, err := client.PartialUpdateObject(
		...
		"<YOUR_INDEX_NAME>",
		"uniqueID",
		map[string]any{"attributeId": "new value"},
		nil,
	)
	if err != nil {
		// handle the eventual error
...
func SnippetForPartialUpdateObjectOfSearch1() {
	...
	*/
	...
	// Call the API
	response, err := client.PartialUpdateObject(context.Background(), "<YOUR_INDEX_NAME>", "uniqueID", map[string]any{"attributeId": 1}, nil)
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForPartialUpdateObjectOfSearch2() {
	...
	*/
	...
	// Call the API
	response, err := client.PartialUpdateObject(context.Background(), "<YOUR_INDEX_NAME>", "uniqueID", map[string]any{"attributeId": true}, nil)
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForPartialUpdateObjectOfSearch3() {
	...
	*/
	...
	response, err := client.PartialUpdateObject(
		...
		"<YOUR_INDEX_NAME>",
		"uniqueID",
		map[string]any{"attributeId": []string{"one", "two", "three"}},
		nil,
	)
	if err != nil {
		// handle the eventual error
...
func SnippetForPartialUpdateObjectOfSearch4() {
	...
	*/
	...
	response, err := client.PartialUpdateObject(
		...
		"<YOUR_INDEX_NAME>",
		"uniqueID",
		map[string]any{"attributeId": map[string]any{"nested": "value"}},
		nil,
	)
	if err != nil {
		// handle the eventual error
...
func SnippetForPartialUpdateObjectOfSearch5() {
	...
	*/
	...
	response, err := client.PartialUpdateObject(
		...
		"<YOUR_INDEX_NAME>",
		"uniqueID",
		map[string]any{"visible_by": []string{"Angela", "group/Finance", "group/Shareholders"}},
		nil,
	)
	if err != nil {
		// handle the eventual error
...
func SnippetForPartialUpdateObjectOfSearch6() {
	...
	*/
	...
	response, err := client.PartialUpdateObject(
		...
		"<YOUR_INDEX_NAME>",
		"productId",
		map[string]any{"categoryPageId": map[string]any{"_operation": "Add", "value": "men-clothing-pants"}},
		nil,
	)
	if err != nil {
		// handle the eventual error
...
func SnippetForPartialUpdateObjectOfSearch7() {
	...
	*/
	...
	response, err := client.PartialUpdateObject(
		...
		"<YOUR_INDEX_NAME>",
		"productId",
		map[string]any{"categoryPageId": map[string]any{"_operation": "Remove", "value": "men-clothing-pants"}},
		nil,
	)
	if err != nil {
		// handle the eventual error
...
func SnippetForPartialUpdateObjectsOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.PartialUpdateObjects(context.Background(), "<YOUR_INDEX_NAME>",
...
func SnippetForRemoveUserIdOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.RemoveUserId(context.Background(), "uniqueID")
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForReplaceAllObjectsOfSearch1() {
	...
	*/
	...
	// Call the API
	response, err := client.ReplaceAllObjects(context.Background(), "<YOUR_INDEX_NAME>",
		[]map[string]any{{"objectID": "1", "name": "Adam"}, {"objectID": "2", "name": "Benoit"}}, search.WithBatchSize(77), search.WithScopes(
			[]search.ScopeType{search.SCOPE_TYPE_SETTINGS, search.SCOPE_TYPE_SYNONYMS}))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForReplaceSourcesOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.ReplaceSources(context.Background(),
...
func SnippetForRestoreApiKeyOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.RestoreApiKey(context.Background(), "ALGOLIA_API_KEY")
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForSaveObjectsOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.SaveObjects(context.Background(), "<YOUR_INDEX_NAME>",
...
func SnippetForSaveObjectsWithTransformationOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.SaveObjectsWithTransformation(context.Background(), "<YOUR_INDEX_NAME>",
...
func SnippetForSaveRuleOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.SaveRule(context.Background(), "<YOUR_INDEX_NAME>", "id1",
...
func SnippetForSaveRuleOfSearch1() {
	...
	*/
	...
	response, err := client.SaveRule(context.Background(), "<YOUR_INDEX_NAME>", "id1",
		search.NewEmptyRule().SetObjectID("id1").SetConditions(
			[]search.Condition{
				*search.NewEmptyCondition().SetPattern("apple").SetAnchoring(search.ANCHORING_CONTAINS).SetAlternatives(false).SetContext("search"),
			}).
			SetConsequence(
				search.NewEmptyConsequence().SetParams(
					search.NewEmptyConsequenceParams().SetFilters("brand:apple").SetQuery(search.ConsequenceQueryObjectAsConsequenceQuery(
						search.NewEmptyConsequenceQueryObject().SetRemove(
							...
							[]search.Edit{
								*search.NewEmptyEdit().SetType(search.EDIT_TYPE_REMOVE).SetDelete("abc").SetInsert("cde"),
								*search.NewEmptyEdit().SetType(search.EDIT_TYPE_REPLACE).SetDelete("abc").SetInsert("cde"),
							}),
					))).SetHide(
...
func SnippetForSaveRuleOfSearch2() {
	...
	*/
	...
	// Call the API
	response, err := client.SaveRule(context.Background(), "<YOUR_INDEX_NAME>", "article-rule",
			...
			search.NewEmptyConsequence().SetParams(
				search.NewEmptyConsequenceParams().SetQuery(search.ConsequenceQueryObjectAsConsequenceQuery(
					search.NewEmptyConsequenceQueryObject().SetEdits(
						[]search.Edit{
							*search.NewEmptyEdit().SetType(search.EDIT_TYPE_REMOVE).SetDelete("article"),
						}),
...
func SnippetForSaveRuleOfSearch3() {
	...
	*/
	...
	// Call the API
	response, err := client.SaveRule(context.Background(), "<YOUR_INDEX_NAME>", "director-rule",
		search.NewEmptyRule().SetObjectID("director-rule").SetConditions(
			[]search.Condition{
				*search.NewEmptyCondition().SetPattern("{facet:director} director").SetAnchoring(search.ANCHORING_CONTAINS),
			}).
			SetConsequence(
				search.NewEmptyConsequence().SetParams(
...
func SnippetForSaveRuleOfSearch4() {
	...
	*/
	...
	// Call the API
	response, err := client.SaveRule(context.Background(), "<YOUR_INDEX_NAME>", "harry-potter-rule",
...
func SnippetForSaveRuleOfSearch5() {
	...
	*/
	...
	// Call the API
	response, err := client.SaveRule(context.Background(), "<YOUR_INDEX_NAME>", "clearance-category-filter",
...
func SnippetForSaveRuleOfSearch6() {
	...
	*/
	...
	// Call the API
	response, err := client.SaveRule(context.Background(), "<YOUR_INDEX_NAME>", "redirect-help-rule",
...
func SnippetForSaveRuleOfSearch7() {
	...
	*/
	...
	// Call the API
	response, err := client.SaveRule(context.Background(), "<YOUR_INDEX_NAME>", "tomato-fruit",
...
func SnippetForSaveRuleOfSearch8() {
	...
	*/
	...
	// Call the API
	response, err := client.SaveRule(context.Background(), "<YOUR_INDEX_NAME>", "Promote-Apple-Newest",
...
func SnippetForSaveRuleOfSearch9() {
	...
	*/
	...
	// Call the API
	response, err := client.SaveRule(context.Background(), "<YOUR_INDEX_NAME>", "Promote-iPhone-X",
...
func SnippetForSaveRuleOfSearch10() {
	...
	*/
	...
	// Call the API
	response, err := client.SaveRule(context.Background(), "<YOUR_INDEX_NAME>", "promote-harry-potter-box-set",
...
func SnippetForSaveRuleOfSearch12() {
	...
	*/
	...
	// Call the API
	response, err := client.SaveRule(context.Background(), "<YOUR_INDEX_NAME>", "tagged-brand-rule",
		search.NewEmptyRule().SetConditions(
			[]search.Condition{
				*search.NewEmptyCondition().SetPattern("brand: {facet:brand}").SetAnchoring(search.ANCHORING_CONTAINS).SetAlternatives(false),
			}).
			SetConsequence(
				search.NewEmptyConsequence().SetParams(
...
func SnippetForSaveRuleOfSearch13() {
	...
	*/
	...
	// Call the API
	response, err := client.SaveRule(context.Background(), "<YOUR_INDEX_NAME>", "color-facets",
...
func SnippetForSaveRuleOfSearch14() {
	...
	*/
	...
	// Call the API
	response, err := client.SaveRule(context.Background(), "<YOUR_INDEX_NAME>", "hide-12345",
...
func SnippetForSaveRuleOfSearch15() {
	...
	*/
	...
	// Call the API
	response, err := client.SaveRule(context.Background(), "<YOUR_INDEX_NAME>", "red-color",
...
func SnippetForSaveRuleOfSearch16() {
	...
	*/
	...
	// Call the API
	response, err := client.SaveRule(context.Background(), "<YOUR_INDEX_NAME>", "cheap",
...
func SnippetForSaveRuleOfSearch17() {
	...
	*/
	...
	// Call the API
	response, err := client.SaveRule(context.Background(), "<YOUR_INDEX_NAME>", "gluten-free-rule",
...
func SnippetForSaveRuleOfSearch18() {
	...
	*/
	...
	// Call the API
	response, err := client.SaveRule(context.Background(), "<YOUR_INDEX_NAME>", "diet-rule",
...
func SnippetForSaveRuleOfSearch20() {
	...
	*/
	...
	// Call the API
	response, err := client.SaveRule(context.Background(), "<YOUR_INDEX_NAME>", "a-rule-id",
	...
	*/
	...
	response, err := client.SaveRule(context.Background(), "<YOUR_INDEX_NAME>", "a-rule-id",
		search.NewEmptyRule().SetObjectID("a-rule-id").SetConsequence(
			search.NewEmptyConsequence().SetParams(
				search.NewEmptyConsequenceParams().SetAroundRadius(search.IntAsAroundRadius(1000)))).SetValidity(
	...
	*/
	...
	response, err := client.SaveRule(context.Background(), "<YOUR_INDEX_NAME>", "a-rule-id",
		search.NewEmptyRule().SetObjectID("a-rule-id").SetConsequence(
			search.NewEmptyConsequence().SetParams(
				search.NewEmptyConsequenceParams().SetAroundRadius(search.IntAsAroundRadius(1000)))).SetValidity(
			[]search.TimeRange{*search.NewEmptyTimeRange().SetFrom(1577836800)}), nil)
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForSaveRulesOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.SaveRules(context.Background(), "<YOUR_INDEX_NAME>",
...
func SnippetForSaveSynonymOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.SaveSynonym(context.Background(), "<YOUR_INDEX_NAME>", "id1",
		search.NewEmptySynonymHit().SetObjectID("id1").SetType(search.SYNONYM_TYPE_SYNONYM).SetSynonyms(
			[]string{"car", "vehicle", "auto"}), utils.ToPtr(true))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForSaveSynonymsOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.SaveSynonyms(context.Background(), "<YOUR_INDEX_NAME>",
		[]search.SynonymHit{*search.NewEmptySynonymHit().SetObjectID("id1").SetType(search.SYNONYM_TYPE_SYNONYM).SetSynonyms(
			[]string{"car", "vehicle", "auto"}), *search.NewEmptySynonymHit().SetObjectID("id2").SetType(search.SYNONYM_TYPE_ONEWAYSYNONYM).SetInput("iphone").SetSynonyms(
...
func SnippetForSearchOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.Search(context.Background(),
...
func SnippetForSearchOfSearch4() {
	...
	*/
	...
	response, err := client.Search(context.Background(),
		[]search.SearchQuery{*search.SearchForHitsAsSearchQuery(
			search.NewEmptySearchForHits().SetIndexName("<YOUR_INDEX_NAME>"))}, nil)
	if err != nil {
		// handle the eventual error
		panic(err)
	}
	...
	*/
	...
	response, err := client.Search(context.Background(),
		[]search.SearchQuery{*search.SearchForFacetsAsSearchQuery(
			search.NewEmptySearchForFacets().SetIndexName("<YOUR_INDEX_NAME>").SetType(search.SEARCH_TYPE_FACET_FACET).SetFacet("editor"))}, utils.ToPtr(search.SEARCH_STRATEGY_STOP_IF_ENOUGH_MATCHES))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForSearchOfSearch9() {
	...
	*/
	...
	response, err := client.Search(context.Background(),
		[]search.SearchQuery{*search.SearchForHitsAsSearchQuery(
			search.NewEmptySearchForHits().SetIndexName("<YOUR_INDEX_NAME>").SetQuery("myQuery").SetHitsPerPage(50).SetType(search.SEARCH_TYPE_DEFAULT_DEFAULT))}, nil)
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForSearchOfSearch10() {
	...
	*/
	...
	response, err := client.Search(context.Background(),
		[]search.SearchQuery{*search.SearchForFacetsAsSearchQuery(
			search.NewEmptySearchForFacets().SetIndexName("<YOUR_INDEX_NAME>").SetType(search.SEARCH_TYPE_FACET_FACET).SetFacet("theFacet").SetFacetQuery("theFacetQuery").SetQuery("theQuery").SetMaxFacetHits(50))}, utils.ToPtr(search.SEARCH_STRATEGY_STOP_IF_ENOUGH_MATCHES))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
	...
	*/
	...
	response, err := client.Search(context.Background(),
		[]search.SearchQuery{*search.SearchForHitsAsSearchQuery(
			...
			search.NewEmptySearchForFacets().SetIndexName("<YOUR_INDEX_NAME>").SetType(search.SEARCH_TYPE_FACET_FACET).SetFacet("theFacet")), *search.SearchForHitsAsSearchQuery(
			search.NewEmptySearchForHits().SetIndexName("<YOUR_INDEX_NAME>").SetType(search.SEARCH_TYPE_DEFAULT_DEFAULT))}, utils.ToPtr(search.SEARCH_STRATEGY_STOP_IF_ENOUGH_MATCHES))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForSearchOfSearch12() {
	...
	*/
	...
	response, err := client.Search(context.Background(),
		[]search.SearchQuery{*search.SearchForFacetsAsSearchQuery(
			search.NewEmptySearchForFacets().SetIndexName("<YOUR_INDEX_NAME>").SetType(search.SEARCH_TYPE_FACET_FACET).SetFacet("theFacet").SetFacetQuery("theFacetQuery").SetQuery("theQuery").SetMaxFacetHits(50)), *search.SearchForHitsAsSearchQuery(
			search.NewEmptySearchForHits().SetIndexName("<YOUR_INDEX_NAME>").SetQuery("myQuery").SetHitsPerPage(50).SetType(search.SEARCH_TYPE_DEFAULT_DEFAULT))}, utils.ToPtr(search.SEARCH_STRATEGY_STOP_IF_ENOUGH_MATCHES))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
	...
	response, err := client.Search(context.Background(),
		[]search.SearchQuery{*search.SearchForHitsAsSearchQuery(
			search.NewEmptySearchForHits().SetAdvancedSyntax(true).SetAdvancedSyntaxFeatures(
				...
				[]string{""}).SetAroundLatLng("").SetAroundLatLngViaIP(true).SetAroundPrecision(search.IntAsAroundPrecision(0)).SetAroundRadius(search.AroundRadiusAllAsAroundRadius(search.AROUND_RADIUS_ALL_ALL)).SetAttributeCriteriaComputedByMinProximity(true).SetAttributesToHighlight(
				[]string{""}).SetAttributesToRetrieve(
				...
				[]string{""}).SetDistinct(search.IntAsDistinct(0)).SetEnableABTest(true).SetEnablePersonalization(true).SetEnableReRanking(true).SetEnableRules(true).SetExactOnSingleWordQuery(search.EXACT_ON_SINGLE_WORD_QUERY_ATTRIBUTE).SetFacetFilters(search.ArrayOfFacetFiltersAsFacetFilters(
...
func SnippetForSearchDictionaryEntriesOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.SearchDictionaryEntries(context.Background(), search.DICTIONARY_TYPE_STOPWORDS, "about", nil)
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForSearchDictionaryEntriesOfSearch1() {
	...
	*/
	...
	// Call the API
	response, err := client.SearchDictionaryEntries(
		context.Background(),
		search.DICTIONARY_TYPE_COMPOUNDS,
		"foo",
		search.NewSearchDictionaryEntriesOptions().WithPage(4).WithHitsPerPage(2).WithLanguage(search.SUPPORTED_LANGUAGE_FR),
	)
	if err != nil {
		// handle the eventual error
		panic(err)
...
func SnippetForSearchForFacetValuesOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.SearchForFacetValues(context.Background(), "<YOUR_INDEX_NAME>", "facetName", nil)
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForSearchForFacetValuesOfSearch1() {
	...
	*/
	...
	// Call the API
	response, err := client.SearchForFacetValues(
		context.Background(),
		"<YOUR_INDEX_NAME>",
		"facetName",
		search.NewSearchForFacetValuesOptions().WithParams("query=foo&facetFilters=['bar']").WithFacetQuery("foo").WithMaxFacetHits(42),
	)
	if err != nil {
		// handle the eventual error
		panic(err)
...
func SnippetForSearchForFacetValuesOfSearch2() {
	...
	*/
	...
	response, err := client.SearchForFacetValues(
		...
		"<YOUR_INDEX_NAME>",
		"author",
		search.NewSearchForFacetValuesOptions().WithFacetQuery("stephen"),
	)
	if err != nil {
		// handle the eventual error
		panic(err)
...
func SnippetForSearchRulesOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.SearchRules(context.Background(), "<YOUR_INDEX_NAME>", search.NewSearchRulesOptions().WithQuery("zorro"))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForSearchSingleIndexOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.SearchSingleIndex(context.Background(), "<YOUR_INDEX_NAME>", nil)
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForSearchSingleIndexOfSearch2() {
	...
	*/
	...
	// Call the API
	response, err := client.SearchSingleIndex(context.Background(), "<YOUR_INDEX_NAME>", search.SearchParamsObjectAsSearchParams(
...
func SnippetForSearchSingleIndexOfSearch27() {
	...
	*/
	...
	// Call the API
	response, err := client.SearchSingleIndex(context.Background(), "<YOUR_INDEX_NAME>", search.SearchParamsObjectAsSearchParams(
		search.NewEmptySearchParamsObject().SetAroundLatLng("40.71, -74.01").SetAroundRadius(search.IntAsAroundRadius(1000000))))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForSearchSingleIndexOfSearch84() {
	...
	*/
	...
	// Call the API
	response, err := client.SearchSingleIndex(context.Background(), "<YOUR_INDEX_NAME>", search.SearchParamsObjectAsSearchParams(
		search.NewEmptySearchParamsObject().SetQuery("query").SetAroundRadius(search.IntAsAroundRadius(1000))))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForSearchSingleIndexOfSearch86() {
	...
	*/
	...
	// Call the API
	response, err := client.SearchSingleIndex(context.Background(), "<YOUR_INDEX_NAME>", search.SearchParamsObjectAsSearchParams(
		search.NewEmptySearchParamsObject().SetQuery("query").SetAroundPrecision(search.IntAsAroundPrecision(100))))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForSearchSingleIndexOfSearch114() {
	...
	*/
	...
	// Call the API
	response, err := client.SearchSingleIndex(context.Background(), "<YOUR_INDEX_NAME>", search.SearchParamsObjectAsSearchParams(
		search.NewEmptySearchParamsObject().SetQuery("query").SetDistinct(search.IntAsDistinct(0))))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForSearchSynonymsOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.SearchSynonyms(context.Background(), "<YOUR_INDEX_NAME>", nil)
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForSearchSynonymsOfSearch1() {
	...
	*/
	...
	// Call the API
	response, err := client.SearchSynonyms(
		context.Background(),
		"<YOUR_INDEX_NAME>",
		search.NewSearchSynonymsOptions().WithQuery("myQuery").WithType(search.SYNONYM_TYPE_ALTCORRECTION1).WithPage(10).WithHitsPerPage(10),
	)
	if err != nil {
		// handle the eventual error
		panic(err)
...
func SnippetForSearchUserIdsOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.SearchUserIds(
		context.Background(),
		"test",
		search.NewSearchUserIdsOptions().WithClusterName("theClusterName").WithPage(5).WithHitsPerPage(10),
	)
	if err != nil {
		// handle the eventual error
		panic(err)
...
func SnippetForSetDictionarySettingsOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.SetDictionarySettings(context.Background(),
...
func SnippetForSetDictionarySettingsOfSearch1() {
	...
	*/
	...
	// Call the API
	response, err := client.SetDictionarySettings(
		context.Background(),
...
func SnippetForSetSettingsOfSearch1() {
	...
	*/
	...
	// Call the API
	response, err := client.SetSettings(context.Background(), "<YOUR_INDEX_NAME>",
...
func SnippetForSetSettingsOfSearch8() {
	...
	*/
	...
	// Call the API
	response, err := client.SetSettings(context.Background(), "<YOUR_INDEX_NAME>",
		search.NewEmptyIndexSettings().SetDistinct(search.IntAsDistinct(1)), utils.ToPtr(true))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
	...
	response, err := client.SetSettings(context.Background(), "<YOUR_INDEX_NAME>",
		search.NewEmptyIndexSettings().SetAdvancedSyntax(true).SetAdvancedSyntaxFeatures(
			[]search.AdvancedSyntaxFeatures{
				search.ADVANCED_SYNTAX_FEATURES_EXACT_PHRASE,
			}).
			...
			[]search.AlternativesAsExact{
				search.ALTERNATIVES_AS_EXACT_SINGLE_WORD_SYNONYM,
			}).
			...
			SetDistinct(search.IntAsDistinct(3)).
			SetEnablePersonalization(true).
			SetEnableReRanking(false).
			SetEnableRules(true).
			SetExactOnSingleWordQuery(search.EXACT_ON_SINGLE_WORD_QUERY_ATTRIBUTE).
			...
			[]search.SupportedLanguage{
				search.SUPPORTED_LANGUAGE_FR,
			}).
			SetKeepDiacriticsOnCharacters("abc").
			SetMaxFacetHits(20).
			SetMaxValuesPerFacet(30).
			SetMinProximity(6).
			SetMinWordSizefor1Typo(5).SetMinWordSizefor2Typos(11).SetMode(search.MODE_NEURAL_SEARCH).SetNumericAttributesForFiltering(
			...
			SetRemoveWordsIfNoResults(search.REMOVE_WORDS_IF_NO_RESULTS_LAST_WORDS).SetRenderingContent(
			search.NewEmptyRenderingContent().SetFacetOrdering(
				search.NewEmptyFacetOrdering().SetFacets(
					search.NewEmptyFacets().SetOrder(
						[]string{"a", "b"})).SetValues(map[string]search.Value{"a": *search.NewEmptyValue().SetOrder(
...
func SnippetForSetSettingsOfSearch101() {
	...
	*/
	...
	// Call the API
	response, err := client.SetSettings(context.Background(), "<YOUR_INDEX_NAME>",
		search.NewEmptyIndexSettings().SetCustomNormalization(map[string]map[string]string{"default": {"ä": "ae"}}), nil)
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForSetSettingsOfSearch102() {
	...
	*/
	...
	response, err := client.SetSettings(context.Background(), "<YOUR_INDEX_NAME>",
		search.NewEmptyIndexSettings().SetQueryLanguages(
			[]search.SupportedLanguage{
				search.SUPPORTED_LANGUAGE_ES,
			}).
			SetRemoveStopWords(search.BoolAsRemoveStopWords(true)).SetIgnorePlurals(search.BoolAsIgnorePlurals(true)), nil)
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForSetSettingsOfSearch118() {
	...
	*/
	...
	// Call the API
	response, err := client.SetSettings(context.Background(), "<YOUR_INDEX_NAME>",
		search.NewEmptyIndexSettings().SetDistinct(search.IntAsDistinct(1)).SetAttributeForDistinct("url"), nil)
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForUpdateApiKeyOfSearch() {
	...
	*/
	...
	response, err := client.UpdateApiKey(
		...
		search.NewUpdateApiKeyOptions().WithValidity(300).WithMaxQueriesPerIPPerHour(100).WithMaxHitsPerQuery(20),
	)
	if err != nil {
		// handle the eventual error
		panic(err)
...
func SnippetForWaitForApiKeyOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.WaitForApiKey(context.Background(), "api-key-add-operation-test-go", search.API_KEY_OPERATION_ADD)
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForWaitForApiKeyOfSearch1() {
	...
	*/
	...
	response, err := client.WaitForApiKey(
		context.Background(),
		"api-key-update-operation-test-go",
		search.API_KEY_OPERATION_UPDATE,
		search.WithApiKey(
			search.NewEmptyApiKey().SetDescription("my updated api key").SetAcl(
				[]search.Acl{search.ACL_SEARCH, search.ACL_ADD_OBJECT, search.ACL_DELETE_OBJECT}).SetIndexes(
...
func SnippetForWaitForApiKeyOfSearch2() {
	...
	*/
	...
	// Call the API
	response, err := client.WaitForApiKey(context.Background(), "api-key-delete-operation-test-go", search.API_KEY_OPERATION_DELETE)
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForWaitForAppTaskOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.WaitForAppTask(context.Background(), 123)
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForWaitForTaskOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.WaitForTask(context.Background(), "<YOUR_INDEX_NAME>", 123)
	if err != nil {
		// handle the eventual error
		panic(err)
	}
