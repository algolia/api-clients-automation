...
func SnippetForCustomGetOfSearch2() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomGet(context.Background(), "test/all", map[string]any{"query": "to be overriden"}, search.WithQueryParam("query", "parameters with space"), search.WithQueryParam("and an array",
...
func SnippetForCustomPostOfSearch1() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomPost(context.Background(), "test/all", search.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"body": "parameters"}))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForCustomPostOfSearch2() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomPost(context.Background(), "test/requestOptions", search.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), search.WithQueryParam("query", "myQueryParameter"))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForCustomPostOfSearch3() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomPost(context.Background(), "test/requestOptions", search.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), search.WithQueryParam("query2", "myQueryParameter"))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForCustomPostOfSearch4() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomPost(context.Background(), "test/requestOptions", search.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), search.WithHeaderParam("x-algolia-api-key", "ALGOLIA_API_KEY"))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForCustomPostOfSearch6() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomPost(context.Background(), "test/requestOptions", search.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), search.WithQueryParam("isItWorking", true))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForCustomPostOfSearch7() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomPost(context.Background(), "test/requestOptions", search.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), search.WithQueryParam("myParam", 2))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForCustomPostOfSearch8() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomPost(context.Background(), "test/requestOptions", search.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), search.WithQueryParam("myParam",
		[]string{"b and c", "d"}))
	if err != nil {
		// handle the eventual error
		panic(err)
...
func SnippetForCustomPutOfSearch1() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomPut(context.Background(), "test/all", search.NewCustomPutOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"body": "parameters"}))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
	...
	*/
	...
	response, err := client.GenerateSecuredApiKey("2640659426d5107b6e47d75db9cbaef8",
		search.NewEmptySecuredApiKeyRestrictions().SetValidUntil(2524604400).SetRestrictIndices(
			...
			search.NewEmptySearchParamsObject().SetQuery("batman").SetTypoTolerance(search.TypoToleranceEnumAsTypoTolerance(search.TYPO_TOLERANCE_ENUM_STRICT)).SetAroundRadius(search.AroundRadiusAllAsAroundRadius(search.AROUND_RADIUS_ALL_ALL)).SetMode(search.MODE_NEURAL_SEARCH).SetHitsPerPage(10).SetOptionalWords(search.ArrayOfStringAsOptionalWords(
				[]string{"one", "two"}))))
	if err != nil {
		// handle the eventual error
		panic(err)
...
func SnippetForGetLogsOfSearch1() {
	...
	*/
	...
	// Call the API
	response, err := client.GetLogs(context.Background(), search.NewGetLogsOptions().WithOffset(5).WithLength(10).WithIndexName("<YOUR_INDEX_NAME>").WithType(search.LOG_TYPE_ALL))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForGetSettingsOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.GetSettings(context.Background(), "<YOUR_INDEX_NAME>")
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForMultipleBatchOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.MultipleBatch(context.Background(),
		[]search.MultipleBatchRequest{*search.NewEmptyMultipleBatchRequest().SetAction(search.ACTION_ADD_OBJECT).SetBody(map[string]any{"key": "value"}).SetIndexName("<YOUR_INDEX_NAME>")})
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForOperationIndexOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.OperationIndex(context.Background(), "<SOURCE_INDEX_NAME>", search.OPERATION_TYPE_MOVE, "<DESTINATION_INDEX_NAME>", utils.ToPtr(
...
func SnippetForPartialUpdateObjectOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.PartialUpdateObject(context.Background(), "<YOUR_INDEX_NAME>", "uniqueID", map[string]any{"attributeId": "new value"}, nil)
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForPartialUpdateObjectOfSearch3() {
	...
	*/
	...
	// Call the API
	response, err := client.PartialUpdateObject(context.Background(), "<YOUR_INDEX_NAME>", "uniqueID", map[string]any{"attributeId": []string{"one", "two", "three"}}, nil)
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForPartialUpdateObjectOfSearch4() {
	...
	*/
	...
	// Call the API
	response, err := client.PartialUpdateObject(context.Background(), "<YOUR_INDEX_NAME>", "uniqueID", map[string]any{"attributeId": map[string]any{"nested": "value"}}, nil)
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForPartialUpdateObjectOfSearch5() {
	...
	*/
	...
	// Call the API
	response, err := client.PartialUpdateObject(context.Background(), "<YOUR_INDEX_NAME>", "uniqueID", map[string]any{"visible_by": []string{"Angela", "group/Finance", "group/Shareholders"}}, nil)
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForPartialUpdateObjectOfSearch6() {
	...
	*/
	...
	// Call the API
	response, err := client.PartialUpdateObject(context.Background(), "<YOUR_INDEX_NAME>", "productId", map[string]any{"categoryPageId": map[string]any{"_operation": "Add", "value": "men-clothing-pants"}}, nil)
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForPartialUpdateObjectOfSearch7() {
	...
	*/
	...
	// Call the API
	response, err := client.PartialUpdateObject(context.Background(), "<YOUR_INDEX_NAME>", "productId", map[string]any{"categoryPageId": map[string]any{"_operation": "Remove", "value": "men-clothing-pants"}}, nil)
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForSaveObjectOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.SaveObject(context.Background(), "<YOUR_INDEX_NAME>", map[string]any{"name": "Black T-shirt", "color": "#000000||black", "availableIn": "https://source.unsplash.com/100x100/?paris||Paris", "objectID": "myID"})
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForSearchDictionaryEntriesOfSearch1() {
	...
	*/
	...
	// Call the API
	response, err := client.SearchDictionaryEntries(context.Background(), search.DICTIONARY_TYPE_COMPOUNDS, "foo", search.NewSearchDictionaryEntriesOptions().WithPage(4).WithHitsPerPage(2).WithLanguage(search.SUPPORTED_LANGUAGE_FR))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForSearchForFacetValuesOfSearch1() {
	...
	*/
	...
	// Call the API
	response, err := client.SearchForFacetValues(context.Background(), "<YOUR_INDEX_NAME>", "facetName", search.NewSearchForFacetValuesOptions().WithParams("query=foo&facetFilters=['bar']").WithFacetQuery("foo").WithMaxFacetHits(42))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForSearchForFacetValuesOfSearch2() {
	...
	*/
	...
	// Call the API
	response, err := client.SearchForFacetValues(context.Background(), "<YOUR_INDEX_NAME>", "author", search.NewSearchForFacetValuesOptions().WithFacetQuery("stephen"))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForSearchSynonymsOfSearch1() {
	...
	*/
	...
	// Call the API
	response, err := client.SearchSynonyms(context.Background(), "<YOUR_INDEX_NAME>", search.NewSearchSynonymsOptions().WithQuery("myQuery").WithType(search.SYNONYM_TYPE_ALTCORRECTION1).WithPage(10).WithHitsPerPage(10))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForSearchUserIdsOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.SearchUserIds(context.Background(), "test", search.NewSearchUserIdsOptions().WithClusterName("theClusterName").WithPage(5).WithHitsPerPage(10))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForSetSettingsOfSearch() {
	...
	*/
	...
	response, err := client.SetSettings(context.Background(), "<YOUR_INDEX_NAME>",
		search.NewEmptyIndexSettings().SetPaginationLimitedTo(10).SetTypoTolerance(search.TypoToleranceEnumAsTypoTolerance(search.TYPO_TOLERANCE_ENUM_FALSE)), utils.ToPtr(true))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForUpdateApiKeyOfSearch() {
	...
	*/
	...
	// Call the API
	response, err := client.UpdateApiKey(context.Background(), "ALGOLIA_API_KEY",
...
func SnippetForWaitForApiKeyOfSearch1() {
	...
	*/
	...
	// Call the API
	response, err := client.WaitForApiKey(context.Background(), "api-key-update-operation-test-go", search.API_KEY_OPERATION_UPDATE, search.WithApiKey(
