...
func SnippetForCustomPostOfPersonalization1() {
	...
	*/
	...
	response, err := client.CustomPost(
		"test/all",
		personalization.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"body": "parameters"}),
	)
	if err != nil {
		// handle the eventual error
		panic(err)
...
func SnippetForCustomPutOfPersonalization1() {
	...
	*/
	...
	response, err := client.CustomPut(
		"test/all",
		personalization.NewCustomPutOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"body": "parameters"}),
	)
	if err != nil {
		// handle the eventual error
		panic(err)
