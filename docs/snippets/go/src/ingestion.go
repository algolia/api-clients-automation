...
func SnippetForCreateAuthenticationOfIngestion() {
	...
	*/
	...
	// Call the API
	response, err := client.CreateAuthentication(context.Background(), ingestion.AUTHENTICATION_TYPE_OAUTH, "authName", ingestion.AuthOAuthAsAuthInput(
...
func SnippetForCreateAuthenticationOfIngestion1() {
	...
	*/
	...
	// Call the API
	response, err := client.CreateAuthentication(context.Background(), ingestion.AUTHENTICATION_TYPE_ALGOLIA, "authName", ingestion.AuthAlgoliaAsAuthInput(
...
func SnippetForCreateSourceOfIngestion() {
	...
	*/
	...
	// Call the API
	response, err := client.CreateSource(context.Background(), ingestion.SOURCE_TYPE_COMMERCETOOLS, "sourceName", ingestion.NewCreateSourceOptions().WithInput(ingestion.SourceCommercetoolsAsSourceInput(
...
func SnippetForCreateTaskOfIngestion() {
	...
	*/
	...
	// Call the API
	response, err := client.CreateTask(context.Background(), "search", "destinationName", ingestion.ACTION_TYPE_REPLACE, nil)
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForCreateTaskOfIngestion1() {
	...
	*/
	...
	// Call the API
	response, err := client.CreateTask(context.Background(), "search", "destinationName", ingestion.ACTION_TYPE_REPLACE, ingestion.NewCreateTaskOptions().WithCron("* * * * *").WithNotifications(
...
func SnippetForCreateTaskOfIngestion2() {
	...
	*/
	...
	// Call the API
	response, err := client.CreateTask(context.Background(), "search", "destinationName", ingestion.ACTION_TYPE_REPLACE, ingestion.NewCreateTaskOptions().WithCron("* * * * *").WithInput(ingestion.DockerStreamsInputAsTaskInput(
...
func SnippetForCreateTransformationOfIngestion() {
	...
	*/
	...
	// Call the API
	response, err := client.CreateTransformation(context.Background(), "foo", "bar", ingestion.NewCreateTransformationOptions().WithDescription("baz"))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForCustomGetOfIngestion2() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomGet(context.Background(), "test/all", map[string]any{"query": "to be overriden"}, ingestion.WithQueryParam("query", "parameters with space"), ingestion.WithQueryParam("and an array",
...
func SnippetForCustomPostOfIngestion1() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomPost(context.Background(), "test/all", ingestion.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"body": "parameters"}))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForCustomPostOfIngestion2() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomPost(context.Background(), "test/requestOptions", ingestion.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), ingestion.WithQueryParam("query", "myQueryParameter"))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForCustomPostOfIngestion3() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomPost(context.Background(), "test/requestOptions", ingestion.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), ingestion.WithQueryParam("query2", "myQueryParameter"))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForCustomPostOfIngestion4() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomPost(context.Background(), "test/requestOptions", ingestion.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), ingestion.WithHeaderParam("x-algolia-api-key", "ALGOLIA_API_KEY"))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForCustomPostOfIngestion6() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomPost(context.Background(), "test/requestOptions", ingestion.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), ingestion.WithQueryParam("isItWorking", true))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForCustomPostOfIngestion7() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomPost(context.Background(), "test/requestOptions", ingestion.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), ingestion.WithQueryParam("myParam", 2))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForCustomPostOfIngestion8() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomPost(context.Background(), "test/requestOptions", ingestion.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), ingestion.WithQueryParam("myParam",
		[]string{"b and c", "d"}))
	if err != nil {
		// handle the eventual error
		panic(err)
...
func SnippetForCustomPutOfIngestion1() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomPut(context.Background(), "test/all", ingestion.NewCustomPutOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"body": "parameters"}))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForListAuthenticationsOfIngestion1() {
	...
	*/
	...
	// Call the API
	response, err := client.ListAuthentications(context.Background(), ingestion.NewListAuthenticationsOptions().WithItemsPerPage(2).WithPage(1).WithType(
...
func SnippetForPushOfIngestion() {
	...
	*/
	...
	// Call the API
	response, err := client.Push(context.Background(), "<YOUR_INDEX_NAME>", ingestion.ACTION_ADD_OBJECT,
...
func SnippetForPushTaskOfIngestion() {
	...
	*/
	...
	// Call the API
	response, err := client.PushTask(context.Background(), "6c02aeb1-775e-418e-870b-1faccd4b2c0f", ingestion.ACTION_ADD_OBJECT,
		[]ingestion.PushTaskRecords{*ingestion.NewEmptyPushTaskRecords().SetAdditionalProperty("key", "bar").SetAdditionalProperty("foo", "1").SetObjectID("o"), *ingestion.NewEmptyPushTaskRecords().SetAdditionalProperty("key", "baz").SetAdditionalProperty("foo", "2").SetObjectID("k")}, nil)
	if err != nil {
		// handle the eventual error
		panic(err)
...
func SnippetForRunSourceOfIngestion() {
	...
	*/
	...
	// Call the API
	response, err := client.RunSource(context.Background(), "6c02aeb1-775e-418e-870b-1faccd4b2c0f", ingestion.NewRunSourceOptions().WithIndexToInclude(
...
func SnippetForRunTaskOfIngestion() {
	...
	*/
	...
	// Call the API
	response, err := client.RunTask(context.Background(), "6c02aeb1-775e-418e-870b-1faccd4b2c0f")
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForRunTaskV1OfIngestion() {
	...
	*/
	...
	// Call the API
	response, err := client.RunTaskV1(context.Background(), "6c02aeb1-775e-418e-870b-1faccd4b2c0f")
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForTryTransformationOfIngestion() {
	...
	*/
	...
	// Call the API
	response, err := client.TryTransformation(context.Background(), "foo", map[string]any{"bar": "baz"}, nil)
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForTryTransformationOfIngestion1() {
	...
	*/
	...
	// Call the API
	response, err := client.TryTransformation(context.Background(), "foo", map[string]any{"bar": "baz"}, utils.ToPtr(
...
func SnippetForTryTransformationBeforeUpdateOfIngestion() {
	...
	*/
	...
	// Call the API
	response, err := client.TryTransformationBeforeUpdate(context.Background(), "6c02aeb1-775e-418e-870b-1faccd4b2c0f", "foo", map[string]any{"bar": "baz"}, nil)
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForTryTransformationBeforeUpdateOfIngestion1() {
	...
	*/
	...
	// Call the API
	response, err := client.TryTransformationBeforeUpdate(context.Background(), "6c02aeb1-775e-418e-870b-1faccd4b2c0f", "foo", map[string]any{"bar": "baz"}, utils.ToPtr(
		[]ingestion.AuthenticationCreate{*ingestion.NewEmptyAuthenticationCreate().SetType(ingestion.AUTHENTICATION_TYPE_OAUTH).SetName("authName").SetInput(ingestion.AuthOAuthAsAuthInput(
			ingestion.NewEmptyAuthOAuth().SetUrl("http://test.oauth").SetClientId("myID").SetClientSecret("mySecret")))}))
	if err != nil {
		// handle the eventual error
...
func SnippetForUpdateAuthenticationOfIngestion() {
	...
	*/
	...
	// Call the API
	response, err := client.UpdateAuthentication(context.Background(), "6c02aeb1-775e-418e-870b-1faccd4b2c0f", ingestion.NewUpdateAuthenticationOptions().WithName("newName"))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForUpdateDestinationOfIngestion() {
	...
	*/
	...
	// Call the API
	response, err := client.UpdateDestination(context.Background(), "6c02aeb1-775e-418e-870b-1faccd4b2c0f", ingestion.NewUpdateDestinationOptions().WithName("newName"))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForUpdateSourceOfIngestion() {
	...
	*/
	...
	// Call the API
	response, err := client.UpdateSource(context.Background(), "6c02aeb1-775e-418e-870b-1faccd4b2c0f", ingestion.NewUpdateSourceOptions().WithName("newName"))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForUpdateTaskOfIngestion() {
	...
	*/
	...
	// Call the API
	response, err := client.UpdateTask(context.Background(), "6c02aeb1-775e-418e-870b-1faccd4b2c0f", ingestion.NewUpdateTaskOptions().WithEnabled(false).WithCron("* * * * *"))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForUpdateTaskV1OfIngestion() {
	...
	*/
	...
	// Call the API
	response, err := client.UpdateTaskV1(context.Background(), "6c02aeb1-775e-418e-870b-1faccd4b2c0f", ingestion.NewUpdateTaskV1Options().WithEnabled(false))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForUpdateTransformationOfIngestion() {
	...
	*/
	...
	// Call the API
	response, err := client.UpdateTransformation(context.Background(), "6c02aeb1-775e-418e-870b-1faccd4b2c0f", "foo", "bar", ingestion.NewUpdateTransformationOptions().WithDescription("baz"))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForValidateSourceOfIngestion() {
	...
	*/
	...
	// Call the API
	response, err := client.ValidateSource(context.Background(), ingestion.SOURCE_TYPE_COMMERCETOOLS, "sourceName", ingestion.NewValidateSourceOptions().WithInput(ingestion.SourceCommercetoolsAsSourceInput(
		ingestion.NewEmptySourceCommercetools().SetStoreKeys(
			[]string{"myStore"}).SetLocales(
...
func SnippetForValidateSourceBeforeUpdateOfIngestion() {
	...
	*/
	...
	// Call the API
	response, err := client.ValidateSourceBeforeUpdate(context.Background(), "6c02aeb1-775e-418e-870b-1faccd4b2c0f", ingestion.NewValidateSourceBeforeUpdateOptions().WithName("newName"))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
