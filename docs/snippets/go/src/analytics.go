...
func SnippetForGetAddToCartRateOfAnalytics1() {
	...
	*/
	...
	// Call the API
	response, err := client.GetAddToCartRate(
		context.Background(),
		"index",
...
func SnippetForGetAverageClickPositionOfAnalytics1() {
	...
	*/
	...
	// Call the API
	response, err := client.GetAverageClickPosition(
		context.Background(),
		"index",
...
func SnippetForGetClickPositionsOfAnalytics1() {
	...
	*/
	...
	// Call the API
	response, err := client.GetClickPositions(
		context.Background(),
		"index",
...
func SnippetForGetClickThroughRateOfAnalytics1() {
	...
	*/
	...
	// Call the API
	response, err := client.GetClickThroughRate(
		context.Background(),
		"index",
...
func SnippetForGetConversionRateOfAnalytics1() {
	...
	*/
	...
	// Call the API
	response, err := client.GetConversionRate(
		context.Background(),
		"index",
...
func SnippetForGetNoClickRateOfAnalytics1() {
	...
	*/
	...
	// Call the API
	response, err := client.GetNoClickRate(
		context.Background(),
		"index",
...
func SnippetForGetNoResultsRateOfAnalytics1() {
	...
	*/
	...
	// Call the API
	response, err := client.GetNoResultsRate(
		context.Background(),
		"index",
...
func SnippetForGetPurchaseRateOfAnalytics1() {
	...
	*/
	...
	// Call the API
	response, err := client.GetPurchaseRate(
		context.Background(),
		"index",
...
func SnippetForGetRevenueOfAnalytics1() {
	...
	*/
	...
	// Call the API
	response, err := client.GetRevenue(
		context.Background(),
		"index",
...
func SnippetForGetSearchesCountOfAnalytics1() {
	...
	*/
	...
	// Call the API
	response, err := client.GetSearchesCount(
		context.Background(),
		"index",
...
func SnippetForGetSearchesNoClicksOfAnalytics1() {
	...
	*/
	...
	// Call the API
	response, err := client.GetSearchesNoClicks(
		context.Background(),
		"index",
		analytics.NewGetSearchesNoClicksOptions().WithStartDate("1999-09-19").WithEndDate("2001-01-01").WithLimit(21).WithOffset(42).WithTags("tag"),
	)
	if err != nil {
		// handle the eventual error
		panic(err)
...
func SnippetForGetSearchesNoResultsOfAnalytics1() {
	...
	*/
	...
	// Call the API
	response, err := client.GetSearchesNoResults(
		context.Background(),
		"index",
		analytics.NewGetSearchesNoResultsOptions().WithStartDate("1999-09-19").WithEndDate("2001-01-01").WithLimit(21).WithOffset(42).WithTags("tag"),
	)
	if err != nil {
		// handle the eventual error
		panic(err)
...
func SnippetForGetTopCountriesOfAnalytics1() {
	...
	*/
	...
	// Call the API
	response, err := client.GetTopCountries(
		context.Background(),
		"index",
...
func SnippetForGetTopFilterAttributesOfAnalytics1() {
	...
	*/
	...
	// Call the API
	response, err := client.GetTopFilterAttributes(
		context.Background(),
		"index",
...
func SnippetForGetTopFilterForAttributeOfAnalytics2() {
	...
	*/
	...
	// Call the API
	response, err := client.GetTopFilterForAttribute(
		context.Background(),
		"myAttribute",
		"index",
...
func SnippetForGetTopFiltersNoResultsOfAnalytics1() {
	...
	*/
	...
	// Call the API
	response, err := client.GetTopFiltersNoResults(
		context.Background(),
		"index",
...
func SnippetForGetTopHitsOfAnalytics1() {
	...
	*/
	...
	// Call the API
	response, err := client.GetTopHits(
		context.Background(),
		"index",
...
func SnippetForGetTopSearchesOfAnalytics1() {
	...
	*/
	...
	// Call the API
	response, err := client.GetTopSearches(
		context.Background(),
		"index",
...
func SnippetForGetUsersCountOfAnalytics1() {
	...
	*/
	...
	// Call the API
	response, err := client.GetUsersCount(
		context.Background(),
		"index",
