...
// >IMPORT
import "github.com/algolia/algoliasearch-client-go/v4/algolia/next/recommend"
...
func SnippetForBatchRecommendRulesOfRecommend() {
	...
	*/
	...
	// Call the API
	response, err := client.BatchRecommendRules("<YOUR_INDEX_NAME>", recommend.RECOMMEND_MODELS_RELATED_PRODUCTS, nil)
	if err != nil {
...
func SnippetForCustomGetOfRecommend2() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomGet("test/all", map[string]any{"query": "to be overriden"}, recommend.WithQueryParam("query", "parameters with space"), recommend.WithQueryParam("and an array",
...
func SnippetForCustomPostOfRecommend1() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomPost("test/all", recommend.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"body": "parameters"}))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForCustomPostOfRecommend2() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomPost("test/requestOptions", recommend.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), recommend.WithQueryParam("query", "myQueryParameter"))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForCustomPostOfRecommend3() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomPost("test/requestOptions", recommend.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), recommend.WithQueryParam("query2", "myQueryParameter"))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForCustomPostOfRecommend4() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomPost("test/requestOptions", recommend.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), recommend.WithHeaderParam("x-algolia-api-key", "ALGOLIA_API_KEY"))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForCustomPostOfRecommend6() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomPost("test/requestOptions", recommend.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), recommend.WithQueryParam("isItWorking", true))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForCustomPostOfRecommend7() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomPost("test/requestOptions", recommend.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), recommend.WithQueryParam("myParam", 2))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForCustomPostOfRecommend8() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomPost("test/requestOptions", recommend.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), recommend.WithQueryParam("myParam",
		[]string{"b and c", "d"}))
	if err != nil {
		// handle the eventual error
		panic(err)
...
func SnippetForCustomPutOfRecommend1() {
	...
	*/
	...
	// Call the API
	response, err := client.CustomPut("test/all", recommend.NewCustomPutOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"body": "parameters"}))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForDeleteRecommendRuleOfRecommend() {
	...
	*/
	...
	// Call the API
	response, err := client.DeleteRecommendRule("<YOUR_INDEX_NAME>", recommend.RECOMMEND_MODELS_RELATED_PRODUCTS, "objectID")
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForGetRecommendRuleOfRecommend() {
	...
	*/
	...
	// Call the API
	response, err := client.GetRecommendRule("<YOUR_INDEX_NAME>", recommend.RECOMMEND_MODELS_RELATED_PRODUCTS, "objectID")
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForGetRecommendStatusOfRecommend() {
	...
	*/
	...
	// Call the API
	response, err := client.GetRecommendStatus("<YOUR_INDEX_NAME>", recommend.RECOMMEND_MODELS_RELATED_PRODUCTS, 12345)
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForGetRecommendationsOfRecommend() {
	...
	*/
	...
	// Call the API
	response, err := client.GetRecommendations(
...
func SnippetForSearchRecommendRulesOfRecommend() {
	...
	*/
	...
	// Call the API
	response, err := client.SearchRecommendRules("<YOUR_INDEX_NAME>", recommend.RECOMMEND_MODELS_RELATED_PRODUCTS, nil)
	if err != nil {
		// handle the eventual error
		panic(err)
	}
