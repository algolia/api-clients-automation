...
func SnippetForDeleteCompositionOfComposition() {
	...
	*/
	...
	// Call the API
	response, err := client.DeleteComposition(context.Background(), "1234")
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForDeleteCompositionRuleOfComposition() {
	...
	*/
	...
	// Call the API
	response, err := client.DeleteCompositionRule(context.Background(), "1234", "5678")
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForGetCompositionOfComposition() {
	...
	*/
	...
	// Call the API
	response, err := client.GetComposition(context.Background(), "foo")
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForGetRuleOfComposition() {
	...
	*/
	...
	// Call the API
	response, err := client.GetRule(context.Background(), "foo", "123")
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForGetTaskOfComposition() {
	...
	*/
	...
	// Call the API
	response, err := client.GetTask(context.Background(), "foo", 42)
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForListCompositionsOfComposition() {
	...
	*/
	...
	// Call the API
	response, err := client.ListCompositions(context.Background(), nil)
	if err != nil {
		// handle the eventual error
		panic(err)
	}
...
func SnippetForPutCompositionOfComposition() {
	...
	*/
	...
	// Call the API
	response, err := client.PutComposition(context.Background(), "1234", "1234", "my first composition",
		composition.NewEmptyCompositionBehavior().SetInjection(
			composition.NewEmptyInjection().SetMain(
				composition.NewEmptyMain().SetSource(
					composition.NewEmptyCompositionSource().SetSearch(
...
func SnippetForPutCompositionOfComposition1() {
	...
	*/
	...
	// Call the API
	response, err := client.PutComposition(context.Background(), "my-external-injection-compo", "my-external-injection-compo", "my first composition",
		composition.NewEmptyCompositionBehavior().SetInjection(
			composition.NewEmptyInjection().SetMain(
				composition.NewEmptyMain().SetSource(
					composition.NewEmptyCompositionSource().SetSearch(
...
func SnippetForPutCompositionOfComposition2() {
	...
	*/
	...
	// Call the API
	response, err := client.PutComposition(context.Background(), "my-metadata-compo", "my-metadata-compo", "my composition",
		composition.NewEmptyCompositionBehavior().SetInjection(
			composition.NewEmptyInjection().SetMain(
				composition.NewEmptyMain().SetSource(
					composition.NewEmptyCompositionSource().SetSearch(
...
func SnippetForPutCompositionOfComposition3() {
	...
	*/
	...
	// Call the API
	response, err := client.PutComposition(context.Background(), "my-compo", "my-compo", "my composition",
		composition.NewEmptyCompositionBehavior().SetInjection(
			composition.NewEmptyInjection().SetMain(
				composition.NewEmptyMain().SetSource(
					composition.NewEmptyCompositionSource().SetSearch(
...
func SnippetForPutCompositionRuleOfComposition() {
	...
	*/
	...
	// Call the API
	response, err := client.PutCompositionRule(context.Background(), "compositionID", "ruleID",
...
func SnippetForPutCompositionRuleOfComposition1() {
	...
	*/
	...
	// Call the API
	response, err := client.PutCompositionRule(context.Background(), "compositionID", "rule-with-metadata",
...
func SnippetForPutCompositionRuleOfComposition2() {
	...
	*/
	...
	// Call the API
	response, err := client.PutCompositionRule(context.Background(), "compositionID", "rule-with-exernal-source",
...
func SnippetForPutCompositionRuleOfComposition3() {
	...
	*/
	...
	// Call the API
	response, err := client.PutCompositionRule(context.Background(), "compositionID", "rule-with-deduplication",
...
func SnippetForSaveRulesOfComposition() {
	...
	*/
	...
	// Call the API
	response, err := client.SaveRules(context.Background(), "foo", utils.ToPtr(
...
func SnippetForSaveRulesOfComposition1() {
	...
	*/
	...
	// Call the API
	response, err := client.SaveRules(context.Background(), "rule-with-metadata", utils.ToPtr(
		[]composition.RulesMultipleBatchRequest{
			*composition.NewEmptyRulesMultipleBatchRequest().SetAction(composition.ACTION_UPSERT).SetBody(composition.CompositionRuleAsRulesBatchCompositionAction(
				composition.NewEmptyCompositionRule().SetObjectID("rule-with-metadata").SetConditions(
					[]composition.Condition{*composition.NewEmptyCondition().SetAnchoring(composition.ANCHORING_IS).SetPattern("test")}).SetConsequence(
...
func SnippetForSaveRulesOfComposition2() {
	...
	*/
	...
	// Call the API
	response, err := client.SaveRules(context.Background(), "rule-with-exernal-source", utils.ToPtr(
		[]composition.RulesMultipleBatchRequest{
			*composition.NewEmptyRulesMultipleBatchRequest().SetAction(composition.ACTION_UPSERT).SetBody(composition.CompositionRuleAsRulesBatchCompositionAction(
				composition.NewEmptyCompositionRule().SetObjectID("rule-with-exernal-source").SetDescription("my description").SetTags(
					[]string{"tag1", "tag2"}).SetEnabled(true).SetValidity(
...
func SnippetForSaveRulesOfComposition3() {
	...
	*/
	...
	// Call the API
	response, err := client.SaveRules(context.Background(), "my-compo", utils.ToPtr(
		[]composition.RulesMultipleBatchRequest{
			*composition.NewEmptyRulesMultipleBatchRequest().SetAction(composition.ACTION_UPSERT).SetBody(composition.CompositionRuleAsRulesBatchCompositionAction(
				composition.NewEmptyCompositionRule().SetObjectID("rule-with-deduplication").SetDescription("my description").SetEnabled(true).SetConditions(
...
func SnippetForSearchCompositionRulesOfComposition() {
	...
	*/
	...
	// Call the API
	response, err := client.SearchCompositionRules(context.Background(), "foo", composition.NewSearchCompositionRulesOptions().WithQuery("batman"))
	if err != nil {
		// handle the eventual error
		panic(err)
	}
