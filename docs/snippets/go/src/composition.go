...
// >IMPORT
import "github.com/algolia/algoliasearch-client-go/v4/algolia/next/composition"
...
func SnippetForSearchOfComposition() {
	...
	*/
	...
	// Call the API
	response, err := client.Search("foo",
...
func SnippetForSearchForFacetValuesOfComposition() {
	...
	*/
	...
	// Call the API
	response, err := client.SearchForFacetValues("foo", "brand",
