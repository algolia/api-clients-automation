...
class SnippetAgentStudioClient {
  suspend fun snippetForBulkCreateAllowedDomains() {
  ...
  suspend fun snippetForBulkDeleteAllowedDomains() {
  ...
  suspend fun snippetForCreateAgentAllowedDomain() {
  ...
  suspend fun snippetForCreateFeedback() {
  ...
  suspend fun snippetForCreateFeedback1() {
  ...
  suspend fun snippetForCreateSecretKey() {
    // >SEPARATOR createSecretKey createSecretKey with minimal parameters
    // Initialize the client
    val client = AgentStudioClient(appId = "ALGOLIA_APPLICATION_ID", apiKey = "ALGOLIA_API_KEY")

    // Call the API
    var response = client.createSecretKey(secretKeyCreate = SecretKeyCreate(name = "my-secret-key"))
  ...
  suspend fun snippetForCreateSecretKey1() {
  ...
  suspend fun snippetForDeleteAllowedDomain() {
  ...
  suspend fun snippetForDeleteSecretKey() {
    // >SEPARATOR deleteSecretKey default
    // Initialize the client
    val client = AgentStudioClient(appId = "ALGOLIA_APPLICATION_ID", apiKey = "ALGOLIA_API_KEY")

    // Call the API
    client.deleteSecretKey(secretKeyId = "a1b2c3d4-5678-90ab-cdef-123456789abc")
  ...
  suspend fun snippetForExportConversations2() {
  ...
  suspend fun snippetForGetAllowedDomain() {
  ...
  suspend fun snippetForGetAllowedDomain1() {
  ...
  suspend fun snippetForGetConfiguration() {
  ...
  suspend fun snippetForGetConfiguration1() {
  ...
  suspend fun snippetForGetSecretKey() {
    // >SEPARATOR getSecretKey getSecretKey
    // Initialize the client
    val client = AgentStudioClient(appId = "ALGOLIA_APPLICATION_ID", apiKey = "ALGOLIA_API_KEY")

    // Call the API
    var response = client.getSecretKey(secretKeyId = "a1b2c3d4-5678-90ab-cdef-123456789abc")
  ...
  suspend fun snippetForGetSecretKey1() {
    // >SEPARATOR getSecretKey e2e get secret key
    // Initialize the client
    val client = AgentStudioClient(appId = "ALGOLIA_APPLICATION_ID", apiKey = "ALGOLIA_API_KEY")

    // Call the API
    var response = client.getSecretKey(secretKeyId = "f730dda4-9649-4cfb-9d88-b7e992fb89c9")
  ...
  suspend fun snippetForListAgentAllowedDomains() {
    // >SEPARATOR listAgentAllowedDomains listAgentAllowed-Domains
    // Initialize the client
    val client = AgentStudioClient(appId = "ALGOLIA_APPLICATION_ID", apiKey = "ALGOLIA_API_KEY")

    // Call the API
    var response = client.listAgentAllowedDomains(agentId = "785b14e4-61a8-4c03-8028-bf2ba3ae85ff")
  ...
  suspend fun snippetForListAgentAllowedDomains1() {
  ...
  suspend fun snippetForListAgentConversations2() {
  ...
  suspend fun snippetForListProviderModels1() {
  ...
  suspend fun snippetForListSecretKeys() {
    // >SEPARATOR listSecretKeys listSecretKeys with no params
    // Initialize the client
    val client = AgentStudioClient(appId = "ALGOLIA_APPLICATION_ID", apiKey = "ALGOLIA_API_KEY")

    // Call the API
    var response = client.listSecretKeys()
  ...
  suspend fun snippetForListSecretKeys1() {
    // >SEPARATOR listSecretKeys listSecretKeys with pagination
    // Initialize the client
    val client = AgentStudioClient(appId = "ALGOLIA_APPLICATION_ID", apiKey = "ALGOLIA_API_KEY")

    // Call the API
    var response = client.listSecretKeys(page = 2, limit = 5)
  ...
  suspend fun snippetForListSecretKeys2() {
    // >SEPARATOR listSecretKeys e2e list secret keys
    // Initialize the client
    val client = AgentStudioClient(appId = "ALGOLIA_APPLICATION_ID", apiKey = "ALGOLIA_API_KEY")

    // Call the API
    var response = client.listSecretKeys(page = 1, limit = 10)
  ...
  suspend fun snippetForUpdateSecretKey() {
