...
class SnippetSearchClient {
  ...
  suspend fun snippetForAppendSource() {
    ...
    // Call the API
    var response =
      client.appendSource(source = Source(source = "theSource", description = "theDescription"))
    ...
    var response =
      client.getObjects(
        getObjectsParams =
          GetObjectsParams(
            requests =
              listOf(GetObjectsRequest(objectID = "uniqueID", indexName = "<YOUR_INDEX_NAME>"))
          )
      )
      ...
      client.partialUpdateObject(
        ...
        attributesToUpdate =
          buildJsonObject {
            put(
              "attributeId",
              JsonArray(listOf(JsonPrimitive("one"), JsonPrimitive("two"), JsonPrimitive("three"))),
            )
          },
      )
      ...
      client.saveRule(
        ...
        rule =
          Rule(
            ...
            consequence =
              Consequence(
                params = ConsequenceParams(optionalFilters = OptionalFilters.of("food_group:fruit"))
              ),
          ),
      )
  ...
  suspend fun snippetForSearch4() {
    ...
    var response =
      client.search(
        searchMethodParams =
          SearchMethodParams(requests = listOf(SearchForHits(indexName = "<YOUR_INDEX_NAME>")))
      )
      ...
      client.search(
        searchMethodParams =
          SearchMethodParams(
            requests =
              listOf(
                SearchForHits(indexName = "<YOUR_INDEX_NAME>"),
                SearchForFacets(
                  indexName = "<YOUR_INDEX_NAME>",
                  type = SearchTypeFacet.entries.first { it.value == "facet" },
                  facet = "theFacet",
                  ...
                  reRankingApplyFilter =
                    ReRankingApplyFilter.of(
                      listOf(
                        ...
                        ReRankingApplyFilter.of(listOf(ReRankingApplyFilter.of("mySearch:filters"))),
                      )
                    ),
                  tagFilters =
                    TagFilters.of(
  ...
  suspend fun snippetForSearchForFacetValues() {
    ...
    // Call the API
    var response =
      client.searchForFacetValues(indexName = "<YOUR_INDEX_NAME>", facetName = "facetName")
  ...
  suspend fun snippetForSearchSingleIndex129() {
  ...
  suspend fun snippetForSearchSingleIndex130() {
  ...
  suspend fun snippetForSearchSingleIndex132() {
  ...
  suspend fun snippetForSearchSingleIndex133() {
  ...
  suspend fun snippetForSearchSingleIndex134() {
  ...
  suspend fun snippetForSearchSingleIndex135() {
    ...
    var response =
      client.searchSingleIndex(
        ...
        requestOptions = RequestOptions(headers = buildMap { put("X-Algolia-User-ID", "user1234") }),
      )
  ...
  suspend fun snippetForSearchSingleIndex136() {
      ...
      client.setSettings(
        ...
        indexSettings =
          IndexSettings(
            ...
            ranking =
              listOf("custom", "typo", "geo", "words", "filters", "proximity", "attribute", "exact"),
          ),
      )
  ...
  suspend fun snippetForSetSettings126() {
  ...
  suspend fun snippetForSetSettings127() {
  ...
  suspend fun snippetForSetSettings128() {
  ...
  suspend fun snippetForSetSettings129() {
  ...
  suspend fun snippetForSetSettings130() {
