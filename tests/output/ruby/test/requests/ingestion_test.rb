...
class TestIngestionClient < Test::Unit::TestCase
  ...
  def test_get_authentications1
    ...
    res = @e2e_client.get_authentications_with_http_info(2, 1, ["basic", "algolia"], ["none"], "createdAt", "asc")

    assert_equal(res.status, 200)
    res = @e2e_client.get_authentications(2, 1, ["basic", "algolia"], ["none"], "createdAt", "asc")
