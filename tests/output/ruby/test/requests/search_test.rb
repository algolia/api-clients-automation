...
class TestSearchClient < Test::Unit::TestCase
  ...
  def test_search16
    req = @client.search_with_http_info(
      Algolia::Search::SearchMethodParams.new(
        requests: [
          Algolia::Search::SearchForHits.new(
            index_name: "cts_e2e_query_categorization",
            query: "sofa",
  ...
  def test_search_single_index13
    ...
    assert(({}.to_a - req.headers.to_a).empty?, req.headers.to_s)
    assert_equal(
      JSON.parse("{\"filters\":\"(company:Google<score=3> OR company:Amazon<score=2> OR company:Facebook<score=1>)\"}"),
      JSON.parse(req.body)
    )
  end
  ...
  def test_search_single_index19
    req = @client.search_single_index_with_http_info(
      "indexName",
      Algolia::Search::SearchParamsObject.new(numeric_filters: "price>20")
    )
    ...
    assert_equal({}.to_a, req.query_params.to_a)
    assert(({}.to_a - req.headers.to_a).empty?, req.headers.to_s)
    assert_equal(JSON.parse("{\"numericFilters\":\"price>20\"}"), JSON.parse(req.body))
  end
  ...
  def test_search_single_index39
    ...
    assert(({}.to_a - req.headers.to_a).empty?, req.headers.to_s)
    assert_equal(
      JSON.parse("{\"query\":\"wolf\",\"restrictSearchableAttributes\":[\"title_fr\"]}"),
      JSON.parse(req.body)
    )
  end
  ...
  def test_search_single_index40
    ...
    assert_equal({}.to_a, req.query_params.to_a)
    assert(({}.to_a - req.headers.to_a).empty?, req.headers.to_s)
    assert_equal(JSON.parse("{\"query\":\"test\",\"getRankingInfo\":true}"), JSON.parse(req.body))
  end
  ...
  def test_search_single_index82
    req = @client.search_single_index_with_http_info(
      "indexName",
      Algolia::Search::SearchParamsObject.new(query: "query", page: 2, hits_per_page: 5)
    )
    ...
    assert_equal({}.to_a, req.query_params.to_a)
    assert(({}.to_a - req.headers.to_a).empty?, req.headers.to_s)
    assert_equal(JSON.parse("{\"query\":\"query\",\"page\":2,\"hitsPerPage\":5}"), JSON.parse(req.body))
  end
  ...
  def test_search_single_index90
    ...
    assert_equal({}.to_a, req.query_params.to_a)
    assert(
      ({:"x-forwarded-for" => "XX.XXX.XXX.XXX"}.transform_keys(&:to_s).to_a - req.headers.to_a).empty?,
      req.headers.to_s
    )
  ...
  def test_search_single_index132
    req = @client.search_single_index_with_http_info(
      "indexName",
  ...
  # set_ab_test
  def test_search_single_index133
    req = @client.search_single_index_with_http_info(
      "indexName",
  ...
  def test_search_single_index134
    req = @client.search_single_index_with_http_info(
      "indexName",
  ...
  def test_search_single_index135
    req = @client.search_single_index_with_http_info(
      "indexName",
  ...
  def test_search_single_index136
    req = @client.search_single_index_with_http_info(
      "playlists",
  ...
  # typoToleranceMin
  def test_set_settings127
    req = @client.set_settings_with_http_info("theIndexName", Algolia::Search::IndexSettings.new(typo_tolerance: "min"))
  ...
  def test_set_settings128
    req = @client.set_settings_with_http_info(
      "theIndexName",
      Algolia::Search::IndexSettings.new(min_word_sizefor1_typo: 5)
    )
    ...
    assert_equal({}.to_a, req.query_params.to_a)
    assert(({}.to_a - req.headers.to_a).empty?, req.headers.to_s)
    assert_equal(JSON.parse("{\"minWordSizefor1Typo\":5}"), JSON.parse(req.body))
  end

  # attributesToSnippetBodyTitle
  def test_set_settings129
    req = @client.set_settings_with_http_info(
      "theIndexName",
    ...
    assert_equal({}.to_a, req.query_params.to_a)
    assert(({}.to_a - req.headers.to_a).empty?, req.headers.to_s)
    assert_equal(JSON.parse("{\"attributesToSnippet\":[\"body:20\",\"title\"]}"), JSON.parse(req.body))
  end

  # snippetEllipsisTextHellip
  def test_set_settings130
    req = @client.set_settings_with_http_info(
      "theIndexName",
    ...
    assert_equal({}.to_a, req.query_params.to_a)
    assert(({}.to_a - req.headers.to_a).empty?, req.headers.to_s)
    assert_equal(JSON.parse("{\"snippetEllipsisText\":\"[&hellip;]\"}"), JSON.parse(req.body))
  end
