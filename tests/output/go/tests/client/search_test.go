...
func TestSearchapi1(t *testing.T) {
	...
	client, err = search.NewClientWithConfig(cfg)
	require.NoError(t, err)
	res, err = client.SearchSingleIndex(context.Background(), "indexName", nil)
	require.NoError(t, err)
	require.Equal(t, "test-app-id-dsn.algolia.net", echo.Host)
}
...
func TestSearchapi3(t *testing.T) {
	...
	client, err = search.NewClientWithConfig(cfg)
	require.NoError(t, err)
	res, err = client.CustomGet(context.Background(), "1/test/retry/go", nil)
	require.NoError(t, err)
...
func TestSearchapi4(t *testing.T) {
	...
	client, err = search.NewClientWithConfig(cfg)
	require.NoError(t, err)
	res, err = client.CustomGet(context.Background(), "1/test/hang/go", nil)
...
func TestSearchapi5(t *testing.T) {
	...
	client, err = search.NewClientWithConfig(cfg)
	require.NoError(t, err)
	res, err = client.CustomPost(context.Background(), "1/test/gzip", search.NewCustomPostOptions().WithParameters(map[string]any{}).WithBody(map[string]any{"message": "this is a compressed body"}))
	require.NoError(t, err)
	rawBody, err := json.Marshal(res)
	require.NoError(t, err)
...
func TestSearchapi6(t *testing.T) {
	...
	_ = echo
	res, err = client.CustomGet(context.Background(), "1/test", nil)
	require.NoError(t, err)
...
func TestSearchapi8(t *testing.T) {
	...
	client, err = search.NewClientWithConfig(cfg)
	require.NoError(t, err)
	res, err = client.GetSettings(context.Background(), "cts_e2e_unknownField_go")
	require.NoError(t, err)
	rawBody, err := json.Marshal(res)
	require.NoError(t, err)
...
func TestSearchapi9(t *testing.T) {
	...
	client, err = search.NewClientWithConfig(cfg)
	require.NoError(t, err)
	res, err = client.GetRule(context.Background(), "cts_e2e_unknownFieldNested_go", "ruleObjectID")
	require.NoError(t, err)
	rawBody, err := json.Marshal(res)
	require.NoError(t, err)
...
func TestSearchdeleteObjects0(t *testing.T) {
	...
	require.NoError(t, err)
	{
		res, err = client.DeleteObjects(context.Background(), "cts_e2e_deleteObjects_go",
			[]string{"1", "2"})
		require.NoError(t, err)
		rawBody, err := json.Marshal(res)
		require.NoError(t, err)
...
func TestSearchgenerateSecuredApiKey0(t *testing.T) {
	...
	_ = echo
	{
		res, err = client.GenerateSecuredApiKey("2640659426d5107b6e47d75db9cbaef8",
...
func TestSearchgenerateSecuredApiKey5(t *testing.T) {
	...
	_ = echo
	{
		res, err = client.GenerateSecuredApiKey("YourSearchOnlyApiKey",
...
func TestSearchindexExists0(t *testing.T) {
	...
	require.NoError(t, err)
	{
		res, err = client.IndexExists(context.Background(), "indexExistsYES")
		require.NoError(t, err)
...
func TestSearchindexExists1(t *testing.T) {
	...
	require.NoError(t, err)
	{
		res, err = client.IndexExists(context.Background(), "indexExistsNO")
		require.NoError(t, err)
...
func TestSearchindexExists2(t *testing.T) {
	...
	client, err = search.NewClientWithConfig(cfg)
	require.NoError(t, err)
	res, err = client.IndexExists(context.Background(), "indexExistsERROR")
...
func TestSearchparameters2(t *testing.T) {
	...
	client, echo := createSearchClient(t)
	_ = echo
	res, err = client.AddOrUpdateObject(context.Background(), tests.ZeroValue[string](), "my-object-id", map[string]any{})
	require.EqualError(t, err, "Parameter `indexName` is required when calling `AddOrUpdateObject`.")
	res, err = client.AddOrUpdateObject(context.Background(), "my-index-name", tests.ZeroValue[string](), map[string]any{})
	require.EqualError(t, err, "Parameter `objectID` is required when calling `AddOrUpdateObject`.")
	res, err = client.AddOrUpdateObject(context.Background(), "my-index-name", "my-object-id", tests.ZeroValue[map[string]any]())
...
func TestSearchpartialUpdateObjects0(t *testing.T) {
	...
	require.NoError(t, err)
	{
		res, err = client.PartialUpdateObjects(context.Background(), "cts_e2e_partialUpdateObjects_go",
...
func TestSearchreplaceAllObjects0(t *testing.T) {
	...
	require.NoError(t, err)
	{
		res, err = client.ReplaceAllObjects(context.Background(), "cts_e2e_replace_all_objects_go",
...
func TestSearchreplaceAllObjects1(t *testing.T) {
	...
	require.NoError(t, err)
	{
		res, err = client.ReplaceAllObjects(context.Background(), "cts_e2e_replace_all_objects_scopes_go",
...
func TestSearchreplaceAllObjects2(t *testing.T) {
	...
	client, err = search.NewClientWithConfig(cfg)
	require.NoError(t, err)
	res, err = client.ReplaceAllObjects(context.Background(), "cts_e2e_replace_all_objects_too_big_go",
...
func TestSearchsaveObjects0(t *testing.T) {
	...
	require.NoError(t, err)
	{
		res, err = client.SaveObjects(context.Background(), "cts_e2e_saveObjects_go",
...
func TestSearchsaveObjects2(t *testing.T) {
	...
	require.NoError(t, err)
	{
		res, err = client.SaveObjects(context.Background(), "playlists",
...
func TestSearchsearchSingleIndex0(t *testing.T) {
	...
	client, err = search.NewClientWithConfig(cfg)
	require.NoError(t, err)
	res, err = client.SearchSingleIndex(context.Background(), "playlists", search.SearchParamsObjectAsSearchParams(
...
func TestSearchwaitForApiKey0(t *testing.T) {
	...
	require.NoError(t, err)
	{
		res, err = client.WaitForApiKey(context.Background(), "api-key-add-operation-test-go", search.API_KEY_OPERATION_ADD)
		require.NoError(t, err)
		rawBody, err := json.Marshal(res)
		require.NoError(t, err)
...
func TestSearchwaitForApiKey1(t *testing.T) {
	...
	require.NoError(t, err)
	{
		res, err = client.WaitForApiKey(context.Background(), "api-key-update-operation-test-go", search.API_KEY_OPERATION_UPDATE, search.WithApiKey(
...
func TestSearchwaitForApiKey2(t *testing.T) {
	...
	require.NoError(t, err)
	{
		res, err = client.WaitForApiKey(context.Background(), "api-key-delete-operation-test-go", search.API_KEY_OPERATION_DELETE)
		require.NoError(t, err)
		require.Nil(t, res)
	}
}
...
func TestSearchwaitForAppTask0(t *testing.T) {
	...
	require.NoError(t, err)
	{
		res, err = client.WaitForAppTask(context.Background(), 123)
		require.NoError(t, err)
		rawBody, err := json.Marshal(res)
		require.NoError(t, err)
...
func TestSearchwaitForTask0(t *testing.T) {
	...
	require.NoError(t, err)
	{
		res, err = client.WaitForTask(context.Background(), "wait-task-go", 123)
		require.NoError(t, err)
		rawBody, err := json.Marshal(res)
		require.NoError(t, err)
		require.JSONEq(t, `{"status":"published"}`, string(rawBody))
