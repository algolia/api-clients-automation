...
func TestSearchapi5(t *testing.T) {
	...
	client, err = search.NewClientWithConfig(cfg)
	require.NoError(t, err)
	res, err = client.CustomPost(context.Background(), "1/test/error/go", nil)
	require.NoError(t, err)
	rawBody, err := json.Marshal(res)
	require.NoError(t, err)
...
func TestSearchapi6(t *testing.T) {
	...
	res, err = client.CustomPost(
		context.Background(),
		"1/test/gzip",
		search.NewCustomPostOptions().WithParameters(map[string]any{}).WithBody(map[string]any{"message": "this is a compressed body"}),
	)
	require.NoError(t, err)
	rawBody, err := json.Marshal(res)
	require.NoError(t, err)
...
func TestSearchapi9(t *testing.T) {
	...
	client, err = search.NewClientWithConfig(cfg)
	require.NoError(t, err)
	res, err = client.GetSettings(context.Background(), "cts_e2e_unknownField_go", nil)
	require.NoError(t, err)
	rawBody, err := json.Marshal(res)
	require.NoError(t, err)
...
func TestSearchsaveObjectsWithTransformation0(t *testing.T) {
	...
	require.NoError(t, err)
	{
		res, err = client.SaveObjectsWithTransformation(context.Background(), "cts_e2e_saveObjectsWithTransformation_go",
