...
func TestSearchcommonApi1(t *testing.T) {
	...
	res, err = client.CustomPost(client.NewApiCustomPostRequest(
		"1/test"))
	require.NoError(t, err)
	require.Regexp(t, regexp.MustCompile(`^Algolia for Go \(4.19.0\).*`), echo.Header.Get("User-Agent"))
}
