...
func TestIngestionapi0(t *testing.T) {
	...
	client, err = ingestion.NewClientWithConfig(cfg)
	require.NoError(t, err)
	res, err = client.CustomGet("1/html-error", nil)
...
func TestIngestionapi3(t *testing.T) {
	...
	client, err = ingestion.NewClientWithConfig(cfg)
	require.NoError(t, err)
	res, err = client.CustomGet("1/long-wait", nil)
	require.NoError(t, err)
...
func TestIngestionapi4(t *testing.T) {
	...
	client, echo := createIngestionClient(t)
	_ = echo
	res, err = client.ValidateSourceBeforeUpdate("6c02aeb1-775e-418e-870b-1faccd4b2c0f", ingestion.NewValidateSourceBeforeUpdateOptions().WithName("newName"))
	require.NoError(t, err)
...
func TestIngestionapi5(t *testing.T) {
	...
	client, echo := createIngestionClient(t)
	_ = echo
	res, err = client.ValidateSourceBeforeUpdate("6c02aeb1-775e-418e-870b-1faccd4b2c0f", ingestion.NewValidateSourceBeforeUpdateOptions().WithName("newName"), ingestion.WithWriteTimeout(3456*time.Millisecond))
	require.NoError(t, err)
	require.Equal(t, int64(180000), echo.ConnectTimeout.Milliseconds())
...
func TestIngestionparameters0(t *testing.T) {
	...
	client, err = ingestion.NewClientWithConfig(cfg)
	require.NoError(t, err)
	res, err = client.GetSource("6c02aeb1-775e-418e-870b-1faccd4b2c0f")
	require.NoError(t, err)
