...
func TestAbtesting_AddABTests(t *testing.T) {
	...
	t.Run("addABTests with minimal parameters", func(t *testing.T) {
		...
		ja := jsonassert.New(t)
		ja.Assertf(*echo.Body, `{"name":"myABTest","variants":[{"index":"AB_TEST_1","trafficPercentage":30},{"index":"AB_TEST_2","trafficPercentage":50}],"endAt":"2022-12-31T00:00:00.000Z"}`)
	})
}
...
func TestAbtesting_CustomGet(t *testing.T) {
	...
	t.Run("requestOptions should be escaped too", func(t *testing.T) {
		_, err := client.CustomGet(context.Background(), "test/all", map[string]any{"query": "to be overriden"}, abtesting.WithQueryParam("query", "parameters with space"), abtesting.WithQueryParam("and an array",
...
func TestAbtesting_CustomPost(t *testing.T) {
	...
	t.Run("allow post method for a custom path with all parameters", func(t *testing.T) {
		_, err := client.CustomPost(context.Background(), "test/all", abtesting.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"body": "parameters"}))
		require.NoError(t, err)
	...
	t.Run("requestOptions can override default query parameters", func(t *testing.T) {
		_, err := client.CustomPost(context.Background(), "test/requestOptions", abtesting.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), abtesting.WithQueryParam("query", "myQueryParameter"))
		require.NoError(t, err)
	...
	t.Run("requestOptions merges query parameters with default ones", func(t *testing.T) {
		_, err := client.CustomPost(context.Background(), "test/requestOptions", abtesting.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), abtesting.WithQueryParam("query2", "myQueryParameter"))
		require.NoError(t, err)
	...
	t.Run("requestOptions can override default headers", func(t *testing.T) {
		_, err := client.CustomPost(context.Background(), "test/requestOptions", abtesting.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), abtesting.WithHeaderParam("x-algolia-api-key", "ALGOLIA_API_KEY"))
		require.NoError(t, err)
	...
	t.Run("requestOptions queryParameters accepts booleans", func(t *testing.T) {
		_, err := client.CustomPost(context.Background(), "test/requestOptions", abtesting.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), abtesting.WithQueryParam("isItWorking", true))
		require.NoError(t, err)
	...
	t.Run("requestOptions queryParameters accepts integers", func(t *testing.T) {
		_, err := client.CustomPost(context.Background(), "test/requestOptions", abtesting.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), abtesting.WithQueryParam("myParam", 2))
		require.NoError(t, err)
	...
	t.Run("requestOptions queryParameters accepts list of string", func(t *testing.T) {
		_, err := client.CustomPost(context.Background(), "test/requestOptions", abtesting.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), abtesting.WithQueryParam("myParam",
			[]string{"b and c", "d"}))
		require.NoError(t, err)
...
func TestAbtesting_CustomPut(t *testing.T) {
	...
	t.Run("allow put method for a custom path with all parameters", func(t *testing.T) {
		_, err := client.CustomPut(context.Background(), "test/all", abtesting.NewCustomPutOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"body": "parameters"}))
		require.NoError(t, err)
...
func TestAbtesting_ListABTests(t *testing.T) {
	...
	t.Run("listABTests with parameters", func(t *testing.T) {
		_, err := client.ListABTests(context.Background(), abtesting.NewListABTestsOptions().WithOffset(0).WithLimit(21).WithIndexPrefix("cts_e2e ab").WithIndexSuffix("t"))
		require.NoError(t, err)
...
func TestAbtesting_ScheduleABTest(t *testing.T) {
	...
	t.Run("scheduleABTest with minimal parameters", func(t *testing.T) {
		...
		ja := jsonassert.New(t)
		ja.Assertf(*echo.Body, `{"name":"myABTest","variants":[{"index":"AB_TEST_1","trafficPercentage":30},{"index":"AB_TEST_2","trafficPercentage":50}],"scheduledAt":"2022-11-31T00:00:00.000Z","endAt":"2022-12-31T00:00:00.000Z"}`)
	})
}
