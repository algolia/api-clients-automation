...
func TestSearch_BatchDictionaryEntries(t *testing.T) {
	...
	t.Run("replace", func(t *testing.T) {
		_, err := client.BatchDictionaryEntries(context.Background(), search.DICTIONARY_TYPE_PLURALS,
	...
	t.Run("append", func(t *testing.T) {
		_, err := client.BatchDictionaryEntries(context.Background(), search.DICTIONARY_TYPE_STOPWORDS,
			[]search.BatchDictionaryEntriesRequest{*search.NewEmptyBatchDictionaryEntriesRequest().SetAction(search.DICTIONARY_ACTION_ADD_ENTRY).SetBody(
...
func TestSearch_CustomGet(t *testing.T) {
	...
	t.Run("requestOptions should be escaped too", func(t *testing.T) {
		_, err := client.CustomGet(context.Background(), "test/all", map[string]any{"query": "to be overriden"}, search.WithQueryParam("query", "parameters with space"), search.WithQueryParam("and an array",
...
func TestSearch_CustomPost(t *testing.T) {
	...
	t.Run("allow post method for a custom path with all parameters", func(t *testing.T) {
		_, err := client.CustomPost(context.Background(), "test/all", search.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"body": "parameters"}))
		require.NoError(t, err)
	...
	t.Run("requestOptions can override default query parameters", func(t *testing.T) {
		_, err := client.CustomPost(context.Background(), "test/requestOptions", search.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), search.WithQueryParam("query", "myQueryParameter"))
		require.NoError(t, err)
	...
	t.Run("requestOptions merges query parameters with default ones", func(t *testing.T) {
		_, err := client.CustomPost(context.Background(), "test/requestOptions", search.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), search.WithQueryParam("query2", "myQueryParameter"))
		require.NoError(t, err)
	...
	t.Run("requestOptions can override default headers", func(t *testing.T) {
		_, err := client.CustomPost(context.Background(), "test/requestOptions", search.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), search.WithHeaderParam("x-algolia-api-key", "ALGOLIA_API_KEY"))
		require.NoError(t, err)
	...
	t.Run("requestOptions queryParameters accepts booleans", func(t *testing.T) {
		_, err := client.CustomPost(context.Background(), "test/requestOptions", search.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), search.WithQueryParam("isItWorking", true))
		require.NoError(t, err)
	...
	t.Run("requestOptions queryParameters accepts integers", func(t *testing.T) {
		_, err := client.CustomPost(context.Background(), "test/requestOptions", search.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), search.WithQueryParam("myParam", 2))
		require.NoError(t, err)
	...
	t.Run("requestOptions queryParameters accepts list of string", func(t *testing.T) {
		_, err := client.CustomPost(context.Background(), "test/requestOptions", search.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), search.WithQueryParam("myParam",
			[]string{"b and c", "d"}))
		require.NoError(t, err)
...
func TestSearch_CustomPut(t *testing.T) {
	...
	t.Run("allow put method for a custom path with all parameters", func(t *testing.T) {
		_, err := client.CustomPut(context.Background(), "test/all", search.NewCustomPutOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"body": "parameters"}))
		require.NoError(t, err)
...
func TestSearch_GetLogs(t *testing.T) {
	...
	t.Run("getLogs with parameters", func(t *testing.T) {
		_, err := client.GetLogs(context.Background(), search.NewGetLogsOptions().WithOffset(5).WithLength(10).WithIndexName("theIndexName").WithType(search.LOG_TYPE_ALL))
		require.NoError(t, err)
...
func TestSearch_GetSettings(t *testing.T) {
	...
	t.Run("getSettings", func(t *testing.T) {
		_, err := client.GetSettings(context.Background(), "cts_e2e_settings")
		require.NoError(t, err)
...
func TestSearch_MultipleBatch(t *testing.T) {
	...
	t.Run("multipleBatch", func(t *testing.T) {
		_, err := client.MultipleBatch(context.Background(),
...
func TestSearch_OperationIndex(t *testing.T) {
	...
	t.Run("scopes", func(t *testing.T) {
		_, err := client.OperationIndex(context.Background(), "<SOURCE_INDEX_NAME>", search.OPERATION_TYPE_MOVE, "<DESTINATION_INDEX_NAME>", utils.ToPtr(
...
func TestSearch_PartialUpdateObject(t *testing.T) {
	...
	t.Run("Partial update with a new value for an array attribute", func(t *testing.T) {
		_, err := client.PartialUpdateObject(context.Background(), "theIndexName", "uniqueID", map[string]any{"attributeId": []string{"one", "two", "three"}}, nil)
		require.NoError(t, err)
	...
	t.Run("Partial update with a new value for an object attribute", func(t *testing.T) {
		_, err := client.PartialUpdateObject(context.Background(), "theIndexName", "uniqueID", map[string]any{"attributeId": map[string]any{"nested": "value"}}, nil)
		require.NoError(t, err)
	...
	t.Run("with visible_by filter", func(t *testing.T) {
		_, err := client.PartialUpdateObject(context.Background(), "theIndexName", "uniqueID", map[string]any{"visible_by": []string{"Angela", "group/Finance", "group/Shareholders"}}, nil)
		require.NoError(t, err)
	...
	t.Run("add men pant", func(t *testing.T) {
		_, err := client.PartialUpdateObject(context.Background(), "theIndexName", "productId", map[string]any{"categoryPageId": map[string]any{"_operation": "Add", "value": "men-clothing-pants"}}, nil)
		require.NoError(t, err)
	...
	t.Run("remove men pant", func(t *testing.T) {
		_, err := client.PartialUpdateObject(context.Background(), "theIndexName", "productId", map[string]any{"categoryPageId": map[string]any{"_operation": "Remove", "value": "men-clothing-pants"}}, nil)
		require.NoError(t, err)
...
func TestSearch_SaveObject(t *testing.T) {
	...
	t.Run("saveObject", func(t *testing.T) {
		_, err := client.SaveObject(context.Background(), "<YOUR_INDEX_NAME>", map[string]any{"name": "Black T-shirt", "color": "#000000||black", "availableIn": "https://source.unsplash.com/100x100/?paris||Paris", "objectID": "myID"})
		require.NoError(t, err)
...
func TestSearch_SearchDictionaryEntries(t *testing.T) {
	...
	t.Run("get searchDictionaryEntries results with all parameters", func(t *testing.T) {
		_, err := client.SearchDictionaryEntries(context.Background(), search.DICTIONARY_TYPE_COMPOUNDS, "foo", search.NewSearchDictionaryEntriesOptions().WithPage(4).WithHitsPerPage(2).WithLanguage(search.SUPPORTED_LANGUAGE_FR))
		require.NoError(t, err)
...
func TestSearch_SearchForFacetValues(t *testing.T) {
	...
	t.Run("get searchForFacetValues results with all parameters", func(t *testing.T) {
		_, err := client.SearchForFacetValues(context.Background(), "indexName", "facetName", search.NewSearchForFacetValuesOptions().WithParams("query=foo&facetFilters=['bar']").WithFacetQuery("foo").WithMaxFacetHits(42))
		require.NoError(t, err)
	...
	t.Run("facetName and facetQuery", func(t *testing.T) {
		_, err := client.SearchForFacetValues(context.Background(), "indexName", "author", search.NewSearchForFacetValuesOptions().WithFacetQuery("stephen"))
		require.NoError(t, err)
...
func TestSearch_SearchSynonyms(t *testing.T) {
	...
	t.Run("searchSynonyms with all parameters", func(t *testing.T) {
		_, err := client.SearchSynonyms(context.Background(), "indexName", search.NewSearchSynonymsOptions().WithQuery("myQuery").WithType(search.SYNONYM_TYPE_ALTCORRECTION1).WithPage(10).WithHitsPerPage(10))
		require.NoError(t, err)
...
func TestSearch_SearchUserIds(t *testing.T) {
	...
	t.Run("searchUserIds", func(t *testing.T) {
		_, err := client.SearchUserIds(context.Background(), "test", search.NewSearchUserIdsOptions().WithClusterName("theClusterName").WithPage(5).WithHitsPerPage(10))
		require.NoError(t, err)
...
func TestSearch_SetSettings(t *testing.T) {
	...
	t.Run("minimal parameters", func(t *testing.T) {
		_, err := client.SetSettings(context.Background(), "cts_e2e_settings",
...
func TestSearch_UpdateApiKey(t *testing.T) {
	...
	t.Run("updateApiKey", func(t *testing.T) {
		_, err := client.UpdateApiKey(context.Background(), "ALGOLIA_API_KEY",
