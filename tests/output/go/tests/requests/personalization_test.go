...
func TestPersonalization_CustomGet(t *testing.T) {
	...
	t.Run("requestOptions should be escaped too", func(t *testing.T) {
		_, err := client.CustomGet(context.Background(), "test/all", map[string]any{"query": "to be overriden"}, personalization.WithQueryParam("query", "parameters with space"), personalization.WithQueryParam("and an array",
...
func TestPersonalization_CustomPost(t *testing.T) {
	...
	t.Run("allow post method for a custom path with all parameters", func(t *testing.T) {
		_, err := client.CustomPost(context.Background(), "test/all", personalization.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"body": "parameters"}))
		require.NoError(t, err)
	...
	t.Run("requestOptions can override default query parameters", func(t *testing.T) {
		_, err := client.CustomPost(context.Background(), "test/requestOptions", personalization.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), personalization.WithQueryParam("query", "myQueryParameter"))
		require.NoError(t, err)
	...
	t.Run("requestOptions merges query parameters with default ones", func(t *testing.T) {
		_, err := client.CustomPost(context.Background(), "test/requestOptions", personalization.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), personalization.WithQueryParam("query2", "myQueryParameter"))
		require.NoError(t, err)
	...
	t.Run("requestOptions can override default headers", func(t *testing.T) {
		_, err := client.CustomPost(context.Background(), "test/requestOptions", personalization.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), personalization.WithHeaderParam("x-algolia-api-key", "ALGOLIA_API_KEY"))
		require.NoError(t, err)
	...
	t.Run("requestOptions queryParameters accepts booleans", func(t *testing.T) {
		_, err := client.CustomPost(context.Background(), "test/requestOptions", personalization.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), personalization.WithQueryParam("isItWorking", true))
		require.NoError(t, err)
	...
	t.Run("requestOptions queryParameters accepts integers", func(t *testing.T) {
		_, err := client.CustomPost(context.Background(), "test/requestOptions", personalization.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), personalization.WithQueryParam("myParam", 2))
		require.NoError(t, err)
	...
	t.Run("requestOptions queryParameters accepts list of string", func(t *testing.T) {
		_, err := client.CustomPost(context.Background(), "test/requestOptions", personalization.NewCustomPostOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"facet": "filters"}), personalization.WithQueryParam("myParam",
			[]string{"b and c", "d"}))
		require.NoError(t, err)
...
func TestPersonalization_CustomPut(t *testing.T) {
	...
	t.Run("allow put method for a custom path with all parameters", func(t *testing.T) {
		_, err := client.CustomPut(context.Background(), "test/all", personalization.NewCustomPutOptions().WithParameters(map[string]any{"query": "parameters"}).WithBody(map[string]any{"body": "parameters"}))
		require.NoError(t, err)
...
func TestPersonalization_SetPersonalizationStrategy(t *testing.T) {
	...
	t.Run("set setPersonalizationStrategy", func(t *testing.T) {
		_, err := client.SetPersonalizationStrategy(context.Background(),
		...
		ja := jsonassert.New(t)
		ja.Assertf(*echo.Body, `{"eventsScoring":[{"score":42,"eventName":"Algolia","eventType":"click"}],"facetsScoring":[{"score":42,"facetName":"Event"}],"personalizationImpact":42}`)
	})
}
