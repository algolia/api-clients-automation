	...
	tests := []struct {
	...
	}{
		{
			...
			testFunc: func(t *testing.T) {
				...
				req := personalization.ApiCustomDeleteRequest{}
...
func TestPersonalization_CustomGet(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			testFunc: func(t *testing.T) {
				parametersStr := `{"path":"/test/minimal"}`
				req := personalization.ApiCustomGetRequest{}
				require.NoError(t, json.Unmarshal([]byte(parametersStr), &req))
...
func TestPersonalization_CustomPost(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			testFunc: func(t *testing.T) {
				parametersStr := `{"path":"/test/minimal"}`
				req := personalization.ApiCustomPostRequest{}
				require.NoError(t, json.Unmarshal([]byte(parametersStr), &req))
...
func TestPersonalization_CustomPut(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			testFunc: func(t *testing.T) {
				parametersStr := `{"path":"/test/minimal"}`
				req := personalization.ApiCustomPutRequest{}
				require.NoError(t, json.Unmarshal([]byte(parametersStr), &req))
