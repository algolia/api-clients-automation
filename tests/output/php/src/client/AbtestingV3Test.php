...
class AbtestingV3Test extends TestCase implements HttpClientInterface
{
    ...
    {
        $client = AbtestingV3Client::createWithConfig(AbtestingV3Config::create('test-app-id', 'test-api-key', 'us')->setFullHosts(['http://'.('true' == getenv('CI') ? 'localhost' : 'host.docker.internal').':6691']));
