...
$client = AbtestingV3Client::createWithConfig(AbtestingV3Config::create("test-app-id","test-api-key","us")->setFullHosts(["http://" . (getenv("CI") == "true" ? "localhost" : "host.docker.internal") . ":6683"]));
