...
class AgentStudioTest extends TestCase implements HttpClientInterface
{
    ...
    {
        $client = AgentStudioClient::createWithConfig(AgentStudioConfig::create('test-app-id', 'test-api-key')->setFullHosts(['http://'.('true' == getenv('CI') ? 'localhost' : 'host.docker.internal').':6692']));
    ...
    {
        $client = AgentStudioClient::createWithConfig(AgentStudioConfig::create('test-app-id', 'test-api-key')->setFullHosts(['http://'.('true' == getenv('CI') ? 'localhost' : 'host.docker.internal').':6683']));
     ...
     * @param mixed $apiKey
     */
    private function createClient($appId, $apiKey): AgentStudioClient
    {
