...
class InsightsTest extends TestCase implements HttpClientInterface
{
    ...
    {
        $client = InsightsClient::createWithConfig(InsightsConfig::create('test-app-id', 'test-api-key', 'us')->setFullHosts(['http://'.('true' == getenv('CI') ? 'localhost' : 'host.docker.internal').':6692']));
