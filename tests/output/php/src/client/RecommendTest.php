...
$client = RecommendClient::createWithConfig(RecommendConfig::create("test-app-id","test-api-key")->setFullHosts(["http://" . (getenv("CI") == "true" ? "localhost" : "host.docker.internal") . ":6683"]));
