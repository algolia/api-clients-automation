...
class QuerySuggestionsTest extends TestCase implements HttpClientInterface
{
    ...
    {
        $client = QuerySuggestionsClient::createWithConfig(QuerySuggestionsConfig::create('test-app-id', 'test-api-key', 'us')->setFullHosts(['http://'.('true' == getenv('CI') ? 'localhost' : 'host.docker.internal').':6691']));
