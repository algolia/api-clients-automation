...
class MonitoringTest extends TestCase implements HttpClientInterface
{
    ...
    {
        $client = MonitoringClient::createWithConfig(MonitoringConfig::create('test-app-id', 'test-api-key')->setFullHosts(['http://'.('true' == getenv('CI') ? 'localhost' : 'host.docker.internal').':6692']));
