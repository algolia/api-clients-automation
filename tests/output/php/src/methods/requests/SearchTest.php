...
["cluster" => "theCluster"
        ...
        $this->assertRequests([
            [
                ...
                "searchParams" => json_decode("{\"X-Algolia-User-ID\":\"userID\"}"),
            ],
        ]);
    }
...
true
        ...
        $this->assertRequests([
            [
                ...
                "method" => "POST",
                "body" => json_decode("[{\"objectID\":\"a-rule-id\",\"conditions\":[{\"pattern\":\"smartphone\",\"anchoring\":\"contains\"}],\"consequence\":{\"params\":{\"filters\":\"category:smartphone\"}}},{\"objectID\":\"a-second-rule-id\",\"conditions\":[{\"pattern\":\"apple\",\"anchoring\":\"contains\"}],\"consequence\":{\"params\":{\"filters\":\"brand:apple\"}}}]"),
                "searchParams" => json_decode("{\"forwardToReplicas\":\"true\",\"clearExistingRules\":\"true\"}"),
            ],
        ]);
    }
...
"cursor" => "cts"
        ...
        $this->assertRequests([
            [
                "path" => "/1/indexes/indexName/browse",
                "method" => "POST",
                "body" => json_decode("{\"params\":\"query=foo&facetFilters=['bar']\",\"cursor\":\"cts\"}"),
            ],
        ]);
    }
...
"all"
        ...
        $this->assertRequests([
            [
                "path" => "/1/logs",
                "method" => "GET",
                "searchParams" => json_decode("{\"offset\":\"5\",\"length\":\"10\",\"indexName\":\"theIndexName\",\"type\":\"all\"}"),
            ],
        ]);
    }
 ...
 "attr2"
        ...
        $this->assertRequests([
            [
                "path" => "/1/indexes/theIndexName/uniqueID",
                "method" => "GET",
                "searchParams" => json_decode("{\"attributesToRetrieve\":\"attr1,attr2\"}"),
            ],
        ]);
    }
...
100
        ...
        $this->assertRequests([
            [
                "path" => "/1/clusters/mapping",
                "method" => "GET",
                "searchParams" => json_decode("{\"page\":\"8\",\"hitsPerPage\":\"100\"}"),
            ],
        ]);
    }
...
"strategy" => "stopIfEnoughMatches"
        ...
        $this->assertRequests([
            [
                ...
                "method" => "POST",
                "body" => json_decode("{\"requests\":[{\"indexName\":\"theIndexName\",\"query\":\"test\",\"type\":\"facet\",\"facet\":\"theFacet\",\"params\":\"testParam\"}],\"strategy\":\"stopIfEnoughMatches\"}"),
            ],
        ]);
    }
...
true
        ...
        $this->assertRequests([
            [
                ...
                "searchParams" => json_decode("{\"createIfNotExists\":\"true\"}"),
            ],
        ]);
    }
...
true
        ...
        $this->assertRequests([
            [
                "path" => "/1/indexes/indexName/rules/id1",
                "method" => "PUT",
                "body" => json_decode("{\"objectID\":\"id1\",\"conditions\":[{\"pattern\":\"apple\",\"anchoring\":\"contains\"}],\"consequence\":{\"params\":{\"filters\":\"brand:apple\"}}}"),
                "searchParams" => json_decode("{\"forwardToReplicas\":\"true\"}"),
            ],
        ]);
    }
...
false
        ...
        $this->assertRequests([
            [
                ...
                "searchParams" => json_decode("{\"forwardToReplicas\":\"true\",\"replaceExistingSynonyms\":\"false\"}"),
            ],
        ]);
    }
