...
class AgentStudioTest extends TestCase implements HttpClientInterface
{
    ...
    #[TestDox('createAgentCompletion with v5 messages and all query params')]
    public function testCreateAgentCompletion1(): void
    {
        $client = $this->getClient();
        $client->createAgentCompletion(
            '785b14e4-61a8-4c03-8028-bf2ba3ae85ff',
        ...
        $this->assertRequests([
            [
                'path' => '/1/agents/785b14e4-61a8-4c03-8028-bf2ba3ae85ff/completions',
                'method' => 'POST',
                'body' => json_decode('{"messages":[{"role":"user","parts":[{"type":"text","text":"What is Algolia?"}]}],"id":"test-conversation-id"}'),
                'queryParameters' => json_decode('{"compatibilityMode":"ai-sdk-5","stream":"false","cache":"false","memory":"false"}', true),
            ],
        ]);
    }

    #[TestDox('createAgentCompletion with test configuration')]
    public function testCreateAgentCompletion2(): void
    {
        $client = $this->getClient();
        $client->createAgentCompletion(
            '785b14e4-61a8-4c03-8028-bf2ba3ae85ff',
        ...
        $this->assertRequests([
            [
                'path' => '/1/agents/785b14e4-61a8-4c03-8028-bf2ba3ae85ff/completions',
                'method' => 'POST',
                'body' => json_decode('{"messages":[{"role":"user","content":"Hello"}],"configuration":{"instructions":"Test instructions override","config":{"temperature":0.2},"tools":[{"type":"start"}]}}'),
                'queryParameters' => json_decode('{"compatibilityMode":"ai-sdk-4"}', true),
            ],
        ]);
    }
