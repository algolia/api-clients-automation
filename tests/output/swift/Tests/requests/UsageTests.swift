...
final class UsageClientRequestsTests: XCTestCase {
    ...
    func testCustomDeleteTest0() async throws {
        let configuration = try UsageClientConfiguration(
            appID: UsageClientRequestsTests.APPLICATION_ID,
            apiKey: UsageClientRequestsTests.API_KEY
        )
    ...
    func testGetIndexUsageTest0() async throws {
        let configuration = try UsageClientConfiguration(
            appID: UsageClientRequestsTests.APPLICATION_ID,
            apiKey: UsageClientRequestsTests.API_KEY
        )
        ...
        let response = try await client.getIndexUsageWithHTTPInfo(
        ...
        XCTAssertEqual(echoResponse.path, "/1/usage/queries_operations/myIndexName")
        XCTAssertEqual(echoResponse.method, HTTPMethod.get)
    ...
    func testGetUsageTest0() async throws {
        let configuration = try UsageClientConfiguration(
            appID: UsageClientRequestsTests.APPLICATION_ID,
            apiKey: UsageClientRequestsTests.API_KEY
        )
        ...
        let response = try await client.getUsageWithHTTPInfo(
            statistic: Statistic.queriesOperations,
            startDate: "2024-04-03T12:46:43Z",
            endDate: "2024-04-05T12:46:43Z"
        )
        ...
        XCTAssertEqual(echoResponse.path, "/1/usage/queries_operations")
        XCTAssertEqual(echoResponse.method, HTTPMethod.get)
