...
final class AnalyticsClientRequestsTests: XCTestCase {
  ...
  func testCustomDeleteTest0() async throws {
    ...
    let client: AnalyticsClient = AnalyticsClient(
  ...
  func testGetAverageClickPositionTest0() async throws {
    ...
    let response = try await client.getAverageClickPositionWithHTTPInfo(
      index: "index", requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testGetSearchesNoClicksTest1() async throws {
    ...
    let response = try await client.getSearchesNoClicksWithHTTPInfo(
      index: "index", startDate: "1999-09-19", endDate: "2001-01-01", limit: 21, offset: 42,
      tags: "tag", requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testGetTopFilterAttributesTest1() async throws {
    ...
    let response = try await client.getTopFilterAttributesWithHTTPInfo(
      index: "index", search: "mySearch", startDate: "1999-09-19", endDate: "2001-01-01", limit: 21,
      offset: 42, tags: "tag", requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testGetTopFilterForAttributeTest0() async throws {
    ...
    let response = try await client.getTopFilterForAttributeWithHTTPInfo(
      attribute: "myAttribute", index: "index", requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testGetTopFilterForAttributeTest1() async throws {
    ...
    let response = try await client.getTopFilterForAttributeWithHTTPInfo(
      attribute: "myAttribute1,myAttribute2", index: "index", requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testGetTopFilterForAttributeTest2() async throws {
    ...
    let response = try await client.getTopFilterForAttributeWithHTTPInfo(
      attribute: "myAttribute", index: "index", search: "mySearch", startDate: "1999-09-19",
      endDate: "2001-01-01", limit: 21, offset: 42, tags: "tag", requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testGetTopFilterForAttributeTest3() async throws {
    ...
    let response = try await client.getTopFilterForAttributeWithHTTPInfo(
      attribute: "myAttribute1,myAttribute2", index: "index", search: "mySearch",
      startDate: "1999-09-19", endDate: "2001-01-01", limit: 21, offset: 42, tags: "tag",
      requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testGetTopHitsTest1() async throws {
    ...
    let response = try await client.getTopHitsWithHTTPInfo(
      index: "index", search: "mySearch", clickAnalytics: true, startDate: "1999-09-19",
      endDate: "2001-01-01", limit: 21, offset: 42, tags: "tag", requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testGetTopSearchesTest1() async throws {
    ...
    let response = try await client.getTopSearchesWithHTTPInfo(
      index: "index", clickAnalytics: true, startDate: "1999-09-19", endDate: "2001-01-01",
      orderBy: OrderBy.searchCount, direction: Direction.asc, limit: 21, offset: 42, tags: "tag",
      requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
