...
final class AnalyticsClientRequestsTests: XCTestCase {
    ...
    func testGetAverageClickPositionTest0() async throws {
        ...
        let response = try await client.getAverageClickPositionWithHTTPInfo(index: "index", requestOptions: nil)
        let responseBodyData = try XCTUnwrap(response.bodyData)
        let echoResponse = try CodableHelper.jsonDecoder.decode(EchoResponse.self, from: responseBodyData)
    ...
    func testGetAverageClickPositionTest1() async throws {
        ...
        let response = try await client.getAverageClickPositionWithHTTPInfo(index: "index", startDate: "1999-09-19", endDate: "2001-01-01", tags: "tag", requestOptions: nil)
        let responseBodyData = try XCTUnwrap(response.bodyData)
        let echoResponse = try CodableHelper.jsonDecoder.decode(EchoResponse.self, from: responseBodyData)
    ...
    func testGetClickPositionsTest0() async throws {
        ...
        let response = try await client.getClickPositionsWithHTTPInfo(index: "index", requestOptions: nil)
        let responseBodyData = try XCTUnwrap(response.bodyData)
        let echoResponse = try CodableHelper.jsonDecoder.decode(EchoResponse.self, from: responseBodyData)
    ...
    func testGetClickPositionsTest1() async throws {
        ...
        let response = try await client.getClickPositionsWithHTTPInfo(index: "index", startDate: "1999-09-19", endDate: "2001-01-01", tags: "tag", requestOptions: nil)
        let responseBodyData = try XCTUnwrap(response.bodyData)
        let echoResponse = try CodableHelper.jsonDecoder.decode(EchoResponse.self, from: responseBodyData)
    ...
    func testGetClickThroughRateTest0() async throws {
        ...
        let response = try await client.getClickThroughRateWithHTTPInfo(index: "index", requestOptions: nil)
        let responseBodyData = try XCTUnwrap(response.bodyData)
        let echoResponse = try CodableHelper.jsonDecoder.decode(EchoResponse.self, from: responseBodyData)
    ...
    func testGetClickThroughRateTest1() async throws {
        ...
        let response = try await client.getClickThroughRateWithHTTPInfo(index: "index", startDate: "1999-09-19", endDate: "2001-01-01", tags: "tag", requestOptions: nil)
        let responseBodyData = try XCTUnwrap(response.bodyData)
        let echoResponse = try CodableHelper.jsonDecoder.decode(EchoResponse.self, from: responseBodyData)
    ...
    func testGetConversationRateTest0() async throws {
        ...
        let response = try await client.getConversationRateWithHTTPInfo(index: "index", requestOptions: nil)
        let responseBodyData = try XCTUnwrap(response.bodyData)
        let echoResponse = try CodableHelper.jsonDecoder.decode(EchoResponse.self, from: responseBodyData)
    ...
    func testGetConversationRateTest1() async throws {
        ...
        let response = try await client.getConversationRateWithHTTPInfo(index: "index", startDate: "1999-09-19", endDate: "2001-01-01", tags: "tag", requestOptions: nil)
        let responseBodyData = try XCTUnwrap(response.bodyData)
        let echoResponse = try CodableHelper.jsonDecoder.decode(EchoResponse.self, from: responseBodyData)
    ...
    func testGetNoClickRateTest0() async throws {
        ...
        let response = try await client.getNoClickRateWithHTTPInfo(index: "index", requestOptions: nil)
        let responseBodyData = try XCTUnwrap(response.bodyData)
        let echoResponse = try CodableHelper.jsonDecoder.decode(EchoResponse.self, from: responseBodyData)
    ...
    func testGetNoClickRateTest1() async throws {
        ...
        let response = try await client.getNoClickRateWithHTTPInfo(index: "index", startDate: "1999-09-19", endDate: "2001-01-01", tags: "tag", requestOptions: nil)
        let responseBodyData = try XCTUnwrap(response.bodyData)
        let echoResponse = try CodableHelper.jsonDecoder.decode(EchoResponse.self, from: responseBodyData)
    ...
    func testGetNoResultsRateTest0() async throws {
        ...
        let response = try await client.getNoResultsRateWithHTTPInfo(index: "index", requestOptions: nil)
        let responseBodyData = try XCTUnwrap(response.bodyData)
        let echoResponse = try CodableHelper.jsonDecoder.decode(EchoResponse.self, from: responseBodyData)
    ...
    func testGetNoResultsRateTest1() async throws {
        ...
        let response = try await client.getNoResultsRateWithHTTPInfo(index: "index", startDate: "1999-09-19", endDate: "2001-01-01", tags: "tag", requestOptions: nil)
        let responseBodyData = try XCTUnwrap(response.bodyData)
        let echoResponse = try CodableHelper.jsonDecoder.decode(EchoResponse.self, from: responseBodyData)
    ...
    func testGetSearchesCountTest0() async throws {
        ...
        let response = try await client.getSearchesCountWithHTTPInfo(index: "index", requestOptions: nil)
        let responseBodyData = try XCTUnwrap(response.bodyData)
        let echoResponse = try CodableHelper.jsonDecoder.decode(EchoResponse.self, from: responseBodyData)
    ...
    func testGetSearchesCountTest1() async throws {
        ...
        let response = try await client.getSearchesCountWithHTTPInfo(index: "index", startDate: "1999-09-19", endDate: "2001-01-01", tags: "tag", requestOptions: nil)
        let responseBodyData = try XCTUnwrap(response.bodyData)
        let echoResponse = try CodableHelper.jsonDecoder.decode(EchoResponse.self, from: responseBodyData)
    ...
    func testGetSearchesNoClicksTest0() async throws {
        ...
        let response = try await client.getSearchesNoClicksWithHTTPInfo(index: "index", requestOptions: nil)
        let responseBodyData = try XCTUnwrap(response.bodyData)
        let echoResponse = try CodableHelper.jsonDecoder.decode(EchoResponse.self, from: responseBodyData)
    ...
    func testGetSearchesNoClicksTest1() async throws {
        ...
        let response = try await client.getSearchesNoClicksWithHTTPInfo(index: "index", startDate: "1999-09-19", endDate: "2001-01-01", limit: 21, offset: 42, tags: "tag", requestOptions: nil)
        let responseBodyData = try XCTUnwrap(response.bodyData)
        let echoResponse = try CodableHelper.jsonDecoder.decode(EchoResponse.self, from: responseBodyData)
    ...
    func testGetSearchesNoResultsTest0() async throws {
        ...
        let response = try await client.getSearchesNoResultsWithHTTPInfo(index: "index", requestOptions: nil)
        let responseBodyData = try XCTUnwrap(response.bodyData)
        let echoResponse = try CodableHelper.jsonDecoder.decode(EchoResponse.self, from: responseBodyData)
    ...
    func testGetSearchesNoResultsTest1() async throws {
        ...
        let response = try await client.getSearchesNoResultsWithHTTPInfo(index: "index", startDate: "1999-09-19", endDate: "2001-01-01", limit: 21, offset: 42, tags: "tag", requestOptions: nil)
        let responseBodyData = try XCTUnwrap(response.bodyData)
        let echoResponse = try CodableHelper.jsonDecoder.decode(EchoResponse.self, from: responseBodyData)
    ...
    func testGetStatusTest0() async throws {
        ...
        let response = try await client.getStatusWithHTTPInfo(index: "index", requestOptions: nil)
        let responseBodyData = try XCTUnwrap(response.bodyData)
        let echoResponse = try CodableHelper.jsonDecoder.decode(EchoResponse.self, from: responseBodyData)
    ...
    func testGetTopCountriesTest0() async throws {
        ...
        let response = try await client.getTopCountriesWithHTTPInfo(index: "index", requestOptions: nil)
        let responseBodyData = try XCTUnwrap(response.bodyData)
        let echoResponse = try CodableHelper.jsonDecoder.decode(EchoResponse.self, from: responseBodyData)
    ...
    func testGetTopCountriesTest1() async throws {
        ...
        let response = try await client.getTopCountriesWithHTTPInfo(index: "index", startDate: "1999-09-19", endDate: "2001-01-01", limit: 21, offset: 42, tags: "tag", requestOptions: nil)
        let responseBodyData = try XCTUnwrap(response.bodyData)
        let echoResponse = try CodableHelper.jsonDecoder.decode(EchoResponse.self, from: responseBodyData)
    ...
    func testGetTopFilterAttributesTest0() async throws {
        ...
        let response = try await client.getTopFilterAttributesWithHTTPInfo(index: "index", requestOptions: nil)
        let responseBodyData = try XCTUnwrap(response.bodyData)
        let echoResponse = try CodableHelper.jsonDecoder.decode(EchoResponse.self, from: responseBodyData)
    ...
    func testGetTopFilterAttributesTest1() async throws {
        ...
        let response = try await client.getTopFilterAttributesWithHTTPInfo(index: "index", search: "mySearch", startDate: "1999-09-19", endDate: "2001-01-01", limit: 21, offset: 42, tags: "tag", requestOptions: nil)
        let responseBodyData = try XCTUnwrap(response.bodyData)
        let echoResponse = try CodableHelper.jsonDecoder.decode(EchoResponse.self, from: responseBodyData)
    ...
    func testGetTopFilterForAttributeTest0() async throws {
        ...
        let response = try await client.getTopFilterForAttributeWithHTTPInfo(attribute: "myAttribute", index: "index", requestOptions: nil)
        let responseBodyData = try XCTUnwrap(response.bodyData)
        let echoResponse = try CodableHelper.jsonDecoder.decode(EchoResponse.self, from: responseBodyData)
    ...
    func testGetTopFilterForAttributeTest1() async throws {
        ...
        let response = try await client.getTopFilterForAttributeWithHTTPInfo(attribute: "myAttribute1,myAttribute2", index: "index", requestOptions: nil)
        let responseBodyData = try XCTUnwrap(response.bodyData)
        let echoResponse = try CodableHelper.jsonDecoder.decode(EchoResponse.self, from: responseBodyData)
    ...
    func testGetTopFilterForAttributeTest2() async throws {
        ...
        let response = try await client.getTopFilterForAttributeWithHTTPInfo(attribute: "myAttribute", index: "index", search: "mySearch", startDate: "1999-09-19", endDate: "2001-01-01", limit: 21, offset: 42, tags: "tag", requestOptions: nil)
        let responseBodyData = try XCTUnwrap(response.bodyData)
        let echoResponse = try CodableHelper.jsonDecoder.decode(EchoResponse.self, from: responseBodyData)
    ...
    func testGetTopFilterForAttributeTest3() async throws {
        ...
        let response = try await client.getTopFilterForAttributeWithHTTPInfo(attribute: "myAttribute1,myAttribute2", index: "index", search: "mySearch", startDate: "1999-09-19", endDate: "2001-01-01", limit: 21, offset: 42, tags: "tag", requestOptions: nil)
        let responseBodyData = try XCTUnwrap(response.bodyData)
        let echoResponse = try CodableHelper.jsonDecoder.decode(EchoResponse.self, from: responseBodyData)
    ...
    func testGetTopFiltersNoResultsTest0() async throws {
        ...
        let response = try await client.getTopFiltersNoResultsWithHTTPInfo(index: "index", requestOptions: nil)
        let responseBodyData = try XCTUnwrap(response.bodyData)
        let echoResponse = try CodableHelper.jsonDecoder.decode(EchoResponse.self, from: responseBodyData)
    ...
    func testGetTopFiltersNoResultsTest1() async throws {
        ...
        let response = try await client.getTopFiltersNoResultsWithHTTPInfo(index: "index", search: "mySearch", startDate: "1999-09-19", endDate: "2001-01-01", limit: 21, offset: 42, tags: "tag", requestOptions: nil)
        let responseBodyData = try XCTUnwrap(response.bodyData)
        let echoResponse = try CodableHelper.jsonDecoder.decode(EchoResponse.self, from: responseBodyData)
    ...
    func testGetTopHitsTest0() async throws {
        ...
        let response = try await client.getTopHitsWithHTTPInfo(index: "index", requestOptions: nil)
        let responseBodyData = try XCTUnwrap(response.bodyData)
        let echoResponse = try CodableHelper.jsonDecoder.decode(EchoResponse.self, from: responseBodyData)
    ...
    func testGetTopHitsTest1() async throws {
        ...
        let response = try await client.getTopHitsWithHTTPInfo(index: "index", search: "mySearch", clickAnalytics: true, startDate: "1999-09-19", endDate: "2001-01-01", limit: 21, offset: 42, tags: "tag", requestOptions: nil)
        let responseBodyData = try XCTUnwrap(response.bodyData)
        let echoResponse = try CodableHelper.jsonDecoder.decode(EchoResponse.self, from: responseBodyData)
    ...
    func testGetTopSearchesTest0() async throws {
        ...
        let response = try await client.getTopSearchesWithHTTPInfo(index: "index", requestOptions: nil)
        let responseBodyData = try XCTUnwrap(response.bodyData)
        let echoResponse = try CodableHelper.jsonDecoder.decode(EchoResponse.self, from: responseBodyData)
    ...
    func testGetTopSearchesTest1() async throws {
        ...
        let response = try await client.getTopSearchesWithHTTPInfo(index: "index", clickAnalytics: true, startDate: "1999-09-19", endDate: "2001-01-01", orderBy: OrderBy.searchCount, direction: Direction.asc, limit: 21, offset: 42, tags: "tag", requestOptions: nil)
        let responseBodyData = try XCTUnwrap(response.bodyData)
        let echoResponse = try CodableHelper.jsonDecoder.decode(EchoResponse.self, from: responseBodyData)
    ...
    func testGetUsersCountTest0() async throws {
        ...
        let response = try await client.getUsersCountWithHTTPInfo(index: "index", requestOptions: nil)
        let responseBodyData = try XCTUnwrap(response.bodyData)
        let echoResponse = try CodableHelper.jsonDecoder.decode(EchoResponse.self, from: responseBodyData)
    ...
    func testGetUsersCountTest1() async throws {
        ...
        let response = try await client.getUsersCountWithHTTPInfo(index: "index", startDate: "1999-09-19", endDate: "2001-01-01", tags: "tag", requestOptions: nil)
        let responseBodyData = try XCTUnwrap(response.bodyData)
        let echoResponse = try CodableHelper.jsonDecoder.decode(EchoResponse.self, from: responseBodyData)
