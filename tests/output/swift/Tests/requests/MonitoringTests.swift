...
final class MonitoringClientRequestsTests: XCTestCase {
  ...
  func testCustomDeleteTest0() async throws {
    ...
    let client: MonitoringClient = MonitoringClient(
  ...
  func testGetClusterIncidentsTest0() async throws {
    ...
    let response = try await client.getClusterIncidentsWithHTTPInfo(
      clusters: "c1-de", requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testGetLatencyTest0() async throws {
    ...
    let response = try await client.getLatencyWithHTTPInfo(clusters: "c1-de", requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testGetMetricsTest0() async throws {
    ...
    let response = try await client.getMetricsWithHTTPInfo(
      metric: Metric.avgBuildTime, period: Period.minute, requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
