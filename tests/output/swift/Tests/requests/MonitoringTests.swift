...
final class MonitoringClientRequestsTests: XCTestCase {
    ...
    func testCustomDeleteTest0() async throws {
        let configuration: Monitoring.Configuration = try Monitoring.Configuration(applicationID: APPLICATION_ID, apiKey: API_KEY)
    ...
    func testGetClusterIncidentsTest0() async throws {
        ...
        let response = try await client.getClusterIncidentsWithHTTPInfo(clusters: "c1-de", requestOptions: nil)
        let responseBodyData = try XCTUnwrap(response.bodyData)
        let echoResponse = try CodableHelper.jsonDecoder.decode(EchoResponse.self, from: responseBodyData)
    ...
    func testGetClusterStatusTest0() async throws {
        ...
        let response = try await client.getClusterStatusWithHTTPInfo(clusters: "c1-de", requestOptions: nil)
        let responseBodyData = try XCTUnwrap(response.bodyData)
        let echoResponse = try CodableHelper.jsonDecoder.decode(EchoResponse.self, from: responseBodyData)
    ...
    func testGetIndexingTimeTest0() async throws {
        ...
        let response = try await client.getIndexingTimeWithHTTPInfo(clusters: "c1-de", requestOptions: nil)
        let responseBodyData = try XCTUnwrap(response.bodyData)
        let echoResponse = try CodableHelper.jsonDecoder.decode(EchoResponse.self, from: responseBodyData)
    ...
    func testGetMetricsTest0() async throws {
        ...
        let response = try await client.getMetricsWithHTTPInfo(metric: Metric.avgBuildTime, period: Period.minute, requestOptions: nil)
        let responseBodyData = try XCTUnwrap(response.bodyData)
        let echoResponse = try CodableHelper.jsonDecoder.decode(EchoResponse.self, from: responseBodyData)
    ...
    func testGetReachabilityTest0() async throws {
        ...
        let response = try await client.getReachabilityWithHTTPInfo(clusters: "c1-de", requestOptions: nil)
        let responseBodyData = try XCTUnwrap(response.bodyData)
        let echoResponse = try CodableHelper.jsonDecoder.decode(EchoResponse.self, from: responseBodyData)
