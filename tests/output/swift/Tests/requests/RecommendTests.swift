...
final class RecommendClientRequestsTests: XCTestCase {
  ...
  func testCustomDeleteTest0() async throws {
    ...
    let client: RecommendClient = RecommendClient(
  ...
  func testDeleteRecommendRuleTest0() async throws {
    ...
    let response = try await client.deleteRecommendRuleWithHTTPInfo(
      indexName: "indexName", model: RecommendModels.relatedProducts, objectID: "objectID",
      requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
    ...
    XCTAssertEqual(
      echoResponse.path, "/1/indexes/indexName/related-products/recommend/rules/objectID")
    XCTAssertEqual(echoResponse.method, HTTPMethod.delete)
  ...
  func testGetRecommendStatusTest0() async throws {
    ...
    let response = try await client.getRecommendStatusWithHTTPInfo(
      indexName: "indexName", model: RecommendModels.relatedProducts, taskID: Int64(12345),
      requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testGetRecommendationsTest0() async throws {
    ...
    let response = try await client.getRecommendationsWithHTTPInfo(
      getRecommendationsParams: GetRecommendationsParams(requests: [
        RecommendationsRequest.recommendationsQuery(
          RecommendationsQuery(
            indexName: "indexName", threshold: 42, model: RecommendationModels.relatedProducts,
            objectID: "objectID"))
      ]), requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
  ...
  func testGetRecommendationsTest1() async throws {
    ...
    let response = try await client.getRecommendationsWithHTTPInfo(
      getRecommendationsParams: GetRecommendationsParams(requests: [
        RecommendationsRequest.recommendationsQuery(
          RecommendationsQuery(
            indexName: "indexName", threshold: 42, maxRecommendations: 10,
            model: RecommendationModels.relatedProducts, objectID: "objectID",
            queryParameters: SearchParamsObject(
              query: "myQuery",
              facetFilters: FacetFilters.arrayOfMixedSearchFilters([
                MixedSearchFilters.string("query")
              ])),
            fallbackParameters: SearchParamsObject(
              query: "myQuery",
              facetFilters: FacetFilters.arrayOfMixedSearchFilters([
                MixedSearchFilters.string("fallback")
              ]))))
      ]), requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
  ...
  func testGetRecommendationsTest2() async throws {
    ...
    let response = try await client.getRecommendationsWithHTTPInfo(
      getRecommendationsParams: GetRecommendationsParams(requests: [
        RecommendationsRequest.trendingItemsQuery(
          TrendingItemsQuery(
            indexName: "indexName", threshold: 42, model: TrendingItemsModel.trendingItems))
      ]), requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testGetRecommendationsTest3() async throws {
    ...
    let response = try await client.getRecommendationsWithHTTPInfo(
      getRecommendationsParams: GetRecommendationsParams(requests: [
        RecommendationsRequest.trendingItemsQuery(
          TrendingItemsQuery(
            indexName: "indexName", threshold: 42, maxRecommendations: 10, facetName: "myFacetName",
            facetValue: "myFacetValue", model: TrendingItemsModel.trendingItems,
            queryParameters: SearchParamsObject(
              query: "myQuery",
              facetFilters: FacetFilters.arrayOfMixedSearchFilters([
                MixedSearchFilters.string("query")
  ...
  func testGetRecommendationsTest4() async throws {
    ...
    let response = try await client.getRecommendationsWithHTTPInfo(
      getRecommendationsParams: GetRecommendationsParams(requests: [
        RecommendationsRequest.recommendationsQuery(
          RecommendationsQuery(
            indexName: "indexName1", threshold: 21, model: RecommendationModels.relatedProducts,
            objectID: "objectID1")),
        RecommendationsRequest.recommendationsQuery(
          RecommendationsQuery(
            indexName: "indexName2", threshold: 21, model: RecommendationModels.relatedProducts,
            objectID: "objectID2")),
      ]), requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
  ...
  func testGetRecommendationsTest5() async throws {
    ...
    let response = try await client.getRecommendationsWithHTTPInfo(
      getRecommendationsParams: GetRecommendationsParams(requests: [
        RecommendationsRequest.recommendationsQuery(
          RecommendationsQuery(
            indexName: "indexName1", threshold: 21, maxRecommendations: 10,
            model: RecommendationModels.relatedProducts, objectID: "objectID1",
            queryParameters: SearchParamsObject(
              query: "myQuery",
              facetFilters: FacetFilters.arrayOfMixedSearchFilters([
                MixedSearchFilters.string("query1")
              ])),
            fallbackParameters: SearchParamsObject(
              query: "myQuery",
              facetFilters: FacetFilters.arrayOfMixedSearchFilters([
                MixedSearchFilters.string("fallback1")
              ])))),
        RecommendationsRequest.recommendationsQuery(
          RecommendationsQuery(
            indexName: "indexName2", threshold: 21, maxRecommendations: 10,
            model: RecommendationModels.relatedProducts, objectID: "objectID2",
            queryParameters: SearchParamsObject(
              query: "myQuery",
              facetFilters: FacetFilters.arrayOfMixedSearchFilters([
                MixedSearchFilters.string("query2")
              ])),
            fallbackParameters: SearchParamsObject(
              query: "myQuery",
              facetFilters: FacetFilters.arrayOfMixedSearchFilters([
                MixedSearchFilters.string("fallback2")
              ])))),
      ]), requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
  ...
  func testGetRecommendationsTest6() async throws {
    ...
    let response = try await client.getRecommendationsWithHTTPInfo(
      getRecommendationsParams: GetRecommendationsParams(requests: [
        RecommendationsRequest.recommendationsQuery(
          RecommendationsQuery(
            indexName: "indexName1", threshold: 42, model: RecommendationModels.boughtTogether,
            objectID: "objectID1"))
      ]), requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
  ...
  func testSearchRecommendRulesTest0() async throws {
    ...
    let response = try await client.searchRecommendRulesWithHTTPInfo(
      indexName: "indexName", model: RecommendModels.relatedProducts, requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
    ...
    XCTAssertEqual(
      echoResponse.path, "/1/indexes/indexName/related-products/recommend/rules/search")
    XCTAssertEqual(echoResponse.method, HTTPMethod.post)
