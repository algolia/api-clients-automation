...
final class SearchClientRequestsTests: XCTestCase {
  ...
  func testAddApiKeyTest0() async throws {
    let configuration: Search.Configuration = try Search.Configuration(
      applicationID: APPLICATION_ID, apiKey: API_KEY)
    let transporter: Transporter = Transporter(
      configuration: configuration, requestBuilder: EchoRequestBuilder())
    let client: SearchClient = SearchClient(configuration: configuration, transporter: transporter)

    let response = try await client.addApiKeyWithHTTPInfo(
      apiKey: ApiKey(
        acl: [Acl.search, Acl.addObject], description: "my new api key", maxHitsPerQuery: 20,
        maxQueriesPerIPPerHour: 100, validity: 300), requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)

    let echoResponseBodyData = try XCTUnwrap(echoResponse.originalBodyData)
    let echoResponseBodyJSON = try JSON(data: echoResponseBodyData, options: .fragmentsAllowed)

    let comparableJSON = JSON(
      parseJSON:
  ...
  func testAddOrUpdateObjectTest0() async throws {
    ...
    let response = try await client.addOrUpdateObjectWithHTTPInfo(
      indexName: "indexName", objectID: "uniqueID", body: ["key": "value"], requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testAppendSourceTest0() async throws {
    ...
    let response = try await client.appendSourceWithHTTPInfo(
      source: Source(source: "theSource", description: "theDescription"), requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testAssignUserIdTest0() async throws {
    ...
    let response = try await client.assignUserIdWithHTTPInfo(
      xAlgoliaUserID: "userID", assignUserIdParams: AssignUserIdParams(cluster: "theCluster"),
      requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
    ...
    let comparableHeadersMap = try CodableHelper.jsonDecoder.decode(
      StringMapObject.self, from: comparableHeaders)
  ...
  func testBatchTest0() async throws {
    ...
    let response = try await client.batchWithHTTPInfo(
      ...
      batchWriteParams: BatchWriteParams(requests: [
        BatchRequest(action: Action.addObject, body: ["key": "value"])
      ]), requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testBatchTest1() async throws {
    ...
    let response = try await client.batchWithHTTPInfo(
      indexName: "theIndexName",
      batchWriteParams: BatchWriteParams(requests: [
        BatchRequest(action: Action.clear, body: ["key": "value"])
      ]), requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testBatchTest2() async throws {
    ...
    let response = try await client.batchWithHTTPInfo(
      indexName: "theIndexName",
      batchWriteParams: BatchWriteParams(requests: [
        BatchRequest(action: Action.delete, body: ["key": "value"])
      ]), requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testBatchTest3() async throws {
    ...
    let response = try await client.batchWithHTTPInfo(
      indexName: "theIndexName",
      batchWriteParams: BatchWriteParams(requests: [
        BatchRequest(action: Action.deleteObject, body: ["key": "value"])
      ]), requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testBatchTest4() async throws {
    ...
    let response = try await client.batchWithHTTPInfo(
      indexName: "theIndexName",
      batchWriteParams: BatchWriteParams(requests: [
        BatchRequest(action: Action.partialUpdateObject, body: ["key": "value"])
      ]), requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testBatchTest5() async throws {
    ...
    let response = try await client.batchWithHTTPInfo(
      indexName: "theIndexName",
      batchWriteParams: BatchWriteParams(requests: [
        BatchRequest(action: Action.partialUpdateObjectNoCreate, body: ["key": "value"])
      ]), requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testBatchTest6() async throws {
    ...
    let response = try await client.batchWithHTTPInfo(
      indexName: "theIndexName",
      batchWriteParams: BatchWriteParams(requests: [
        BatchRequest(action: Action.updateObject, body: ["key": "value"])
      ]), requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testBatchAssignUserIdsTest0() async throws {
    ...
    let response = try await client.batchAssignUserIdsWithHTTPInfo(
      ...
      batchAssignUserIdsParams: BatchAssignUserIdsParams(
        cluster: "theCluster", users: ["user1", "user2"]), requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
    ...
    let response = try await client.batchDictionaryEntriesWithHTTPInfo(
      ...
      batchDictionaryEntriesParams: BatchDictionaryEntriesParams(requests: [
        BatchDictionaryEntriesRequest(
          action: DictionaryAction.addEntry, body: DictionaryEntry(objectID: "1", language: "en")),
        BatchDictionaryEntriesRequest(
          action: DictionaryAction.deleteEntry, body: DictionaryEntry(objectID: "2", language: "fr")
        ),
      ]), requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
        ...
        requests: [
          BatchDictionaryEntriesRequest(
            ...
            body: DictionaryEntry(
              objectID: "1", language: "en", word: "fancy", words: ["believe", "algolia"],
              decomposition: ["trust", "algolia"], state: DictionaryEntryState.enabled)),
          BatchDictionaryEntriesRequest(
            action: DictionaryAction.deleteEntry,
            body: DictionaryEntry(
              objectID: "2", language: "fr", word: "humility", words: ["candor", "algolia"],
              decomposition: ["grit", "algolia"], state: DictionaryEntryState.enabled)),
        ]), requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testBatchDictionaryEntriesTest2() async throws {
    ...
    let response = try await client.batchDictionaryEntriesWithHTTPInfo(
      ...
      batchDictionaryEntriesParams: BatchDictionaryEntriesParams(requests: [
        BatchDictionaryEntriesRequest(
          action: DictionaryAction.addEntry,
          body: DictionaryEntry(from: ["objectID": "1", "language": "en", "additional": "try me"]))
      ]), requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testBrowseTest0() async throws {
    ...
    let response = try await client.browseWithHTTPInfo(
      indexName: "cts_e2e_browse", requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testBrowseTest1() async throws {
    ...
    let response = try await client.browseWithHTTPInfo(
      indexName: "indexName",
      browseParams: BrowseParams.browseParamsObject(
        BrowseParamsObject(
          query: "myQuery",
          facetFilters: FacetFilters.arrayOfMixedSearchFilters([
            MixedSearchFilters.string("tags:algolia")
          ]))), requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testClearObjectsTest0() async throws {
    ...
    let response = try await client.clearObjectsWithHTTPInfo(
      indexName: "theIndexName", requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testClearRulesTest0() async throws {
    ...
    let response = try await client.clearRulesWithHTTPInfo(
      indexName: "indexName", requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testClearSynonymsTest0() async throws {
    ...
    let response = try await client.clearSynonymsWithHTTPInfo(
      indexName: "indexName", requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testCustomDeleteTest0() async throws {
    ...
    let response = try await client.customDeleteWithHTTPInfo(
      path: "/test/minimal", requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testCustomDeleteTest1() async throws {
    ...
    let response = try await client.customDeleteWithHTTPInfo(
      path: "/test/all", parameters: ["query": AnyCodable("parameters")], requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
    ...
    let comparableQueryItemsMap = try CodableHelper.jsonDecoder.decode(
      StringMapObject.self, from: comparableQueryItems)
  ...
  func testCustomPostTest1() async throws {
    ...
    let response = try await client.customPostWithHTTPInfo(
      path: "/test/all", parameters: ["query": AnyCodable("parameters")],
      body: ["body": "parameters"], requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testCustomPostTest2() async throws {
    ...
    let response = try await client.customPostWithHTTPInfo(
      path: "/test/requestOptions", parameters: ["query": AnyCodable("parameters")],
      body: ["facet": "filters"], requestOptions: requestOptions)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testCustomPostTest3() async throws {
    ...
    let comparableQueryItems = try XCTUnwrap(
      "{\"query\":\"parameters\",\"query2\":\"myQueryParameter\"}".data(using: .utf8))
    let comparableQueryItemsMap = try CodableHelper.jsonDecoder.decode(
      StringMapObject.self, from: comparableQueryItems)
  ...
  func testCustomPostTest6() async throws {
    ...
    let comparableQueryItems = try XCTUnwrap(
      "{\"query\":\"parameters\",\"isItWorking\":\"true\"}".data(using: .utf8))
    let comparableQueryItemsMap = try CodableHelper.jsonDecoder.decode(
      StringMapObject.self, from: comparableQueryItems)
  ...
  func testCustomPostTest7() async throws {
    ...
    let comparableQueryItems = try XCTUnwrap(
      "{\"query\":\"parameters\",\"myParam\":\"2\"}".data(using: .utf8))
    let comparableQueryItemsMap = try CodableHelper.jsonDecoder.decode(
      StringMapObject.self, from: comparableQueryItems)
  ...
  func testCustomPostTest8() async throws {
    ...
    let comparableQueryItems = try XCTUnwrap(
      "{\"query\":\"parameters\",\"myParam\":\"c,d\"}".data(using: .utf8))
    let comparableQueryItemsMap = try CodableHelper.jsonDecoder.decode(
      StringMapObject.self, from: comparableQueryItems)
  ...
  func testCustomPostTest9() async throws {
    ...
    let comparableQueryItems = try XCTUnwrap(
      "{\"query\":\"parameters\",\"myParam\":\"true,true,false\"}".data(using: .utf8))
    let comparableQueryItemsMap = try CodableHelper.jsonDecoder.decode(
      StringMapObject.self, from: comparableQueryItems)
  ...
  func testCustomPostTest10() async throws {
    ...
    let comparableQueryItems = try XCTUnwrap(
      "{\"query\":\"parameters\",\"myParam\":\"1,2\"}".data(using: .utf8))
    let comparableQueryItemsMap = try CodableHelper.jsonDecoder.decode(
      StringMapObject.self, from: comparableQueryItems)
  ...
  func testDeleteApiKeyTest0() async throws {
    ...
    let response = try await client.deleteApiKeyWithHTTPInfo(
      key: "myTestApiKey", requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testDeleteByTest0() async throws {
    ...
    let response = try await client.deleteByWithHTTPInfo(
      indexName: "theIndexName", deleteByParams: DeleteByParams(filters: "brand:brandName"),
      requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testDeleteIndexTest0() async throws {
    ...
    let response = try await client.deleteIndexWithHTTPInfo(
      indexName: "theIndexName", requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testDeleteObjectTest0() async throws {
    ...
    let response = try await client.deleteObjectWithHTTPInfo(
      indexName: "theIndexName", objectID: "uniqueID", requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testDeleteRuleTest0() async throws {
    ...
    let response = try await client.deleteRuleWithHTTPInfo(
      indexName: "indexName", objectID: "id1", requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testDeleteRuleTest1() async throws {
    ...
    let response = try await client.deleteRuleWithHTTPInfo(
      indexName: "indexName", objectID: "test/with/slash", requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testDeleteSourceTest0() async throws {
    ...
    let response = try await client.deleteSourceWithHTTPInfo(
      source: "theSource", requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testDeleteSynonymTest0() async throws {
    ...
    let response = try await client.deleteSynonymWithHTTPInfo(
      indexName: "indexName", objectID: "id1", requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testGetLogsTest1() async throws {
    ...
    let response = try await client.getLogsWithHTTPInfo(
      offset: 5, length: 10, indexName: "theIndexName", type: LogType.all, requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
    ...
    let comparableQueryItems = try XCTUnwrap(
      "{\"offset\":\"5\",\"length\":\"10\",\"indexName\":\"theIndexName\",\"type\":\"all\"}".data(
        using: .utf8))
    let comparableQueryItemsMap = try CodableHelper.jsonDecoder.decode(
      StringMapObject.self, from: comparableQueryItems)
  ...
  func testGetObjectTest0() async throws {
    ...
    let response = try await client.getObjectWithHTTPInfo(
      indexName: "theIndexName", objectID: "uniqueID", attributesToRetrieve: ["attr1", "attr2"],
      requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
    ...
    let comparableQueryItems = try XCTUnwrap(
      "{\"attributesToRetrieve\":\"attr1,attr2\"}".data(using: .utf8))
    let comparableQueryItemsMap = try CodableHelper.jsonDecoder.decode(
      StringMapObject.self, from: comparableQueryItems)
  ...
  func testGetObjectsTest0() async throws {
    ...
    let response = try await client.getObjectsWithHTTPInfo(
      getObjectsParams: GetObjectsParams(requests: [
        GetObjectsRequest(
  ...
  func testGetRuleTest0() async throws {
    ...
    let response = try await client.getRuleWithHTTPInfo(
      indexName: "indexName", objectID: "id1", requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testGetSettingsTest0() async throws {
    ...
    let response = try await client.getSettingsWithHTTPInfo(
      indexName: "cts_e2e_settings", requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testGetSynonymTest0() async throws {
    ...
    let response = try await client.getSynonymWithHTTPInfo(
      indexName: "indexName", objectID: "id1", requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testGetTaskTest0() async throws {
    ...
    let response = try await client.getTaskWithHTTPInfo(
      indexName: "theIndexName", taskID: Int64(123), requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testHasPendingMappingsTest1() async throws {
    ...
    let response = try await client.hasPendingMappingsWithHTTPInfo(
      getClusters: true, requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testListIndicesTest1() async throws {
    ...
    let response = try await client.listIndicesWithHTTPInfo(
      page: 8, hitsPerPage: 3, requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
    ...
    let comparableQueryItems = try XCTUnwrap(
      "{\"page\":\"8\",\"hitsPerPage\":\"3\"}".data(using: .utf8))
    let comparableQueryItemsMap = try CodableHelper.jsonDecoder.decode(
      StringMapObject.self, from: comparableQueryItems)
  ...
  func testListUserIdsTest1() async throws {
    ...
    let response = try await client.listUserIdsWithHTTPInfo(
      page: 8, hitsPerPage: 100, requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
    ...
    let comparableQueryItems = try XCTUnwrap(
      "{\"page\":\"8\",\"hitsPerPage\":\"100\"}".data(using: .utf8))
    let comparableQueryItemsMap = try CodableHelper.jsonDecoder.decode(
      StringMapObject.self, from: comparableQueryItems)
  ...
  func testMultipleBatchTest0() async throws {
    ...
    let response = try await client.multipleBatchWithHTTPInfo(
      batchParams: BatchParams(requests: [
        MultipleBatchRequest(
          action: Action.addObject, body: ["key": "value"], indexName: "theIndexName")
      ]), requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testOperationIndexTest0() async throws {
    ...
    let response = try await client.operationIndexWithHTTPInfo(
      ...
      operationIndexParams: OperationIndexParams(
        ...
        scope: [ScopeType.rules, ScopeType.settings]), requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testPartialUpdateObjectTest0() async throws {
    ...
    let response = try await client.partialUpdateObjectWithHTTPInfo(
      indexName: "theIndexName", objectID: "uniqueID",
      attributesToUpdate: [
        "id1": AttributeToUpdate.string("test"),
        "id2": AttributeToUpdate.builtInOperation(
          BuiltInOperation(operation: BuiltInOperationType.addUnique, value: "test2")),
      ], createIfNotExists: true, requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testRemoveUserIdTest0() async throws {
    ...
    let response = try await client.removeUserIdWithHTTPInfo(
      userID: "uniqueID", requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testReplaceSourcesTest0() async throws {
    ...
    let response = try await client.replaceSourcesWithHTTPInfo(
      source: [Source(source: "theSource", description: "theDescription")], requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testSaveObjectTest0() async throws {
    ...
    let response = try await client.saveObjectWithHTTPInfo(
      indexName: "theIndexName", body: ["objectID": "id", "test": "val"], requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testSaveRuleTest0() async throws {
    ...
    let response = try await client.saveRuleWithHTTPInfo(
      indexName: "indexName", objectID: "id1",
      rule: Rule(
        objectID: "id1", conditions: [Condition(pattern: "apple", anchoring: Anchoring.contains)]),
      requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testSaveRuleTest1() async throws {
    ...
    let response = try await client.saveRuleWithHTTPInfo(
      ...
      rule: Rule(
        ...
        conditions: [
          Condition(
            pattern: "apple", anchoring: Anchoring.contains, alternatives: false, context: "search")
        ],
        consequence: Consequence(
          params: ConsequenceParams(
            filters: "brand:apple",
            query: ConsequenceQuery.consequenceQueryObject(
          ...
          ], filterPromotes: false, hide: [ConsequenceHide(objectID: "321")],
          userData: ["algolia": "aloglia"]), description: "test", enabled: true,
        validity: [TimeRange(from: 1_656_670_273, until: 1_656_670_277)]), forwardToReplicas: true,
      requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testSaveRulesTest1() async throws {
    ...
    let response = try await client.saveRulesWithHTTPInfo(
      ...
      rules: [
        Rule(
          ...
          conditions: [
            Condition(
              pattern: "apple", anchoring: Anchoring.contains, alternatives: false,
              context: "search")
          ],
          consequence: Consequence(
            params: ConsequenceParams(
      ...
      ], forwardToReplicas: true, clearExistingRules: true, requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
    ...
    let comparableQueryItems = try XCTUnwrap(
      "{\"forwardToReplicas\":\"true\",\"clearExistingRules\":\"true\"}".data(using: .utf8))
    let comparableQueryItemsMap = try CodableHelper.jsonDecoder.decode(
      StringMapObject.self, from: comparableQueryItems)
  ...
  func testSaveSynonymTest0() async throws {
    ...
    let response = try await client.saveSynonymWithHTTPInfo(
      ...
      synonymHit: SynonymHit(
        objectID: "id1", type: SynonymType.synonym, synonyms: ["car", "vehicule", "auto"]),
      forwardToReplicas: true, requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testSaveSynonymsTest0() async throws {
    ...
    let response = try await client.saveSynonymsWithHTTPInfo(
      ...
      synonymHit: [
        SynonymHit(
          objectID: "id1", type: SynonymType.synonym, synonyms: ["car", "vehicule", "auto"]),
        SynonymHit(
          objectID: "id2", type: SynonymType.onewaysynonym,
          synonyms: ["ephone", "aphone", "yphone"], input: "iphone"),
      ], forwardToReplicas: true, replaceExistingSynonyms: false, requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
    ...
    let comparableQueryItems = try XCTUnwrap(
      "{\"forwardToReplicas\":\"true\",\"replaceExistingSynonyms\":\"false\"}".data(using: .utf8))
    let comparableQueryItemsMap = try CodableHelper.jsonDecoder.decode(
      StringMapObject.self, from: comparableQueryItems)
  ...
  func testSearchTest0() async throws {
    ...
    let response = try await client.searchWithHTTPInfo(
      searchMethodParams: SearchMethodParams(requests: [
        SearchQuery.searchForHits(SearchForHits(indexName: "cts_e2e_search_empty_index"))
      ]), requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testSearchTest1() async throws {
    ...
    let response = try await client.searchWithHTTPInfo(
      searchMethodParams: SearchMethodParams(
        requests: [
          SearchQuery.searchForFacets(
            SearchForFacets(
              facet: "editor", indexName: "cts_e2e_search_facet", type: SearchTypeFacet.facet))
        ], strategy: SearchStrategy.stopIfEnoughMatches), requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
    ...
    let response = try await client.searchWithHTTPInfo(
      searchMethodParams: SearchMethodParams(requests: [
        SearchQuery.searchForHits(
          SearchForHits(
            query: "myQuery", hitsPerPage: 50, indexName: "theIndexName",
    ...
    let response = try await client.searchWithHTTPInfo(
      searchMethodParams: SearchMethodParams(
        requests: [
          SearchQuery.searchForFacets(
            SearchForFacets(
              query: "theQuery", maxFacetHits: 50, facet: "theFacet", indexName: "theIndexName",
              facetQuery: "theFacetQuery", type: SearchTypeFacet.facet))
        ], strategy: SearchStrategy.stopIfEnoughMatches), requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
    ...
    let response = try await client.searchWithHTTPInfo(
      searchMethodParams: SearchMethodParams(
        requests: [
          ...
          SearchQuery.searchForFacets(
            SearchForFacets(
              facet: "theFacet", indexName: "theIndexName2", type: SearchTypeFacet.facet)),
          SearchQuery.searchForHits(
      ...
      searchMethodParams: SearchMethodParams(requests: [
        SearchQuery.searchForHits(
          SearchForHits(
            ...
            sumOrFiltersScores: true, restrictSearchableAttributes: [""], facets: [""],
            facetingAfterDistinct: true, page: 0, offset: 0, length: 1, aroundLatLng: "",
            aroundLatLngViaIP: true,
            aroundRadius: AroundRadius.aroundRadiusAll(AroundRadiusAll.all),
            aroundPrecision: AroundPrecision.int(0), minimumAroundRadius: 1,
            insideBoundingBox: [
              [47.3165, 4.9665, 47.3424, 5.0201], [40.9234, 2.1185, 38.643, 1.9916],
            ],
            insidePolygon: [
              [47.3165, 4.9665, 47.3424, 5.0201, 47.32, 4.9],
              [40.9234, 2.1185, 38.643, 1.9916, 39.2587, 2.0104],
            ], naturalLanguages: [""], ruleContexts: [""], personalizationImpact: 0, userToken: "",
            getRankingInfo: true, explain: ["foo", "bar"], synonyms: true, clickAnalytics: true,
            analytics: true, analyticsTags: [""], percentileComputation: true, enableABTest: true,
            attributesForFaceting: [""], attributesToRetrieve: [""], ranking: [""],
            customRanking: [""], relevancyStrictness: 0, attributesToHighlight: [""],
            attributesToSnippet: [""], highlightPreTag: "", highlightPostTag: "",
            snippetEllipsisText: "", restrictHighlightAndSnippetArrays: true, hitsPerPage: 1,
            minWordSizefor1Typo: 0, minWordSizefor2Typos: 0,
            typoTolerance: TypoTolerance.typoToleranceEnum(TypoToleranceEnum.min),
            allowTyposOnNumericTokens: true, disableTypoToleranceOnAttributes: [""],
            ignorePlurals: IgnorePlurals.bool(false), removeStopWords: RemoveStopWords.bool(true),
            keepDiacriticsOnCharacters: "", queryLanguages: [""], decompoundQuery: true,
            enableRules: true, enablePersonalization: true, queryType: QueryType.prefixAll,
            removeWordsIfNoResults: RemoveWordsIfNoResults.allOptional, advancedSyntax: true,
            optionalWords: [""], disableExactOnAttributes: [""],
            exactOnSingleWordQuery: ExactOnSingleWordQuery.attribute,
            alternativesAsExact: [AlternativesAsExact.multiWordsSynonym],
            advancedSyntaxFeatures: [AdvancedSyntaxFeatures.exactPhrase], distinct: Distinct.int(0),
            replaceSynonymsInHighlight: true, minProximity: 1, responseFields: [""],
            maxValuesPerFacet: 0, sortFacetValuesBy: "",
            ...
            reRankingApplyFilter: ReRankingApplyFilter.arrayOfMixedSearchFilters([
              MixedSearchFilters.string("")
            ]), indexName: "theIndexName", type: SearchTypeDefault.`default`))
      ]), requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testSearchDictionaryEntriesTest1() async throws {
    ...
    let response = try await client.searchDictionaryEntriesWithHTTPInfo(
      ...
      searchDictionaryEntriesParams: SearchDictionaryEntriesParams(
        query: "foo", page: 4, hitsPerPage: 2, language: "fr"), requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testSearchForFacetValuesTest0() async throws {
    ...
    let response = try await client.searchForFacetValuesWithHTTPInfo(
      indexName: "indexName", facetName: "facetName", requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testSearchRulesTest0() async throws {
    ...
    let response = try await client.searchRulesWithHTTPInfo(
      indexName: "indexName", searchRulesParams: SearchRulesParams(query: "something"),
      requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testSearchSingleIndexTest1() async throws {
    ...
    let response = try await client.searchSingleIndexWithHTTPInfo(
      indexName: "cts_e2e_space in index", requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testSearchSingleIndexTest2() async throws {
    ...
    let response = try await client.searchSingleIndexWithHTTPInfo(
      indexName: "indexName",
      searchParams: SearchParams.searchParamsObject(
        SearchParamsObject(
          query: "myQuery",
          facetFilters: FacetFilters.arrayOfMixedSearchFilters([
            MixedSearchFilters.string("tags:algolia")
  ...
  func testSearchSynonymsTest1() async throws {
    ...
    let response = try await client.searchSynonymsWithHTTPInfo(
      ...
      searchSynonymsParams: SearchSynonymsParams(
        query: "myQuery", type: SynonymType.altcorrection1, page: 10, hitsPerPage: 10),
      requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testSearchUserIdsTest0() async throws {
    ...
    let response = try await client.searchUserIdsWithHTTPInfo(
      searchUserIdsParams: SearchUserIdsParams(
        query: "test", clusterName: "theClusterName", page: 5, hitsPerPage: 10), requestOptions: nil
    )
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testSetDictionarySettingsTest0() async throws {
    ...
    let response = try await client.setDictionarySettingsWithHTTPInfo(
      dictionarySettingsParams: DictionarySettingsParams(
        disableStandardEntries: StandardEntries(plurals: ["fr": false, "en": false, "ru": true])),
      requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
    ...
    let response = try await client.setDictionarySettingsWithHTTPInfo(
      dictionarySettingsParams: DictionarySettingsParams(
        disableStandardEntries: StandardEntries(
          plurals: ["fr": false, "en": false, "ru": true], stopwords: ["fr": false],
          compounds: ["ru": true])), requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testSetSettingsTest0() async throws {
    ...
    let response = try await client.setSettingsWithHTTPInfo(
      indexName: "cts_e2e_settings", indexSettings: IndexSettings(paginationLimitedTo: 10),
      forwardToReplicas: true, requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testSetSettingsTest7() async throws {
    ...
    let response = try await client.setSettingsWithHTTPInfo(
      indexName: "theIndexName", indexSettings: IndexSettings(distinct: Distinct.bool(true)),
      forwardToReplicas: true, requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testSetSettingsTest8() async throws {
    ...
    let response = try await client.setSettingsWithHTTPInfo(
      indexName: "theIndexName", indexSettings: IndexSettings(distinct: Distinct.int(1)),
      forwardToReplicas: true, requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testSetSettingsTest9() async throws {
    ...
    let response = try await client.setSettingsWithHTTPInfo(
      indexName: "theIndexName",
      indexSettings: IndexSettings(
        replicas: [""], paginationLimitedTo: 0, unretrievableAttributes: ["foo"],
        disableTypoToleranceOnWords: ["algolia"], attributesToTransliterate: ["algolia"],
        camelCaseAttributes: ["algolia"], decompoundedAttributes: ["algolia": "aloglia"],
        indexLanguages: ["algolia"], disablePrefixOnAttributes: ["algolia"],
        allowCompressionOfIntegerArray: true, numericAttributesForFiltering: ["algolia"],
        separatorsToIndex: "bar", searchableAttributes: ["foo"], userData: ["user": "data"],
        customNormalization: ["algolia": ["aloglia": "aglolia"]], attributeForDistinct: "test",
        attributesForFaceting: ["algolia"], attributesToRetrieve: ["algolia"], ranking: ["geo"],
        customRanking: ["algolia"], relevancyStrictness: 10, attributesToHighlight: ["algolia"],
        attributesToSnippet: ["algolia"], highlightPreTag: "<span>", highlightPostTag: "</span>",
        snippetEllipsisText: "---", restrictHighlightAndSnippetArrays: true, hitsPerPage: 10,
        minWordSizefor1Typo: 5, minWordSizefor2Typos: 11, typoTolerance: TypoTolerance.bool(false),
        allowTyposOnNumericTokens: true, disableTypoToleranceOnAttributes: ["algolia"],
        ignorePlurals: IgnorePlurals.bool(false), removeStopWords: RemoveStopWords.bool(false),
        keepDiacriticsOnCharacters: "abc", queryLanguages: ["algolia"], decompoundQuery: false,
        enableRules: true, enablePersonalization: true, queryType: QueryType.prefixLast,
        removeWordsIfNoResults: RemoveWordsIfNoResults.lastWords, mode: Mode.neuralSearch,
        semanticSearch: SemanticSearch(eventSources: ["foo"]), advancedSyntax: true,
        optionalWords: ["myspace"], disableExactOnAttributes: ["algolia"],
        exactOnSingleWordQuery: ExactOnSingleWordQuery.attribute,
        alternativesAsExact: [AlternativesAsExact.singleWordSynonym],
        advancedSyntaxFeatures: [AdvancedSyntaxFeatures.exactPhrase], distinct: Distinct.int(3),
        replaceSynonymsInHighlight: true, minProximity: 6, responseFields: ["algolia"],
        maxFacetHits: 20, maxValuesPerFacet: 30, sortFacetValuesBy: "date",
        attributeCriteriaComputedByMinProximity: true,
        renderingContent: RenderingContent(
          facetOrdering: FacetOrdering(
            facets: Facets(order: ["a", "b"]),
        ...
        reRankingApplyFilter: ReRankingApplyFilter.string("mySearch:filters")), requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
  ...
  func testUpdateApiKeyTest0() async throws {
    ...
    let response = try await client.updateApiKeyWithHTTPInfo(
      key: "myApiKey",
      apiKey: ApiKey(
        acl: [Acl.search, Acl.addObject], maxHitsPerQuery: 20, maxQueriesPerIPPerHour: 100,
        validity: 300), requestOptions: nil)
    let responseBodyData = try XCTUnwrap(response.bodyData)
    let echoResponse = try CodableHelper.jsonDecoder.decode(
      EchoResponse.self, from: responseBodyData)
