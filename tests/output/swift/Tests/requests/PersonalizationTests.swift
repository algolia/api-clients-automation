...
final class PersonalizationClientRequestsTests: XCTestCase {
    ...
    func testDeleteUserProfileTest0() async throws {
        ...
        let response = try await client.deleteUserProfileWithHTTPInfo(userToken: "UserToken", requestOptions: nil)
        let responseBodyData = try XCTUnwrap(response.bodyData)
        let echoResponse = try CodableHelper.jsonDecoder.decode(EchoResponse.self, from: responseBodyData)
    ...
    func testGetUserTokenProfileTest0() async throws {
        ...
        let response = try await client.getUserTokenProfileWithHTTPInfo(userToken: "UserToken", requestOptions: nil)
        let responseBodyData = try XCTUnwrap(response.bodyData)
        let echoResponse = try CodableHelper.jsonDecoder.decode(EchoResponse.self, from: responseBodyData)
    ...
    func testSetPersonalizationStrategyTest0() async throws {
        ...
        let response = try await client.setPersonalizationStrategyWithHTTPInfo(personalizationStrategyParams: PersonalizationStrategyParams(eventScoring: [EventScoring(score: 42, eventName: "Algolia", eventType: "Event")], facetScoring: [FacetScoring(score: 42, facetName: "Event")], personalizationImpact: 42), requestOptions: nil)
        let responseBodyData = try XCTUnwrap(response.bodyData)
        let echoResponse = try CodableHelper.jsonDecoder.decode(EchoResponse.self, from: responseBodyData)
