...
final class ForgeSecuredUserTokenTests: XCTestCase {
    func testForgeSecuredUserToken() throws {
        ...
        let token = client.forgeSecuredUserToken(secretKey: "my-secret-key", secretKeyId: "my-key-id", userId: "user-123")
    ...
    func testForgeSecuredUserTokenCustomExpiry() throws {
        ...
        let token = client.forgeSecuredUserToken(secretKey: "my-secret-key", secretKeyId: "my-key-id", userId: "user-456", expiresIn: 3600)
