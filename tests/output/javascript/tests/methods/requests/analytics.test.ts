...
const client = new AnalyticsApi(appId, apiKey, 'us', { requester: new EchoRequester() });
...
describe('getAverageClickPosition', () => {
  ...
  test('get getAverageClickPosition with all parameters', async () => {
    const req = (await client.getAverageClickPosition({"index":"index","startDate":"1999-09-19","endDate":"2001-01-01","tags":"tag"})) as unknown as EchoResponse;

    expect(req.path).toEqual('/2/clicks/averageClickPosition');
    expect(req.method).toEqual('GET');
    expect(req.data).toEqual(undefined);
    expect(req.searchParams).toEqual({"index":"index","startDate":"1999-09-19","endDate":"2001-01-01","tags":"tag"});
  });
...
describe('getClickPositions', () => {
  ...
  test('get getClickPositions with all parameters', async () => {
    const req = (await client.getClickPositions({"index":"index","startDate":"1999-09-19","endDate":"2001-01-01","tags":"tag"})) as unknown as EchoResponse;
...
describe('getClickThroughRate', () => {
  ...
  test('get getClickThroughRate with all parameters', async () => {
    const req = (await client.getClickThroughRate({"index":"index","startDate":"1999-09-19","endDate":"2001-01-01","tags":"tag"})) as unknown as EchoResponse;
...
describe('getConversationRate', () => {
  test('get getConversationRate with minimal parameters', async () => {
    const req = (await client.getConversationRate({"index":"index"})) as unknown as EchoResponse;
  ...
  test('get getConversationRate with all parameters', async () => {
    const req = (await client.getConversationRate({"index":"index","startDate":"1999-09-19","endDate":"2001-01-01","tags":"tag"})) as unknown as EchoResponse;
...
describe('getNoClickRate', () => {
  ...
  test('get getNoClickRate with all parameters', async () => {
    const req = (await client.getNoClickRate({"index":"index","startDate":"1999-09-19","endDate":"2001-01-01","tags":"tag"})) as unknown as EchoResponse;
...
describe('getNoResultsRate', () => {
  ...
  test('get getNoResultsRate with all parameters', async () => {
    const req = (await client.getNoResultsRate({"index":"index","startDate":"1999-09-19","endDate":"2001-01-01","tags":"tag"})) as unknown as EchoResponse;
...
describe('getSearchesCount', () => {
  ...
  test('get getSearchesCount with all parameters', async () => {
    const req = (await client.getSearchesCount({"index":"index","startDate":"1999-09-19","endDate":"2001-01-01","tags":"tag"})) as unknown as EchoResponse;
...
describe('getSearchesNoClicks', () => {
  ...
  test('get getSearchesNoClicks with all parameters', async () => {
    const req = (await client.getSearchesNoClicks({"index":"index","startDate":"1999-09-19","endDate":"2001-01-01","limit":21,"offset":42,"tags":"tag"})) as unknown as EchoResponse;

    expect(req.path).toEqual('/2/searches/noClicks');
    expect(req.method).toEqual('GET');
    expect(req.data).toEqual(undefined);
    expect(req.searchParams).toEqual({"index":"index","startDate":"1999-09-19","endDate":"2001-01-01","limit":"21","offset":"42","tags":"tag"});
  });
...
describe('getSearchesNoResults', () => {
  ...
  test('get getSearchesNoResults with all parameters', async () => {
    const req = (await client.getSearchesNoResults({"index":"index","startDate":"1999-09-19","endDate":"2001-01-01","limit":21,"offset":42,"tags":"tag"})) as unknown as EchoResponse;
...
describe('getTopCountries', () => {
  ...
  test('get getTopCountries with all parameters', async () => {
    const req = (await client.getTopCountries({"index":"index","startDate":"1999-09-19","endDate":"2001-01-01","limit":21,"offset":42,"tags":"tag"})) as unknown as EchoResponse;
...
describe('getTopFilterAttributes', () => {
  ...
  test('get getTopFilterAttributes with all parameters', async () => {
    const req = (await client.getTopFilterAttributes({"index":"index","search":"mySearch","startDate":"1999-09-19","endDate":"2001-01-01","limit":21,"offset":42,"tags":"tag"})) as unknown as EchoResponse;

    expect(req.path).toEqual('/2/filters');
    expect(req.method).toEqual('GET');
    expect(req.data).toEqual(undefined);
    expect(req.searchParams).toEqual({"index":"index","search":"mySearch","startDate":"1999-09-19","endDate":"2001-01-01","limit":"21","offset":"42","tags":"tag"});
  });
...
describe('getTopFilterForAttribute', () => {
  test('get getTopFilterForAttribute with minimal parameters', async () => {
    const req = (await client.getTopFilterForAttribute({"attribute":"myAttribute","index":"index"})) as unknown as EchoResponse;
  ...
  test('get getTopFilterForAttribute with minimal parameters and multiple attributes', async () => {
    const req = (await client.getTopFilterForAttribute({"attribute":"myAttribute1,myAttribute2","index":"index"})) as unknown as EchoResponse;
  ...
  test('get getTopFilterForAttribute with all parameters', async () => {
    const req = (await client.getTopFilterForAttribute({"attribute":"myAttribute","index":"index","search":"mySearch","startDate":"1999-09-19","endDate":"2001-01-01","limit":21,"offset":42,"tags":"tag"})) as unknown as EchoResponse;
  ...
  test('get getTopFilterForAttribute with all parameters and multiple attributes', async () => {
    const req = (await client.getTopFilterForAttribute({"attribute":"myAttribute1,myAttribute2","index":"index","search":"mySearch","startDate":"1999-09-19","endDate":"2001-01-01","limit":21,"offset":42,"tags":"tag"})) as unknown as EchoResponse;
...
describe('getTopFiltersNoResults', () => {
  ...
  test('get getTopFiltersNoResults with all parameters', async () => {
    const req = (await client.getTopFiltersNoResults({"index":"index","search":"mySearch","startDate":"1999-09-19","endDate":"2001-01-01","limit":21,"offset":42,"tags":"tag"})) as unknown as EchoResponse;
...
describe('getTopHits', () => {
  ...
  test('get getTopHits with all parameters', async () => {
    const req = (await client.getTopHits({"index":"index","search":"mySearch","clickAnalytics":true,"startDate":"1999-09-19","endDate":"2001-01-01","limit":21,"offset":42,"tags":"tag"})) as unknown as EchoResponse;

    expect(req.path).toEqual('/2/hits');
    expect(req.method).toEqual('GET');
    expect(req.data).toEqual(undefined);
    expect(req.searchParams).toEqual({"index":"index","search":"mySearch","clickAnalytics":"true","startDate":"1999-09-19","endDate":"2001-01-01","limit":"21","offset":"42","tags":"tag"});
  });
...
describe('getTopSearches', () => {
  ...
  test('get getTopSearches with all parameters', async () => {
    const req = (await client.getTopSearches({"index":"index","clickAnalytics":true,"startDate":"1999-09-19","endDate":"2001-01-01","orderBy":"searchCount","direction":"asc","limit":21,"offset":42,"tags":"tag"})) as unknown as EchoResponse;

    expect(req.path).toEqual('/2/searches');
    expect(req.method).toEqual('GET');
    expect(req.data).toEqual(undefined);
    expect(req.searchParams).toEqual({"index":"index","clickAnalytics":"true","startDate":"1999-09-19","endDate":"2001-01-01","orderBy":"searchCount","direction":"asc","limit":"21","offset":"42","tags":"tag"});
  });
...
describe('getUsersCount', () => {
  ...
  test('get getUsersCount with all parameters', async () => {
    const req = (await client.getUsersCount({"index":"index","startDate":"1999-09-19","endDate":"2001-01-01","tags":"tag"})) as unknown as EchoResponse;
