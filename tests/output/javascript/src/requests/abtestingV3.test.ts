...
import type { ClientOptions, ServerSentEvent } from '@algolia/client-common';
...
const client = algoliasearch(appId, apiKey).initAbtestingV3({ options: clientOptions,  region:'us'  });;

describe('addABTests', () => {
  test('addABTests with minimal parameters', async () => {
    const req = (await client.addABTests({"endAt":"2022-12-31T00:00:00.000Z","name":"myABTest","metrics":[{"name":"myMetric"}],"variants":[{"index":"AB_TEST_1","trafficPercentage":30},{"index":"AB_TEST_2","trafficPercentage":50}]})) as unknown as EchoResponse;

    expect(req.path).toEqual('/3/abtests');
    expect(req.method).toEqual('POST');
    expect(req.data).toEqual({"endAt":"2022-12-31T00:00:00.000Z","name":"myABTest","metrics":[{"name":"myMetric"}],"variants":[{"index":"AB_TEST_1","trafficPercentage":30},{"index":"AB_TEST_2","trafficPercentage":50}]});
...
describe('customDelete', () => {
  ...
  test('allow del method for a custom path with all parameters', async () => {
    const req = (await client.customDelete({"path":"test/all","parameters":{"query":"parameters"}})) as unknown as EchoResponse;
...
describe('customGet', () => {
  ...
  test('allow get method for a custom path with all parameters', async () => {
    const req = (await client.customGet({"path":"test/all","parameters":{"query":"parameters with space"}})) as unknown as EchoResponse;
  ...
  test('requestOptions should be escaped too', async () => {
    const req = (await client.customGet({"path":"test/all","parameters":{"query":"to be overridden"}}, {
    ...
    expect(req.method).toEqual('GET');
    expect(req.data).toEqual(undefined);
    expect(req.searchParams).toStrictEqual({"query":"parameters%20with%20space","and%20an%20array":"array%2Cwith%20spaces"});
...
describe('customPost', () => {
  ...
  test('allow post method for a custom path with all parameters', async () => {
    const req = (await client.customPost({"path":"test/all","parameters":{"query":"parameters"},"body":{"body":"parameters"}})) as unknown as EchoResponse;
  ...
  test('requestOptions can override default query parameters', async () => {
    const req = (await client.customPost({"path":"test/requestOptions","parameters":{"query":"parameters"},"body":{"facet":"filters"}}, {
  ...
  test('requestOptions can override default headers', async () => {
    ...
    expect(req.searchParams).toStrictEqual({"query":"parameters"});
    expect(req.headers).toEqual(
      expect.objectContaining({"x-algolia-api-key":"ALGOLIA_API_KEY"})
    );
  });
...
describe('customPut', () => {
  ...
  test('allow put method for a custom path with all parameters', async () => {
    const req = (await client.customPut({"path":"test/all","parameters":{"query":"parameters"},"body":{"body":"parameters"}})) as unknown as EchoResponse;
...
describe('estimateABTest', () => {
  test('estimate AB Test sample size', async () => {
    const req = (await client.estimateABTest({"configuration":{"minimumDetectableEffect":{"size":0.03,"metric":"conversionRate"}},"variants":[{"index":"AB_TEST_1","trafficPercentage":50},{"index":"AB_TEST_2","trafficPercentage":50}]})) as unknown as EchoResponse;

    expect(req.path).toEqual('/3/abtests/estimate');
    expect(req.method).toEqual('POST');
    expect(req.data).toEqual({"configuration":{"minimumDetectableEffect":{"size":0.03,"metric":"conversionRate"}},"variants":[{"index":"AB_TEST_1","trafficPercentage":50},{"index":"AB_TEST_2","trafficPercentage":50}]});
    expect(req.searchParams).toStrictEqual(undefined);
  });
...
describe('listABTests', () => {
  ...
  test('listABTests with parameters', async () => {
    const req = (await client.listABTests({"offset":0,"limit":21,"indexPrefix":"cts_e2e ab","indexSuffix":"t","direction":"asc"})) as unknown as EchoResponse;

    expect(req.path).toEqual('/3/abtests');
    expect(req.method).toEqual('GET');
    expect(req.data).toEqual(undefined);
    expect(req.searchParams).toStrictEqual({"offset":"0","limit":"21","indexPrefix":"cts_e2e%20ab","indexSuffix":"t","direction":"asc"});
  });
...
describe('stopABTest', () => {
  test('stopABTest', async () => {
    ...
    expect(req.path).toEqual('/3/abtests/42/stop');
    expect(req.method).toEqual('POST');
    expect(req.data).toEqual(undefined);
    expect(req.searchParams).toStrictEqual(undefined);
  });
