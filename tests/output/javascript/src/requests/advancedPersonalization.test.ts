...
const client = advancedPersonalizationClient(appId, apiKey, 'eu', { requester: nodeEchoRequester() });

describe('computeRealtimeUser', () => {
  test('computeRealtimeUser', async () => {
    const req = (await client.computeRealtimeUser({ userToken: 'foo' })) as unknown as EchoResponse;

    expect(req.path).toEqual('/2/realtime/users/foo/compute');
...
describe('deleteUser', () => {
  test('deleteUser', async () => {
    const req = (await client.deleteUser({ userID: 'user-1' })) as unknown as EchoResponse;

    expect(req.path).toEqual('/2/users/user-1');
    expect(req.method).toEqual('DELETE');
    expect(req.data).toEqual(undefined);
    expect(req.searchParams).toStrictEqual(undefined);
  });
...
describe('getConfig', () => {
  test('getConfig', async () => {
    const req = (await client.getConfig()) as unknown as EchoResponse;

    expect(req.path).toEqual('/2/config');
    expect(req.method).toEqual('GET');
    expect(req.data).toEqual(undefined);
    expect(req.searchParams).toStrictEqual(undefined);
  });
...
describe('getRealtimeUser', () => {
  test('getRealtimeUser', async () => {
    const req = (await client.getRealtimeUser({ userToken: 'foo' })) as unknown as EchoResponse;

    expect(req.path).toEqual('/2/realtime/users/foo');
    expect(req.method).toEqual('GET');
    expect(req.data).toEqual(undefined);
    expect(req.searchParams).toStrictEqual(undefined);
  });
...
describe('getUser', () => {
  test('getUser', async () => {
    const req = (await client.getUser({ userID: 'user-1' })) as unknown as EchoResponse;
...
describe('getUsers', () => {
  test('getUsers', async () => {
    const req = (await client.getUsers({ indices: ['indexName'] })) as unknown as EchoResponse;

    expect(req.path).toEqual('/2/users');
    expect(req.method).toEqual('GET');
    expect(req.data).toEqual(undefined);
    expect(req.searchParams).toStrictEqual({ indices: 'indexName' });
  });
});

describe('putConfig', () => {
  test('putConfig', async () => {
    const req = (await client.putConfig({
      indices: [],
