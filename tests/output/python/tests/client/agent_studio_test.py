...
class TestAgentStudioClient:
    def create_client(self) -> AgentStudioClient:
        _config = AgentStudioConfig("appId", "apiKey", "us")
        return AgentStudioClient.create_with_config(
    ...
    async def test_api_0(self):
        ...
        _req = await _client.list_agents_with_http_info()
        assert _req.timeouts.get("connect") == 30000
    ...
    async def test_api_1(self):
        ...
        _req = await _client.create_agent_with_http_info(
            agent_config_create={
                "name": "test-agent",
    ...
    async def test_common_api_0(self):
        ...
        regex_user_agent = compile(
            "^Algolia for Python \\(\\d+\\.\\d+\\.\\d+(-?.*)?\\)(; [a-zA-Z. ]+ (\\(\\d+((\\.\\d+)?\\.\\d+)?(-?.*)?\\))?)*(; AgentStudio (\\(\\d+\\.\\d+\\.\\d+(-?.*)?\\)))(; [a-zA-Z. ]+ (\\(\\d+((\\.\\d+)?\\.\\d+)?(-?.*)?\\))?)*$"
        )
    ...
    async def test_common_api_1(self):
        ...
        regex_user_agent = compile("^Algolia for Python \\(4.37.0\\).*")
        assert regex_user_agent.match(_req.headers.get("user-agent")) is not None
    ...
    async def test_parameters_0(self):
        ...
        _config = AgentStudioConfig("my-app-id", "my-api-key", "eu")
        ...
        assert _req.host == "agent-studio.eu.algolia.com"
    ...
    async def test_parameters_1(self):
        ...
        _config = AgentStudioConfig("my-app-id", "my-api-key", "us")
        _client = AgentStudioClient.create_with_config(
            config=_config, transporter=EchoTransporter(_config)
        )
        _req = await _client.custom_get_with_http_info(
        ...
        assert _req.host == "agent-studio.us.algolia.com"
    ...
    async def test_parameters_2(self):
        ...
        try:
            _config = AgentStudioConfig("my-app-id", "my-api-key", "not_a_region")
            _client = AgentStudioClient.create_with_config(
                config=_config, transporter=EchoTransporter(_config)
            )
            assert False
    ...
    async def test_set_client_api_key_0(self):
        ...
        _config = AgentStudioConfig("test-app-id", "test-api-key", "us")
        ...
        _client = AgentStudioClient.create_with_config(config=_config)
...
class TestAgentStudioClientSync:
    def create_client(self) -> AgentStudioClientSync:
        _config = AgentStudioConfig("appId", "apiKey", "us")
        return AgentStudioClientSync.create_with_config(
    ...
    def test_api_0(self):
        ...
        _req = _client.list_agents_with_http_info()
        assert _req.timeouts.get("connect") == 30000
        assert _req.timeouts.get("response") == 30000
    ...
    def test_api_1(self):
        ...
        _req = _client.create_agent_with_http_info(
            agent_config_create={
                "name": "test-agent",
                "instructions": "test instructions",
            },
    ...
    def test_set_client_api_key_0(self):
        ...
        _client = AgentStudioClientSync.create_with_config(config=_config)
