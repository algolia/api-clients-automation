...
class TestAgentStudioClient:
    def create_client(self) -> AgentStudioClient:
        _config = AgentStudioConfig("appId", "apiKey")
    ...
    async def test_common_api_1(self):
        ...
        regex_user_agent = compile("^Algolia for Python \\(4.44.3\\).*")
        assert regex_user_agent.match(_req.headers.get("user-agent")) is not None
    ...
    async def test_no_content_0(self):
        ...
        _config = AgentStudioConfig("test-app-id", "test-api-key")
    ...
    async def test_parameters_0(self):
        ...
        _config = AgentStudioConfig("my-app-id", "my-api-key")
        ...
        assert _req.host == "my-app-id-dsn.algolia.net"
