...
class TestInsightsClient:
    ...
    async def test_push_events_1(self):
        ...
        assert _req.headers.items() >= {}.items()
        assert loads(_req.data) == loads(
            """{"events":[{"eventType":"conversion","eventName":"Product Purchased","index":"products","userToken":"user-123456","authenticatedUserToken":"user-123456","timestamp":1788480000000,"objectIDs":["9780545139700","9780439784542"],"queryID":"43b15df305339e827f0ac0bdc5ebcaa7"},{"eventType":"view","eventName":"Product Detail Page Viewed","index":"products","userToken":"user-123456","authenticatedUserToken":"user-123456","timestamp":1788480000000,"objectIDs":["9780545139700","9780439784542"]}]}"""
        )
