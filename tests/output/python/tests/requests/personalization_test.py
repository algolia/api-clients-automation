...
class TestPersonalizationClientSync:
    _config = PersonalizationConfig("test_app_id", "test_api_key", "us")
    _client = PersonalizationClientSync.create_with_config(
    ...
    def test_delete_user_profile_(self):
        """
        delete deleteUserProfile
        """
        _req = self._client.delete_user_profile_with_http_info(
            user_token="UserToken",
        )
    ...
    def test_get_personalization_strategy_(self):
        """
        get getPersonalizationStrategy
        """
        _req = self._client.get_personalization_strategy_with_http_info()
    ...
    def test_get_user_token_profile_(self):
        """
        get getUserTokenProfile
        """
        _req = self._client.get_user_token_profile_with_http_info(
            user_token="UserToken",
        )
    ...
    def test_set_personalization_strategy_(self):
        """
        set setPersonalizationStrategy
        """
