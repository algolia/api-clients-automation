...
public class AbtestingV3ClientRequestTests
{
  private readonly AbtestingV3Client client;
  private readonly EchoHttpRequester _echo;

  public AbtestingV3ClientRequestTests()
  {
    _echo = new EchoHttpRequester();
    client = new AbtestingV3Client(new AbtestingV3Config("appId", "apiKey", "us"), _echo);
  }
  ...
  public async Task EstimateABTestTest()
  {
    ...
    var req = _echo.LastResponse;
    Assert.Equal("/3/abtests/estimate", req.Path);
    Assert.Equal("POST", req.Method.ToString());
    JsonAssert.EqualOverrideDefault(
  ...
  {
    await client.GetTimeseriesAsync(42);
