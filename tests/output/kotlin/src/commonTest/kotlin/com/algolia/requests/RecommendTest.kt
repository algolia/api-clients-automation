...
class RecommendTest {
  ...
  fun `batch recommend rules`() = runTest {
    client.runTest(
      ...
      intercept = {
        assertEquals(
          "/1/indexes/indexName/related-products/recommend/rules/batch".toPathSegments(),
          it.url.pathSegments,
        )
  ...
  fun `deleteRecommendRule`() = runTest {
    client.runTest(
      ...
      intercept = {
        assertEquals(
          "/1/indexes/indexName/related-products/recommend/rules/objectID".toPathSegments(),
          it.url.pathSegments,
        )
        assertEquals(HttpMethod.parse("DELETE"), it.method)
        assertNoBody(it.body)
  ...
  fun `getRecommendStatus`() = runTest {
    client.runTest(
      ...
      intercept = {
        assertEquals(
          "/1/indexes/indexName/related-products/task/12345".toPathSegments(),
          it.url.pathSegments,
        )
        assertEquals(HttpMethod.parse("GET"), it.method)
        assertNoBody(it.body)
  ...
  fun `searchRecommendRules`() = runTest {
    client.runTest(
      ...
      intercept = {
        assertEquals(
          "/1/indexes/indexName/related-products/recommend/rules/search".toPathSegments(),
          it.url.pathSegments,
        )
        assertEquals(HttpMethod.parse("POST"), it.method)
        assertJsonBody("""{}""", it.body)
