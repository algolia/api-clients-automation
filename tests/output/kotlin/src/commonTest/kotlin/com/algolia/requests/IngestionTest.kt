...
class IngestionTest {
  ...
  fun `pushTask`() = runTest {
    client.runTest(
      ...
      intercept = {
        assertEquals(
          "/2/tasks/6c02aeb1-775e-418e-870b-1faccd4b2c0f/push".toPathSegments(),
          it.url.pathSegments,
        )
        assertEquals(HttpMethod.parse("POST"), it.method)
        assertJsonBody(
  ...
  fun `runSource`() = runTest {
    client.runTest(
      ...
      intercept = {
        assertEquals(
          "/1/sources/6c02aeb1-775e-418e-870b-1faccd4b2c0f/run".toPathSegments(),
          it.url.pathSegments,
        )
        assertEquals(HttpMethod.parse("POST"), it.method)
        assertJsonBody(
  ...
  fun `tryTransformationBeforeUpdate`() = runTest {
    client.runTest(
      ...
      intercept = {
        assertEquals(
          "/1/transformations/6c02aeb1-775e-418e-870b-1faccd4b2c0f/try".toPathSegments(),
          it.url.pathSegments,
        )
        assertEquals(HttpMethod.parse("POST"), it.method)
        assertJsonBody(
  ...
  fun `validateSourceBeforeUpdate`() = runTest {
    client.runTest(
      ...
      intercept = {
        assertEquals(
          "/1/sources/6c02aeb1-775e-418e-870b-1faccd4b2c0f/validate".toPathSegments(),
          it.url.pathSegments,
        )
        assertEquals(HttpMethod.parse("POST"), it.method)
        assertJsonBody("""{"name":"newName"}""", it.body)
