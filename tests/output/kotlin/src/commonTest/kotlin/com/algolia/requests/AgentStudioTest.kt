...
class AgentStudioTest {
      ...
      call = {
        createAgentCompletion(
          ...
          agentCompletionRequest =
            AgentCompletionRequest(
              messages =
                MessagesNullableUnionUnion.ofListOfMessageV4(
        ...
        createProvider(
          providerAuthenticationCreate =
            ProviderAuthenticationCreate(
              ...
              input = OpenAIProviderInputInput(apiKey = "sk-test-key-1234"),
            )
        )
      },
      intercept = {
      ...
      call = {
        createSecretKey(
          secretKeyCreate =
            SecretKeyCreate(
              name = "scoped-key",
              agentIds = listOf("785b14e4-61a8-4c03-8028-bf2ba3ae85ff"),
            )
        )
      },
      intercept = {
  ...
  fun `deleteAgent`() = runTest {
    client.runTest(
      ...
      intercept = {
        assertEquals(
          "/agent-studio/1/agents/785b14e4-61a8-4c03-8028-bf2ba3ae85ff".toPathSegments(),
          it.url.pathSegments,
        )
        assertEquals(HttpMethod.parse("DELETE"), it.method)
        assertNoBody(it.body)
  ...
  fun `deleteProvider`() = runTest {
    client.runTest(
      ...
      intercept = {
        assertEquals(
          "/agent-studio/1/providers/5e33d805-7892-4329-bda7-b524dc3fd04a".toPathSegments(),
          it.url.pathSegments,
        )
        assertEquals(HttpMethod.parse("DELETE"), it.method)
        assertNoBody(it.body)
  ...
  fun `e2e get secret key1`() = runTest {
    client.runTest(
      ...
      intercept = {
        assertEquals(
          "/agent-studio/1/secret-keys/f730dda4-9649-4cfb-9d88-b7e992fb89c9".toPathSegments(),
          it.url.pathSegments,
        )
        assertEquals(HttpMethod.parse("GET"), it.method)
        assertNoBody(it.body)
  ...
  fun `invalidateAgentCache without before`() = runTest {
    client.runTest(
      ...
      intercept = {
        assertEquals(
          "/agent-studio/1/agents/785b14e4-61a8-4c03-8028-bf2ba3ae85ff/cache".toPathSegments(),
          it.url.pathSegments,
        )
        assertEquals(HttpMethod.parse("DELETE"), it.method)
        assertNoBody(it.body)
  ...
  fun `listProviderModels`() = runTest {
    client.runTest(
      ...
      intercept = {
        assertEquals(
          "/agent-studio/1/providers/5e33d805-7892-4329-bda7-b524dc3fd04a/models".toPathSegments(),
          it.url.pathSegments,
        )
        assertEquals(HttpMethod.parse("GET"), it.method)
        assertNoBody(it.body)
  ...
  fun `publishAgent`() = runTest {
    client.runTest(
      ...
      intercept = {
        assertEquals(
          "/agent-studio/1/agents/785b14e4-61a8-4c03-8028-bf2ba3ae85ff/publish".toPathSegments(),
          it.url.pathSegments,
        )
        assertEquals(HttpMethod.parse("POST"), it.method)
  ...
  fun `unpublishAgent`() = runTest {
    client.runTest(
      ...
      intercept = {
        assertEquals(
          "/agent-studio/1/agents/785b14e4-61a8-4c03-8028-bf2ba3ae85ff/unpublish".toPathSegments(),
          it.url.pathSegments,
        )
        assertEquals(HttpMethod.parse("POST"), it.method)
        assertEmptyBody(it.body)
        ...
        updateProvider(
          ...
          providerAuthenticationPatch =
            ProviderAuthenticationPatch(
              ...
              input = OpenAIProviderInputInput(apiKey = "sk-new-key-5678"),
            ),
        )
      },
      intercept = {
