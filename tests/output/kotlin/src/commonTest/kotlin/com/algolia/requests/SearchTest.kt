...
class SearchTest {
  ...
  @Test
  fun `aroundLatLngViaIP17`() = runTest {
    client.runTest(
      call = {
        searchSingleIndex(
          indexName = "indexName",
  ...
  @Test
  fun `insideBoundingBox19`() = runTest {
    client.runTest(
      call = {
        searchSingleIndex(
          indexName = "indexName",
  ...
  @Test
  fun `optionalFiltersMany23`() = runTest {
    client.runTest(
      call = {
        searchSingleIndex(
          indexName = "indexName",
  ...
  @Test
  fun `optionalFiltersSimple24`() = runTest {
    client.runTest(
      call = {
        searchSingleIndex(
          indexName = "indexName",
  ...
  @Test
  fun `restrictSearchableAttributes25`() = runTest {
    client.runTest(
      call = {
        searchSingleIndex(
          indexName = "indexName",
  ...
  @Test
  fun `clickAnalyticsUserToken28`() = runTest {
    client.runTest(
      call = {
        searchSingleIndex(
          indexName = "indexName",
  ...
  @Test
  fun `enablePersonalization29`() = runTest {
    client.runTest(
      call = {
        searchSingleIndex(
          indexName = "indexName",
  ...
  @Test
  fun `facetFiltersUsers32`() = runTest {
    client.runTest(
      call = {
        searchSingleIndex(
          indexName = "indexName",
  ...
  @Test
  fun `unlink replica index37`() = runTest {
    client.runTest(
      call = {
        setSettings(
          indexName = "theIndexName",
  ...
  @Test
  fun `forwardToReplicas38`() = runTest {
    client.runTest(
      call = {
        setSettings(
          indexName = "theIndexName",
  ...
  @Test
  fun `maxValuesPerFacet39`() = runTest {
    client.runTest(
      call = {
        setSettings(
          indexName = "theIndexName",
  ...
  @Test
  fun `attributesForFaceting complex41`() = runTest {
    client.runTest(
      call = {
        setSettings(
          indexName = "<YOUR_INDEX_NAME>",
  ...
  @Test
  fun `ranking closest dates42`() = runTest {
    client.runTest(
      call = {
        setSettings(
          indexName = "theIndexName",
  ...
  @Test
  fun `searchableAttributes item variation43`() = runTest {
    client.runTest(
      call = {
        setSettings(
          indexName = "theIndexName",
  ...
  @Test
  fun `searchableAttributes around location44`() = runTest {
    client.runTest(
      call = {
        setSettings(
          indexName = "theIndexName",
  ...
  @Test
  fun `disableTypoToleranceOnAttributes46`() = runTest {
    client.runTest(
      call = {
        setSettings(
          indexName = "theIndexName",
  ...
  @Test
  fun `searchableAttributesWithCustomRankingsAndAttributesForFaceting48`() = runTest {
    client.runTest(
      call = {
        setSettings(
          indexName = "theIndexName",
  ...
  @Test
  fun `searchableAttributesProductReferenceSuffixes49`() = runTest {
    client.runTest(
      call = {
        setSettings(
          indexName = "theIndexName",
  ...
  @Test
  fun `queryLanguageAndIgnorePlurals50`() = runTest {
    client.runTest(
      call = {
        setSettings(
          indexName = "theIndexName",
  ...
  @Test
  fun `searchableAttributesInMovies51`() = runTest {
    client.runTest(
      call = {
        setSettings(
          indexName = "movies",
  ...
  @Test
  fun `disablePrefixOnAttributes52`() = runTest {
    client.runTest(
      call = {
        setSettings(
          indexName = "theIndexName",
  ...
  @Test
  fun `disableTypoToleranceOnAttributes53`() = runTest {
    client.runTest(
      call = {
        setSettings(
          indexName = "theIndexName",
  ...
  @Test
  fun `searchableAttributesSimpleExample54`() = runTest {
    client.runTest(
      call = {
        setSettings(
          indexName = "theIndexName",
  ...
  @Test
  fun `searchableAttributesSimpleExampleAlt55`() = runTest {
    client.runTest(
      call = {
        setSettings(
          indexName = "theIndexName",
