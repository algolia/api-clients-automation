...
class SearchApiTests {
  ...
  void batchDictionaryEntriesTest0() {
    ...
    BatchDictionaryEntries batchDictionaryEntries1 = new BatchDictionaryEntries();
    {
      List requests2 = new ArrayList();
      {
      ...
      batchDictionaryEntries1.setRequests(requests2);
    }
  ...
  void batchDictionaryEntriesTest1() {
    ...
    BatchDictionaryEntries batchDictionaryEntries1 = new BatchDictionaryEntries();
    {
      ...
      batchDictionaryEntries1.setClearExistingDictionaryEntries(
  ...
  void searchDictionaryEntriesTest0() {
    ...
    SearchDictionaryEntries searchDictionaryEntries1 = new SearchDictionaryEntries();
    {
      String query2 = "foo";

      searchDictionaryEntries1.setQuery(query2);
    }
  ...
  void searchDictionaryEntriesTest1() {
    ...
    SearchDictionaryEntries searchDictionaryEntries1 = new SearchDictionaryEntries();
    {
      ...
      searchDictionaryEntries1.setPage(page2);

      int hitsPerPage2 = 2;

      searchDictionaryEntries1.setHitsPerPage(hitsPerPage2);
      String language2 = "fr";

      searchDictionaryEntries1.setLanguage(language2);
    }
  ...
  void setDictionarySettingsTest0() {
    DictionarySettingsRequest param0 = new DictionarySettingsRequest();
    {
