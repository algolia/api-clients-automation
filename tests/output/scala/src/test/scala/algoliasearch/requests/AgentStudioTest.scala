...
class AgentStudioTest extends AnyFunSuite {
  ...
  test("bulkCreateAllowedDomains") {
    ...
    assert(res.path == "/agent-studio/1/agents/76710f1b-8231-42e5-b0d1-f43aac618e15/allowed-domains/bulk")
  ...
  test("createAgent with all parameters1") {
    ...
    val future = client.createAgent(
      agentConfigCreate = AgentConfigCreate(
        ...
        providerId = Some("c2905529-b933-4b69-87ec-75f9829d5f59"),
        model = Some("gpt-4"),
        instructions = "You are a helpful assistant.",
  ...
  test("createAgentAllowedDomain") {
    ...
    assert(res.path == "/agent-studio/1/agents/76710f1b-8231-42e5-b0d1-f43aac618e15/allowed-domains")
    assert(res.method == "POST")
  ...
  test("createAgentCompletion with v4 messages") {
    ...
    assert(res.path == "/agent-studio/1/agents/76710f1b-8231-42e5-b0d1-f43aac618e15/completions")
    assert(res.method == "POST")
  ...
  test("createFeedback with required parameters") {
    ...
    assert(res.method == "POST")
    val expectedBody = parse("""{"messageId":"msg-abc123","agentId":"76710f1b-8231-42e5-b0d1-f43aac618e15","vote":1}""")
    val actualBody = parse(res.body.get)
    assert(actualBody == expectedBody)
  }
  ...
  test("createSecretKey with agent IDs1") {
    ...
    assert(res.path == "/agent-studio/1/secret-keys")
    assert(res.method == "POST")
    val expectedBody = parse("""{"name":"scoped-key","agentIds":["76710f1b-8231-42e5-b0d1-f43aac618e15"]}""")
    val actualBody = parse(res.body.get)
    assert(actualBody == expectedBody)
  }
  ...
  test("deleteAgentConversations without filters") {
    ...
    assert(res.path == "/agent-studio/1/agents/76710f1b-8231-42e5-b0d1-f43aac618e15/conversations")
    assert(res.method == "DELETE")
    assert(res.body.isEmpty)
  }
  ...
  test("deleteAllowedDomain") {
    ...
    assert(
      res.path == "/agent-studio/1/agents/76710f1b-8231-42e5-b0d1-f43aac618e15/allowed-domains/a1b2c3d4-5678-90ab-cdef-123456789abc"
    )
    assert(res.method == "DELETE")
    assert(res.body.isEmpty)
  }
  ...
  test("deleteConversation") {
    ...
    assert(res.path == "/agent-studio/1/agents/76710f1b-8231-42e5-b0d1-f43aac618e15/conversations/test-conversation-id")
    assert(res.method == "DELETE")
    assert(res.body.isEmpty)
  }
  ...
  test("deleteProvider") {
    ...
    assert(res.path == "/agent-studio/1/providers/c2905529-b933-4b69-87ec-75f9829d5f59")
    assert(res.method == "DELETE")
    assert(res.body.isEmpty)
  }
  ...
  test("exportConversations without filters") {
    ...
    assert(res.path == "/agent-studio/1/agents/76710f1b-8231-42e5-b0d1-f43aac618e15/conversations/export")
    assert(res.method == "GET")
    assert(res.body.isEmpty)
  }
  ...
  test("e2e get allowed domain1") {
    ...
    assert(
      res.path == "/agent-studio/1/agents/76710f1b-8231-42e5-b0d1-f43aac618e15/allowed-domains/6e8a0441-9a41-477c-a1d6-679a461e0990"
    )
    assert(res.method == "GET")
    assert(res.body.isEmpty)
  }
  ...
  test("e2e get secret key1") {
    ...
    assert(res.path == "/agent-studio/1/secret-keys/c110e615-7d5a-4103-865f-c5062c0d6f4d")
    assert(res.method == "GET")
    assert(res.body.isEmpty)
  }
  ...
  test("invalidateAgentCache without before") {
    ...
    assert(res.path == "/agent-studio/1/agents/76710f1b-8231-42e5-b0d1-f43aac618e15/cache")
    assert(res.method == "DELETE")
    assert(res.body.isEmpty)
  }
  ...
  test("list agents with all parameters1") {
    ...
    assert(res.method == "GET")
    assert(res.body.isEmpty)
    val expectedQuery = parse("""{"page":"2","limit":"5","providerId":"c2905529-b933-4b69-87ec-75f9829d5f59"}""")
      .asInstanceOf[JObject]
      .obj
      .toMap
    val actualQuery = res.queryParameters
  ...
  test("listProviderModels") {
    ...
    assert(res.path == "/agent-studio/1/providers/c2905529-b933-4b69-87ec-75f9829d5f59/models")
    assert(res.method == "GET")
    assert(res.body.isEmpty)
  }
  ...
  test("updateSecretKey") {
    ...
    assert(res.path == "/agent-studio/1/secret-keys/a1b2c3d4-5678-90ab-cdef-123456789abc")
    assert(res.method == "PATCH")
    val expectedBody = parse("""{"name":"renamed-key","agentIds":["76710f1b-8231-42e5-b0d1-f43aac618e15"]}""")
    val actualBody = parse(res.body.get)
    assert(actualBody == expectedBody)
  }
