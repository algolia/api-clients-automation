...
class SearchTest extends AnyFunSuite {
  ...
  test("nlu test1") {
    ...
    assert(res.path == "/1/keys")
    assert(res.method == "POST")
    val expectedBody = parse("""{"acl":["search","addObject","nluReadProject"],"description":"my new api key"}""")
    val actualBody = parse(res.body.get)
    assert(actualBody == expectedBody)
  }
  ...
  test("customRankingWithoutCategories7") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
    ...
    assert(res.method == "POST")
    val expectedBody =
      parse("""{"query":"User search query","facetingAfterDistinct":true,"filters":"ranked_category:none"}""")
    val actualBody = parse(res.body.get)
    assert(actualBody == expectedBody)
  }

  test("customRankingWithCategories8") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("filtersWithScores13") {
    ...
    assert(res.method == "POST")
    val expectedBody =
      parse("""{"filters":"(company:Google<score=3> OR company:Amazon<score=2> OR company:Facebook<score=1>)"}""")
    val actualBody = parse(res.body.get)
    assert(actualBody == expectedBody)
  }

  test("filtersSumOrFiltersScoresFalse14") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("filtersSumOrFiltersScoresTrue15") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("filtersNumericGreaterThan19") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
    ...
    assert(res.path == "/1/indexes/indexName/query")
    assert(res.method == "POST")
    val expectedBody = parse("""{"numericFilters":"price>20"}""")
    val actualBody = parse(res.body.get)
    assert(actualBody == expectedBody)
  }

  test("facetFiltersList20") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("restrictSearchableAttributes38") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("restrictSearchableAttributesWolf39") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
    ...
    assert(res.path == "/1/indexes/indexName/query")
    assert(res.method == "POST")
    val expectedBody = parse("""{"query":"wolf","restrictSearchableAttributes":["title_fr"]}""")
    val actualBody = parse(res.body.get)
    assert(actualBody == expectedBody)
  }

  test("getRankingInfo40") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("clickAnalyticsUserToken42") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("attributesToHighlightOverride49") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("disableTypoToleranceOnAttributes50") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("api_filtering_range_example53") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("override_retrievable_attributes55") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("restrict_searchable_attributes56") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("override_default_relevancy57") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("apply_negative_filters_restaurants66") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("set_sum_or_filters_scores69") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("retrieve_only_some_facets71") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("override_default_max_values_per_facet72") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("enable_faceting_after_distinct73") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("sort_facet_values_alphabetically74") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("override_attributes_to_snippet75") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("override_default_highlight_pre_tag76") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("override_default_highlight_post_tag77") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("override_default_snippet_ellipsis_text78") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("enable_restrict_highlight_and_snippet_arrays79") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("override_default_hits_per_page81") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("overrideDefaultPageAndHitsPerPage82") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
    ...
    assert(res.path == "/1/indexes/indexName/query")
    assert(res.method == "POST")
    val expectedBody = parse("""{"query":"query","page":2,"hitsPerPage":5}""")
    val actualBody = parse(res.body.get)
    assert(actualBody == expectedBody)
  }
  ...
  test("override_default_min_word_size_for_one_typo85") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("override_default_min_word_size_for_two_typos86") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("override_default_typo_tolerance_mode87") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("disable_typos_on_numeric_tokens_at_search_time88") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("search_around_a_position89") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("search_around_server_ip90") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
    ...
    val actualBody = parse(res.body.get)
    assert(actualBody == expectedBody)
    val expectedHeaders = parse("""{"x-forwarded-for":"XX.XXX.XXX.XXX"}""").asInstanceOf[JObject].obj.toMap
    val actualHeaders = res.headers
    for ((k, v) <- expectedHeaders) {
      assert(actualHeaders.contains(k))
      assert(actualHeaders(k) == v.asInstanceOf[JString].s)
  ...
  test("disable_automatic_radius93") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("set_geo_search_precision94") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("set_geo_search_precision_non_linear95") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("set_minimum_geo_search_radius96") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("search_inside_rectangular_area97") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("search_inside_multiple_rectangular_areas98") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("search_inside_polygon_area99") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("search_inside_multiple_polygon_areas100") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("set_querylanguages_override101") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("set_querylanguages_with_japanese_query102") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("override_natural_languages_with_query104") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("enable_decompound_query_search_time105") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("enable_rules_search_time106") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("enable_personalization108") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("enable_personalization_with_user_token109") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("personalization_impact110") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("set_user_token_with_personalization112") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("override_default_query_type113") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("override_default_remove_words_if_no_results114") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("enable_advanced_syntax_search_time115") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("overide_default_optional_words116") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("disabling_exact_for_some_attributes_search_time117") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("override_default_exact_single_word_query118") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("override_default_aternative_as_exact119") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("enable_advanced_syntax_exact_phrase120") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("enable_advanced_syntax_exclude_words121") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("disable_click_analytics124") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("enable_click_analytics125") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("override_replace_synonyms_in_highlights129") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("override_min_proximity130") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("override_default_field131") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("override_percentile_computation132") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "indexName",
      searchParams = Some(
  ...
  test("mcm with algolia user id136") {
    val (client, echo) = testClient()
    val future = client.searchSingleIndex(
      indexName = "playlists",
      searchParams = Some(
  ...
  test("highlightWithCustomPrePostTags53") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("attributesToHighlightStar54") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("searchableAttributesWithCustomRankingsAndAttributesForFaceting56") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("searchableAttributesOrdering57") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("searchableAttributesProductReferenceSuffixes58") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("queryLanguageAndIgnorePlurals59") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("searchableAttributesInMovies60") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "movies",
      indexSettings = IndexSettings(
  ...
  test("disablePrefixOnAttributes61") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("disableTypoToleranceOnAttributes62") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("searchableAttributesSimpleExample63") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("searchableAttributesSimpleExampleAlt64") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("set_attributes_for_faceting66") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("unretrievable_attributes67") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("set_retrievable_attributes68") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("set_all_attributes_as_retrievable69") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("specify_attributes_not_to_retrieve70") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("set_ranking_by_attribute_asc74") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("set_ranking_by_attribute_desc75") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("set_default_max_values_per_facet79") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("set_default_sort_facet_values_by80") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("set_attributes_to_snippet81") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("set_all_attributes_to_snippet82") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("set_default_highlight_pre_tag83") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("set_default_highlight_post_tag84") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("set_default_snippet_ellipsis_text85") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("enable_restrict_highlight_and_snippet_arrays_by_default86") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("set_default_hits_per_page87") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("set_default_min_word_size_for_one_typo89") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("set_default_min_word_size_for_two_typos90") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("set_default_typo_tolerance_mode91") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("disable_typos_on_numeric_tokens_by_default92") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("disable_typo_tolerance_for_words93") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("set_separators_to_index94") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("set_querylanguage_ignoreplurals95") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("set_attributes_to_transliterate96") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("set_querylanguage_removestopwords97") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("set_camel_case_attributes98") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("set_decompounded_attributes99") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("set_decompounded_multiple_attributes100") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("set_keep_diacritics_on_characters101") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
    ...
    assert(res.path == "/1/indexes/theIndexName/settings")
    assert(res.method == "PUT")
    val expectedBody = parse("""{"keepDiacriticsOnCharacters":"øé"}""")
    val actualBody = parse(res.body.get)
    assert(actualBody == expectedBody)
  }

  test("set_custom_normalization102") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
    ...
    assert(res.path == "/1/indexes/theIndexName/settings")
    assert(res.method == "PUT")
    val expectedBody = parse("""{"customNormalization":{"default":{"ä":"ae"}}}""")
    val actualBody = parse(res.body.get)
    assert(actualBody == expectedBody)
  }

  test("set_querylanguage_both103") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("enable_decompound_query_by_default105") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("enable_rules_syntax_by_default106") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("enable_personalization_settings107") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("set_default_query_type108") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("set_default_remove_words_if_no_result109") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("enable_advanced_syntax_by_default110") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("set_default_optional_words111") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("disabling_prefix_search_for_some_attributes_by_default112") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("disabling_exact_for_some_attributes_by_default113") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("set_default_exact_single_word_query114") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("set_default_aternative_as_exact115") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
  ...
  test("minWordSizefor1Typo5128") {
    ...
    assert(res.path == "/1/indexes/theIndexName/settings")
    assert(res.method == "PUT")
    val expectedBody = parse("""{"minWordSizefor1Typo":5}""")
    val actualBody = parse(res.body.get)
    assert(actualBody == expectedBody)
  }

  test("attributesToSnippetBodyTitle129") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
    ...
    assert(res.path == "/1/indexes/theIndexName/settings")
    assert(res.method == "PUT")
    val expectedBody = parse("""{"attributesToSnippet":["body:20","title"]}""")
    val actualBody = parse(res.body.get)
    assert(actualBody == expectedBody)
  }

  test("snippetEllipsisTextHellip130") {
    val (client, echo) = testClient()
    val future = client.setSettings(
      indexName = "theIndexName",
      indexSettings = IndexSettings(
    ...
    assert(res.path == "/1/indexes/theIndexName/settings")
    assert(res.method == "PUT")
    val expectedBody = parse("""{"snippetEllipsisText":"[&hellip;]"}""")
    val actualBody = parse(res.body.get)
    assert(actualBody == expectedBody)
  }
