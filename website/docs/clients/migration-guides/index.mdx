...
import { snippets as searchSnippets } from '../../src/generated/search-snippets';
import { snippets as abtestingSnippets } from '../../src/generated/abtesting-snippets';
...
`${searchSnippets[language].import}

${searchSnippets[language].init}

${searchSnippets[language].search}
`)}></CodeBlockLanguage>
...
<CodeBlockLanguage snippet={(language) => (
`${abtestingSnippets[language].import}

${abtestingSnippets[language].init}

${abtestingSnippets[language].getABTest}
`)}></CodeBlockLanguage>
...
${searchSnippets[language].saveObject}
...
${searchSnippets[language].operationIndex}
