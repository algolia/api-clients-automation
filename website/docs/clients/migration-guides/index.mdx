...
import { TabsLanguage, languagesTabValues, languagesTabValuesNoPHP } from '../../../src/components/TabsLanguage';
...
<TabsLanguage values={languagesTabValues}>
...
<TabsLanguage values={languagesTabValuesNoPHP}>
<TabItem value="javascript">
