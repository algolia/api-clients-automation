...
import { waitForTaskSnippet, getSnippet } from '../../../src/snippets';
...
${getSnippet(language, 'search', 'search')}
`)}/>
...
<CodeBlockLanguage snippet={(language) => (
`${getSnippet(language, 'abtesting', 'import')}

${getSnippet(language, 'abtesting', 'init')}

${getSnippet(language, 'abtesting', 'getABTest')}
`)}/>
...
${getSnippet(language, 'search', 'saveObject')}
...
${getSnippet(language, 'search', 'operationIndex', 'scopes')}
...
${getSnippet(language, 'search', 'batch')}
