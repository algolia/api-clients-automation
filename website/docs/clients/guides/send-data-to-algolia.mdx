...
// for a lightweight version, you can import the `lite` client which only exposes search methods
...
If the data you are sending is more than 1000 records at once, wecommend you to use [our chunked batch solution](/docs/clients/guides/filtering-your-search) instead.
