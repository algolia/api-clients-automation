...
await client.SaveRulesAsync("<YOUR_INDEX_NAME>", rules, forwardToReplicas: false, clearExistingRules: true);
```
...
await client.SaveSynonymsAsync("<YOUR_INDEX_NAME>", synonyms, forwardToReplicas: false, replaceExistingSynonyms: true);
```
