...
import { addComment, getSnippet, waitForTaskSnippet } from '../../../src/snippets';
...
${getSnippet(language, 'search', 'setSettings', 'setSettingsAttributesForFaceting')}
...
<CodeBlockLanguage snippet={(language) => (
`${addComment(language, 'Only "Scarlett Johansson" actor')}
${getSnippet(language, 'search', 'search', 'filterOnly')}

${addComment(language, 'Only "Tom Cruise" or "Scarlett Johansson" actor')}
${getSnippet(language, 'search', 'search', 'filterOr')}

${addComment(language, 'Everything but "Nicolas Cage" actor')}
${getSnippet(language, 'search', 'search', 'filterNot')}
`)}/>
