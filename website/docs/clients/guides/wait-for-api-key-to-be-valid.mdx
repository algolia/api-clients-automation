...
import { getSnippet, waitForApiKeySnippet } from '../../../src/snippets';
...
${waitForApiKeySnippet(language, 'add')}
`)}/>
...
${waitForApiKeySnippet(language, 'update')}
`)}/>
...
${waitForApiKeySnippet(language, 'delete')}
`)}/>
