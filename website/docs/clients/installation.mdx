...
> If you don't find one that suits your need, please [request it](https://github.com/algolia/api-clients-automation/issues/new?assignees=&labels=&template=Feature_request.md).
