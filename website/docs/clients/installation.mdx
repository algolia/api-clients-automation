...
To get started, add the [algoliasearch-client-java](https://oss.sonatype.org/content/repositories/snapshots/com/algolia/algoliasearch-client-java/4.0.0-beta.0/) dependency to your project, either with [Maven](https://maven.apache.org/):
...
```groovy
dependencies {
  testImplementation 'com.algolia:algoliasearch-client-java:4.0.0-beta.0'
}
```
