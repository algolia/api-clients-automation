...
The package is divided into multiples API Clients, you can find the list nowhere.
To create a client, prepare your credentials a follow this example:
...
You can specify a custom `Requester`, or add segments to the `User Agent`:
```java
