...
public class AlgoliaCTSGenerator extends DefaultCodegen {
  ...
  protected Builder<String, Lambda> addMustacheLambdas() {
    ...
    lambdas.put("rubyNil", new RubyNilLambda());
  ...
  public Map<String, Object> postProcessSupportingFileData(Map<String, Object> objs) {
    try {
      ...
      bundle.put("requestIdSupport", Helpers.requestIdSupport(client) || client.equals("algoliasearch"));
      ...
      Helpers.generateServers(servers, bundle);
