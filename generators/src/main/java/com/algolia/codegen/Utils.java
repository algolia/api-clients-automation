...
public class Utils {
  ...
  public static void generateServer(String clientKebab, Map<String, Object> additionalProperties)
      throws ConfigException {
    Yaml yaml = new Yaml();
    try {
      Map<String, Object> spec =
          yaml.load(new FileInputStream("specs/bundled/" + clientKebab + ".yml"));
      ...
      for (Map<String, Object> server : servers) {
        ...
        Map<String, Map<String, Object>> variables =
            (Map<String, Map<String, Object>>) server.get("variables");
  ...
  public static String getClientConfigField(String language, String... fields)
      throws ConfigException {
    if (fields.length == 0) {
  ...
  public static String getOpenApiToolsField(String language, String client, String... fields)
      throws ConfigException {
    if (fields.length == 0) {
