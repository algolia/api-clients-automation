  ...
  module Transport
    ...
    class Transport
      ...
      def request(call_type, method, path, body, opts = {})
        ...
        raise Algolia::AlgoliaUnreachableHostError.new("Unreachable hosts. If the error persists, please visit our help center <SUPPORT_LINK_HERE> or reach out to the Algolia Support team: https://alg.li/support.", retry_errors)
      end
