...
module Algolia
  module AgentStudio
    module MessagePartAssistantMessageAGUI
      class << self
      # List of class defined in oneOf (OpenAPI v3)
        ...
        def build(data)
          ...
          if data.is_a?(Hash) && data.key?("type")
            case data["type"]
            when "text"
              return find_and_cast_into_type(:"TextPartAGUI", data)
            when "thinking"
              return find_and_cast_into_type(:"ReasoningPartAGUI", data)
            when "tool-call"
              return find_and_cast_into_type(:"ToolCallPartAGUI", data)
            when "tool-result"
              return find_and_cast_into_type(:"ToolCallResultPartAGUI", data)
            end
          end
