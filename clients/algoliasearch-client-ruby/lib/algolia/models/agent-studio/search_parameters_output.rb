    ...
    class SearchParametersOutput
      ...
      def self.types_mapping
        {
          ...
          :typo_tolerance => :"TypoToleranceUnionSearchParametersOutput",
          ...
          :filters => :"String",
          :facet_filters => :"FacetFiltersOutputUnion",
          :facets => :"FacetsUnion",
          ...
          :remove_stop_words => :"RemoveStopWordsUnionSearchParametersOutput",
          :ignore_plurals => :"IgnorePluralsUnionSearchParametersOutput",
          :remove_words_if_no_results => :"RemoveWordsIfNoResults",
      ...
      def initialize(attributes = {})
        if (!attributes.is_a?(Hash))
          raise(
            ArgumentError,
            "The input argument (attributes) must be a hash in `Algolia::SearchParametersOutput` initialize method"
          )
        end
        ...
        attributes = attributes.each_with_object({}) { |(k, v), h|
          if (!self.class.attribute_map.key?(k.to_sym))
            raise(
              ArgumentError,
              "`#{k}` is not a valid attribute in `Algolia::SearchParametersOutput`. Please check the name to make sure it's valid. List of attributes: " +
