      ...
      # List of class defined in oneOf (OpenAPI v3)
        ...
        def build(data)
          ...
          if data.is_a?(Hash) && data.key?("role")
            case data["role"]
            when "assistant"
              return find_and_cast_into_type(:"AssistantMessageAGUI", data)
            when "reasoning"
              return find_and_cast_into_type(:"ReasoningMessageAGUI", data)
            when "tool"
              return find_and_cast_into_type(:"ToolMessageAGUI", data)
            when "user"
              return find_and_cast_into_type(:"UserMessageAGUI", data)
            end
          end
