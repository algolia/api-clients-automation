        ...
        def build(data)
          ...
          if data.is_a?(Hash) && data.key?("type")
            ...
            when "algolia_recommend"
              return find_and_cast_into_type(:"AlgoliaRecommendToolConfigOutput", data)
            when "algolia_search_index"
              return find_and_cast_into_type(:"AlgoliaSearchToolConfigOutput", data)
            when "client_side"
              return find_and_cast_into_type(:"ClientSideToolConfig", data)
            when "mcp_tools"
              return find_and_cast_into_type(:"McpServerToolConfigOutput", data)
            when "unknown"
