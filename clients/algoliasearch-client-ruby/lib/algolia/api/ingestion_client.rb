...
module Algolia
  class IngestionClient
    ...
    # @param with_notifications [Boolean] If specified, the response only includes tasks with notifications.email.enabled set to this value.
    ...
    def list_tasks_with_http_info(
      ...
      query_params[:withNotifications] = with_notifications unless with_notifications.nil?
      query_params[:sort] = sort unless sort.nil?
      query_params[:order] = order unless order.nil?
      query_params = query_params.merge(request_options[:query_params]) unless request_options[:query_params].nil?
      header_params = {}
