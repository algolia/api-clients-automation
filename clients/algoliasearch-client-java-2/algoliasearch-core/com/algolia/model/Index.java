...
public class Index {
  ...
  public static final String SERIALIZED_NAME_LAST_BUILD_TIME_S = "lastBuildTimeS";
  @SerializedName(SERIALIZED_NAME_LAST_BUILD_TIME_S)
  private Integer lastBuildTimeS;

  public static final String SERIALIZED_NAME_NUMBER_OF_PENDING_TASK = "numberOfPendingTask";
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Index creation date. An empty string means that the index has no records.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Date of last update (ISO-8601 format).")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Number of records contained in the index.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Number of bytes of the index in minified format.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Number of bytes of the index binary file.")
  ...
  **/
  ...
  @ApiModelProperty(value = "Number of pending indexing operations. This value is deprecated and should not be used.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "A boolean which says whether the index has pending tasks. This value is deprecated and should not be used.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Only present if the index is a replica. Contains the name of the related primary index.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Only present if the index is a primary index with replicas. Contains the names of all linked replicas.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, createdAt, updatedAt, entries, dataSize, fileSize, lastBuildTimeS, numberOfPendingTask, pendingTask, primary, replicas);
  }
