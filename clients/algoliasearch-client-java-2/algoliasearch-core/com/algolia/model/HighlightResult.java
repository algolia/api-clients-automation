...
public class HighlightResult {
  ...
  public enum MatchLevelEnum {
    ...
    public static class Adapter extends TypeAdapter<MatchLevelEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final MatchLevelEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public MatchLevelEnum read(final JsonReader jsonReader) throws IOException {
  ...
  public static final String SERIALIZED_NAME_FULLY_HIGHLIGHTED = "fullyHighlighted";
  ...
  **/
  ...
  @ApiModelProperty(example = "<em>George</em> <em>Clo</em>oney", value = "Markup text with occurrences highlighted.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates how well the attribute matched the search query.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "List of words from the query that matched the object.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Whether the entire attribute value is highlighted.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.value, highlightResult.value) &&
