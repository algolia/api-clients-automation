...
public class SearchParams {
  ...
  public static final String SERIALIZED_NAME_OPTIONAL_FILTERS = "optionalFilters";
  ...
  public static final String SERIALIZED_NAME_SUM_OR_FILTERS_SCORES = "sumOrFiltersScores";
  ...
  public static final String SERIALIZED_NAME_FACETING_AFTER_DISTINCT = "facetingAfterDistinct";
  ...
  public static final String SERIALIZED_NAME_AROUND_LAT_LNG_VIA_I_P = "aroundLatLngViaIP";
  ...
  public static final String SERIALIZED_NAME_AROUND_PRECISION = "aroundPrecision";
  @SerializedName(SERIALIZED_NAME_AROUND_PRECISION)
  private Integer aroundPrecision = 10;

  public static final String SERIALIZED_NAME_MINIMUM_AROUND_RADIUS = "minimumAroundRadius";
  @SerializedName(SERIALIZED_NAME_MINIMUM_AROUND_RADIUS)
  private Integer minimumAroundRadius;

  public static final String SERIALIZED_NAME_INSIDE_BOUNDING_BOX = "insideBoundingBox";
  ...
  public static final String SERIALIZED_NAME_NATURAL_LANGUAGES = "naturalLanguages";
  ...
  public static final String SERIALIZED_NAME_PERSONALIZATION_IMPACT = "personalizationImpact";
  ...
  public static final String SERIALIZED_NAME_GET_RANKING_INFO = "getRankingInfo";
  ...
  public static final String SERIALIZED_NAME_PERCENTILE_COMPUTATION = "percentileComputation";
  ...
  public static final String SERIALIZED_NAME_ENABLE_RE_RANKING = "enableReRanking";
  ...
  public static final String SERIALIZED_NAME_ATTRIBUTES_FOR_FACETING = "attributesForFaceting";
  @SerializedName(SERIALIZED_NAME_ATTRIBUTES_FOR_FACETING)
  private List<String> attributesForFaceting = null;

  public static final String SERIALIZED_NAME_UNRETRIEVABLE_ATTRIBUTES = "unretrievableAttributes";
  ...
  public static final String SERIALIZED_NAME_RESTRICT_SEARCHABLE_ATTRIBUTES = "restrictSearchableAttributes";
  ...
  public static final String SERIALIZED_NAME_RELEVANCY_STRICTNESS = "relevancyStrictness";
  ...
  public static final String SERIALIZED_NAME_ATTRIBUTES_TO_SNIPPET = "attributesToSnippet";
  ...
  public static final String SERIALIZED_NAME_SNIPPET_ELLIPSIS_TEXT = "snippetEllipsisText";
  @SerializedName(SERIALIZED_NAME_SNIPPET_ELLIPSIS_TEXT)
  private String snippetEllipsisText = "…";

  public static final String SERIALIZED_NAME_RESTRICT_HIGHLIGHT_AND_SNIPPET_ARRAYS = "restrictHighlightAndSnippetArrays";
  ...
  public static final String SERIALIZED_NAME_MIN_WORD_SIZEFOR1_TYPO = "minWordSizefor1Typo";
  @SerializedName(SERIALIZED_NAME_MIN_WORD_SIZEFOR1_TYPO)
  private Integer minWordSizefor1Typo = 4;

  public static final String SERIALIZED_NAME_MIN_WORD_SIZEFOR2_TYPOS = "minWordSizefor2Typos";
  ...
  public static final String SERIALIZED_NAME_ALLOW_TYPOS_ON_NUMERIC_TOKENS = "allowTyposOnNumericTokens";
  @SerializedName(SERIALIZED_NAME_ALLOW_TYPOS_ON_NUMERIC_TOKENS)
  private Boolean allowTyposOnNumericTokens = true;

  public static final String SERIALIZED_NAME_DISABLE_TYPO_TOLERANCE_ON_ATTRIBUTES = "disableTypoToleranceOnAttributes";
  ...
  public static final String SERIALIZED_NAME_SEPARATORS_TO_INDEX = "separatorsToIndex";
  ...
  public static final String SERIALIZED_NAME_REMOVE_STOP_WORDS = "removeStopWords";
  @SerializedName(SERIALIZED_NAME_REMOVE_STOP_WORDS)
  private String removeStopWords = "false";

  public static final String SERIALIZED_NAME_KEEP_DIACRITICS_ON_CHARACTERS = "keepDiacriticsOnCharacters";
  ...
  public static final String SERIALIZED_NAME_DECOMPOUND_QUERY = "decompoundQuery";
  ...
  public static final String SERIALIZED_NAME_ENABLE_PERSONALIZATION = "enablePersonalization";
  ...
  public enum RemoveWordsIfNoResultsEnum {
    ...
    public static class Adapter extends TypeAdapter<RemoveWordsIfNoResultsEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final RemoveWordsIfNoResultsEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public RemoveWordsIfNoResultsEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
  ...
  public static final String SERIALIZED_NAME_REMOVE_WORDS_IF_NO_RESULTS = "removeWordsIfNoResults";
  @SerializedName(SERIALIZED_NAME_REMOVE_WORDS_IF_NO_RESULTS)
  private RemoveWordsIfNoResultsEnum removeWordsIfNoResults = RemoveWordsIfNoResultsEnum.NONE;
  ...
  public static final String SERIALIZED_NAME_DISABLE_EXACT_ON_ATTRIBUTES = "disableExactOnAttributes";
  ...
  public enum ExactOnSingleWordQueryEnum {
    ...
    public static class Adapter extends TypeAdapter<ExactOnSingleWordQueryEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final ExactOnSingleWordQueryEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public ExactOnSingleWordQueryEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
  ...
  public static final String SERIALIZED_NAME_EXACT_ON_SINGLE_WORD_QUERY = "exactOnSingleWordQuery";
  @SerializedName(SERIALIZED_NAME_EXACT_ON_SINGLE_WORD_QUERY)
  private ExactOnSingleWordQueryEnum exactOnSingleWordQuery = ExactOnSingleWordQueryEnum.ATTRIBUTE;
  ...
  public enum AlternativesAsExactEnum {
    ...
    public static class Adapter extends TypeAdapter<AlternativesAsExactEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final AlternativesAsExactEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public AlternativesAsExactEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
  ...
  public static final String SERIALIZED_NAME_ALTERNATIVES_AS_EXACT = "alternativesAsExact";
  ...
  public enum AdvancedSyntaxFeaturesEnum {
    ...
    public static class Adapter extends TypeAdapter<AdvancedSyntaxFeaturesEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final AdvancedSyntaxFeaturesEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public AdvancedSyntaxFeaturesEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
  ...
  public static final String SERIALIZED_NAME_ADVANCED_SYNTAX_FEATURES = "advancedSyntaxFeatures";
  ...
  public static final String SERIALIZED_NAME_REPLACE_SYNONYMS_IN_HIGHLIGHT = "replaceSynonymsInHighlight";
  ...
  public static final String SERIALIZED_NAME_ATTRIBUTE_CRITERIA_COMPUTED_BY_MIN_PROXIMITY = "attributeCriteriaComputedByMinProximity";
  ...
  **/
  ...
  @ApiModelProperty(value = "Overrides the query parameter and performs a more generic search that can be used to find \"similar\" results.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Filter the query with numeric, facet and/or tag filters.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Create filters for ranking purposes, where records that match the filter are ranked higher, or lower in the case of a negative optional filter.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Determines how to calculate the total score for filtering.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Maximum number of facet values to return for each facet during a regular search.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Force faceting to be applied after de-duplication (via the Distinct setting).")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Set the number of hits to retrieve (used only with offset).")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Search for entries around a central geolocation, enabling a geo search within a circular area.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Search for entries around a given location automatically computed from the requester’s IP address.")
  ...
  public SearchParams aroundRadius(Integer aroundRadius) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Define the maximum radius for a geo search (in meters).")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Precision of geo search (in meters), to add grouping by geo location to the ranking formula.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Minimum radius (in meters) used for a geo search when aroundRadius is not set.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Search inside a rectangular area (in geo coordinates).")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "This parameter changes the default values of certain parameters and settings that work best for a natural language query, such as ignorePlurals, removeStopWords, removeWordsIfNoResults, analyticsTags and ruleContexts. These parameters and settings work well together when the query is formatted in natural language instead of keywords, for example when your user performs a voice search.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Associates a certain user token with the current search.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Whether the current query will be taken into account in the Analytics.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "List of tags to apply to the query for analytics purposes.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Whether to include or exclude a query from the processing-time percentile computation.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Whether this search should participate in running AB tests.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The complete list of attributes used for searching.")
  ...
  public SearchParams attributesForFaceting(List<String> attributesForFaceting) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The complete list of attributes that will be used for faceting.")
  ...
  public SearchParams unretrievableAttributes(List<String> unretrievableAttributes) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "List of attributes that can’t be retrieved at query time.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "This parameter controls which attributes to retrieve and which not to retrieve.")
  ...
  public SearchParams restrictSearchableAttributes(List<String> restrictSearchableAttributes) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Restricts a given query to look in only a subset of your searchable attributes.")
  ...
  public void setRestrictSearchableAttributes(List<String> restrictSearchableAttributes) {
    this.restrictSearchableAttributes = restrictSearchableAttributes;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Controls the relevancy threshold below which less relevant results aren’t included in the results.")
  ...
  public SearchParams attributesToHighlight(List<String> attributesToHighlight) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "List of attributes to snippet, with an optional maximum number of words to snippet.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The HTML string to insert before the highlighted parts in all highlight and snippet results.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The HTML string to insert after the highlighted parts in all highlight and snippet results.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "String used as an ellipsis indicator when a snippet is truncated.")
  ...
  public SearchParams restrictHighlightAndSnippetArrays(Boolean restrictHighlightAndSnippetArrays) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Restrict highlighting and snippeting to items that matched the query.")
  ...
  public void setRestrictHighlightAndSnippetArrays(Boolean restrictHighlightAndSnippetArrays) {
    this.restrictHighlightAndSnippetArrays = restrictHighlightAndSnippetArrays;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Minimum number of characters a word in the query string must contain to accept matches with 1 typo.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Minimum number of characters a word in the query string must contain to accept matches with 2 typos.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Controls whether typo tolerance is enabled and how it is applied.")
  ...
  public SearchParams allowTyposOnNumericTokens(Boolean allowTyposOnNumericTokens) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Whether to allow typos on numbers (“numeric tokens”) in the query string.")
  ...
  public SearchParams disableTypoToleranceOnAttributes(List<String> disableTypoToleranceOnAttributes) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "List of attributes on which you want to disable typo tolerance.")
  ...
  public void setDisableTypoToleranceOnAttributes(List<String> disableTypoToleranceOnAttributes) {
    this.disableTypoToleranceOnAttributes = disableTypoToleranceOnAttributes;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Removes stop (common) words from the query before executing it.")
  ...
  public SearchParams keepDiacriticsOnCharacters(String keepDiacriticsOnCharacters) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Sets the languages to be used by language-specific settings and functionalities such as ignorePlurals, removeStopWords, and CJK word-detection.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Splits compound words into their composing atoms in the query.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Controls if and how query words are interpreted as prefixes.")
  ...
  public SearchParams removeWordsIfNoResults(RemoveWordsIfNoResultsEnum removeWordsIfNoResults) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Selects a strategy to remove words from the query when it doesn’t match any hits.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A list of words that should be considered as optional when found in the query.")
  ...
  public SearchParams disableExactOnAttributes(List<String> disableExactOnAttributes) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "List of attributes on which you want to disable the exact ranking criterion.")
  ...
  public void setDisableExactOnAttributes(List<String> disableExactOnAttributes) {
    this.disableExactOnAttributes = disableExactOnAttributes;
  }


  public SearchParams exactOnSingleWordQuery(ExactOnSingleWordQueryEnum exactOnSingleWordQuery) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Controls how the exact ranking criterion is computed when the query contains only one word.")
  ...
  public void setExactOnSingleWordQuery(ExactOnSingleWordQueryEnum exactOnSingleWordQuery) {
    this.exactOnSingleWordQuery = exactOnSingleWordQuery;
  }


  public SearchParams alternativesAsExact(List<AlternativesAsExactEnum> alternativesAsExact) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "List of alternatives that should be considered an exact match by the exact ranking criterion.")
  ...
  public void setAlternativesAsExact(List<AlternativesAsExactEnum> alternativesAsExact) {
    this.alternativesAsExact = alternativesAsExact;
  }


  public SearchParams advancedSyntaxFeatures(List<AdvancedSyntaxFeaturesEnum> advancedSyntaxFeatures) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Allows you to specify which advanced syntax features are active when ‘advancedSyntax’ is enabled.")
  ...
  public void setAdvancedSyntaxFeatures(List<AdvancedSyntaxFeaturesEnum> advancedSyntaxFeatures) {
    this.advancedSyntaxFeatures = advancedSyntaxFeatures;
  }
  ...
  **/
  ...
  public SearchParams replaceSynonymsInHighlight(Boolean replaceSynonymsInHighlight) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Whether to highlight and snippet the original word that matches the synonym or the synonym itself.")
  ...
  public void setReplaceSynonymsInHighlight(Boolean replaceSynonymsInHighlight) {
    this.replaceSynonymsInHighlight = replaceSynonymsInHighlight;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Choose which fields to return in the API response. This parameters applies to search and browse queries.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Maximum number of facet hits to return during a search for facet values.")
  ...
  public SearchParams attributeCriteriaComputedByMinProximity(Boolean attributeCriteriaComputedByMinProximity) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "When attribute is ranked above proximity in your ranking formula, proximity is used to select which searchable attribute is matched in the attribute ranking stage.")
  ...
  public void setAttributeCriteriaComputedByMinProximity(Boolean attributeCriteriaComputedByMinProximity) {
    this.attributeCriteriaComputedByMinProximity = attributeCriteriaComputedByMinProximity;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Content defining how the search interface should be rendered. Can be set via the settings for a default value and can be overridden via rules.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.query, searchParams.query) &&
        ...
        Objects.equals(this.searchableAttributes, searchParams.searchableAttributes) &&
        Objects.equals(this.attributesForFaceting, searchParams.attributesForFaceting) &&
        Objects.equals(this.unretrievableAttributes, searchParams.unretrievableAttributes) &&
