...
public class RankingInfo {
  ...
  public static final String SERIALIZED_NAME_FIRST_MATCHED_WORD = "firstMatchedWord";
  ...
  public static final String SERIALIZED_NAME_MATCHED_GEO_LOCATION = "matchedGeoLocation";
  ...
  public static final String SERIALIZED_NAME_PROXIMITY_DISTANCE = "proximityDistance";
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Position of the most important matched attribute in the attributes to index list.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Distance between the geo location in the search query and the best matching geo location in the record, divided by the geo precision (in meters).")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Precision used when computing the geo distance, in meters.")
  ...
  public RankingInfo matchedGeoLocation(Map<String, RankingInfoMatchedGeoLocation> matchedGeoLocation) {
  ...
  **/
  ...
  public void setMatchedGeoLocation(Map<String, RankingInfoMatchedGeoLocation> matchedGeoLocation) {
    this.matchedGeoLocation = matchedGeoLocation;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Number of typos encountered when matching the record.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Present and set to true if a Rule promoted the hit.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "When the query contains more than one word, the sum of the distances between matched words (in meters).")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Custom ranking for the object, expressed as a single integer value.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Number of matched words, including prefixes and typos.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.filters, rankingInfo.filters) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(filters, firstMatchedWord, geoDistance, geoPrecision, matchedGeoLocation, nbExactWords, nbTypos, promoted, proximityDistance, userScore, word);
  }
