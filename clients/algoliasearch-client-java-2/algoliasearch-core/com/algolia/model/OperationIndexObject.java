...
public class OperationIndexObject {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Type of operation to perform (move or copy).")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "products", required = true, value = "The Algolia index name.")
  ...
  **/
  ...
  @ApiModelProperty(value = "Scope of the data to copy. When absent, a full copy is performed. When present, only the selected scopes are copied.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.operation, operationIndexObject.operation) &&
