...
public class BaseSearchResponse {
  ...
  public static final String SERIALIZED_NAME_AB_TEST_VARIANT_I_D = "abTestVariantID";
  ...
  public static final String SERIALIZED_NAME_AUTOMATIC_RADIUS = "automaticRadius";
  @SerializedName(SERIALIZED_NAME_AUTOMATIC_RADIUS)
  private String automaticRadius;

  public static final String SERIALIZED_NAME_EXHAUSTIVE_FACETS_COUNT = "exhaustiveFacetsCount";
  @SerializedName(SERIALIZED_NAME_EXHAUSTIVE_FACETS_COUNT)
  private Boolean exhaustiveFacetsCount;

  public static final String SERIALIZED_NAME_EXHAUSTIVE_NB_HITS = "exhaustiveNbHits";
  ...
  public static final String SERIALIZED_NAME_PROCESSING_TIME_M_S = "processingTimeMS";
  ...
  public static final String SERIALIZED_NAME_QUERY_AFTER_REMOVAL = "queryAfterRemoval";
  ...
  **/
  ...
  @ApiModelProperty(value = "If a search encounters an index that is being A/B tested, abTestID reports the ongoing A/B test ID.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "If a search encounters an index that is being A/B tested, abTestVariantID reports the variant ID of the index used.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The automatically computed radius. For legacy reasons, this parameter is a string and not an integer.")
  ...
  public BaseSearchResponse exhaustiveFacetsCount(Boolean exhaustiveFacetsCount) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Whether the facet count is exhaustive or approximate.")
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Indicate if the nbHits count was exhaustive or approximate")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Indicate if the typo-tolerence search was exhaustive or approximate (only included when typo-tolerance is enabled)")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "{\"category\":{\"food\":1,\"tech\":42}}", value = "A mapping of each facet name to the corresponding facet counts.")
  ...
  public BaseSearchResponse facetsStats(Map<String, BaseSearchResponseFacetsStats> facetsStats) {
  ...
  **/
  ...
  public void setFacetsStats(Map<String, BaseSearchResponseFacetsStats> facetsStats) {
    this.facetsStats = facetsStats;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "indexName", value = "Index name used for the query.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "indexNameAlt", value = "Index name used for the query. In the case of an A/B test, the targeted index isn’t always the index used by the query.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "20", required = true, value = "Number of hits that the search query matched")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "1", required = true, value = "Number of pages available for the current query")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "20", value = "The number of hits selected and sorted by the relevant sort algorithm")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "query=a&hitsPerPage=20", required = true, value = "A url-encoded string of all search parameters.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The query string that will be searched, after normalization.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "20", required = true, value = "Time the server took to process the request, in milliseconds.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A markup text indicating which parts of the original query have been removed in order to retrieve a non-empty result set.")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.abTestID, baseSearchResponse.abTestID) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(abTestID, abTestVariantID, aroundLatLng, automaticRadius, exhaustiveFacetsCount, exhaustiveNbHits, exhaustiveTypo, facets, facetsStats, hitsPerPage, index, indexUsed, message, nbHits, nbPages, nbSortedHits, page, params, parsedQuery, processingTimeMS, query, queryAfterRemoval, serverUsed, userData);
  }
