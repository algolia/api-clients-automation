...
public class ApiClient {
  ...
  public ApiClient(String[] authNames) {
    ...
    for (String authName : authNames) {
      ...
      if ("apiKey".equals(authName)) {
        auth = new ApiKeyAuth("header", "X-Algolia-API-Key");
      } else if ("appId".equals(authName)) {
        auth = new ApiKeyAuth("header", "X-Algolia-Application-Id");
      } else {
  ...
  public void setApiAuthorizations(
    Map<String, RequestInterceptor> apiAuthorizations
  ) {
  ...
  public String selectHeaderAccept(String[] accepts) {
    ...
    if (
      StringUtil.containsIgnoreCase(accepts, "application/json")
  ...
  public String selectHeaderContentType(String[] contentTypes) {
    ...
    if (
      StringUtil.containsIgnoreCase(contentTypes, "application/json")
    ) return "application/json";
  ...
  private <T extends RequestInterceptor> T getAuthorization(Class<T> type) {
    return (T) apiAuthorizations
      .values()
      .stream()
      .filter(requestInterceptor ->
        type.isAssignableFrom(requestInterceptor.getClass())
      )
      .findFirst()
      .orElseThrow(() ->
