...
public class ApiClient {
  ...
  public ApiClient() {
    ...
    authentications.put(
      "apiKey",
      new ApiKeyAuth("header", "X-Algolia-API-Key")
    );
    authentications.put(
      "appId",
      new ApiKeyAuth("header", "X-Algolia-Application-Id")
    );
  ...
  public File prepareDownloadFile(Response response) throws IOException {
    ...
    if (tempFolderPath == null) return Files
      .createTempFile(prefix, suffix)
      .toFile(); else return Files
      .createTempFile(Paths.get(tempFolderPath), prefix, suffix)
      .toFile();
  }
