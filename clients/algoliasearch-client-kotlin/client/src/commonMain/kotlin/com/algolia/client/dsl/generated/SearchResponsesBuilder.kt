...
public class SearchResponsesBuilder {
  public var results: List<SearchResult>? = null

  internal fun build(): SearchResponses =
    SearchResponses(results = requireNotNull(results) { "SearchResponses.results is required" })
}
