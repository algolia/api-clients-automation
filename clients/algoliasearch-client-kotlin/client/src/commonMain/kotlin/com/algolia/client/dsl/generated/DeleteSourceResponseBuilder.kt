...
public class DeleteSourceResponseBuilder {
  public var deletedAt: String? = null

  internal fun build(): DeleteSourceResponse =
    DeleteSourceResponse(
      deletedAt = requireNotNull(deletedAt) { "DeleteSourceResponse.deletedAt is required" }
    )
}
