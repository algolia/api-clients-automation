...
public class DeleteApiKeyResponseBuilder {
  public var deletedAt: String? = null

  internal fun build(): DeleteApiKeyResponse =
    DeleteApiKeyResponse(
      deletedAt = requireNotNull(deletedAt) { "DeleteApiKeyResponse.deletedAt is required" }
    )
}
