...
public class DictionaryLanguageBuilder {
  public var nbCustomEntries: Int? = null

  internal fun build(): DictionaryLanguage = DictionaryLanguage(nbCustomEntries = nbCustomEntries)
}
