...
public class ConsequenceRedirectBuilder {
  public var indexName: String? = null

  internal fun build(): ConsequenceRedirect =
    ConsequenceRedirect(
      indexName = requireNotNull(indexName) { "ConsequenceRedirect.indexName is required" }
    )
}
