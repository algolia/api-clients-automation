...
public class ListClustersResponseBuilder {
  public var topUsers: List<String>? = null

  internal fun build(): ListClustersResponse =
    ListClustersResponse(
      topUsers = requireNotNull(topUsers) { "ListClustersResponse.topUsers is required" }
    )
}
