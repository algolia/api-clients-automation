...
public class BatchWriteParamsBuilder {
  public var requests: List<BatchRequest>? = null

  internal fun build(): BatchWriteParams =
    BatchWriteParams(
      requests = requireNotNull(requests) { "BatchWriteParams.requests is required" }
    )
}
