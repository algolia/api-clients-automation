...
public class RemoveUserIdResponseBuilder {
  public var deletedAt: String? = null

  internal fun build(): RemoveUserIdResponse =
    RemoveUserIdResponse(
      deletedAt = requireNotNull(deletedAt) { "RemoveUserIdResponse.deletedAt is required" }
    )
}
