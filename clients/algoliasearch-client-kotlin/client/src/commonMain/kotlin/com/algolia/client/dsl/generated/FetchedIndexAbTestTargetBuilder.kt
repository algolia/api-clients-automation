...
public class FetchedIndexAbTestTargetBuilder {
  public var indexName: String? = null

  internal fun build(): FetchedIndexAbTestTarget =
    FetchedIndexAbTestTarget(
      indexName = requireNotNull(indexName) { "FetchedIndexAbTestTarget.indexName is required" }
    )
}
