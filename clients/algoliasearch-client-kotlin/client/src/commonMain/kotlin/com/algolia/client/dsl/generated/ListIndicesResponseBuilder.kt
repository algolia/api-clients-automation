...
public class ListIndicesResponseBuilder {
  public var items: List<FetchedIndex>? = null
  public var nbPages: Int? = null

  internal fun build(): ListIndicesResponse =
    ListIndicesResponse(
      items = requireNotNull(items) { "ListIndicesResponse.items is required" },
      nbPages = nbPages,
    )
}
