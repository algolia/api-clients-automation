...
@Serializable
public enum class InstantSearchTelemetryEvent(public val value: kotlin.String) {

  @SerialName(value = "instantsearch_telemetry") InstantsearchTelemetry("instantsearch_telemetry");
