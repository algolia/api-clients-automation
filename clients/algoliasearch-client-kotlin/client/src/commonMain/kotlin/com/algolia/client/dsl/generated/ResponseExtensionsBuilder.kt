...
public class ResponseExtensionsBuilder {
  public var queryCategorization: QueryCategorization? = null

  internal fun build(): ResponseExtensions =
    ResponseExtensions(queryCategorization = queryCategorization)
}
