 ...
 * @param injectedItems A list of injected objectIDs into an external source.
 */
@Serializable
public data class Params(
  ...
  @SerialName(value = "injectedItems") val injectedItems: List<ExternalInjectedItem>? = null,
)
