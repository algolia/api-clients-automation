...
public class ConsequenceHideBuilder {
  public var objectID: String? = null

  internal fun build(): ConsequenceHide =
    ConsequenceHide(objectID = requireNotNull(objectID) { "ConsequenceHide.objectID is required" })
}
