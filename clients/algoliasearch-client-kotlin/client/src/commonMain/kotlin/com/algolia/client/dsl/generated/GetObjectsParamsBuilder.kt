...
public class GetObjectsParamsBuilder {
  public var requests: List<GetObjectsRequest>? = null

  internal fun build(): GetObjectsParams =
    GetObjectsParams(
      requests = requireNotNull(requests) { "GetObjectsParams.requests is required" }
    )
}
