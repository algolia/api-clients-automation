...
public class GetTopUserIdsResponseBuilder {
  public var topUsers: List<Map<kotlin.String, List<UserId>>>? = null

  internal fun build(): GetTopUserIdsResponse =
    GetTopUserIdsResponse(
      topUsers = requireNotNull(topUsers) { "GetTopUserIdsResponse.topUsers is required" }
    )
}
