...
) : AlgoliaRuntimeException("Error(s) while processing the retry strategy. If the error persists, please visit our help center <SUPPORT_LINK_HERE> or reach out to the Algolia Support team: https://alg.li/support.", exceptions.last())
