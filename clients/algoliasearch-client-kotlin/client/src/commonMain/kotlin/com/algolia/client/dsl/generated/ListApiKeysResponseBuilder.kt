...
public class ListApiKeysResponseBuilder {
  public var keys: List<GetApiKeyResponse>? = null

  internal fun build(): ListApiKeysResponse =
    ListApiKeysResponse(keys = requireNotNull(keys) { "ListApiKeysResponse.keys is required" })
}
