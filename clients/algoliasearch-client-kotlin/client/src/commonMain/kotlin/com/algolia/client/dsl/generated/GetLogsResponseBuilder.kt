...
public class GetLogsResponseBuilder {
  public var logs: List<Log>? = null

  internal fun build(): GetLogsResponse =
    GetLogsResponse(logs = requireNotNull(logs) { "GetLogsResponse.logs is required" })
}
