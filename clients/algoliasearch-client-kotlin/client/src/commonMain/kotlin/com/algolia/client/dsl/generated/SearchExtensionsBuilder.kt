...
public class SearchExtensionsBuilder {
  public var queryCategorization: SearchExtensionsQueryCategorization? = null

  internal fun build(): SearchExtensions =
    SearchExtensions(queryCategorization = queryCategorization)
}
