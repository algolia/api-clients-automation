...
/*
 * The fixture index is frozen: every server-contract row (L01–L53, D1–D2) was computed against
 * exactly these settings, records and rule. Changing any of them requires recomputing every row.
 *
 ...
 * `desktop`, so it cannot affect any other row.
 */
