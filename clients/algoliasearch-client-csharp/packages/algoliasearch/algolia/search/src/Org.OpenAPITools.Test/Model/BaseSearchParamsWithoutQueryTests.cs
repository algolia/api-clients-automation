...
{
  /// <summary>
  ///  Class for testing BaseSearchParamsWithoutQuery
  /// </summary>
  /// <remarks>
  /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
  /// Please update the test case below to test the model.
  /// </remarks>
  public class BaseSearchParamsWithoutQueryTests : IDisposable
  {
    // TODO uncomment below to declare an instance variable for BaseSearchParamsWithoutQuery
    //private BaseSearchParamsWithoutQuery instance;

    public BaseSearchParamsWithoutQueryTests()
    {
      // TODO uncomment below to create an instance of BaseSearchParamsWithoutQuery
      //instance = new BaseSearchParamsWithoutQuery();
    }
    ...
    /// <summary>
    /// Test an instance of BaseSearchParamsWithoutQuery
    /// </summary>
    [Fact]
    public void BaseSearchParamsWithoutQueryInstanceTest()
    {
      // TODO uncomment below to test "IsType" BaseSearchParamsWithoutQuery
      //Assert.IsType<BaseSearchParamsWithoutQuery>(instance);
    }
