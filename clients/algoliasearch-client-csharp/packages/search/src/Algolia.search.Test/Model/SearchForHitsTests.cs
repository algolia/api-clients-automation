...
{
  /// <summary>
  ///  Class for testing SearchForHits
  /// </summary>
  /// <remarks>
  /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
  /// Please update the test case below to test the model.
  /// </remarks>
  public class SearchForHitsTests : IDisposable
  {
    // TODO uncomment below to declare an instance variable for SearchForHits
    //private SearchForHits instance;

    public SearchForHitsTests()
    {
      // TODO uncomment below to create an instance of SearchForHits
      //instance = new SearchForHits();
    }
    ...
    /// <summary>
    /// Test an instance of SearchForHits
    /// </summary>
    [Fact]
    public void SearchForHitsInstanceTest()
    {
      // TODO uncomment below to test "IsType" SearchForHits
      //Assert.IsType<SearchForHits>(instance);
    }
