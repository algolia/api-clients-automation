...
{
  /// <summary>
  ///  Class for testing IndexSettings
  /// </summary>
  /// <remarks>
  /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
  /// Please update the test case below to test the model.
  /// </remarks>
  public class IndexSettingsTests : IDisposable
  {
    // TODO uncomment below to declare an instance variable for IndexSettings
    //private IndexSettings instance;

    public IndexSettingsTests()
    {
      // TODO uncomment below to create an instance of IndexSettings
      //instance = new IndexSettings();
    }
    ...
    /// <summary>
    /// Test an instance of IndexSettings
    /// </summary>
    [Fact]
    public void IndexSettingsInstanceTest()
    {
      // TODO uncomment below to test "IsType" IndexSettings
      //Assert.IsType<IndexSettings>(instance);
    }
