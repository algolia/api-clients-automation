...
{
  /// <summary>
  ///  Class for testing SearchParamsObject
  /// </summary>
  /// <remarks>
  /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
  /// Please update the test case below to test the model.
  /// </remarks>
  public class SearchParamsObjectTests : IDisposable
  {
    // TODO uncomment below to declare an instance variable for SearchParamsObject
    //private SearchParamsObject instance;

    public SearchParamsObjectTests()
    {
      // TODO uncomment below to create an instance of SearchParamsObject
      //instance = new SearchParamsObject();
    }
    ...
    /// <summary>
    /// Test an instance of SearchParamsObject
    /// </summary>
    [Fact]
    public void SearchParamsObjectInstanceTest()
    {
      // TODO uncomment below to test "IsType" SearchParamsObject
      //Assert.IsType<SearchParamsObject>(instance);
    }
