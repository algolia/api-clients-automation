...
{
  /// <summary>
  ///  Class for testing BrowseParams
  /// </summary>
  /// <remarks>
  /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
  /// Please update the test case below to test the model.
  /// </remarks>
  public class BrowseParamsTests : IDisposable
  {
    // TODO uncomment below to declare an instance variable for BrowseParams
    //private BrowseParams instance;

    public BrowseParamsTests()
    {
      // TODO uncomment below to create an instance of BrowseParams
      //instance = new BrowseParams();
    }
    ...
    /// <summary>
    /// Test an instance of BrowseParams
    /// </summary>
    [Fact]
    public void BrowseParamsInstanceTest()
    {
      // TODO uncomment below to test "IsType" BrowseParams
      //Assert.IsType<BrowseParams>(instance);
    }
