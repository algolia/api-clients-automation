...
{
  /// <summary>
  ///  Class for testing BaseSearchResponse
  /// </summary>
  /// <remarks>
  /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
  /// Please update the test case below to test the model.
  /// </remarks>
  public class BaseSearchResponseTests : IDisposable
  {
    // TODO uncomment below to declare an instance variable for BaseSearchResponse
    //private BaseSearchResponse instance;

    public BaseSearchResponseTests()
    {
      // TODO uncomment below to create an instance of BaseSearchResponse
      //instance = new BaseSearchResponse();
    }
    ...
    /// <summary>
    /// Test an instance of BaseSearchResponse
    /// </summary>
    [Fact]
    public void BaseSearchResponseInstanceTest()
    {
      // TODO uncomment below to test "IsType" BaseSearchResponse
      //Assert.IsType<BaseSearchResponse>(instance);
    }
