...
internal class HttpTransport
{
    ...
    where TData : class
  {
    ...
    throw new AlgoliaUnreachableHostException(
      "RetryStrategy failed to connect to Algolia. If the error persists, please visit our help center <SUPPORT_LINK_HERE> or reach out to the Algolia Support team: https://alg.li/support. Reason: " + _errorMessage
    );
  }
