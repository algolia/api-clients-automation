...
/// </summary>
public partial class SearchParametersInput
{
  /// <summary>
  ...
  /// <summary>
  /// Initializes a new instance of the SearchParametersInput class.
  /// </summary>
  public SearchParametersInput() { }
  ...
  public FacetFiltersInputUnion FacetFilters { get; set; }
  ...
  {
    if (obj is not SearchParametersInput input)
    {
      return false;
    }
