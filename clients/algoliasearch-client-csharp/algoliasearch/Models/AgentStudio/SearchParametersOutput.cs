...
/// </summary>
public partial class SearchParametersOutput
{
  /// <summary>
  ...
  /// <summary>
  /// Initializes a new instance of the SearchParametersOutput class.
  /// </summary>
  public SearchParametersOutput() { }
  ...
  public TypoToleranceUnionSearchParametersOutput TypoTolerance { get; set; }
  ...
  public FacetFiltersOutputUnion FacetFilters { get; set; }
  ...
  public RemoveStopWordsUnionSearchParametersOutput RemoveStopWords { get; set; }

  /// <summary>
  /// Gets or Sets IgnorePlurals
  /// </summary>
  [JsonPropertyName("ignorePlurals")]
  public IgnorePluralsUnionSearchParametersOutput IgnorePlurals { get; set; }
  ...
  {
    if (obj is not SearchParametersOutput input)
    {
      return false;
    }
