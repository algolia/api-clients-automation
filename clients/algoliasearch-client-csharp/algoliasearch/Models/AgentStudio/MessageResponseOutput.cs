...
/// </summary>
public partial class MessageResponseOutput
{
  /// <summary>
  /// Gets or Sets Role
  /// </summary>
  ...
  /// <summary>
  /// Initializes a new instance of the MessageResponseOutput class.
  /// </summary>
  [JsonConstructor]
  public MessageResponseOutput() { }
  ...
  {
    if (obj is not MessageResponseOutput input)
    {
      return false;
    }
