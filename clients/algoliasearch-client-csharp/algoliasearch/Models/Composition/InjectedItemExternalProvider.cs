...
/// </summary>
public partial class InjectedItemExternalProvider
{
  /// <summary>
  ...
  /// <summary>
  /// Initializes a new instance of the InjectedItemExternalProvider class.
  /// </summary>
  [JsonConstructor]
  ...
  public InjectedItemExternalProvider(string index, string configurationID)
  {
  ...
  public override string ToString()
  {
    ...
    sb.Append("class InjectedItemExternalProvider {\n");
  ...
  {
    if (obj is not InjectedItemExternalProvider input)
    {
      return false;
    }
