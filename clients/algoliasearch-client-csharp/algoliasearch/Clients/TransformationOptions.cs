...
public class TransformationOptions
{
  ...
  /// <summary>
  /// Override how many times a 429 is waited out on the same host for the ingestion transporter.
  /// Defaults to the parent client's <see cref="AlgoliaConfig.MaxRateLimitRetries"/>.
  /// </summary>
