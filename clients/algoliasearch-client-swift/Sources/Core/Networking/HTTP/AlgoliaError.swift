...
public enum AlgoliaError: Error, LocalizedError {
    ...
    public var errorDescription: String? {
        ...
        case let .noReachableHosts(errors, exposeIntermediateErrors):
            "All hosts are unreachable. If the error persists, please visit our help center <SUPPORT_LINK_HERE> or reach out to the Algolia Support team: https://alg.li/support. " +
                (
