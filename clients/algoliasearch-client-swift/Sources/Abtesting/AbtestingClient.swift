...
open class AbtestingClient {
    ...
    /// - returns: ScheduledABTestResponse
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open func scheduleABTest(
        scheduleABTestsRequest: ScheduleABTestsRequest,
        requestOptions: RequestOptions? = nil
    ) async throws -> ScheduledABTestResponse {
        let response: Response<ScheduledABTestResponse> = try await scheduleABTestWithHTTPInfo(
            scheduleABTestsRequest: scheduleABTestsRequest,
            requestOptions: requestOptions
        )
    ...
    //
    // - parameter scheduleABTestsRequest: (body)
    // - returns: RequestBuilder<ScheduledABTestResponse>

    open func scheduleABTestWithHTTPInfo(
        scheduleABTestsRequest: ScheduleABTestsRequest,
        requestOptions userRequestOptions: RequestOptions? = nil
    ) async throws -> Response<ScheduledABTestResponse> {
