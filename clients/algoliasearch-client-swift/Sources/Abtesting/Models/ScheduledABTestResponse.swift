...
public struct ScheduledABTestResponse: Codable, JSONEncodable {
...
extension ScheduledABTestResponse: Equatable {
    public static func ==(lhs: ScheduledABTestResponse, rhs: ScheduledABTestResponse) -> Bool {
        lhs.abTestScheduleID == rhs.abTestScheduleID
    }
}

extension ScheduledABTestResponse: Hashable {
