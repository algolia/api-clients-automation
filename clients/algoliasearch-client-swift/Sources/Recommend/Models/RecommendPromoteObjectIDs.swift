...
/// Records to promote.
public struct RecommendPromoteObjectIDs: Codable, JSONEncodable, Hashable {
    ...
    public static func ==(lhs: RecommendPromoteObjectIDs, rhs: RecommendPromoteObjectIDs) -> Bool {
