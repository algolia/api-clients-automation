...
public struct RecommendBaseSearchParams: Codable, JSONEncodable, Hashable {
    /// Search query.
    ...
    public static func ==(lhs: RecommendBaseSearchParams, rhs: RecommendBaseSearchParams) -> Bool {
        lhs.query == rhs.query &&
