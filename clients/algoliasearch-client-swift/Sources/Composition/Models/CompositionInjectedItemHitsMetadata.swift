...
public struct CompositionInjectedItemHitsMetadata: Codable, JSONEncodable {
...
extension CompositionInjectedItemHitsMetadata: Equatable {
    public static func ==(lhs: CompositionInjectedItemHitsMetadata, rhs: CompositionInjectedItemHitsMetadata) -> Bool {
        lhs.addItemKey == rhs.addItemKey &&
            lhs.extra == rhs.extra
    }
}

extension CompositionInjectedItemHitsMetadata: Hashable {
