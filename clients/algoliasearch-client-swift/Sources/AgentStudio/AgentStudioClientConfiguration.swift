...
public struct AgentStudioClientConfiguration: BaseConfiguration, Credentials {
    ...
    public init(
        ...
        UserAgentController.append(UserAgent(title: "AgentStudio", version: Version.current.description))
        ...
        guard let hosts else {
            ...
            guard let url = URL(string: "https://agent-studio.{region}.algolia.com".replacingOccurrences(
                of: "{region}",
