...
public struct SearchParametersOutput: Codable, JSONEncodable {
    ...
    public var typoTolerance: TypoToleranceUnionSearchParametersOutput?
    ...
    public var facetFilters: FacetFiltersOutputUnion?
    ...
    public var removeStopWords: RemoveStopWordsUnionSearchParametersOutput?
    public var ignorePlurals: IgnorePluralsUnionSearchParametersOutput?
    ...
    public init(
        ...
        typoTolerance: TypoToleranceUnionSearchParametersOutput? = nil,
        ...
        filters: String? = nil,
        facetFilters: FacetFiltersOutputUnion? = nil,
        ...
        removeStopWords: RemoveStopWordsUnionSearchParametersOutput? = nil,
        ignorePlurals: IgnorePluralsUnionSearchParametersOutput? = nil,
...
extension SearchParametersOutput: Equatable {
    public static func ==(lhs: SearchParametersOutput, rhs: SearchParametersOutput) -> Bool {
...
extension SearchParametersOutput: Hashable {
