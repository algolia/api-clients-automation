...
public struct IndexSearchParametersOutput: Codable, JSONEncodable {
...
extension IndexSearchParametersOutput: Equatable {
    public static func ==(lhs: IndexSearchParametersOutput, rhs: IndexSearchParametersOutput) -> Bool {
        lhs.query == rhs.query &&
...
extension IndexSearchParametersOutput: Hashable {
