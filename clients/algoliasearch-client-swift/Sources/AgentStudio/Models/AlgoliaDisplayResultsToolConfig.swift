...
extension AlgoliaDisplayResultsToolConfig: Equatable {
    public static func ==(lhs: AlgoliaDisplayResultsToolConfig, rhs: AlgoliaDisplayResultsToolConfig) -> Bool {
        lhs.name == rhs.name &&
            lhs.type == rhs.type &&
            lhs.minGroups == rhs.minGroups &&
            lhs.maxGroups == rhs.maxGroups &&
            lhs.minResultsPerGroup == rhs.minResultsPerGroup &&
            lhs.maxResultsPerGroup == rhs.maxResultsPerGroup
    }
}
