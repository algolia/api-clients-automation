...
public struct SearchParametersInput: Codable, JSONEncodable {
    ...
    public var facetFilters: FacetFiltersInputUnion?
    ...
    public init(
        ...
        filters: String? = nil,
        facetFilters: FacetFiltersInputUnion? = nil,
...
extension SearchParametersInput: Equatable {
    public static func ==(lhs: SearchParametersInput, rhs: SearchParametersInput) -> Bool {
...
extension SearchParametersInput: Hashable {
