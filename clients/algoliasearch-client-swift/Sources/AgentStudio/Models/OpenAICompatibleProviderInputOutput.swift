...
public struct OpenAICompatibleProviderInputOutput: Codable, JSONEncodable {
...
extension OpenAICompatibleProviderInputOutput: Equatable {
    public static func ==(lhs: OpenAICompatibleProviderInputOutput, rhs: OpenAICompatibleProviderInputOutput) -> Bool {
...
extension OpenAICompatibleProviderInputOutput: Hashable {
