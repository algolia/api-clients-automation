...
/// Error.
public struct AgentStudioErrorBase: Codable, JSONEncodable {
...
extension AgentStudioErrorBase: Equatable {
    public static func ==(lhs: AgentStudioErrorBase, rhs: AgentStudioErrorBase) -> Bool {
        lhs.message == rhs.message
            && lhs.additionalProperties == rhs.additionalProperties
    }
}

extension AgentStudioErrorBase: Hashable {
