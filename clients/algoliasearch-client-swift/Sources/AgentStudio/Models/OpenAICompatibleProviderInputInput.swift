...
public struct OpenAICompatibleProviderInputInput: Codable, JSONEncodable {
...
extension OpenAICompatibleProviderInputInput: Equatable {
    public static func ==(lhs: OpenAICompatibleProviderInputInput, rhs: OpenAICompatibleProviderInputInput) -> Bool {
...
extension OpenAICompatibleProviderInputInput: Hashable {
