...
public struct IndexSearchParametersInput: Codable, JSONEncodable {
...
extension IndexSearchParametersInput: Equatable {
    public static func ==(lhs: IndexSearchParametersInput, rhs: IndexSearchParametersInput) -> Bool {
        lhs.query == rhs.query &&
...
extension IndexSearchParametersInput: Hashable {
