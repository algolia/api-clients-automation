...
public struct IndexSettings: Codable, JSONEncodable {
    ...
    public var attributeCriteriaComputedBy: SearchAttributeCriteriaComputedBy?
    ...
    public init(
        ...
        attributeCriteriaComputedBy: SearchAttributeCriteriaComputedBy? = nil,
        ...
        self.attributeCriteriaComputedBy = attributeCriteriaComputedBy
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(self.attributeCriteriaComputedBy, forKey: .attributeCriteriaComputedBy)
...
extension IndexSettings: Hashable {
    public func hash(into hasher: inout Hasher) {
        ...
        hasher.combine(self.attributeCriteriaComputedBy?.hashValue)
