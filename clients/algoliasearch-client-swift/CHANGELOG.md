## [10.0.0](https://github.com/algolia/algoliasearch-client-swift/compare/9.49.0...10.0.0)
...
- [56d569c780](https://github.com/algolia/api-clients-automation/commit/56d569c780) feat(clients): wait and retry on 429 with Retry-After ([#6978](https://github.com/algolia/api-clients-automation/pull/6978)) by [@MarioAlexandruDan](https://github.com/MarioAlexandruDan/)
...
## [9.46.1](https://github.com/algolia/algoliasearch-client-swift/compare/9.46.0...9.46.1)
...
- [2a1802e459](https://github.com/algolia/api-clients-automation/commit/2a1802e459) fix(swift): preserve host URL path prefix in Transporter ([#6445](https://github.com/algolia/api-clients-automation/pull/6445)) by [@Fluf22](https://github.com/Fluf22/)
- [35bf16c848](https://github.com/algolia/api-clients-automation/commit/35bf16c848) fix(specs): BREAKING CHANGE – add searchResponsePartial fallback to searchResult oneOf ([#6350](https://github.com/algolia/api-clients-automation/pull/6350)) by [@Fluf22](https://github.com/Fluf22/)
  - For those of you who want really clean responses without hits nor facets, we added a third fallback type to the search response. It should not impact the rest of the users, but just to be careful, be sure you have a default case in your Swift switch, since they need to be exhaustive.
...
## [9.29.0](https://github.com/algolia/algoliasearch-client-swift/compare/9.28.0...9.29.0)
