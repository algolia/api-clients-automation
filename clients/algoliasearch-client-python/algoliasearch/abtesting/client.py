...
from algoliasearch.abtesting.models.scheduled_ab_test_response import (
...
class AbtestingClient:
    ...
    async def schedule_ab_test(
        ...
        :type schedule_ab_tests_request: ScheduleABTestsRequest
        :param request_options: The request options to send along with the query, they will be merged with the transporter base parameters (headers, query params, timeouts, etc.). (optional)
        :return: Returns the deserialized response in a 'ScheduledABTestResponse' result object.
        """
        return (
            await self.schedule_ab_test_with_http_info(
                schedule_ab_tests_request, request_options
            )
        ).deserialize(ScheduledABTestResponse)
