...
class IngestionClient:
    ...
    async def list_tasks_with_http_info(
        ...
        :param with_notifications: If specified, the response only includes tasks with notifications.email.enabled set to this value.
        ...
        if with_notifications is not None:
            _query_parameters["withNotifications"] = with_notifications
        if sort is not None:
            _query_parameters["sort"] = sort
        if order is not None:
            _query_parameters["order"] = order
