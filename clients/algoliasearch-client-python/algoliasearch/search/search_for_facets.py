...
class SearchForFacets(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SearchForFacets:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SearchForFacets:
        """Create an instance of SearchForFacets from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SearchForFacets.parse_obj(obj)

        _obj = SearchForFacets.parse_obj({
