...
class ConsequenceParams(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConsequenceParams:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConsequenceParams:
        """Create an instance of ConsequenceParams from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConsequenceParams.parse_obj(obj)

        _obj = ConsequenceParams.parse_obj({
