...
from algoliasearch.models.built_in_operation import BuiltInOperation
...
class AttributeToUpdate(BaseModel):
    ...
    if TYPE_CHECKING:
        actual_instance: Union[BuiltInOperation, str]
    else:
        actual_instance: Any
    one_of_schemas: List[str] = Field(ATTRIBUTETOUPDATE_ONE_OF_SCHEMAS, const=True)
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AttributeToUpdate:
        return cls.from_json(json.dumps(obj))

    @classmethod
    def from_json(cls, json_str: str) -> AttributeToUpdate:
