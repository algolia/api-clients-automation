...
class ApiKey(BaseModel):
    ...
    indexes: Optional[conlist(StrictStr)] = Field(
        None,
    ...
    referers: Optional[conlist(StrictStr)] = Field(
        None,
        ...
        _obj = ApiKey.parse_obj(
            {
                ...
                "max_hits_per_query": obj.get("maxHitsPerQuery")
                if obj.get("maxHitsPerQuery") is not None
                else 0,
                "max_queries_per_ip_per_hour": obj.get("maxQueriesPerIPPerHour")
