...
class RedirectRuleIndexMetadata(BaseModel):
    ...
    data: RedirectRuleIndexMetadataData = Field(...)
    __properties = ["source", "dest", "reason", "succeed", "data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RedirectRuleIndexMetadata:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RedirectRuleIndexMetadata:
