...
class BrowseParamsObject(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BrowseParamsObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BrowseParamsObject:
        """Create an instance of BrowseParamsObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BrowseParamsObject.parse_obj(obj)

        _obj = BrowseParamsObject.parse_obj({
