...
class DictionaryEntry(BaseModel):
    ...
    object_id: StrictStr = Field(
        ..., alias="objectID", description="Unique identifier for a dictionary object."
    )
    ...
    words: Optional[conlist(StrictStr)] = Field(
        None,
    ...
    decomposition: Optional[conlist(StrictStr)] = Field(
        None,
