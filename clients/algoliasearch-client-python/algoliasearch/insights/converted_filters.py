...
class ConvertedFilters(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConvertedFilters:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConvertedFilters:
        """Create an instance of ConvertedFilters from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConvertedFilters.parse_obj(obj)

        _obj = ConvertedFilters.parse_obj({
