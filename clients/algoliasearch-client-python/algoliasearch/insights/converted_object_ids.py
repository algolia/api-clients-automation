...
class ConvertedObjectIDs(BaseModel):
    """
    Use this event to track when users convert on items unrelated to a previous Algolia request. For example, if you don't use Algolia to build your category pages, use this event.  To track conversion events related to Algolia requests, use the \"Converted object IDs after search\" event.   # noqa: E501
    """
    ...
    __properties = ["eventName", "eventType", "index", "objectIDs", "userToken", "timestamp", "authenticatedUserToken"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConvertedObjectIDs:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConvertedObjectIDs:
        """Create an instance of ConvertedObjectIDs from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConvertedObjectIDs.parse_obj(obj)

        _obj = ConvertedObjectIDs.parse_obj({
