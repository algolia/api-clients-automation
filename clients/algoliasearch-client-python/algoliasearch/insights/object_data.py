...
class ObjectData(BaseModel):
    ...
    __properties = ["price", "quantity", "discount"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ObjectData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ObjectData:
        """Create an instance of ObjectData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ObjectData.parse_obj(obj)

        _obj = ObjectData.parse_obj(
            {
