...
from algoliasearch.insights.models.instant_search_telemetry_event import (
...
class InstantSearchTelemetry(BaseModel):
    """
    ...
    performance: Optional[object] = None
    """ free form object for performance data. """
    widgets: Optional[object] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InstantSearchTelemetry from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InstantSearchTelemetry from a dict"""
        if obj is None:
            return None
