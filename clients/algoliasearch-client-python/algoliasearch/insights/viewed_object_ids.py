...
class ViewedObjectIDs(BaseModel):
    """
    Use this event to track when users viewed items in the search results.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ViewedObjectIDs:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ViewedObjectIDs:
        """Create an instance of ViewedObjectIDs from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ViewedObjectIDs.parse_obj(obj)

        _obj = ViewedObjectIDs.parse_obj({
