...
class ToolConfigAgentTestConfiguration(BaseModel):
    """
    ...
    def from_dict(cls, obj: Union[str, Dict[str, Any]]) -> Self:
        """Create an instance of ToolConfigAgentTestConfiguration from a JSON string"""
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        raise ValueError(
            "No match found when deserializing the JSON string into ToolConfigAgentTestConfiguration with oneOf schemas: AlgoliaDisplayResultsToolConfig, AlgoliaRecommendToolConfig, AlgoliaSearchToolConfig, ClientSideToolConfig, McpServerToolConfig, UnknownToolConfig. Details: "
            + ", ".join(error_messages)
        )
