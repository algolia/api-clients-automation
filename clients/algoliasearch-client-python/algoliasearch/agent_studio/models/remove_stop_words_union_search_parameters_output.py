...
class RemoveStopWordsUnionSearchParametersOutput(BaseModel):
    """
    ...
    def from_dict(cls, obj: Union[str, Dict[str, Any]]) -> Self:
        """Create an instance of RemoveStopWordsUnionSearchParametersOutput from a JSON string"""
    ...
    def from_json(cls, json_str: Optional[str]) -> Self:
        ...
        raise ValueError(
            "No match found when deserializing the JSON string into RemoveStopWordsUnionSearchParametersOutput with oneOf schemas: List[str], bool. Details: "
            + ", ".join(error_messages)
        )
