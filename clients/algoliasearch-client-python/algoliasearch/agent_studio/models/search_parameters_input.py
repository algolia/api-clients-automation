...
from algoliasearch.agent_studio.models.facet_filters_input_union import (
...
class SearchParametersInput(BaseModel):
    ...
    facet_filters: Optional[FacetFiltersInputUnion] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SearchParametersInput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SearchParametersInput from a dict"""
        if obj is None:
            return None
        ...
        obj["facetFilters"] = (
            FacetFiltersInputUnion.from_dict(obj["facetFilters"])
