...
class ToolConfigOutput(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        raise ValueError(
            "No match found when deserializing the JSON string into ToolConfigOutput with oneOf schemas: AlgoliaRecommendToolConfig, AlgoliaSearchToolConfig, ClientSideToolConfig, McpServerToolConfig, UnknownToolConfig. Details: "
            + ", ".join(error_messages)
        )
