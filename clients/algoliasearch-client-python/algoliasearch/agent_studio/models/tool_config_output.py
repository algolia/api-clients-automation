...
from algoliasearch.agent_studio.models.algolia_recommend_tool_config_output import (
    AlgoliaRecommendToolConfigOutput,
)
from algoliasearch.agent_studio.models.algolia_search_tool_config_output import (
    AlgoliaSearchToolConfigOutput,
)
from algoliasearch.agent_studio.models.client_side_tool_config import (
    ClientSideToolConfig,
)
from algoliasearch.agent_studio.models.mcp_server_tool_config_output import (
    McpServerToolConfigOutput,
)
from algoliasearch.agent_studio.models.unknown_tool_config import UnknownToolConfig


class ToolConfigOutput(BaseModel):
    """
    ToolConfigOutput
    """
    ...
    oneof_schema_2_validator: Optional[AlgoliaSearchToolConfigOutput] = Field(
        default=None
    )

    oneof_schema_3_validator: Optional[AlgoliaRecommendToolConfigOutput] = Field(
        default=None
    )
    ...
    oneof_schema_5_validator: Optional[McpServerToolConfigOutput] = Field(default=None)
    ...
    def from_dict(cls, obj: Union[str, Dict[str, Any]]) -> Self:
        """Create an instance of ToolConfigOutput from a JSON string"""
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if _discriminator_value == "algolia_recommend":
            instance.actual_instance = AlgoliaRecommendToolConfigOutput.from_json(
                json_str
            )
            return instance
        if _discriminator_value == "algolia_search_index":
            instance.actual_instance = AlgoliaSearchToolConfigOutput.from_json(json_str)
            return instance
        ...
        if _discriminator_value == "mcp_tools":
            instance.actual_instance = McpServerToolConfigOutput.from_json(json_str)
            return instance
        ...
        raise ValueError(
            "No match found when deserializing the JSON string into ToolConfigOutput with oneOf schemas: AlgoliaDisplayResultsToolConfig, AlgoliaRecommendToolConfigOutput, AlgoliaSearchToolConfigOutput, ClientSideToolConfig, McpServerToolConfigOutput, UnknownToolConfig. Details: "
            + ", ".join(error_messages)
        )
