...
class ReRankingApplyFilterUnion(BaseModel):
    ...
    oneof_schema_2_validator: Optional[List[object]] = Field(default=None)

    actual_instance: Union[List[object], str, None] = None
    ...
    @model_serializer
    def unwrap_actual_instance(self) -> Union[List[object], str, Self, None]:
        """
    ...
    def from_json(cls, json_str: Optional[str]) -> Self:
        ...
        raise ValueError(
            "No match found when deserializing the JSON string into ReRankingApplyFilterUnion with oneOf schemas: List[object], str. Details: "
            + ", ".join(error_messages)
        )
