...
class TypoToleranceUnionSearchParametersOutput(BaseModel):
    """
    ...
    actual_instance: Union[bool, str, None] = None
    ...
    @model_serializer
    def unwrap_actual_instance(self) -> Union[bool, str, Self, None]:
        """
    ...
    def from_dict(cls, obj: Union[str, Dict[str, Any]]) -> Self:
        """Create an instance of TypoToleranceUnionSearchParametersOutput from a JSON string"""
    ...
    def from_json(cls, json_str: Optional[str]) -> Self:
        ...
        raise ValueError(
            "No match found when deserializing the JSON string into TypoToleranceUnionSearchParametersOutput with oneOf schemas: bool, str. Details: "
            + ", ".join(error_messages)
        )
