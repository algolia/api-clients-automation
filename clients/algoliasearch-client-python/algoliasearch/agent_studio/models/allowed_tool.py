...
class AllowedTool(BaseModel):
    ...
    def from_dict(cls, obj: Union[str, Dict[str, Any]]) -> Self:
        """Create an instance of AllowedTool from a JSON string"""
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        raise ValueError(
            "No match found when deserializing the JSON string into AllowedTool with oneOf schemas: McpToolConfig, bool. Details: "
            + ", ".join(error_messages)
        )
