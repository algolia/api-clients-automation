...
from algoliasearch.models.dict[str,_facets_stats] import Dict[str, FacetsStats]
...
class RecommendationsResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RecommendationsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RecommendationsResponse:
        """Create an instance of RecommendationsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RecommendationsResponse.parse_obj(obj)

        _obj = RecommendationsResponse.parse_obj({
