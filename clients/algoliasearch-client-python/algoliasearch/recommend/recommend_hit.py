...
class RecommendHit(BaseModel):
    ...
    score: Union[confloat(le=100, ge=0, strict=True), conint(le=100, ge=0, strict=True)] = Field(..., alias="_score", description="Recommendation score.")
    additional_properties: Dict[str, Any] = {}
    __properties = ["objectID", "_highlightResult", "_snippetResult", "_rankingInfo", "_distinctSeqID", "_score"]
