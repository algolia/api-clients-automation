...
class TypoTolerance(BaseModel):
    ...
    if TYPE_CHECKING:
        actual_instance: Union[TypoToleranceEnum, bool]
    else:
        actual_instance: Any
    one_of_schemas: List[str] = Field(TYPOTOLERANCE_ONE_OF_SCHEMAS, const=True)
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TypoTolerance:
        return cls.from_json(json.dumps(obj))

    @classmethod
    def from_json(cls, json_str: str) -> TypoTolerance:
