...
class GetNoResultsRateResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'count' => 'int',
        'noResultCount' => 'int',
        'dates' => '\Algolia\AlgoliaSearch\Model\GetNoResultsRateResponseDates[]',
    ];
     ...
     * Gets dates
     *
     * @return \Algolia\AlgoliaSearch\Model\GetNoResultsRateResponseDates[]
     */
     ...
     * Sets dates
     *
     * @param \Algolia\AlgoliaSearch\Model\GetNoResultsRateResponseDates[] $dates a list of searches without results with their date, rate and counts
     *
     * @return self
     */
