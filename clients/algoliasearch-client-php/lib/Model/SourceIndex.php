...
class SourceIndex implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Gets external
     *
     * @return \Algolia\AlgoliaSearch\Model\SourceIndexExternal[]|null
     */
     ...
     * Sets external
     *
     * @param \Algolia\AlgoliaSearch\Model\SourceIndexExternal[]|null $external list of external indices to use to generate custom Query Suggestions
     *
     * @return self
     */
