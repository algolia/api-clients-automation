...
class Rule implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'objectID' => 'string',
        'conditions' => '\Algolia\AlgoliaSearch\Model\Condition[]',
     ...
     * Gets conditions
     *
     * @return \Algolia\AlgoliaSearch\Model\Condition[]|null
     */
     ...
     * Sets conditions
     *
     * @param \Algolia\AlgoliaSearch\Model\Condition[]|null $conditions A list of conditions that should apply to activate a Rule. You can use up to 25 conditions per Rule.
     *
     * @return self
     */
     ...
     * Gets consequence
     *
     * @return \Algolia\AlgoliaSearch\Model\Consequence
     */
     ...
     * Sets consequence
     *
     * @param \Algolia\AlgoliaSearch\Model\Consequence $consequence consequence
     *
     * @return self
     */
     ...
     * Gets validity
     *
     * @return \Algolia\AlgoliaSearch\Model\TimeRange[]|null
     */
     ...
     * Sets validity
     *
     * @param \Algolia\AlgoliaSearch\Model\TimeRange[]|null $validity By default, Rules are permanently valid. When validity periods are specified, the Rule applies only during those periods; it's ignored the rest of the time. The list must not be empty.
     *
     * @return self
     */
