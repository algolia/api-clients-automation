...
class GetNoClickRateResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'count' => 'int',
        'noClickCount' => 'int',
        'dates' => '\Algolia\AlgoliaSearch\Model\GetNoClickRateResponseDates[]',
    ];
     ...
     * Gets dates
     *
     * @return \Algolia\AlgoliaSearch\Model\GetNoClickRateResponseDates[]
     */
     ...
     * Sets dates
     *
     * @param \Algolia\AlgoliaSearch\Model\GetNoClickRateResponseDates[] $dates a list of searches without clicks with their date, rate and counts
     *
     * @return self
     */
