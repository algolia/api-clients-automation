...
/**
 * ToolConfigAgentTestConfiguration Class Doc Comment.
 *
 * @category Class
 */
class ToolConfigAgentTestConfiguration extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    /**
