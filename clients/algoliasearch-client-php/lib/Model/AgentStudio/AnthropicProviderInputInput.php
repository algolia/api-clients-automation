...
/**
 * AnthropicProviderInputInput Class Doc Comment.
 *
 * @category Class
 *
 * @description Anthropic-specific provider input.
 */
class AnthropicProviderInputInput extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    /**
