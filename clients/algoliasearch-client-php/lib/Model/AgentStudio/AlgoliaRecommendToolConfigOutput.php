...
/**
 * AlgoliaRecommendToolConfigOutput Class Doc Comment.
 *
 * @category Class
 *
 * @description Configuration for the Algolia Recommend tool. Allows specifying recommend models and related parameters.
 */
class AlgoliaRecommendToolConfigOutput extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    /**
