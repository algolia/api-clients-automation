 ...
 * @category Class
 *
 * @description An Insights event attributed to an assistant message.
 */
class MessageEvent extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    /**
     ...
     * Sets objectId.
     *
     * @param null|string $objectId objectId
     *
     * @return self
     */
