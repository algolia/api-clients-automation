...
class ProviderAuthenticationResponse extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $modelTypes = [
        ...
        'name' => 'string',
        'providerName' => 'string',
        'input' => '\Algolia\AlgoliaSearch\Model\AgentStudio\ProviderInputProviderAuthenticationResponse',
        'createdAt' => 'string',
        'updatedAt' => 'string',
        'lastUsedAt' => 'string',
    ];
     ...
     * Sets input.
     *
     * @param ProviderInputProviderAuthenticationResponse $input input
     *
     * @return self
     */
