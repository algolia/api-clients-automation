...
/**
 * AlgoliaRecommendToolConfig Class Doc Comment.
 *
 * @category Class
 *
 * @description Configuration for the Algolia Recommend tool. Allows specifying recommend models and related parameters.
 */
class AlgoliaRecommendToolConfig extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    /**
