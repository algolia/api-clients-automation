...
/**
 * AnthropicProviderInputOutput Class Doc Comment.
 *
 * @category Class
 *
 * @description Anthropic-specific provider input.
 */
class AnthropicProviderInputOutput extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    /**
