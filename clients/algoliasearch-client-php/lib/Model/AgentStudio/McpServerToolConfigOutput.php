...
/**
 * McpServerToolConfigOutput Class Doc Comment.
 *
 * @category Class
 */
class McpServerToolConfigOutput extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    /**
