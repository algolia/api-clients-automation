...
/**
 * AlgoliaSearchToolConfigOutput Class Doc Comment.
 *
 * @category Class
 */
class AlgoliaSearchToolConfigOutput extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    /**
    ...
    protected static $modelTypes = [
        'name' => 'string',
        'type' => 'string',
        'indices' => '\Algolia\AlgoliaSearch\Model\AgentStudio\AlgoliaSearchToolIndexConfigOutput[]',
        'description' => 'string',
    ];
     ...
     * Sets indices.
     *
     * @param AlgoliaSearchToolIndexConfigOutput[] $indices indices
     *
     * @return self
     */
