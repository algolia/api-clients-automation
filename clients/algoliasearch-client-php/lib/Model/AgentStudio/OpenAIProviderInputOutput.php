...
/**
 * OpenAIProviderInputOutput Class Doc Comment.
 *
 * @category Class
 *
 * @description OpenAI-specific provider input.
 */
class OpenAIProviderInputOutput extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    /**
