...
class QuerySuggestionsIndexWithIndexParam implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'sourceIndices' => '\Algolia\AlgoliaSearch\Model\SourceIndex[]',
        'languages' => 'string[]',
        'exclude' => 'string[]',
        'indexName' => 'string',
    ];
     ...
     * Gets sourceIndices
     *
     * @return \Algolia\AlgoliaSearch\Model\SourceIndex[]
     */
     ...
     * Sets sourceIndices
     *
     * @param \Algolia\AlgoliaSearch\Model\SourceIndex[] $sourceIndices list of source indices used to generate a Query Suggestions index
     *
     * @return self
     */
