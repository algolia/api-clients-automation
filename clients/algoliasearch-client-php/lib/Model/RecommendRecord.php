...
/**
 * RecommendRecord Class Doc Comment
 *
 * @category Class
 * @description A Recommend record.
 *
 ...
 */
class RecommendRecord implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'recommendRecord';
    ...
    {
        if (($score > 100)) {
            throw new \InvalidArgumentException('invalid value for $score when calling RecommendRecord., must be smaller than or equal to 100.');
        }
        if (($score < 0)) {
            throw new \InvalidArgumentException('invalid value for $score when calling RecommendRecord., must be bigger than or equal to 0.');
        }
