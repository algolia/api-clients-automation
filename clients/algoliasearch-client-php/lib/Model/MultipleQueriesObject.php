 ...
 */
class MultipleQueriesObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'multipleQueriesObject';
    ...
    const STRATEGY_STOP_IF_ENOUGH_MATCHES = 'stopIfEnoughMatches';
    ...
    public function getStrategyAllowableValues()
    {
        return [
            self::STRATEGY_NONE,
            self::STRATEGY_STOP_IF_ENOUGH_MATCHES,
        ];
    }
