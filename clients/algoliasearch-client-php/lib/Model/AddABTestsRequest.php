...
class AddABTestsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'variant' => '\Algolia\AlgoliaSearch\Model\AddABTestsVariant[]',
        'endAt' => 'string',
    ];
     ...
     * Gets variant
     *
     * @return \Algolia\AlgoliaSearch\Model\AddABTestsVariant[]
     */
     ...
     * Sets variant
     *
     * @param \Algolia\AlgoliaSearch\Model\AddABTestsVariant[] $variant list of 2 variants for the A/B test
     *
     * @return self
     */
