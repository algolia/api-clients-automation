...
class Agent extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets agentID.
     *
     * @param string $agentID the ID of the agent to which this event is related
     *
     * @return self
     */
     ...
     * Sets toolCallID.
     *
     * @param string $toolCallID the ID of the instant-search tool to which this event is related
     *
     * @return self
     */
     ...
     * Sets conversationID.
     *
     * @param string $conversationID the ID of the instant-search conversation to which this event is related
     *
     * @return self
     */
