...
class GetRecommendations implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'requests' => '\Algolia\AlgoliaSearch\Model\RecommendationRequest[]',
    ];
     ...
     * Gets requests
     *
     * @return \Algolia\AlgoliaSearch\Model\RecommendationRequest[]
     */
     ...
     * Sets requests
     *
     * @param \Algolia\AlgoliaSearch\Model\RecommendationRequest[] $requests the `getRecommendations` requests
     *
     * @return self
     */
