...
class BatchDictionaryEntries implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Gets requests
     *
     * @return \Algolia\AlgoliaSearch\Model\BatchDictionaryEntriesRequest[]
     */
     ...
     * Sets requests
     *
     * @param \Algolia\AlgoliaSearch\Model\BatchDictionaryEntriesRequest[] $requests List of operations to batch. Each operation is described by an `action` and a `body`.
     *
     * @return self
     */
