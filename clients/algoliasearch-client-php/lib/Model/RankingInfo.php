...
class RankingInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'geoDistance' => 'int',
        'geoPrecision' => 'int',
        'matchedGeoLocation' => 'array<string,\Algolia\AlgoliaSearch\Model\RankingInfoMatchedGeoLocation>',
        'nbExactWords' => 'int',
        'nbTypos' => 'int',
        'promoted' => 'bool',
     ...
     *
     * @return array<string,\Algolia\AlgoliaSearch\Model\RankingInfoMatchedGeoLocation>|null
     */
     ...
     *
     * @param array<string,\Algolia\AlgoliaSearch\Model\RankingInfoMatchedGeoLocation>|null $matchedGeoLocation matchedGeoLocation
     *
     * @return self
     */
