...
class ABTest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'status' => 'string',
        'variants' => '\Algolia\AlgoliaSearch\Model\Variant[]',
    ];
     ...
     * Gets variants
     *
     * @return \Algolia\AlgoliaSearch\Model\Variant[]
     */
     ...
     * Sets variants
     *
     * @param \Algolia\AlgoliaSearch\Model\Variant[] $variants list of A/B test variant
     *
     * @return self
     */
