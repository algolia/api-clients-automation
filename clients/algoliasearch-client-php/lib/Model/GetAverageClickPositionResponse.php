...
class GetAverageClickPositionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'average' => 'double',
        'clickCount' => 'int',
        'dates' => '\Algolia\AlgoliaSearch\Model\GetAverageClickPositionResponseDates[]',
    ];
     ...
     * Gets dates
     *
     * @return \Algolia\AlgoliaSearch\Model\GetAverageClickPositionResponseDates[]
     */
     ...
     * Sets dates
     *
     * @param \Algolia\AlgoliaSearch\Model\GetAverageClickPositionResponseDates[] $dates a list of average click position with their date
     *
     * @return self
     */
