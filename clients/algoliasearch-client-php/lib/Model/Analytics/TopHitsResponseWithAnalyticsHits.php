 ...
 */
class TopHitsResponseWithAnalyticsHits implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'topHitsResponseWithAnalytics_hits';
