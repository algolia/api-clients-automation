...
class BrowseResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'facetsStats' => 'array<string,\Algolia\AlgoliaSearch\Model\BaseSearchResponseFacetsStats>',
        'hitsPerPage' => 'int',
        'index' => 'string',
        'indexUsed' => 'string',
        'message' => 'string',
     ...
     * Gets facetsStats
     *
     * @return array<string,\Algolia\AlgoliaSearch\Model\BaseSearchResponseFacetsStats>|null
     */
     ...
     * Gets hits
     *
     * @return \Algolia\AlgoliaSearch\Model\HitHit[]
     */
     ...
     * Sets hits
     *
     * @param \Algolia\AlgoliaSearch\Model\HitHit[] $hits hits
     *
     * @return self
     */
