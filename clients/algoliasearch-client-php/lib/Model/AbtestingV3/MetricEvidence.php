 ...
 * @category Class
 *
 * @description Evidence verdict for this variant metric's comparison with the control. Only present when the API has a verdict for the comparison. Omitted when evidence isn't applicable or no verdict exists.
 */
