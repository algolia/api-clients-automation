...
class IngestionClient
{
     ...
     * @param bool  $withNotifications If specified, the response only includes tasks with notifications.email.enabled set to this value. (optional)
     ...
     */
    public function listTasks($itemsPerPage = null, $page = null, $action = null, $enabled = null, $sourceID = null, $sourceType = null, $destinationID = null, $triggerType = null, $withNotifications = null, $sort = null, $order = null, $requestOptions = [])
    {
        $resourcePath = '/2/tasks';
        $queryParameters = [];
        $headers = [];
        ...
        if (null !== $withNotifications) {
            $queryParameters['withNotifications'] = $withNotifications;
        }
