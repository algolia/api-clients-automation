...
class Configuration
{
     ...
     * Constructor
     */
    public function __construct(string $appId, string $algoliaApiKey = null)
    {
        $this->tempFolderPath = sys_get_temp_dir();

        $this->setAlgoliaApiKey($algoliaApiKey);
        $this->setApiKey('X-Algolia-API-Key', $algoliaApiKey);

        $this->setAppId($appId);
        $this->setApiKey('X-Algolia-Application-Id', $appId);

        $this->setHost("https://{$appId}-1.algolianet.com");
    }
    ...
    /**
     * Sets the Algolia Application ID
     *
    ...
    /**
     * Sets the Algolia API Key
     *
     * @param string $algoliaApiKey Algolia API Key
     *
     * @return $this
     */
    ...
    {
        $report  = 'PHP SDK (Algolia\AlgoliaSearch) Debug Report:' . PHP_EOL;
