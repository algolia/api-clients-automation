...
// ToolConfigAgentTestConfiguration - struct for ToolConfigAgentTestConfiguration.
type ToolConfigAgentTestConfiguration struct {
...
// ClientSideToolConfigAsToolConfigAgentTestConfiguration is a convenience function that returns ClientSideToolConfig wrapped in ToolConfigAgentTestConfiguration.
func ClientSideToolConfigAsToolConfigAgentTestConfiguration(v *ClientSideToolConfig) *ToolConfigAgentTestConfiguration {
	return &ToolConfigAgentTestConfiguration{
		ClientSideToolConfig: v,
	}
}

// McpServerToolConfigAsToolConfigAgentTestConfiguration is a convenience function that returns McpServerToolConfig wrapped in ToolConfigAgentTestConfiguration.
func McpServerToolConfigAsToolConfigAgentTestConfiguration(v *McpServerToolConfig) *ToolConfigAgentTestConfiguration {
	return &ToolConfigAgentTestConfiguration{
		McpServerToolConfig: v,
	}
}

// AlgoliaSearchToolConfigAsToolConfigAgentTestConfiguration is a convenience function that returns AlgoliaSearchToolConfig wrapped in ToolConfigAgentTestConfiguration.
func AlgoliaSearchToolConfigAsToolConfigAgentTestConfiguration(v *AlgoliaSearchToolConfig) *ToolConfigAgentTestConfiguration {
	return &ToolConfigAgentTestConfiguration{
		AlgoliaSearchToolConfig: v,
	}
}

// AlgoliaRecommendToolConfigAsToolConfigAgentTestConfiguration is a convenience function that returns AlgoliaRecommendToolConfig wrapped in ToolConfigAgentTestConfiguration.
func AlgoliaRecommendToolConfigAsToolConfigAgentTestConfiguration(v *AlgoliaRecommendToolConfig) *ToolConfigAgentTestConfiguration {
	return &ToolConfigAgentTestConfiguration{
		AlgoliaRecommendToolConfig: v,
	}
}

// AlgoliaDisplayResultsToolConfigAsToolConfigAgentTestConfiguration is a convenience function that returns AlgoliaDisplayResultsToolConfig wrapped in ToolConfigAgentTestConfiguration.
func AlgoliaDisplayResultsToolConfigAsToolConfigAgentTestConfiguration(v *AlgoliaDisplayResultsToolConfig) *ToolConfigAgentTestConfiguration {
	return &ToolConfigAgentTestConfiguration{
		AlgoliaDisplayResultsToolConfig: v,
	}
}

// UnknownToolConfigAsToolConfigAgentTestConfiguration is a convenience function that returns UnknownToolConfig wrapped in ToolConfigAgentTestConfiguration.
func UnknownToolConfigAsToolConfigAgentTestConfiguration(v UnknownToolConfig) *ToolConfigAgentTestConfiguration {
	return &ToolConfigAgentTestConfiguration{
		UnknownToolConfig: &v,
	}
}
...
func (dst *ToolConfigAgentTestConfiguration) UnmarshalJSON(data []byte) error {
	var (
		err      error
	...
	return fmt.Errorf("data failed to match schemas in oneOf(ToolConfigAgentTestConfiguration)")
}

// Marshal data from the first non-nil pointers in the struct to JSON.
func (src ToolConfigAgentTestConfiguration) MarshalJSON() ([]byte, error) {
	if src.AlgoliaDisplayResultsToolConfig != nil {
		serialized, err := json.Marshal(&src.AlgoliaDisplayResultsToolConfig)
		if err != nil {
			return nil, fmt.Errorf("failed to unmarshal one of AlgoliaDisplayResultsToolConfig of ToolConfigAgentTestConfiguration: %w", err)
		}
	...
	if src.AlgoliaRecommendToolConfig != nil {
		...
		if err != nil {
			return nil, fmt.Errorf("failed to unmarshal one of AlgoliaRecommendToolConfig of ToolConfigAgentTestConfiguration: %w", err)
		}
	...
	if src.AlgoliaSearchToolConfig != nil {
		...
		if err != nil {
			return nil, fmt.Errorf("failed to unmarshal one of AlgoliaSearchToolConfig of ToolConfigAgentTestConfiguration: %w", err)
		}
	...
	if src.ClientSideToolConfig != nil {
		...
		if err != nil {
			return nil, fmt.Errorf("failed to unmarshal one of ClientSideToolConfig of ToolConfigAgentTestConfiguration: %w", err)
		}
	...
	if src.McpServerToolConfig != nil {
		...
		if err != nil {
			return nil, fmt.Errorf("failed to unmarshal one of McpServerToolConfig of ToolConfigAgentTestConfiguration: %w", err)
		}
	...
	if src.UnknownToolConfig != nil {
		...
		if err != nil {
			return nil, fmt.Errorf("failed to unmarshal one of UnknownToolConfig of ToolConfigAgentTestConfiguration: %w", err)
		}
...
func (obj ToolConfigAgentTestConfiguration) GetActualInstance() any {
