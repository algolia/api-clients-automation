...
func (c *APIClient) BatchRecommendRules(indexName string, model RecommendModels, recommendRule *[]RecommendRule, opts ...RequestOption) (*RecommendUpdatedAtResponse, error) {
	var returnValue *RecommendUpdatedAtResponse

	res, resBody, err := c.BatchRecommendRulesWithHTTPInfo(indexName, model, recommendRule, opts...)
	if err != nil {
...
//   - recommendRule
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) BatchRecommendRulesWithHTTPInfo(indexName string, model RecommendModels, recommendRule *[]RecommendRule, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) DeleteRecommendRule(indexName string, model RecommendModels, objectID string, opts ...RequestOption) (*DeletedAtResponse, error) {
	var returnValue *DeletedAtResponse

	res, resBody, err := c.DeleteRecommendRuleWithHTTPInfo(indexName, model, objectID, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - objectID - Unique record identifier.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) DeleteRecommendRuleWithHTTPInfo(indexName string, model RecommendModels, objectID string, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - objectID - Unique record identifier.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetRecommendRule(indexName string, model RecommendModels, objectID string, opts ...RequestOption) (*RecommendRule, error) {
	var returnValue *RecommendRule

	res, resBody, err := c.GetRecommendRuleWithHTTPInfo(indexName, model, objectID, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - objectID - Unique record identifier.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetRecommendRuleWithHTTPInfo(indexName string, model RecommendModels, objectID string, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/indexes/{indexName}/{model}/recommend/rules/{objectID}"
	requestPath = strings.ReplaceAll(requestPath, "{indexName}", url.PathEscape(utils.ParameterToString(indexName)))
	requestPath = strings.ReplaceAll(requestPath, "{model}", url.PathEscape(utils.ParameterToString(model)))
	requestPath = strings.ReplaceAll(requestPath, "{objectID}", url.PathEscape(utils.ParameterToString(objectID)))
...
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetRecommendStatus(indexName string, model RecommendModels, taskID int64, opts ...RequestOption) (*GetRecommendTaskResponse, error) {
	var returnValue *GetRecommendTaskResponse

	res, resBody, err := c.GetRecommendStatusWithHTTPInfo(indexName, model, taskID, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - taskID - Unique task identifier.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetRecommendStatusWithHTTPInfo(indexName string, model RecommendModels, taskID int64, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetRecommendations(requests []RecommendationsRequest, opts ...RequestOption) (*GetRecommendationsResponse, error) {
	var returnValue *GetRecommendationsResponse

	res, resBody, err := c.GetRecommendationsWithHTTPInfo(requests, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - requests - Recommendation request with parameters depending on the requested model.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetRecommendationsWithHTTPInfo(requests []RecommendationsRequest, opts ...RequestOption) (*http.Response, []byte, error) {
...
func (o *SearchRecommendRulesOptions) WithPage(page int32) *SearchRecommendRulesOptions {
	o.Page = &page
	return o
}
...
func (o *SearchRecommendRulesOptions) WithHitsPerPage(hitsPerPage int32) *SearchRecommendRulesOptions {
...
func (o *SearchRecommendRulesOptions) WithMaxValuesPerFacet(maxValuesPerFacet int32) *SearchRecommendRulesOptions {
...
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) SearchRecommendRules(indexName string, model RecommendModels, optionalParams *SearchRecommendRulesOptions, opts ...RequestOption) (*SearchRecommendRulesResponse, error) {
	var returnValue *SearchRecommendRulesResponse

	res, resBody, err := c.SearchRecommendRulesWithHTTPInfo(indexName, model, optionalParams, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - maxValuesPerFacet - Maximum number of values to return for each facet. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) SearchRecommendRulesWithHTTPInfo(indexName string, model RecommendModels, optionalParams *SearchRecommendRulesOptions, opts ...RequestOption) (*http.Response, []byte, error) {
