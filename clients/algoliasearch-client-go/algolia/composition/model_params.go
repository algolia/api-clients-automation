...
type Params struct {
	...
	InjectedItems []ExternalInjectedItem `json:"injectedItems,omitempty"`
}
...
func WithParamsInjectedItems(val []ExternalInjectedItem) ParamsOption {
	return func(f *Params) {
		f.InjectedItems = val
	}
}
...
func (o *Params) GetInjectedItems() []ExternalInjectedItem {
	if o == nil || o.InjectedItems == nil {
		var ret []ExternalInjectedItem
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Params) GetInjectedItemsOk() ([]ExternalInjectedItem, bool) {
	if o == nil || o.InjectedItems == nil {
		return nil, false
	}
...
// SetInjectedItems gets a reference to the given []ExternalInjectedItem and assigns it to the InjectedItems field.
func (o *Params) SetInjectedItems(v []ExternalInjectedItem) *Params {
	o.InjectedItems = v
	return o
}
