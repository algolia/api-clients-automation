...
func NewABTestResponse(index string, abTestID int, taskID int64) *ABTestResponse {
	this := &ABTestResponse{}
	this.Index = index
...
func (o *ABTestResponse) GetAbTestID() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *ABTestResponse) GetAbTestIDOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ABTestResponse) SetAbTestID(v int) *ABTestResponse {
	o.AbTestID = v
