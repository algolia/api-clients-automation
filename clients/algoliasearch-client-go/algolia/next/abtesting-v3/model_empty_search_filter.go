...
type EmptySearchFilter struct {
	...
	TrackedSearchesCount *int `json:"trackedSearchesCount,omitempty"`
}

type EmptySearchFilterOption func(f *EmptySearchFilter)

func WithEmptySearchFilterUsersCount(val int) EmptySearchFilterOption {
	return func(f *EmptySearchFilter) {
		f.UsersCount = &val
	}
}

func WithEmptySearchFilterTrackedSearchesCount(val int) EmptySearchFilterOption {
	return func(f *EmptySearchFilter) {
...
func (o *EmptySearchFilter) GetUsersCount() int {
...
func (o *EmptySearchFilter) GetUsersCountOk() (*int, bool) {
	if o == nil || o.UsersCount == nil {
		return nil, false
	}
...
// SetUsersCount gets a reference to the given int and assigns it to the UsersCount field.
func (o *EmptySearchFilter) SetUsersCount(v int) *EmptySearchFilter {
	o.UsersCount = &v
...
func (o *EmptySearchFilter) GetTrackedSearchesCount() int {
...
// and a boolean to check if the value has been set.
func (o *EmptySearchFilter) GetTrackedSearchesCountOk() (*int, bool) {
	if o == nil || o.TrackedSearchesCount == nil {
		return nil, false
	}
...
// SetTrackedSearchesCount gets a reference to the given int and assigns it to the TrackedSearchesCount field.
func (o *EmptySearchFilter) SetTrackedSearchesCount(v int) *EmptySearchFilter {
