...
type ABTest struct {
	...
	MigratedAbTestID *int `json:"migratedAbTestID,omitempty"`
}
...
func WithABTestMigratedAbTestID(val int) ABTestOption {
	return func(f *ABTest) {
...
func (o *ABTest) GetAbTestIDOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ABTest) SetAbTestID(v int) *ABTest {
	o.AbTestID = v
...
func (o *ABTest) GetMigratedAbTestID() int {
...
// and a boolean to check if the value has been set.
func (o *ABTest) GetMigratedAbTestIDOk() (*int, bool) {
	if o == nil || o.MigratedAbTestID == nil {
		return nil, false
	}
...
// SetMigratedAbTestID gets a reference to the given int and assigns it to the MigratedAbTestID field.
func (o *ABTest) SetMigratedAbTestID(v int) *ABTest {
