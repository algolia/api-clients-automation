...
func NewTimeseries(abTestID int, variants []TimeseriesVariant) *Timeseries {
	this := &Timeseries{}
...
func (o *Timeseries) GetAbTestID() int {
	if o == nil {
		var ret int
...
func (o *Timeseries) GetAbTestIDOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Timeseries) SetAbTestID(v int) *Timeseries {
	o.AbTestID = v
