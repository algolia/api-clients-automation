...
func NewBigCommerceChannel(id int, opts ...BigCommerceChannelOption) *BigCommerceChannel {
...
func (o *BigCommerceChannel) GetId() int {
	if o == nil {
		var ret int
...
func (o *BigCommerceChannel) GetIdOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BigCommerceChannel) SetId(v int) *BigCommerceChannel {
	o.Id = v
