...
func NewPagination(nbPages int, page int, nbItems int, itemsPerPage int) *Pagination {
	this := &Pagination{}
...
func (o *Pagination) GetNbPages() int {
	if o == nil {
		var ret int
...
func (o *Pagination) GetNbPagesOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Pagination) SetNbPages(v int) *Pagination {
	o.NbPages = v
...
// and a boolean to check if the value has been set.
func (o *Pagination) GetPageOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Pagination) SetPage(v int) *Pagination {
	o.Page = v
...
func (o *Pagination) GetNbItems() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *Pagination) GetNbItemsOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Pagination) SetNbItems(v int) *Pagination {
	o.NbItems = v
...
func (o *Pagination) GetItemsPerPage() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *Pagination) GetItemsPerPageOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Pagination) SetItemsPerPage(v int) *Pagination {
	o.ItemsPerPage = v
