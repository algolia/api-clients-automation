...
func (c *APIClient) CreateAuthentication(type_ AuthenticationType, name string, input *AuthInput, platform *Platform, opts ...RequestOption) (*AuthenticationCreateResponse, error) {
...
//   - platform
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) CreateAuthenticationWithHTTPInfo(type_ AuthenticationType, name string, input *AuthInput, platform *Platform, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) CreateDestination(type_ DestinationType, name string, input *DestinationInput, optionalParams *CreateDestinationOptions, opts ...RequestOption) (*DestinationCreateResponse, error) {
...
//   - transformationIDs  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) CreateDestinationWithHTTPInfo(type_ DestinationType, name string, input *DestinationInput, optionalParams *CreateDestinationOptions, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - authenticationID - Universally unique identifier (UUID) of an authentication resource. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) CreateSource(type_ SourceType, name string, optionalParams *CreateSourceOptions, opts ...RequestOption) (*SourceCreateResponse, error) {
...
//   - authenticationID - Universally unique identifier (UUID) of an authentication resource. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) CreateSourceWithHTTPInfo(type_ SourceType, name string, optionalParams *CreateSourceOptions, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) CreateTask(sourceID string, destinationID string, action ActionType, optionalParams *CreateTaskOptions, opts ...RequestOption) (*TaskCreateResponse, error) {
...
//   - policies  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) CreateTaskWithHTTPInfo(sourceID string, destinationID string, action ActionType, optionalParams *CreateTaskOptions, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/2/tasks"
...
func (c *APIClient) CreateTaskV1(sourceID string, destinationID string, trigger *TaskCreateTrigger, action ActionType, optionalParams *CreateTaskV1Options, opts ...RequestOption) (*TaskCreateResponse, error) {
	var returnValue *TaskCreateResponse
...
//
// Deprecated: CreateTaskV1 is deprecated.
func (c *APIClient) CreateTaskV1WithHTTPInfo(sourceID string, destinationID string, trigger *TaskCreateTrigger, action ActionType, optionalParams *CreateTaskV1Options, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/tasks"
...
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) CreateTransformation(code string, name string, optionalParams *CreateTransformationOptions, opts ...RequestOption) (*TransformationCreateResponse, error) {
...
//   - authenticationIDs - The authentications associated with the current transformation. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) CreateTransformationWithHTTPInfo(code string, name string, optionalParams *CreateTransformationOptions, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - order - Sort order of the response, ascending or descending. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) ListAuthenticationsWithHTTPInfo(optionalParams *ListAuthenticationsOptions, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/authentications"
...
//   - order - Sort order of the response, ascending or descending. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) ListTransformationsWithHTTPInfo(optionalParams *ListTransformationsOptions, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/transformations"
...
//   - watch - When provided, the push operation will be synchronous and the API will wait for the ingestion to be finished before responding.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) PushWithHTTPInfo(indexName string, action Action, records []PushTaskRecords, watch *bool, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - watch - When provided, the push operation will be synchronous and the API will wait for the ingestion to be finished before responding.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) PushTaskWithHTTPInfo(taskID string, action Action, records []PushTaskRecords, watch *bool, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - authentications
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) TryTransformation(code string, sampleRecord map[string]any, authentications *[]AuthenticationCreate, opts ...RequestOption) (*TransformationTryResponse, error) {
...
//   - authentications
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) TryTransformationWithHTTPInfo(code string, sampleRecord map[string]any, authentications *[]AuthenticationCreate, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - authentications
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) TryTransformationBeforeUpdate(transformationID string, code string, sampleRecord map[string]any, authentications *[]AuthenticationCreate, opts ...RequestOption) (*TransformationTryResponse, error) {
	var returnValue *TransformationTryResponse
...
//   - authentications
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) TryTransformationBeforeUpdateWithHTTPInfo(transformationID string, code string, sampleRecord map[string]any, authentications *[]AuthenticationCreate, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - input  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) UpdateAuthentication(authenticationID string, optionalParams *UpdateAuthenticationOptions, opts ...RequestOption) (*AuthenticationUpdateResponse, error) {
...
//   - input  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) UpdateAuthenticationWithHTTPInfo(authenticationID string, optionalParams *UpdateAuthenticationOptions, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/authentications/{authenticationID}"
	requestPath = strings.ReplaceAll(requestPath, "{authenticationID}", url.PathEscape(utils.ParameterToString(authenticationID)))
...
//   - transformationIDs  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) UpdateDestination(destinationID string, optionalParams *UpdateDestinationOptions, opts ...RequestOption) (*DestinationUpdateResponse, error) {
...
//   - transformationIDs  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) UpdateDestinationWithHTTPInfo(destinationID string, optionalParams *UpdateDestinationOptions, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/destinations/{destinationID}"
	requestPath = strings.ReplaceAll(requestPath, "{destinationID}", url.PathEscape(utils.ParameterToString(destinationID)))
...
//   - authenticationID - Universally unique identifier (UUID) of an authentication resource. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) UpdateSourceWithHTTPInfo(sourceID string, optionalParams *UpdateSourceOptions, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/sources/{sourceID}"
	requestPath = strings.ReplaceAll(requestPath, "{sourceID}", url.PathEscape(utils.ParameterToString(sourceID)))
...
//
// Deprecated: UpdateTaskV1 is deprecated.
func (c *APIClient) UpdateTaskV1WithHTTPInfo(taskID string, optionalParams *UpdateTaskV1Options, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/tasks/{taskID}"
	requestPath = strings.ReplaceAll(requestPath, "{taskID}", url.PathEscape(utils.ParameterToString(taskID)))
...
//   - authenticationIDs - The authentications associated with the current transformation. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) UpdateTransformation(transformationID string, code string, name string, optionalParams *UpdateTransformationOptions, opts ...RequestOption) (*TransformationUpdateResponse, error) {
...
//   - authenticationIDs - The authentications associated with the current transformation. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) UpdateTransformationWithHTTPInfo(transformationID string, code string, name string, optionalParams *UpdateTransformationOptions, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/transformations/{transformationID}"
	requestPath = strings.ReplaceAll(requestPath, "{transformationID}", url.PathEscape(utils.ParameterToString(transformationID)))
...
//   - authenticationID - Universally unique identifier (UUID) of an authentication resource. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) ValidateSource(type_ SourceType, name string, optionalParams *ValidateSourceOptions, opts ...RequestOption) (*WatchResponse, error) {
	var returnValue *WatchResponse
...
//   - authenticationID - Universally unique identifier (UUID) of an authentication resource. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) ValidateSourceWithHTTPInfo(type_ SourceType, name string, optionalParams *ValidateSourceOptions, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - authenticationID - Universally unique identifier (UUID) of an authentication resource. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) ValidateSourceBeforeUpdate(sourceID string, optionalParams *ValidateSourceBeforeUpdateOptions, opts ...RequestOption) (*WatchResponse, error) {
	var returnValue *WatchResponse
...
//   - authenticationID - Universally unique identifier (UUID) of an authentication resource. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) ValidateSourceBeforeUpdateWithHTTPInfo(sourceID string, optionalParams *ValidateSourceBeforeUpdateOptions, opts ...RequestOption) (*http.Response, []byte, error) {
