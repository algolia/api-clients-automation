...
func (c *APIClient) CreateAuthentication(ctx context.Context, type_ AuthenticationType, name string, input *AuthInput, platform *Platform, opts ...RequestOption) (*AuthenticationCreateResponse, error) {
...
//   - platform
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) CreateAuthenticationWithHTTPInfo(ctx context.Context, type_ AuthenticationType, name string, input *AuthInput, platform *Platform, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) CreateDestination(ctx context.Context, type_ DestinationType, name string, input *DestinationInput, optionalParams *CreateDestinationOptions, opts ...RequestOption) (*DestinationCreateResponse, error) {
...
//   - transformationIDs  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) CreateDestinationWithHTTPInfo(ctx context.Context, type_ DestinationType, name string, input *DestinationInput, optionalParams *CreateDestinationOptions, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - authenticationID - Universally unique identifier (UUID) of an authentication resource. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) CreateSource(ctx context.Context, type_ SourceType, name string, optionalParams *CreateSourceOptions, opts ...RequestOption) (*SourceCreateResponse, error) {
...
//   - authenticationID - Universally unique identifier (UUID) of an authentication resource. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) CreateSourceWithHTTPInfo(ctx context.Context, type_ SourceType, name string, optionalParams *CreateSourceOptions, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) CreateTask(ctx context.Context, sourceID string, destinationID string, action ActionType, optionalParams *CreateTaskOptions, opts ...RequestOption) (*TaskCreateResponse, error) {
...
//   - policies  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) CreateTaskWithHTTPInfo(ctx context.Context, sourceID string, destinationID string, action ActionType, optionalParams *CreateTaskOptions, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/2/tasks"
...
func (c *APIClient) CreateTaskV1(ctx context.Context, sourceID string, destinationID string, trigger *TaskCreateTrigger, action ActionType, optionalParams *CreateTaskV1Options, opts ...RequestOption) (*TaskCreateResponse, error) {
	var returnValue *TaskCreateResponse
...
//
// Deprecated: CreateTaskV1 is deprecated.
func (c *APIClient) CreateTaskV1WithHTTPInfo(ctx context.Context, sourceID string, destinationID string, trigger *TaskCreateTrigger, action ActionType, optionalParams *CreateTaskV1Options, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/tasks"
...
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) CreateTransformation(ctx context.Context, code string, name string, optionalParams *CreateTransformationOptions, opts ...RequestOption) (*TransformationCreateResponse, error) {
	var returnValue *TransformationCreateResponse

	res, resBody, err := c.CreateTransformationWithHTTPInfo(ctx, code, name, optionalParams, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - authenticationIDs - The authentications associated with the current transformation. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) CreateTransformationWithHTTPInfo(ctx context.Context, code string, name string, optionalParams *CreateTransformationOptions, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - parameters - Query parameters to apply to the current query.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) CustomDeleteWithHTTPInfo(ctx context.Context, path string, parameters map[string]any, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/{path}"
...
//   - parameters - Query parameters to apply to the current query.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) CustomGetWithHTTPInfo(ctx context.Context, path string, parameters map[string]any, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/{path}"
	requestPath = strings.ReplaceAll(requestPath, "{path}", utils.ParameterToString(path))
...
//   - body - Parameters to send with the custom request. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) CustomPostWithHTTPInfo(ctx context.Context, path string, optionalParams *CustomPostOptions, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/{path}"
	requestPath = strings.ReplaceAll(requestPath, "{path}", utils.ParameterToString(path))
...
//   - body - Parameters to send with the custom request. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) CustomPutWithHTTPInfo(ctx context.Context, path string, optionalParams *CustomPutOptions, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/{path}"
	requestPath = strings.ReplaceAll(requestPath, "{path}", utils.ParameterToString(path))
...
//   - authenticationID - Unique identifier of an authentication resource.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) DeleteAuthenticationWithHTTPInfo(ctx context.Context, authenticationID string, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - transformationID - Unique identifier of a transformation.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) DeleteTransformationWithHTTPInfo(ctx context.Context, transformationID string, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - authenticationID - Unique identifier of an authentication resource.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) GetAuthenticationWithHTTPInfo(ctx context.Context, authenticationID string, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/authentications/{authenticationID}"
	requestPath = strings.ReplaceAll(requestPath, "{authenticationID}", url.PathEscape(utils.ParameterToString(authenticationID)))
...
//   - transformationID - Unique identifier of a transformation.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) GetTransformationWithHTTPInfo(ctx context.Context, transformationID string, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/transformations/{transformationID}"
	requestPath = strings.ReplaceAll(requestPath, "{transformationID}", url.PathEscape(utils.ParameterToString(transformationID)))
...
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) ListAuthentications(ctx context.Context, optionalParams *ListAuthenticationsOptions, opts ...RequestOption) (*ListAuthenticationsResponse, error) {
...
//   - order - Sort order of the response, ascending or descending. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) ListAuthenticationsWithHTTPInfo(ctx context.Context, optionalParams *ListAuthenticationsOptions, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/authentications"
...
//   - order - Sort order of the response, ascending or descending. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) ListDestinations(ctx context.Context, optionalParams *ListDestinationsOptions, opts ...RequestOption) (*ListDestinationsResponse, error) {
...
//   - order - Sort order of the response, ascending or descending. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) ListDestinationsWithHTTPInfo(ctx context.Context, optionalParams *ListDestinationsOptions, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/destinations"
...
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) ListEvents(ctx context.Context, runID string, optionalParams *ListEventsOptions, opts ...RequestOption) (*ListEventsResponse, error) {
...
//   - endDate - Date and time in RFC 3339 format for the latest events to retrieve. By default, the current time is used. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) ListEventsWithHTTPInfo(ctx context.Context, runID string, optionalParams *ListEventsOptions, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - endDate - Date in RFC 3339 format for the latest run to retrieve. By default, the current day is used. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) ListRunsWithHTTPInfo(ctx context.Context, optionalParams *ListRunsOptions, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/runs"
...
//   - order - Sort order of the response, ascending or descending. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) ListSourcesWithHTTPInfo(ctx context.Context, optionalParams *ListSourcesOptions, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/sources"
...
//   - order - Sort order of the response, ascending or descending. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) ListTasksWithHTTPInfo(ctx context.Context, optionalParams *ListTasksOptions, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/2/tasks"
...
//
// Deprecated: ListTasksV1 is deprecated.
func (c *APIClient) ListTasksV1WithHTTPInfo(ctx context.Context, optionalParams *ListTasksV1Options, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/tasks"
...
//   - order - Sort order of the response, ascending or descending. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) ListTransformations(ctx context.Context, optionalParams *ListTransformationsOptions, opts ...RequestOption) (*ListTransformationsResponse, error) {
...
//   - order - Sort order of the response, ascending or descending. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) ListTransformationsWithHTTPInfo(ctx context.Context, optionalParams *ListTransformationsOptions, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/transformations"
...
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) Push(ctx context.Context, indexName string, action Action, records []PushTaskRecords, watch *bool, opts ...RequestOption) (*WatchResponse, error) {
	var returnValue *WatchResponse

	res, resBody, err := c.PushWithHTTPInfo(ctx, indexName, action, records, watch, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - watch - When provided, the push operation will be synchronous and the API will wait for the ingestion to be finished before responding.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) PushWithHTTPInfo(ctx context.Context, indexName string, action Action, records []PushTaskRecords, watch *bool, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - watch - When provided, the push operation will be synchronous and the API will wait for the ingestion to be finished before responding.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) PushTask(ctx context.Context, taskID string, action Action, records []PushTaskRecords, watch *bool, opts ...RequestOption) (*WatchResponse, error) {
	var returnValue *WatchResponse
...
//   - watch - When provided, the push operation will be synchronous and the API will wait for the ingestion to be finished before responding.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) PushTaskWithHTTPInfo(ctx context.Context, taskID string, action Action, records []PushTaskRecords, watch *bool, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) RunSource(ctx context.Context, sourceID string, optionalParams *RunSourceOptions, opts ...RequestOption) (*RunSourceResponse, error) {
...
//   - entityType  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) RunSourceWithHTTPInfo(ctx context.Context, sourceID string, optionalParams *RunSourceOptions, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - taskID - Unique identifier of a task.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) RunTask(ctx context.Context, taskID string, opts ...RequestOption) (*RunResponse, error) {
	var returnValue *RunResponse

	res, resBody, err := c.RunTaskWithHTTPInfo(ctx, taskID, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - taskID - Unique identifier of a task.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) RunTaskWithHTTPInfo(ctx context.Context, taskID string, opts ...RequestOption) (*http.Response, []byte, error) {
...
func (c *APIClient) RunTaskV1(ctx context.Context, taskID string, opts ...RequestOption) (*RunResponse, error) {
	var returnValue *RunResponse

	res, resBody, err := c.RunTaskV1WithHTTPInfo(ctx, taskID, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//
// Deprecated: RunTaskV1 is deprecated.
func (c *APIClient) RunTaskV1WithHTTPInfo(ctx context.Context, taskID string, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - authenticationIDs
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) SearchAuthenticationsWithHTTPInfo(ctx context.Context, authenticationIDs []string, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - destinationIDs
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) SearchDestinationsWithHTTPInfo(ctx context.Context, destinationIDs []string, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - transformationIDs
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) SearchTransformationsWithHTTPInfo(ctx context.Context, transformationIDs []string, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - sourceID - Unique identifier of a source.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) TriggerDockerSourceDiscoverWithHTTPInfo(ctx context.Context, sourceID string, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - authentications
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) TryTransformation(ctx context.Context, code string, sampleRecord map[string]any, authentications *[]AuthenticationCreate, opts ...RequestOption) (*TransformationTryResponse, error) {
	var returnValue *TransformationTryResponse

	res, resBody, err := c.TryTransformationWithHTTPInfo(ctx, code, sampleRecord, authentications, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - authentications
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) TryTransformationWithHTTPInfo(ctx context.Context, code string, sampleRecord map[string]any, authentications *[]AuthenticationCreate, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - authentications
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) TryTransformationBeforeUpdate(ctx context.Context, transformationID string, code string, sampleRecord map[string]any, authentications *[]AuthenticationCreate, opts ...RequestOption) (*TransformationTryResponse, error) {
	var returnValue *TransformationTryResponse

	res, resBody, err := c.TryTransformationBeforeUpdateWithHTTPInfo(ctx, transformationID, code, sampleRecord, authentications, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - authentications
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) TryTransformationBeforeUpdateWithHTTPInfo(ctx context.Context, transformationID string, code string, sampleRecord map[string]any, authentications *[]AuthenticationCreate, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - input  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) UpdateAuthentication(ctx context.Context, authenticationID string, optionalParams *UpdateAuthenticationOptions, opts ...RequestOption) (*AuthenticationUpdateResponse, error) {
...
//   - input  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) UpdateAuthenticationWithHTTPInfo(ctx context.Context, authenticationID string, optionalParams *UpdateAuthenticationOptions, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/authentications/{authenticationID}"
	requestPath = strings.ReplaceAll(requestPath, "{authenticationID}", url.PathEscape(utils.ParameterToString(authenticationID)))
...
//   - transformationIDs  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) UpdateDestination(ctx context.Context, destinationID string, optionalParams *UpdateDestinationOptions, opts ...RequestOption) (*DestinationUpdateResponse, error) {
...
//   - transformationIDs  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) UpdateDestinationWithHTTPInfo(ctx context.Context, destinationID string, optionalParams *UpdateDestinationOptions, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/destinations/{destinationID}"
	requestPath = strings.ReplaceAll(requestPath, "{destinationID}", url.PathEscape(utils.ParameterToString(destinationID)))
...
//   - authenticationID - Universally unique identifier (UUID) of an authentication resource. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) UpdateSource(ctx context.Context, sourceID string, optionalParams *UpdateSourceOptions, opts ...RequestOption) (*SourceUpdateResponse, error) {
...
//   - authenticationID - Universally unique identifier (UUID) of an authentication resource. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) UpdateSourceWithHTTPInfo(ctx context.Context, sourceID string, optionalParams *UpdateSourceOptions, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/sources/{sourceID}"
	requestPath = strings.ReplaceAll(requestPath, "{sourceID}", url.PathEscape(utils.ParameterToString(sourceID)))
...
//   - policies  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) UpdateTask(ctx context.Context, taskID string, optionalParams *UpdateTaskOptions, opts ...RequestOption) (*TaskUpdateResponse, error) {
	var returnValue *TaskUpdateResponse
...
//   - policies  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) UpdateTaskWithHTTPInfo(ctx context.Context, taskID string, optionalParams *UpdateTaskOptions, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/2/tasks/{taskID}"
	requestPath = strings.ReplaceAll(requestPath, "{taskID}", url.PathEscape(utils.ParameterToString(taskID)))
...
func (c *APIClient) UpdateTaskV1(ctx context.Context, taskID string, optionalParams *UpdateTaskV1Options, opts ...RequestOption) (*TaskUpdateResponse, error) {
	var returnValue *TaskUpdateResponse
...
//
// Deprecated: UpdateTaskV1 is deprecated.
func (c *APIClient) UpdateTaskV1WithHTTPInfo(ctx context.Context, taskID string, optionalParams *UpdateTaskV1Options, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/tasks/{taskID}"
	requestPath = strings.ReplaceAll(requestPath, "{taskID}", url.PathEscape(utils.ParameterToString(taskID)))
...
//   - authenticationIDs - The authentications associated with the current transformation. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) UpdateTransformation(ctx context.Context, transformationID string, code string, name string, optionalParams *UpdateTransformationOptions, opts ...RequestOption) (*TransformationUpdateResponse, error) {
	var returnValue *TransformationUpdateResponse

	res, resBody, err := c.UpdateTransformationWithHTTPInfo(ctx, transformationID, code, name, optionalParams, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - authenticationIDs - The authentications associated with the current transformation. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) UpdateTransformationWithHTTPInfo(ctx context.Context, transformationID string, code string, name string, optionalParams *UpdateTransformationOptions, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/transformations/{transformationID}"
	requestPath = strings.ReplaceAll(requestPath, "{transformationID}", url.PathEscape(utils.ParameterToString(transformationID)))
...
//   - authenticationID - Universally unique identifier (UUID) of an authentication resource. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) ValidateSource(ctx context.Context, type_ SourceType, name string, optionalParams *ValidateSourceOptions, opts ...RequestOption) (*WatchResponse, error) {
	var returnValue *WatchResponse
...
//   - authenticationID - Universally unique identifier (UUID) of an authentication resource. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) ValidateSourceWithHTTPInfo(ctx context.Context, type_ SourceType, name string, optionalParams *ValidateSourceOptions, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - authenticationID - Universally unique identifier (UUID) of an authentication resource. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) ValidateSourceBeforeUpdate(ctx context.Context, sourceID string, optionalParams *ValidateSourceBeforeUpdateOptions, opts ...RequestOption) (*WatchResponse, error) {
	var returnValue *WatchResponse
...
//   - authenticationID - Universally unique identifier (UUID) of an authentication resource. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) ValidateSourceBeforeUpdateWithHTTPInfo(ctx context.Context, sourceID string, optionalParams *ValidateSourceBeforeUpdateOptions, opts ...RequestOption) (*http.Response, []byte, error) {
