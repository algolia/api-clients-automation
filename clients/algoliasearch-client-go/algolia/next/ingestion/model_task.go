...
func WithTaskFailureThreshold(val int) TaskOption {
	return func(f *Task) {
...
func (o *Task) GetFailureThreshold() int {
...
// and a boolean to check if the value has been set.
func (o *Task) GetFailureThresholdOk() (*int, bool) {
	if o == nil || o.FailureThreshold == nil {
		return nil, false
	}
...
func (o *Task) SetFailureThreshold(v int) *Task {
