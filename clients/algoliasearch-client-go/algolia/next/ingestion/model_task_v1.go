...
func WithTaskV1FailureThreshold(val int) TaskV1Option {
	return func(f *TaskV1) {
...
func (o *TaskV1) GetFailureThreshold() int {
...
// and a boolean to check if the value has been set.
func (o *TaskV1) GetFailureThresholdOk() (*int, bool) {
	if o == nil || o.FailureThreshold == nil {
		return nil, false
	}
...
// SetFailureThreshold gets a reference to the given int and assigns it to the FailureThreshold field.
func (o *TaskV1) SetFailureThreshold(v int) *TaskV1 {
