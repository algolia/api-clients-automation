...
func WithRunFailureThreshold(val int) RunOption {
	return func(f *Run) {
...
func (o *Run) GetFailureThreshold() int {
...
// and a boolean to check if the value has been set.
func (o *Run) GetFailureThresholdOk() (*int, bool) {
	if o == nil || o.FailureThreshold == nil {
		return nil, false
	}
...
func (o *Run) SetFailureThreshold(v int) *Run {
