...
func WithPoliciesCriticalThreshold(val int) PoliciesOption {
...
func (o *Policies) GetCriticalThreshold() int {
...
func (o *Policies) GetCriticalThresholdOk() (*int, bool) {
	if o == nil || o.CriticalThreshold == nil {
		return nil, false
	}
...
// SetCriticalThreshold gets a reference to the given int and assigns it to the CriticalThreshold field.
func (o *Policies) SetCriticalThreshold(v int) *Policies {
