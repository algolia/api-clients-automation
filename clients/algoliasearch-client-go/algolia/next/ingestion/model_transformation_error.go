...
func WithTransformationErrorCode(val int) TransformationErrorOption {
...
func (o *TransformationError) GetCode() int {
	if o == nil || o.Code == nil {
		var ret int
...
func (o *TransformationError) GetCodeOk() (*int, bool) {
	if o == nil || o.Code == nil {
		return nil, false
	}
...
func (o *TransformationError) SetCode(v int) *TransformationError {
	o.Code = &v
