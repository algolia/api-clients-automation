...
func NewAbTestsVariant(index string, trafficPercentage int, opts ...AbTestsVariantOption) *AbTestsVariant {
	this := &AbTestsVariant{}
	this.Index = index
...
func (o *AbTestsVariant) GetTrafficPercentage() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *AbTestsVariant) GetTrafficPercentageOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AbTestsVariant) SetTrafficPercentage(v int) *AbTestsVariant {
