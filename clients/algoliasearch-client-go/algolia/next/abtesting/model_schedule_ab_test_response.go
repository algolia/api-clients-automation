...
type ScheduleABTestResponse struct {
	...
	AbTestScheduleID int `json:"abTestScheduleID"`
}
...
func NewScheduleABTestResponse(abTestScheduleID int) *ScheduleABTestResponse {
...
func (o *ScheduleABTestResponse) GetAbTestScheduleID() int {
	if o == nil {
		var ret int
...
func (o *ScheduleABTestResponse) GetAbTestScheduleIDOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ScheduleABTestResponse) SetAbTestScheduleID(v int) *ScheduleABTestResponse {
