...
func NewListABTestsResponse(abtests []ABTest, count int, total int) *ListABTestsResponse {
...
func (o *ListABTestsResponse) GetCount() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *ListABTestsResponse) GetCountOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ListABTestsResponse) SetCount(v int) *ListABTestsResponse {
	o.Count = v
...
func (o *ListABTestsResponse) GetTotal() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *ListABTestsResponse) GetTotalOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ListABTestsResponse) SetTotal(v int) *ListABTestsResponse {
	o.Total = v
