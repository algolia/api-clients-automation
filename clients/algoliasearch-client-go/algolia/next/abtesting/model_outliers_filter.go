...
func WithOutliersFilterUsersCount(val int) OutliersFilterOption {
	return func(f *OutliersFilter) {
		f.UsersCount = &val
	}
}

func WithOutliersFilterTrackedSearchesCount(val int) OutliersFilterOption {
	return func(f *OutliersFilter) {
...
func (o *OutliersFilter) GetUsersCount() int {
...
func (o *OutliersFilter) GetUsersCountOk() (*int, bool) {
	if o == nil || o.UsersCount == nil {
		return nil, false
	}
...
func (o *OutliersFilter) SetUsersCount(v int) *OutliersFilter {
	o.UsersCount = &v
...
func (o *OutliersFilter) GetTrackedSearchesCount() int {
...
// and a boolean to check if the value has been set.
func (o *OutliersFilter) GetTrackedSearchesCountOk() (*int, bool) {
	if o == nil || o.TrackedSearchesCount == nil {
		return nil, false
	}
...
func (o *OutliersFilter) SetTrackedSearchesCount(v int) *OutliersFilter {
