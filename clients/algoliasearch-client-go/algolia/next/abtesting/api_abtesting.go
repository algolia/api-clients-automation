...
func (c *APIClient) AddABTests(ctx context.Context, name string, variants []AddABTestsVariant, endAt string, opts ...RequestOption) (*ABTestResponse, error) {
...
//   - endAt - End date and time of the A/B test, in RFC 3339 format.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) AddABTestsWithHTTPInfo(ctx context.Context, name string, variants []AddABTestsVariant, endAt string, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) DeleteABTest(ctx context.Context, id int32, opts ...RequestOption) (*ABTestResponse, error) {
	var returnValue *ABTestResponse
...
//   - id - Unique A/B test identifier.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) DeleteABTestWithHTTPInfo(ctx context.Context, id int32, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - variants - A/B test variants.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) EstimateABTest(ctx context.Context, configuration *EstimateConfiguration, variants []AddABTestsVariant, opts ...RequestOption) (*EstimateABTestResponse, error) {
...
//   - variants - A/B test variants.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) EstimateABTestWithHTTPInfo(ctx context.Context, configuration *EstimateConfiguration, variants []AddABTestsVariant, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - id - Unique A/B test identifier.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) GetABTest(ctx context.Context, id int32, opts ...RequestOption) (*ABTest, error) {
...
//   - id - Unique A/B test identifier.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) GetABTestWithHTTPInfo(ctx context.Context, id int32, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/2/abtests/{id}"
	requestPath = strings.ReplaceAll(requestPath, "{id}", url.PathEscape(utils.ParameterToString(id)))
...
//   - indexSuffix - Index name suffix. Only A/B tests for indices ending with this string are included in the response. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) ListABTestsWithHTTPInfo(ctx context.Context, optionalParams *ListABTestsOptions, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/2/abtests"
...
//   - endAt - End date and time of the A/B test, in RFC 3339 format.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) ScheduleABTest(ctx context.Context, name string, variants []AddABTestsVariant, scheduledAt string, endAt string, opts ...RequestOption) (*ScheduleABTestResponse, error) {
...
//   - endAt - End date and time of the A/B test, in RFC 3339 format.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) ScheduleABTestWithHTTPInfo(ctx context.Context, name string, variants []AddABTestsVariant, scheduledAt string, endAt string, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - id - Unique A/B test identifier.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) StopABTest(ctx context.Context, id int32, opts ...RequestOption) (*ABTestResponse, error) {
	var returnValue *ABTestResponse
...
//   - id - Unique A/B test identifier.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) StopABTestWithHTTPInfo(ctx context.Context, id int32, opts ...RequestOption) (*http.Response, []byte, error) {
