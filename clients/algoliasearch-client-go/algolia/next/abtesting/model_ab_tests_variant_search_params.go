...
func (o *AbTestsVariantSearchParams) GetTrafficPercentage() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *AbTestsVariantSearchParams) GetTrafficPercentageOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AbTestsVariantSearchParams) SetTrafficPercentage(v int) *AbTestsVariantSearchParams {
