...
type SourceIndex struct {
	...
	MinLetters *int       `json:"minLetters,omitempty"`
...
func WithSourceIndexMinHits(val int) SourceIndexOption {
	return func(f *SourceIndex) {
		f.MinHits = &val
	}
}

func WithSourceIndexMinLetters(val int) SourceIndexOption {
	return func(f *SourceIndex) {
		f.MinLetters = &val
	}
}
...
func (o *SourceIndex) GetMinHits() int {
...
// and a boolean to check if the value has been set.
func (o *SourceIndex) GetMinHitsOk() (*int, bool) {
	if o == nil || o.MinHits == nil {
		return nil, false
	}
...
// SetMinHits gets a reference to the given int and assigns it to the MinHits field.
func (o *SourceIndex) SetMinHits(v int) *SourceIndex {
	o.MinHits = &v
...
func (o *SourceIndex) GetMinLetters() int {
...
// and a boolean to check if the value has been set.
func (o *SourceIndex) GetMinLettersOk() (*int, bool) {
	if o == nil || o.MinLetters == nil {
		return nil, false
	}
...
// SetMinLetters gets a reference to the given int and assigns it to the MinLetters field.
func (o *SourceIndex) SetMinLetters(v int) *SourceIndex {
	o.MinLetters = &v
