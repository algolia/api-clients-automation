...
type LogFile struct {
	...
	ContextLevel *int `json:"contextLevel,omitempty"`
}
...
func WithLogFileContextLevel(val int) LogFileOption {
	return func(f *LogFile) {
		f.ContextLevel = &val
	}
}
...
func (o *LogFile) GetContextLevel() int {
...
// and a boolean to check if the value has been set.
func (o *LogFile) GetContextLevelOk() (*int, bool) {
	if o == nil || o.ContextLevel == nil {
		return nil, false
	}
...
// SetContextLevel gets a reference to the given int and assigns it to the ContextLevel field.
func (o *LogFile) SetContextLevel(v int) *LogFile {
	o.ContextLevel = &v
