...
//   - configurationWithIndex
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) CreateConfigWithHTTPInfo(ctx context.Context, configurationWithIndex *ConfigurationWithIndex, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) UpdateConfig(ctx context.Context, indexName string, sourceIndices []SourceIndex, optionalParams *UpdateConfigOptions, opts ...RequestOption) (*BaseResponse, error) {
	var returnValue *BaseResponse
...
//   - allowSpecialCharacters - Whether to include suggestions with special characters. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) UpdateConfigWithHTTPInfo(ctx context.Context, indexName string, sourceIndices []SourceIndex, optionalParams *UpdateConfigOptions, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/configs/{indexName}"
	requestPath = strings.ReplaceAll(requestPath, "{indexName}", url.PathEscape(utils.ParameterToString(indexName)))
