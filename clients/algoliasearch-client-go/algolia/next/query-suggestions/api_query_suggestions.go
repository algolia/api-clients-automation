...
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) UpdateConfig(indexName string, sourceIndices []SourceIndex, optionalParams *UpdateConfigOptions, opts ...RequestOption) (*BaseResponse, error) {
	var returnValue *BaseResponse
...
//   - allowSpecialCharacters - Whether to include suggestions with special characters. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) UpdateConfigWithHTTPInfo(indexName string, sourceIndices []SourceIndex, optionalParams *UpdateConfigOptions, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/configs/{indexName}"
	requestPath = strings.ReplaceAll(requestPath, "{indexName}", url.PathEscape(utils.ParameterToString(indexName)))
