...
func WithBaseResponseStatus(val int) BaseResponseOption {
...
func (o *BaseResponse) GetStatus() int {
...
func (o *BaseResponse) GetStatusOk() (*int, bool) {
	if o == nil || o.Status == nil {
		return nil, false
	}
...
func (o *BaseResponse) SetStatus(v int) *BaseResponse {
	o.Status = &v
