...
func (o *PersonalizationStrategyParams) GetPersonalizationImpact() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *PersonalizationStrategyParams) GetPersonalizationImpactOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PersonalizationStrategyParams) SetPersonalizationImpact(v int) *PersonalizationStrategyParams {
