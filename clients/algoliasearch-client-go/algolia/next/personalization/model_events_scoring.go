...
func NewEventsScoring(score int, eventName string, eventType EventType) *EventsScoring {
	this := &EventsScoring{}
	this.Score = score
...
func (o *EventsScoring) GetScore() int {
	if o == nil {
		var ret int
...
func (o *EventsScoring) GetScoreOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *EventsScoring) SetScore(v int) *EventsScoring {
	o.Score = v
