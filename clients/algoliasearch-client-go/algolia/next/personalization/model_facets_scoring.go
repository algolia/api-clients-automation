...
func NewFacetsScoring(score int, facetName string) *FacetsScoring {
	this := &FacetsScoring{}
	this.Score = score
...
func (o *FacetsScoring) GetScore() int {
	if o == nil {
		var ret int
...
func (o *FacetsScoring) GetScoreOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *FacetsScoring) SetScore(v int) *FacetsScoring {
	o.Score = v
