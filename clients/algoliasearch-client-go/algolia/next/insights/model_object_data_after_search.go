...
func WithObjectDataAfterSearchQuantity(val int) ObjectDataAfterSearchOption {
	return func(f *ObjectDataAfterSearch) {
		f.Quantity = &val
	}
}
...
func (o *ObjectDataAfterSearch) GetQuantity() int {
...
// and a boolean to check if the value has been set.
func (o *ObjectDataAfterSearch) GetQuantityOk() (*int, bool) {
	if o == nil || o.Quantity == nil {
		return nil, false
	}
...
// SetQuantity gets a reference to the given int and assigns it to the Quantity field.
func (o *ObjectDataAfterSearch) SetQuantity(v int) *ObjectDataAfterSearch {
	o.Quantity = &v
