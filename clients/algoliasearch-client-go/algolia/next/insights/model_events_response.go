...
func WithEventsResponseStatus(val int) EventsResponseOption {
	return func(f *EventsResponse) {
		f.Status = &val
	}
}
...
func (o *EventsResponse) GetStatus() int {
...
// and a boolean to check if the value has been set.
func (o *EventsResponse) GetStatusOk() (*int, bool) {
	if o == nil || o.Status == nil {
		return nil, false
	}
...
func (o *EventsResponse) SetStatus(v int) *EventsResponse {
	o.Status = &v
