...
func (o *ClickedObjectIDsAfterSearch) GetPositions() []int {
	if o == nil {
		var ret []int
...
// and a boolean to check if the value has been set.
func (o *ClickedObjectIDsAfterSearch) GetPositionsOk() ([]int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ClickedObjectIDsAfterSearch) SetPositions(v []int) *ClickedObjectIDsAfterSearch {
	o.Positions = v
