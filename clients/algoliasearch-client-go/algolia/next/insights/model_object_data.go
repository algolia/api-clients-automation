...
func WithObjectDataQuantity(val int) ObjectDataOption {
	return func(f *ObjectData) {
		f.Quantity = &val
	}
}
...
func (o *ObjectData) GetQuantity() int {
...
// and a boolean to check if the value has been set.
func (o *ObjectData) GetQuantityOk() (*int, bool) {
	if o == nil || o.Quantity == nil {
		return nil, false
	}
...
func (o *ObjectData) SetQuantity(v int) *ObjectData {
	o.Quantity = &v
