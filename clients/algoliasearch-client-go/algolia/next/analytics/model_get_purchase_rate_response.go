...
func (o *GetPurchaseRateResponse) GetTrackedSearchCount() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *GetPurchaseRateResponse) GetTrackedSearchCountOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetPurchaseRateResponse) SetTrackedSearchCount(v int) *GetPurchaseRateResponse {
...
func (o *GetPurchaseRateResponse) GetPurchaseCount() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *GetPurchaseRateResponse) GetPurchaseCountOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetPurchaseRateResponse) SetPurchaseCount(v int) *GetPurchaseRateResponse {
	o.PurchaseCount = v
