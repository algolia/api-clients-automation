...
func NewDailyAddToCartRates(rate utils.Nullable[float64], trackedSearchCount int, addToCartCount int, date string) *DailyAddToCartRates {
...
func (o *DailyAddToCartRates) GetTrackedSearchCount() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *DailyAddToCartRates) GetTrackedSearchCountOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DailyAddToCartRates) SetTrackedSearchCount(v int) *DailyAddToCartRates {
...
func (o *DailyAddToCartRates) GetAddToCartCount() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *DailyAddToCartRates) GetAddToCartCountOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DailyAddToCartRates) SetAddToCartCount(v int) *DailyAddToCartRates {
	o.AddToCartCount = v
