...
func (o *GetAverageClickPositionResponse) GetClickCount() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *GetAverageClickPositionResponse) GetClickCountOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetAverageClickPositionResponse) SetClickCount(v int) *GetAverageClickPositionResponse {
	o.ClickCount = v
