...
func NewGetNoResultsRateResponse(rate float64, count int, noResultCount int, dates []DailyNoResultsRates) *GetNoResultsRateResponse {
...
func (o *GetNoResultsRateResponse) GetCount() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *GetNoResultsRateResponse) GetCountOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetNoResultsRateResponse) SetCount(v int) *GetNoResultsRateResponse {
	o.Count = v
...
func (o *GetNoResultsRateResponse) GetNoResultCount() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *GetNoResultsRateResponse) GetNoResultCountOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetNoResultsRateResponse) SetNoResultCount(v int) *GetNoResultsRateResponse {
	o.NoResultCount = v
