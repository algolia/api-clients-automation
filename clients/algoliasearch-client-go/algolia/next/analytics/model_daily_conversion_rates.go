...
func NewDailyConversionRates(rate utils.Nullable[float64], trackedSearchCount int, conversionCount int, date string) *DailyConversionRates {
...
func (o *DailyConversionRates) GetTrackedSearchCount() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *DailyConversionRates) GetTrackedSearchCountOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DailyConversionRates) SetTrackedSearchCount(v int) *DailyConversionRates {
...
func (o *DailyConversionRates) GetConversionCount() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *DailyConversionRates) GetConversionCountOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DailyConversionRates) SetConversionCount(v int) *DailyConversionRates {
	o.ConversionCount = v
