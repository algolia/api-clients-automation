...
func NewDailyClickThroughRates(rate utils.Nullable[float64], clickCount int, trackedSearchCount int, date string) *DailyClickThroughRates {
...
func (o *DailyClickThroughRates) GetClickCount() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *DailyClickThroughRates) GetClickCountOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DailyClickThroughRates) SetClickCount(v int) *DailyClickThroughRates {
	o.ClickCount = v
...
func (o *DailyClickThroughRates) GetTrackedSearchCount() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *DailyClickThroughRates) GetTrackedSearchCountOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DailyClickThroughRates) SetTrackedSearchCount(v int) *DailyClickThroughRates {
