...
func NewGetTopFilterAttribute(attribute string, count int) *GetTopFilterAttribute {
...
func (o *GetTopFilterAttribute) GetCount() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *GetTopFilterAttribute) GetCountOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetTopFilterAttribute) SetCount(v int) *GetTopFilterAttribute {
	o.Count = v
