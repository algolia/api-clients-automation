...
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetAddToCartRate(index string, optionalParams *GetAddToCartRateOptions, opts ...RequestOption) (*GetAddToCartRateResponse, error) {
	var returnValue *GetAddToCartRateResponse

	res, resBody, err := c.GetAddToCartRateWithHTTPInfo(index, optionalParams, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments/).  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetAddToCartRateWithHTTPInfo(index string, optionalParams *GetAddToCartRateOptions, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments/).  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetAverageClickPosition(index string, optionalParams *GetAverageClickPositionOptions, opts ...RequestOption) (*GetAverageClickPositionResponse, error) {
	var returnValue *GetAverageClickPositionResponse

	res, resBody, err := c.GetAverageClickPositionWithHTTPInfo(index, optionalParams, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments/).  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetAverageClickPositionWithHTTPInfo(index string, optionalParams *GetAverageClickPositionOptions, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments/).  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetClickPositions(index string, optionalParams *GetClickPositionsOptions, opts ...RequestOption) (*GetClickPositionsResponse, error) {
	var returnValue *GetClickPositionsResponse

	res, resBody, err := c.GetClickPositionsWithHTTPInfo(index, optionalParams, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments/).  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetClickPositionsWithHTTPInfo(index string, optionalParams *GetClickPositionsOptions, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments/).  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetClickThroughRate(index string, optionalParams *GetClickThroughRateOptions, opts ...RequestOption) (*GetClickThroughRateResponse, error) {
	var returnValue *GetClickThroughRateResponse

	res, resBody, err := c.GetClickThroughRateWithHTTPInfo(index, optionalParams, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments/).  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetClickThroughRateWithHTTPInfo(index string, optionalParams *GetClickThroughRateOptions, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments/).  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetConversionRate(index string, optionalParams *GetConversionRateOptions, opts ...RequestOption) (*GetConversionRateResponse, error) {
	var returnValue *GetConversionRateResponse

	res, resBody, err := c.GetConversionRateWithHTTPInfo(index, optionalParams, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments/).  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetConversionRateWithHTTPInfo(index string, optionalParams *GetConversionRateOptions, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments/).  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetNoClickRate(index string, optionalParams *GetNoClickRateOptions, opts ...RequestOption) (*GetNoClickRateResponse, error) {
	var returnValue *GetNoClickRateResponse

	res, resBody, err := c.GetNoClickRateWithHTTPInfo(index, optionalParams, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments/).  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetNoClickRateWithHTTPInfo(index string, optionalParams *GetNoClickRateOptions, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments/).  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetNoResultsRate(index string, optionalParams *GetNoResultsRateOptions, opts ...RequestOption) (*GetNoResultsRateResponse, error) {
	var returnValue *GetNoResultsRateResponse

	res, resBody, err := c.GetNoResultsRateWithHTTPInfo(index, optionalParams, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments/).  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetNoResultsRateWithHTTPInfo(index string, optionalParams *GetNoResultsRateOptions, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments/).  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetPurchaseRate(index string, optionalParams *GetPurchaseRateOptions, opts ...RequestOption) (*GetPurchaseRateResponse, error) {
	var returnValue *GetPurchaseRateResponse

	res, resBody, err := c.GetPurchaseRateWithHTTPInfo(index, optionalParams, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments/).  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetPurchaseRateWithHTTPInfo(index string, optionalParams *GetPurchaseRateOptions, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments/).  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetRevenue(index string, optionalParams *GetRevenueOptions, opts ...RequestOption) (*GetRevenue, error) {
	var returnValue *GetRevenue

	res, resBody, err := c.GetRevenueWithHTTPInfo(index, optionalParams, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments/).  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetRevenueWithHTTPInfo(index string, optionalParams *GetRevenueOptions, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments/).  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetSearchesCount(index string, optionalParams *GetSearchesCountOptions, opts ...RequestOption) (*GetSearchesCountResponse, error) {
	var returnValue *GetSearchesCountResponse

	res, resBody, err := c.GetSearchesCountWithHTTPInfo(index, optionalParams, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments/).  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetSearchesCountWithHTTPInfo(index string, optionalParams *GetSearchesCountOptions, opts ...RequestOption) (*http.Response, []byte, error) {
...
func (o *GetSearchesNoClicksOptions) WithLimit(limit int32) *GetSearchesNoClicksOptions {
	o.Limit = &limit
	return o
}

// WithOffset Position of the first item to return.
func (o *GetSearchesNoClicksOptions) WithOffset(offset int32) *GetSearchesNoClicksOptions {
	o.Offset = &offset
	return o
}
...
//   - tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments/).  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetSearchesNoClicks(index string, optionalParams *GetSearchesNoClicksOptions, opts ...RequestOption) (*GetSearchesNoClicksResponse, error) {
	var returnValue *GetSearchesNoClicksResponse

	res, resBody, err := c.GetSearchesNoClicksWithHTTPInfo(index, optionalParams, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments/).  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetSearchesNoClicksWithHTTPInfo(index string, optionalParams *GetSearchesNoClicksOptions, opts ...RequestOption) (*http.Response, []byte, error) {
...
// WithLimit Number of items to return.
func (o *GetSearchesNoResultsOptions) WithLimit(limit int32) *GetSearchesNoResultsOptions {
	o.Limit = &limit
	return o
}

// WithOffset Position of the first item to return.
func (o *GetSearchesNoResultsOptions) WithOffset(offset int32) *GetSearchesNoResultsOptions {
	o.Offset = &offset
	return o
}
...
//   - tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments/).  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetSearchesNoResults(index string, optionalParams *GetSearchesNoResultsOptions, opts ...RequestOption) (*GetSearchesNoResultsResponse, error) {
	var returnValue *GetSearchesNoResultsResponse

	res, resBody, err := c.GetSearchesNoResultsWithHTTPInfo(index, optionalParams, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments/).  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetSearchesNoResultsWithHTTPInfo(index string, optionalParams *GetSearchesNoResultsOptions, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - index - Index name.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetStatus(index string, opts ...RequestOption) (*GetStatusResponse, error) {
	var returnValue *GetStatusResponse

	res, resBody, err := c.GetStatusWithHTTPInfo(index, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - index - Index name.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetStatusWithHTTPInfo(index string, opts ...RequestOption) (*http.Response, []byte, error) {
...
// WithLimit Number of items to return.
func (o *GetTopCountriesOptions) WithLimit(limit int32) *GetTopCountriesOptions {
	o.Limit = &limit
	return o
}

// WithOffset Position of the first item to return.
func (o *GetTopCountriesOptions) WithOffset(offset int32) *GetTopCountriesOptions {
	o.Offset = &offset
	return o
}
...
//   - tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments/).  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetTopCountries(index string, optionalParams *GetTopCountriesOptions, opts ...RequestOption) (*GetTopCountriesResponse, error) {
	var returnValue *GetTopCountriesResponse

	res, resBody, err := c.GetTopCountriesWithHTTPInfo(index, optionalParams, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments/).  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetTopCountriesWithHTTPInfo(index string, optionalParams *GetTopCountriesOptions, opts ...RequestOption) (*http.Response, []byte, error) {
...
// WithLimit Number of items to return.
func (o *GetTopFilterAttributesOptions) WithLimit(limit int32) *GetTopFilterAttributesOptions {
	o.Limit = &limit
	return o
}

// WithOffset Position of the first item to return.
func (o *GetTopFilterAttributesOptions) WithOffset(offset int32) *GetTopFilterAttributesOptions {
	o.Offset = &offset
	return o
}
...
//   - tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments/).  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetTopFilterAttributes(index string, optionalParams *GetTopFilterAttributesOptions, opts ...RequestOption) (*GetTopFilterAttributesResponse, error) {
	var returnValue *GetTopFilterAttributesResponse

	res, resBody, err := c.GetTopFilterAttributesWithHTTPInfo(index, optionalParams, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments/).  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetTopFilterAttributesWithHTTPInfo(index string, optionalParams *GetTopFilterAttributesOptions, opts ...RequestOption) (*http.Response, []byte, error) {
...
// WithLimit Number of items to return.
func (o *GetTopFilterForAttributeOptions) WithLimit(limit int32) *GetTopFilterForAttributeOptions {
	o.Limit = &limit
	return o
}

// WithOffset Position of the first item to return.
func (o *GetTopFilterForAttributeOptions) WithOffset(offset int32) *GetTopFilterForAttributeOptions {
	o.Offset = &offset
	return o
}
...
//   - tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments/).  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetTopFilterForAttribute(attribute string, index string, optionalParams *GetTopFilterForAttributeOptions, opts ...RequestOption) (*GetTopFilterForAttributeResponse, error) {
	var returnValue *GetTopFilterForAttributeResponse

	res, resBody, err := c.GetTopFilterForAttributeWithHTTPInfo(attribute, index, optionalParams, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments/).  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetTopFilterForAttributeWithHTTPInfo(attribute string, index string, optionalParams *GetTopFilterForAttributeOptions, opts ...RequestOption) (*http.Response, []byte, error) {
...
// WithLimit Number of items to return.
func (o *GetTopFiltersNoResultsOptions) WithLimit(limit int32) *GetTopFiltersNoResultsOptions {
	o.Limit = &limit
	return o
}

// WithOffset Position of the first item to return.
func (o *GetTopFiltersNoResultsOptions) WithOffset(offset int32) *GetTopFiltersNoResultsOptions {
	o.Offset = &offset
	return o
}
...
//   - tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments/).  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetTopFiltersNoResults(index string, optionalParams *GetTopFiltersNoResultsOptions, opts ...RequestOption) (*GetTopFiltersNoResultsResponse, error) {
	var returnValue *GetTopFiltersNoResultsResponse

	res, resBody, err := c.GetTopFiltersNoResultsWithHTTPInfo(index, optionalParams, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments/).  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetTopFiltersNoResultsWithHTTPInfo(index string, optionalParams *GetTopFiltersNoResultsOptions, opts ...RequestOption) (*http.Response, []byte, error) {
...
// WithLimit Number of items to return.
func (o *GetTopHitsOptions) WithLimit(limit int32) *GetTopHitsOptions {
	o.Limit = &limit
	return o
}

// WithOffset Position of the first item to return.
func (o *GetTopHitsOptions) WithOffset(offset int32) *GetTopHitsOptions {
	o.Offset = &offset
	return o
}
...
//   - tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments/).  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetTopHits(index string, optionalParams *GetTopHitsOptions, opts ...RequestOption) (*GetTopHitsResponse, error) {
	var returnValue *GetTopHitsResponse

	res, resBody, err := c.GetTopHitsWithHTTPInfo(index, optionalParams, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments/).  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetTopHitsWithHTTPInfo(index string, optionalParams *GetTopHitsOptions, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/2/hits"
...
// WithLimit Number of items to return.
func (o *GetTopSearchesOptions) WithLimit(limit int32) *GetTopSearchesOptions {
	o.Limit = &limit
	return o
}

// WithOffset Position of the first item to return.
func (o *GetTopSearchesOptions) WithOffset(offset int32) *GetTopSearchesOptions {
	o.Offset = &offset
	return o
}
...
//   - tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments/).  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetTopSearches(index string, optionalParams *GetTopSearchesOptions, opts ...RequestOption) (*GetTopSearchesResponse, error) {
	var returnValue *GetTopSearchesResponse

	res, resBody, err := c.GetTopSearchesWithHTTPInfo(index, optionalParams, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments/).  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetTopSearchesWithHTTPInfo(index string, optionalParams *GetTopSearchesOptions, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments/).  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetUsersCount(index string, optionalParams *GetUsersCountOptions, opts ...RequestOption) (*GetUsersCountResponse, error) {
	var returnValue *GetUsersCountResponse

	res, resBody, err := c.GetUsersCountWithHTTPInfo(index, optionalParams, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments/).  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetUsersCountWithHTTPInfo(index string, optionalParams *GetUsersCountOptions, opts ...RequestOption) (*http.Response, []byte, error) {
