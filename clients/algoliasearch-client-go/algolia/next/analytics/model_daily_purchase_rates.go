...
func NewDailyPurchaseRates(rate utils.Nullable[float64], trackedSearchCount int, purchaseCount int, date string) *DailyPurchaseRates {
...
func (o *DailyPurchaseRates) GetTrackedSearchCount() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *DailyPurchaseRates) GetTrackedSearchCountOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DailyPurchaseRates) SetTrackedSearchCount(v int) *DailyPurchaseRates {
...
func (o *DailyPurchaseRates) GetPurchaseCount() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *DailyPurchaseRates) GetPurchaseCountOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DailyPurchaseRates) SetPurchaseCount(v int) *DailyPurchaseRates {
	o.PurchaseCount = v
