...
func (o *TopHitWithAnalytics) GetCount() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *TopHitWithAnalytics) GetCountOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TopHitWithAnalytics) SetCount(v int) *TopHitWithAnalytics {
	o.Count = v
...
func (o *TopHitWithAnalytics) GetTrackedHitCount() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *TopHitWithAnalytics) GetTrackedHitCountOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TopHitWithAnalytics) SetTrackedHitCount(v int) *TopHitWithAnalytics {
	o.TrackedHitCount = v
...
func (o *TopHitWithAnalytics) GetClickCount() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *TopHitWithAnalytics) GetClickCountOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TopHitWithAnalytics) SetClickCount(v int) *TopHitWithAnalytics {
	o.ClickCount = v
...
func (o *TopHitWithAnalytics) GetConversionCount() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *TopHitWithAnalytics) GetConversionCountOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TopHitWithAnalytics) SetConversionCount(v int) *TopHitWithAnalytics {
	o.ConversionCount = v
