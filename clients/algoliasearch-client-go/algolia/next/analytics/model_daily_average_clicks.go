...
func NewDailyAverageClicks(average utils.Nullable[float64], clickCount int, date string) *DailyAverageClicks {
...
func (o *DailyAverageClicks) GetClickCount() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *DailyAverageClicks) GetClickCountOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DailyAverageClicks) SetClickCount(v int) *DailyAverageClicks {
	o.ClickCount = v
