...
func NewGetTopFiltersNoResultsValues(count int, values []GetTopFiltersNoResultsValue) *GetTopFiltersNoResultsValues {
...
func (o *GetTopFiltersNoResultsValues) GetCount() int {
	if o == nil {
		var ret int
...
func (o *GetTopFiltersNoResultsValues) GetCountOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetTopFiltersNoResultsValues) SetCount(v int) *GetTopFiltersNoResultsValues {
	o.Count = v
