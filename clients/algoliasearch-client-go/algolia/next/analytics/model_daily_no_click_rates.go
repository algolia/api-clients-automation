...
func NewDailyNoClickRates(rate float64, count int, noClickCount int, date string) *DailyNoClickRates {
...
func (o *DailyNoClickRates) GetCount() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *DailyNoClickRates) GetCountOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DailyNoClickRates) SetCount(v int) *DailyNoClickRates {
	o.Count = v
...
func (o *DailyNoClickRates) GetNoClickCount() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *DailyNoClickRates) GetNoClickCountOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DailyNoClickRates) SetNoClickCount(v int) *DailyNoClickRates {
	o.NoClickCount = v
