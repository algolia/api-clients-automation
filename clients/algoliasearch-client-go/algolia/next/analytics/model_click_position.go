...
func WithClickPositionPosition(val []int) ClickPositionOption {
	return func(f *ClickPosition) {
		f.Position = val
	}
}

func WithClickPositionClickCount(val int) ClickPositionOption {
	return func(f *ClickPosition) {
		f.ClickCount = &val
	}
}
...
func (o *ClickPosition) GetPosition() []int {
...
func (o *ClickPosition) GetPositionOk() ([]int, bool) {
	if o == nil || o.Position == nil {
		return nil, false
	}
...
func (o *ClickPosition) SetPosition(v []int) *ClickPosition {
	o.Position = v
...
func (o *ClickPosition) GetClickCount() int {
...
// and a boolean to check if the value has been set.
func (o *ClickPosition) GetClickCountOk() (*int, bool) {
	if o == nil || o.ClickCount == nil {
		return nil, false
	}
...
// SetClickCount gets a reference to the given int and assigns it to the ClickCount field.
func (o *ClickPosition) SetClickCount(v int) *ClickPosition {
	o.ClickCount = &v
