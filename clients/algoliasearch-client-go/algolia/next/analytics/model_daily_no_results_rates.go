...
func NewDailyNoResultsRates(date string, noResultCount int, count int, rate float64) *DailyNoResultsRates {
...
func (o *DailyNoResultsRates) GetNoResultCount() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *DailyNoResultsRates) GetNoResultCountOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DailyNoResultsRates) SetNoResultCount(v int) *DailyNoResultsRates {
	o.NoResultCount = v
...
func (o *DailyNoResultsRates) GetCount() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *DailyNoResultsRates) GetCountOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DailyNoResultsRates) SetCount(v int) *DailyNoResultsRates {
	o.Count = v
