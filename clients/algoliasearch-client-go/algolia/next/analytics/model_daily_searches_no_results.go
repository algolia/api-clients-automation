...
type DailySearchesNoResults struct {
	...
	WithFilterCount int `json:"withFilterCount"`
}
...
func NewDailySearchesNoResults(search string, count int, withFilterCount int) *DailySearchesNoResults {
...
func (o *DailySearchesNoResults) GetCount() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *DailySearchesNoResults) GetCountOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DailySearchesNoResults) SetCount(v int) *DailySearchesNoResults {
	o.Count = v
...
func (o *DailySearchesNoResults) GetWithFilterCount() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *DailySearchesNoResults) GetWithFilterCountOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DailySearchesNoResults) SetWithFilterCount(v int) *DailySearchesNoResults {
	o.WithFilterCount = v
