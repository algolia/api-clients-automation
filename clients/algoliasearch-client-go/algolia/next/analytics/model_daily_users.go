...
func NewDailyUsers(date string, count int) *DailyUsers {
	this := &DailyUsers{}
	this.Date = date
	this.Count = count
...
func (o *DailyUsers) GetCount() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *DailyUsers) GetCountOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DailyUsers) SetCount(v int) *DailyUsers {
	o.Count = v
