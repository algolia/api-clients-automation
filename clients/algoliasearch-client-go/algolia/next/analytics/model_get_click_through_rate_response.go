...
func (o *GetClickThroughRateResponse) GetClickCount() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *GetClickThroughRateResponse) GetClickCountOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetClickThroughRateResponse) SetClickCount(v int) *GetClickThroughRateResponse {
	o.ClickCount = v
...
func (o *GetClickThroughRateResponse) GetTrackedSearchCount() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *GetClickThroughRateResponse) GetTrackedSearchCountOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetClickThroughRateResponse) SetTrackedSearchCount(v int) *GetClickThroughRateResponse {
