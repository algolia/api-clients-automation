...
func NewDailySearches(date string, count int) *DailySearches {
	this := &DailySearches{}
	this.Date = date
	this.Count = count
...
func (o *DailySearches) GetCount() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *DailySearches) GetCountOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DailySearches) SetCount(v int) *DailySearches {
	o.Count = v
