...
func (o *GetConversionRateResponse) GetTrackedSearchCount() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *GetConversionRateResponse) GetTrackedSearchCountOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetConversionRateResponse) SetTrackedSearchCount(v int) *GetConversionRateResponse {
...
func (o *GetConversionRateResponse) GetConversionCount() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *GetConversionRateResponse) GetConversionCountOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetConversionRateResponse) SetConversionCount(v int) *GetConversionRateResponse {
	o.ConversionCount = v
