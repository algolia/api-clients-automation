...
func NewDailySearchesNoClicks(search string, count int, nbHits int) *DailySearchesNoClicks {
...
func (o *DailySearchesNoClicks) GetCount() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *DailySearchesNoClicks) GetCountOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DailySearchesNoClicks) SetCount(v int) *DailySearchesNoClicks {
	o.Count = v
...
func (o *DailySearchesNoClicks) GetNbHits() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *DailySearchesNoClicks) GetNbHitsOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DailySearchesNoClicks) SetNbHits(v int) *DailySearchesNoClicks {
	o.NbHits = v
