...
func (o *GetAddToCartRateResponse) GetTrackedSearchCount() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *GetAddToCartRateResponse) GetTrackedSearchCountOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetAddToCartRateResponse) SetTrackedSearchCount(v int) *GetAddToCartRateResponse {
...
func (o *GetAddToCartRateResponse) GetAddToCartCount() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *GetAddToCartRateResponse) GetAddToCartCountOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetAddToCartRateResponse) SetAddToCartCount(v int) *GetAddToCartRateResponse {
	o.AddToCartCount = v
