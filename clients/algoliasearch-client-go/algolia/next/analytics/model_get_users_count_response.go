...
func NewGetUsersCountResponse(count int, dates []DailyUsers) *GetUsersCountResponse {
...
func (o *GetUsersCountResponse) GetCount() int {
	if o == nil {
		var ret int
...
func (o *GetUsersCountResponse) GetCountOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetUsersCountResponse) SetCount(v int) *GetUsersCountResponse {
	o.Count = v
