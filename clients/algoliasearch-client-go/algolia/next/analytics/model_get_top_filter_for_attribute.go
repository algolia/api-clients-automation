...
func NewGetTopFilterForAttribute(attribute string, operator Operator, value string, count int) *GetTopFilterForAttribute {
...
func (o *GetTopFilterForAttribute) GetCount() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *GetTopFilterForAttribute) GetCountOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetTopFilterForAttribute) SetCount(v int) *GetTopFilterForAttribute {
	o.Count = v
