...
//   - params
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) SearchForFacetValues(compositionID string, facetName string, params *SearchForFacetValuesParams, opts ...RequestOption) (*SearchForFacetValuesResponse, error) {
...
//   - params
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) SearchForFacetValuesWithHTTPInfo(compositionID string, facetName string, params *SearchForFacetValuesParams, opts ...RequestOption) (*http.Response, []byte, error) {
