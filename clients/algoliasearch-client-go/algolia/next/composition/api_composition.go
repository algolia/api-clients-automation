...
//   - params
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) SearchWithHTTPInfo(ctx context.Context, compositionID string, params *Params, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - params
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) SearchForFacetValues(ctx context.Context, compositionID string, facetName string, params *SearchForFacetValuesParams, opts ...RequestOption) (*SearchForFacetValuesResponse, error) {
...
//   - params
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) SearchForFacetValuesWithHTTPInfo(ctx context.Context, compositionID string, facetName string, params *SearchForFacetValuesParams, opts ...RequestOption) (*http.Response, []byte, error) {
