...
func NewInjectedItem(key string, source InjectedItemSource, position int, length int, opts ...InjectedItemOption) *InjectedItem {
	this := &InjectedItem{}
	this.Key = key
	this.Source = source
...
func (o *InjectedItem) GetPosition() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *InjectedItem) GetPositionOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *InjectedItem) SetPosition(v int) *InjectedItem {
	o.Position = v
...
func (o *InjectedItem) GetLength() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *InjectedItem) GetLengthOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *InjectedItem) SetLength(v int) *InjectedItem {
	o.Length = v
