...
func WithSearchForFacetValuesParamsMaxFacetHits(val int) SearchForFacetValuesParamsOption {
	return func(f *SearchForFacetValuesParams) {
		f.MaxFacetHits = &val
	}
}
...
func (o *SearchForFacetValuesParams) GetMaxFacetHits() int {
...
// and a boolean to check if the value has been set.
func (o *SearchForFacetValuesParams) GetMaxFacetHitsOk() (*int, bool) {
	if o == nil || o.MaxFacetHits == nil {
		return nil, false
	}
...
func (o *SearchForFacetValuesParams) SetMaxFacetHits(v int) *SearchForFacetValuesParams {
	o.MaxFacetHits = &v
