...
func WithSearchForFacetValuesResultsProcessingTimeMS(val int) SearchForFacetValuesResultsOption {
...
func (o *SearchForFacetValuesResults) GetProcessingTimeMS() int {
...
// and a boolean to check if the value has been set.
func (o *SearchForFacetValuesResults) GetProcessingTimeMSOk() (*int, bool) {
	if o == nil || o.ProcessingTimeMS == nil {
		return nil, false
	}
...
func (o *SearchForFacetValuesResults) SetProcessingTimeMS(v int) *SearchForFacetValuesResults {
