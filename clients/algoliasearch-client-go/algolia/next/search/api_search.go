...
//   - validity - Duration (in seconds) after which the API key expires. By default, API keys don't expire.  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) AddApiKeyWithHTTPInfo(ctx context.Context, acl []Acl, optionalParams *AddApiKeyOptions, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/keys"
...
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) AddOrUpdateObject(ctx context.Context, indexName string, objectID string, body map[string]any, opts ...RequestOption) (*UpdatedAtWithObjectIdResponse, error) {
...
//   - body - The record. A schemaless object with attributes that are useful in the context of search and discovery.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) AddOrUpdateObjectWithHTTPInfo(ctx context.Context, indexName string, objectID string, body map[string]any, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - description - Source description.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) AppendSourceWithHTTPInfo(ctx context.Context, source string, description *string, opts ...RequestOption) (*http.Response, []byte, error) {
...
//
// Deprecated: AssignUserId is deprecated.
func (c *APIClient) AssignUserIdWithHTTPInfo(ctx context.Context, xAlgoliaUserID string, cluster string, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - requests
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) BatchWithHTTPInfo(ctx context.Context, indexName string, requests []BatchRequest, opts ...RequestOption) (*http.Response, []byte, error) {
...
func (c *APIClient) BatchAssignUserIds(ctx context.Context, xAlgoliaUserID string, cluster string, users []string, opts ...RequestOption) (*CreatedAtResponse, error) {
	var returnValue *CreatedAtResponse
...
//
// Deprecated: BatchAssignUserIds is deprecated.
func (c *APIClient) BatchAssignUserIdsWithHTTPInfo(ctx context.Context, xAlgoliaUserID string, cluster string, users []string, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) BatchDictionaryEntries(ctx context.Context, dictionaryName DictionaryType, requests []BatchDictionaryEntriesRequest, clearExistingDictionaryEntries *bool, opts ...RequestOption) (*UpdatedAtResponse, error) {
...
//   - clearExistingDictionaryEntries - Whether to replace all custom entries in the dictionary with the ones sent with this request.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) BatchDictionaryEntriesWithHTTPInfo(ctx context.Context, dictionaryName DictionaryType, requests []BatchDictionaryEntriesRequest, clearExistingDictionaryEntries *bool, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - browseParams
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) BrowseWithHTTPInfo(ctx context.Context, indexName string, browseParams *BrowseParams, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - forwardToReplicas - Whether changes are applied to replica indices.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) ClearRulesWithHTTPInfo(ctx context.Context, indexName string, forwardToReplicas *bool, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - forwardToReplicas - Whether changes are applied to replica indices.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) ClearSynonymsWithHTTPInfo(ctx context.Context, indexName string, forwardToReplicas *bool, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) DeleteBy(ctx context.Context, indexName string, optionalParams *DeleteByOptions, opts ...RequestOption) (*UpdatedAtResponse, error) {
	var returnValue *UpdatedAtResponse
...
//   - insidePolygon - Coordinates of a polygon in which to search.  Polygons are defined by 3 to 10,000 points. Each point is represented by its latitude and longitude. Provide multiple polygons as nested arrays. For more information, see [filtering inside polygons](https://www.algolia.com/doc/guides/managing-results/refine-results/geolocation/#filtering-inside-rectangular-or-polygonal-areas). This parameter is ignored if you also specify `insideBoundingBox`.  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) DeleteByWithHTTPInfo(ctx context.Context, indexName string, optionalParams *DeleteByOptions, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - objectID - Unique record identifier.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) DeleteObjectWithHTTPInfo(ctx context.Context, indexName string, objectID string, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/indexes/{indexName}/{objectID}"
	requestPath = strings.ReplaceAll(requestPath, "{indexName}", url.PathEscape(utils.ParameterToString(indexName)))
	requestPath = strings.ReplaceAll(requestPath, "{objectID}", url.PathEscape(utils.ParameterToString(objectID)))
...
//   - forwardToReplicas - Whether changes are applied to replica indices.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) DeleteRule(ctx context.Context, indexName string, objectID string, forwardToReplicas *bool, opts ...RequestOption) (*UpdatedAtResponse, error) {
	var returnValue *UpdatedAtResponse
...
//   - forwardToReplicas - Whether changes are applied to replica indices.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) DeleteRuleWithHTTPInfo(ctx context.Context, indexName string, objectID string, forwardToReplicas *bool, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - forwardToReplicas - Whether changes are applied to replica indices.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) DeleteSynonym(ctx context.Context, indexName string, objectID string, forwardToReplicas *bool, opts ...RequestOption) (*DeletedAtResponse, error) {
	var returnValue *DeletedAtResponse
...
//   - forwardToReplicas - Whether changes are applied to replica indices.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) DeleteSynonymWithHTTPInfo(ctx context.Context, indexName string, objectID string, forwardToReplicas *bool, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) GetObject(ctx context.Context, indexName string, objectID string, attributesToRetrieve *[]string, opts ...RequestOption) (*map[string]any, error) {
	var returnValue *map[string]any
...
//   - attributesToRetrieve - Attributes to include with the records in the response. This is useful to reduce the size of the API response. By default, all retrievable attributes are returned.  `objectID` is always retrieved.  Attributes included in `unretrievableAttributes` won't be retrieved unless the request is authenticated with the admin API key.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) GetObjectWithHTTPInfo(ctx context.Context, indexName string, objectID string, attributesToRetrieve *[]string, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/indexes/{indexName}/{objectID}"
	requestPath = strings.ReplaceAll(requestPath, "{indexName}", url.PathEscape(utils.ParameterToString(indexName)))
	requestPath = strings.ReplaceAll(requestPath, "{objectID}", url.PathEscape(utils.ParameterToString(objectID)))
...
//   - objectID - Unique identifier of a rule object.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) GetRuleWithHTTPInfo(ctx context.Context, indexName string, objectID string, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/indexes/{indexName}/rules/{objectID}"
	requestPath = strings.ReplaceAll(requestPath, "{indexName}", url.PathEscape(utils.ParameterToString(indexName)))
	requestPath = strings.ReplaceAll(requestPath, "{objectID}", url.PathEscape(utils.ParameterToString(objectID)))
...
//   - indexName - Name of the index on which to perform the operation.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) GetSettings(ctx context.Context, indexName string, opts ...RequestOption) (*SettingsResponse, error) {
	var returnValue *SettingsResponse

	res, resBody, err := c.GetSettingsWithHTTPInfo(ctx, indexName, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - indexName - Name of the index on which to perform the operation.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) GetSettingsWithHTTPInfo(ctx context.Context, indexName string, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - objectID - Unique identifier of a synonym object.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) GetSynonymWithHTTPInfo(ctx context.Context, indexName string, objectID string, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/indexes/{indexName}/synonyms/{objectID}"
	requestPath = strings.ReplaceAll(requestPath, "{indexName}", url.PathEscape(utils.ParameterToString(indexName)))
	requestPath = strings.ReplaceAll(requestPath, "{objectID}", url.PathEscape(utils.ParameterToString(objectID)))
...
//   - hitsPerPage - Number of hits per page. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) ListIndicesWithHTTPInfo(ctx context.Context, optionalParams *ListIndicesOptions, opts ...RequestOption) (*http.Response, []byte, error) {
...
//
// Deprecated: ListUserIds is deprecated.
func (c *APIClient) ListUserIdsWithHTTPInfo(ctx context.Context, optionalParams *ListUserIdsOptions, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/clusters/mapping"
...
//   - requests
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) MultipleBatchWithHTTPInfo(ctx context.Context, requests []MultipleBatchRequest, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) OperationIndex(ctx context.Context, indexName string, operation OperationType, destination string, scope *[]ScopeType, opts ...RequestOption) (*UpdatedAtResponse, error) {
	var returnValue *UpdatedAtResponse
...
//   - scope - **Only for copying.**  If you specify a scope, only the selected scopes are copied. Records and the other scopes are left unchanged. If you omit the `scope` parameter, everything is copied: records, settings, synonyms, and rules.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) OperationIndexWithHTTPInfo(ctx context.Context, indexName string, operation OperationType, destination string, scope *[]ScopeType, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) PartialUpdateObject(ctx context.Context, indexName string, objectID string, attributesToUpdate map[string]any, createIfNotExists *bool, opts ...RequestOption) (*UpdatedAtWithObjectIdResponse, error) {
	var returnValue *UpdatedAtWithObjectIdResponse
...
//   - createIfNotExists - Whether to create a new record if it doesn't exist.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) PartialUpdateObjectWithHTTPInfo(ctx context.Context, indexName string, objectID string, attributesToUpdate map[string]any, createIfNotExists *bool, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - body - The record. A schemaless object with attributes that are useful in the context of search and discovery.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) SaveObjectWithHTTPInfo(ctx context.Context, indexName string, body map[string]any, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/indexes/{indexName}"
	requestPath = strings.ReplaceAll(requestPath, "{indexName}", url.PathEscape(utils.ParameterToString(indexName)))
...
//   - forwardToReplicas - Whether changes are applied to replica indices.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) SaveRule(ctx context.Context, indexName string, objectID string, rule *Rule, forwardToReplicas *bool, opts ...RequestOption) (*UpdatedAtResponse, error) {
	var returnValue *UpdatedAtResponse
...
//   - forwardToReplicas - Whether changes are applied to replica indices.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) SaveRuleWithHTTPInfo(ctx context.Context, indexName string, objectID string, rule *Rule, forwardToReplicas *bool, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/indexes/{indexName}/rules/{objectID}"
	requestPath = strings.ReplaceAll(requestPath, "{indexName}", url.PathEscape(utils.ParameterToString(indexName)))
	requestPath = strings.ReplaceAll(requestPath, "{objectID}", url.PathEscape(utils.ParameterToString(objectID)))
...
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) SaveRules(ctx context.Context, indexName string, rules []Rule, optionalParams *SaveRulesOptions, opts ...RequestOption) (*UpdatedAtResponse, error) {
	var returnValue *UpdatedAtResponse
...
//   - clearExistingRules - Whether existing rules should be deleted before adding this batch. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) SaveRulesWithHTTPInfo(ctx context.Context, indexName string, rules []Rule, optionalParams *SaveRulesOptions, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - forwardToReplicas - Whether changes are applied to replica indices.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) SaveSynonym(ctx context.Context, indexName string, objectID string, synonymHit *SynonymHit, forwardToReplicas *bool, opts ...RequestOption) (*SaveSynonymResponse, error) {
...
//   - forwardToReplicas - Whether changes are applied to replica indices.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) SaveSynonymWithHTTPInfo(ctx context.Context, indexName string, objectID string, synonymHit *SynonymHit, forwardToReplicas *bool, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/indexes/{indexName}/synonyms/{objectID}"
	requestPath = strings.ReplaceAll(requestPath, "{indexName}", url.PathEscape(utils.ParameterToString(indexName)))
	requestPath = strings.ReplaceAll(requestPath, "{objectID}", url.PathEscape(utils.ParameterToString(objectID)))
...
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) SaveSynonyms(ctx context.Context, indexName string, synonymHit []SynonymHit, optionalParams *SaveSynonymsOptions, opts ...RequestOption) (*UpdatedAtResponse, error) {
	var returnValue *UpdatedAtResponse
...
//   - replaceExistingSynonyms - Whether to replace all synonyms in the index with the ones sent with this request. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) SaveSynonymsWithHTTPInfo(ctx context.Context, indexName string, synonymHit []SynonymHit, optionalParams *SaveSynonymsOptions, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - strategy
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) SearchWithHTTPInfo(ctx context.Context, requests []SearchQuery, strategy *SearchStrategy, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) SearchDictionaryEntries(ctx context.Context, dictionaryName DictionaryType, query string, optionalParams *SearchDictionaryEntriesOptions, opts ...RequestOption) (*SearchDictionaryEntriesResponse, error) {
...
//   - language  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) SearchDictionaryEntriesWithHTTPInfo(ctx context.Context, dictionaryName DictionaryType, query string, optionalParams *SearchDictionaryEntriesOptions, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) SearchForFacetValues(ctx context.Context, indexName string, facetName string, optionalParams *SearchForFacetValuesOptions, opts ...RequestOption) (*SearchForFacetValuesResponse, error) {
...
//   - maxFacetHits - Maximum number of facet values to return when [searching for facet values](https://www.algolia.com/doc/guides/managing-results/refine-results/faceting/#search-for-facet-values). (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) SearchForFacetValuesWithHTTPInfo(ctx context.Context, indexName string, facetName string, optionalParams *SearchForFacetValuesOptions, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) SearchRules(ctx context.Context, indexName string, optionalParams *SearchRulesOptions, opts ...RequestOption) (*SearchRulesResponse, error) {
...
//   - enabled - If `true`, return only enabled rules. If `false`, return only inactive rules. By default, _all_ rules are returned.  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) SearchRulesWithHTTPInfo(ctx context.Context, indexName string, optionalParams *SearchRulesOptions, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - searchParams
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) SearchSingleIndex(ctx context.Context, indexName string, searchParams *SearchParams, opts ...RequestOption) (*SearchResponse, error) {
...
//   - searchParams
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) SearchSingleIndexWithHTTPInfo(ctx context.Context, indexName string, searchParams *SearchParams, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - hitsPerPage - Number of hits per page. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) SearchSynonyms(ctx context.Context, indexName string, optionalParams *SearchSynonymsOptions, opts ...RequestOption) (*SearchSynonymsResponse, error) {
...
//   - hitsPerPage - Number of hits per page. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) SearchSynonymsWithHTTPInfo(ctx context.Context, indexName string, optionalParams *SearchSynonymsOptions, opts ...RequestOption) (*http.Response, []byte, error) {
...
func (c *APIClient) SearchUserIds(ctx context.Context, query string, optionalParams *SearchUserIdsOptions, opts ...RequestOption) (*SearchUserIdsResponse, error) {
...
//
// Deprecated: SearchUserIds is deprecated.
func (c *APIClient) SearchUserIdsWithHTTPInfo(ctx context.Context, query string, optionalParams *SearchUserIdsOptions, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) SetDictionarySettings(ctx context.Context, disableStandardEntries *StandardEntries, opts ...RequestOption) (*UpdatedAtResponse, error) {
	var returnValue *UpdatedAtResponse
...
//   - disableStandardEntries
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) SetDictionarySettingsWithHTTPInfo(ctx context.Context, disableStandardEntries *StandardEntries, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/dictionaries/*/settings"
...
//   - forwardToReplicas - Whether changes are applied to replica indices.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) SetSettings(ctx context.Context, indexName string, indexSettings *IndexSettings, forwardToReplicas *bool, opts ...RequestOption) (*UpdatedAtResponse, error) {
	var returnValue *UpdatedAtResponse
...
//   - forwardToReplicas - Whether changes are applied to replica indices.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) SetSettingsWithHTTPInfo(ctx context.Context, indexName string, indexSettings *IndexSettings, forwardToReplicas *bool, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/indexes/{indexName}/settings"
	requestPath = strings.ReplaceAll(requestPath, "{indexName}", url.PathEscape(utils.ParameterToString(indexName)))
...
//   - validity - Duration (in seconds) after which the API key expires. By default, API keys don't expire.  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) UpdateApiKey(ctx context.Context, key string, acl []Acl, optionalParams *UpdateApiKeyOptions, opts ...RequestOption) (*UpdateApiKeyResponse, error) {
...
//   - validity - Duration (in seconds) after which the API key expires. By default, API keys don't expire.  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) UpdateApiKeyWithHTTPInfo(ctx context.Context, key string, acl []Acl, optionalParams *UpdateApiKeyOptions, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/keys/{key}"
	requestPath = strings.ReplaceAll(requestPath, "{key}", url.PathEscape(utils.ParameterToString(key)))
