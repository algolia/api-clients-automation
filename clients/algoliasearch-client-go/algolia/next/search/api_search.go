...
type AddApiKeyOptions struct {
	Description            *string
	Indexes                *[]string
	MaxHitsPerQuery        *int32
	MaxQueriesPerIPPerHour *int32
...
func (o *AddApiKeyOptions) WithMaxHitsPerQuery(maxHitsPerQuery int32) *AddApiKeyOptions {
...
func (o *AddApiKeyOptions) WithMaxQueriesPerIPPerHour(maxQueriesPerIPPerHour int32) *AddApiKeyOptions {
...
func (o *AddApiKeyOptions) WithValidity(validity int32) *AddApiKeyOptions {
	o.Validity = &validity
	return o
}
...
func (c *APIClient) AddApiKey(acl []Acl, optionalParams *AddApiKeyOptions, opts ...RequestOption) (*AddApiKeyResponse, error) {
	var returnValue *AddApiKeyResponse

	res, resBody, err := c.AddApiKeyWithHTTPInfo(acl, optionalParams, opts...)
	if err != nil {
...
//   - validity - Duration (in seconds) after which the API key expires. By default, API keys don't expire.  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) AddApiKeyWithHTTPInfo(acl []Acl, optionalParams *AddApiKeyOptions, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/keys"
...
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) AddOrUpdateObject(indexName string, objectID string, body map[string]any, opts ...RequestOption) (*UpdatedAtWithObjectIdResponse, error) {
	var returnValue *UpdatedAtWithObjectIdResponse

	res, resBody, err := c.AddOrUpdateObjectWithHTTPInfo(indexName, objectID, body, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - body - The record. A schemaless object with attributes that are useful in the context of search and discovery.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) AddOrUpdateObjectWithHTTPInfo(indexName string, objectID string, body map[string]any, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) AppendSource(source string, description *string, opts ...RequestOption) (*CreatedAtResponse, error) {
	var returnValue *CreatedAtResponse

	res, resBody, err := c.AppendSourceWithHTTPInfo(source, description, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - description - Source description.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) AppendSourceWithHTTPInfo(source string, description *string, opts ...RequestOption) (*http.Response, []byte, error) {
...
func (c *APIClient) AssignUserId(xAlgoliaUserID string, cluster string, opts ...RequestOption) (*CreatedAtResponse, error) {
	var returnValue *CreatedAtResponse

	res, resBody, err := c.AssignUserIdWithHTTPInfo(xAlgoliaUserID, cluster, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//
// Deprecated: AssignUserId is deprecated.
func (c *APIClient) AssignUserIdWithHTTPInfo(xAlgoliaUserID string, cluster string, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - requests
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) Batch(indexName string, requests []BatchRequest, opts ...RequestOption) (*BatchResponse, error) {
	var returnValue *BatchResponse

	res, resBody, err := c.BatchWithHTTPInfo(indexName, requests, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - requests
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) BatchWithHTTPInfo(indexName string, requests []BatchRequest, opts ...RequestOption) (*http.Response, []byte, error) {
...
func (c *APIClient) BatchAssignUserIds(xAlgoliaUserID string, cluster string, users []string, opts ...RequestOption) (*CreatedAtResponse, error) {
	var returnValue *CreatedAtResponse

	res, resBody, err := c.BatchAssignUserIdsWithHTTPInfo(xAlgoliaUserID, cluster, users, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//
// Deprecated: BatchAssignUserIds is deprecated.
func (c *APIClient) BatchAssignUserIdsWithHTTPInfo(xAlgoliaUserID string, cluster string, users []string, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) BatchDictionaryEntries(dictionaryName DictionaryType, requests []BatchDictionaryEntriesRequest, clearExistingDictionaryEntries *bool, opts ...RequestOption) (*UpdatedAtResponse, error) {
	var returnValue *UpdatedAtResponse

	res, resBody, err := c.BatchDictionaryEntriesWithHTTPInfo(dictionaryName, requests, clearExistingDictionaryEntries, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - clearExistingDictionaryEntries - Whether to replace all custom entries in the dictionary with the ones sent with this request.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) BatchDictionaryEntriesWithHTTPInfo(dictionaryName DictionaryType, requests []BatchDictionaryEntriesRequest, clearExistingDictionaryEntries *bool, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - browseParams
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) Browse(indexName string, browseParams *BrowseParams, opts ...RequestOption) (*BrowseResponse, error) {
	var returnValue *BrowseResponse

	res, resBody, err := c.BrowseWithHTTPInfo(indexName, browseParams, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - browseParams
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) BrowseWithHTTPInfo(indexName string, browseParams *BrowseParams, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - indexName - Name of the index on which to perform the operation.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) ClearObjects(indexName string, opts ...RequestOption) (*UpdatedAtResponse, error) {
	var returnValue *UpdatedAtResponse

	res, resBody, err := c.ClearObjectsWithHTTPInfo(indexName, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - indexName - Name of the index on which to perform the operation.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) ClearObjectsWithHTTPInfo(indexName string, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) ClearRules(indexName string, forwardToReplicas *bool, opts ...RequestOption) (*UpdatedAtResponse, error) {
	var returnValue *UpdatedAtResponse

	res, resBody, err := c.ClearRulesWithHTTPInfo(indexName, forwardToReplicas, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - forwardToReplicas - Whether changes are applied to replica indices.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) ClearRulesWithHTTPInfo(indexName string, forwardToReplicas *bool, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - forwardToReplicas - Whether changes are applied to replica indices.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) ClearSynonyms(indexName string, forwardToReplicas *bool, opts ...RequestOption) (*UpdatedAtResponse, error) {
	var returnValue *UpdatedAtResponse

	res, resBody, err := c.ClearSynonymsWithHTTPInfo(indexName, forwardToReplicas, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - forwardToReplicas - Whether changes are applied to replica indices.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) ClearSynonymsWithHTTPInfo(indexName string, forwardToReplicas *bool, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - key - API key.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) DeleteApiKey(key string, opts ...RequestOption) (*DeleteApiKeyResponse, error) {
	var returnValue *DeleteApiKeyResponse

	res, resBody, err := c.DeleteApiKeyWithHTTPInfo(key, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - key - API key.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) DeleteApiKeyWithHTTPInfo(key string, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) DeleteBy(indexName string, optionalParams *DeleteByOptions, opts ...RequestOption) (*UpdatedAtResponse, error) {
	var returnValue *UpdatedAtResponse

	res, resBody, err := c.DeleteByWithHTTPInfo(indexName, optionalParams, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - insidePolygon - Coordinates of a polygon in which to search.  Polygons are defined by 3 to 10,000 points. Each point is represented by its latitude and longitude. Provide multiple polygons as nested arrays. For more information, see [filtering inside polygons](https://www.algolia.com/doc/guides/managing-results/refine-results/geolocation/#filtering-inside-rectangular-or-polygonal-areas). This parameter is ignored if you also specify `insideBoundingBox`.  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) DeleteByWithHTTPInfo(indexName string, optionalParams *DeleteByOptions, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - indexName - Name of the index on which to perform the operation.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) DeleteIndex(indexName string, opts ...RequestOption) (*DeletedAtResponse, error) {
	var returnValue *DeletedAtResponse

	res, resBody, err := c.DeleteIndexWithHTTPInfo(indexName, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - indexName - Name of the index on which to perform the operation.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) DeleteIndexWithHTTPInfo(indexName string, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - objectID - Unique record identifier.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) DeleteObject(indexName string, objectID string, opts ...RequestOption) (*DeletedAtResponse, error) {
	var returnValue *DeletedAtResponse

	res, resBody, err := c.DeleteObjectWithHTTPInfo(indexName, objectID, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - objectID - Unique record identifier.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) DeleteObjectWithHTTPInfo(indexName string, objectID string, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/indexes/{indexName}/{objectID}"
	requestPath = strings.ReplaceAll(requestPath, "{indexName}", url.PathEscape(utils.ParameterToString(indexName)))
	requestPath = strings.ReplaceAll(requestPath, "{objectID}", url.PathEscape(utils.ParameterToString(objectID)))
...
//   - forwardToReplicas - Whether changes are applied to replica indices.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) DeleteRule(indexName string, objectID string, forwardToReplicas *bool, opts ...RequestOption) (*UpdatedAtResponse, error) {
	var returnValue *UpdatedAtResponse

	res, resBody, err := c.DeleteRuleWithHTTPInfo(indexName, objectID, forwardToReplicas, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - forwardToReplicas - Whether changes are applied to replica indices.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) DeleteRuleWithHTTPInfo(indexName string, objectID string, forwardToReplicas *bool, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - source - IP address range of the source.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) DeleteSource(source string, opts ...RequestOption) (*DeleteSourceResponse, error) {
	var returnValue *DeleteSourceResponse

	res, resBody, err := c.DeleteSourceWithHTTPInfo(source, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - source - IP address range of the source.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) DeleteSourceWithHTTPInfo(source string, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - forwardToReplicas - Whether changes are applied to replica indices.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) DeleteSynonym(indexName string, objectID string, forwardToReplicas *bool, opts ...RequestOption) (*DeletedAtResponse, error) {
	var returnValue *DeletedAtResponse

	res, resBody, err := c.DeleteSynonymWithHTTPInfo(indexName, objectID, forwardToReplicas, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - forwardToReplicas - Whether changes are applied to replica indices.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) DeleteSynonymWithHTTPInfo(indexName string, objectID string, forwardToReplicas *bool, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - key - API key.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetApiKey(key string, opts ...RequestOption) (*GetApiKeyResponse, error) {
	var returnValue *GetApiKeyResponse

	res, resBody, err := c.GetApiKeyWithHTTPInfo(key, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - key - API key.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetApiKeyWithHTTPInfo(key string, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/keys/{key}"
	requestPath = strings.ReplaceAll(requestPath, "{key}", url.PathEscape(utils.ParameterToString(key)))
...
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetAppTask(taskID int64, opts ...RequestOption) (*GetTaskResponse, error) {
	var returnValue *GetTaskResponse

	res, resBody, err := c.GetAppTaskWithHTTPInfo(taskID, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - taskID - Unique task identifier.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetAppTaskWithHTTPInfo(taskID int64, opts ...RequestOption) (*http.Response, []byte, error) {
...
func (o *GetLogsOptions) WithOffset(offset int32) *GetLogsOptions {
	o.Offset = &offset
	return o
}

// WithLength Maximum number of entries to retrieve.
func (o *GetLogsOptions) WithLength(length int32) *GetLogsOptions {
	o.Length = &length
	return o
}
...
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetLogs(optionalParams *GetLogsOptions, opts ...RequestOption) (*GetLogsResponse, error) {
	var returnValue *GetLogsResponse

	res, resBody, err := c.GetLogsWithHTTPInfo(optionalParams, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - type_ - Type of log entries to retrieve. By default, all log entries are retrieved.  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetLogsWithHTTPInfo(optionalParams *GetLogsOptions, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/logs"
...
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetObject(indexName string, objectID string, attributesToRetrieve *[]string, opts ...RequestOption) (*map[string]any, error) {
	var returnValue *map[string]any

	res, resBody, err := c.GetObjectWithHTTPInfo(indexName, objectID, attributesToRetrieve, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - attributesToRetrieve - Attributes to include with the records in the response. This is useful to reduce the size of the API response. By default, all retrievable attributes are returned.  `objectID` is always retrieved.  Attributes included in `unretrievableAttributes` won't be retrieved unless the request is authenticated with the admin API key.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetObjectWithHTTPInfo(indexName string, objectID string, attributesToRetrieve *[]string, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/indexes/{indexName}/{objectID}"
	requestPath = strings.ReplaceAll(requestPath, "{indexName}", url.PathEscape(utils.ParameterToString(indexName)))
	requestPath = strings.ReplaceAll(requestPath, "{objectID}", url.PathEscape(utils.ParameterToString(objectID)))
...
//   - requests
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetObjects(requests []GetObjectsRequest, opts ...RequestOption) (*GetObjectsResponse, error) {
	var returnValue *GetObjectsResponse

	res, resBody, err := c.GetObjectsWithHTTPInfo(requests, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - requests
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetObjectsWithHTTPInfo(requests []GetObjectsRequest, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - objectID - Unique identifier of a rule object.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetRule(indexName string, objectID string, opts ...RequestOption) (*Rule, error) {
	var returnValue *Rule

	res, resBody, err := c.GetRuleWithHTTPInfo(indexName, objectID, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - objectID - Unique identifier of a rule object.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetRuleWithHTTPInfo(indexName string, objectID string, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/indexes/{indexName}/rules/{objectID}"
	requestPath = strings.ReplaceAll(requestPath, "{indexName}", url.PathEscape(utils.ParameterToString(indexName)))
	requestPath = strings.ReplaceAll(requestPath, "{objectID}", url.PathEscape(utils.ParameterToString(objectID)))
...
//   - indexName - Name of the index on which to perform the operation.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetSettings(indexName string, opts ...RequestOption) (*SettingsResponse, error) {
	var returnValue *SettingsResponse

	res, resBody, err := c.GetSettingsWithHTTPInfo(indexName, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - indexName - Name of the index on which to perform the operation.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetSettingsWithHTTPInfo(indexName string, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - objectID - Unique identifier of a synonym object.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetSynonym(indexName string, objectID string, opts ...RequestOption) (*SynonymHit, error) {
	var returnValue *SynonymHit

	res, resBody, err := c.GetSynonymWithHTTPInfo(indexName, objectID, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - objectID - Unique identifier of a synonym object.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetSynonymWithHTTPInfo(indexName string, objectID string, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/indexes/{indexName}/synonyms/{objectID}"
	requestPath = strings.ReplaceAll(requestPath, "{indexName}", url.PathEscape(utils.ParameterToString(indexName)))
	requestPath = strings.ReplaceAll(requestPath, "{objectID}", url.PathEscape(utils.ParameterToString(objectID)))
...
//   - taskID - Unique task identifier.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetTask(indexName string, taskID int64, opts ...RequestOption) (*GetTaskResponse, error) {
	var returnValue *GetTaskResponse

	res, resBody, err := c.GetTaskWithHTTPInfo(indexName, taskID, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - taskID - Unique task identifier.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetTaskWithHTTPInfo(indexName string, taskID int64, opts ...RequestOption) (*http.Response, []byte, error) {
...
func (c *APIClient) GetUserId(userID string, opts ...RequestOption) (*UserId, error) {
	var returnValue *UserId

	res, resBody, err := c.GetUserIdWithHTTPInfo(userID, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//
// Deprecated: GetUserId is deprecated.
func (c *APIClient) GetUserIdWithHTTPInfo(userID string, opts ...RequestOption) (*http.Response, []byte, error) {
...
func (c *APIClient) HasPendingMappings(getClusters *bool, opts ...RequestOption) (*HasPendingMappingsResponse, error) {
	var returnValue *HasPendingMappingsResponse

	res, resBody, err := c.HasPendingMappingsWithHTTPInfo(getClusters, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//
// Deprecated: HasPendingMappings is deprecated.
func (c *APIClient) HasPendingMappingsWithHTTPInfo(getClusters *bool, opts ...RequestOption) (*http.Response, []byte, error) {
...
func (o *ListIndicesOptions) WithPage(page int32) *ListIndicesOptions {
	o.Page = &page
	return o
}

// WithHitsPerPage Number of hits per page.
func (o *ListIndicesOptions) WithHitsPerPage(hitsPerPage int32) *ListIndicesOptions {
...
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) ListIndices(optionalParams *ListIndicesOptions, opts ...RequestOption) (*ListIndicesResponse, error) {
	var returnValue *ListIndicesResponse

	res, resBody, err := c.ListIndicesWithHTTPInfo(optionalParams, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - hitsPerPage - Number of hits per page. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) ListIndicesWithHTTPInfo(optionalParams *ListIndicesOptions, opts ...RequestOption) (*http.Response, []byte, error) {
...
// WithPage Requested page of the API response. If `null`, the API response is not paginated.
func (o *ListUserIdsOptions) WithPage(page int32) *ListUserIdsOptions {
	o.Page = &page
	return o
}

// WithHitsPerPage Number of hits per page.
func (o *ListUserIdsOptions) WithHitsPerPage(hitsPerPage int32) *ListUserIdsOptions {
	o.HitsPerPage = &hitsPerPage
	return o
}
...
func (c *APIClient) ListUserIds(optionalParams *ListUserIdsOptions, opts ...RequestOption) (*ListUserIdsResponse, error) {
	var returnValue *ListUserIdsResponse

	res, resBody, err := c.ListUserIdsWithHTTPInfo(optionalParams, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//
// Deprecated: ListUserIds is deprecated.
func (c *APIClient) ListUserIdsWithHTTPInfo(optionalParams *ListUserIdsOptions, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/clusters/mapping"
...
//   - requests
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) MultipleBatch(requests []MultipleBatchRequest, opts ...RequestOption) (*MultipleBatchResponse, error) {
	var returnValue *MultipleBatchResponse

	res, resBody, err := c.MultipleBatchWithHTTPInfo(requests, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - requests
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) MultipleBatchWithHTTPInfo(requests []MultipleBatchRequest, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) OperationIndex(indexName string, operation OperationType, destination string, scope *[]ScopeType, opts ...RequestOption) (*UpdatedAtResponse, error) {
	var returnValue *UpdatedAtResponse

	res, resBody, err := c.OperationIndexWithHTTPInfo(indexName, operation, destination, scope, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - scope - **Only for copying.**  If you specify a scope, only the selected scopes are copied. Records and the other scopes are left unchanged. If you omit the `scope` parameter, everything is copied: records, settings, synonyms, and rules.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) OperationIndexWithHTTPInfo(indexName string, operation OperationType, destination string, scope *[]ScopeType, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) PartialUpdateObject(indexName string, objectID string, attributesToUpdate map[string]any, createIfNotExists *bool, opts ...RequestOption) (*UpdatedAtWithObjectIdResponse, error) {
	var returnValue *UpdatedAtWithObjectIdResponse

	res, resBody, err := c.PartialUpdateObjectWithHTTPInfo(indexName, objectID, attributesToUpdate, createIfNotExists, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - createIfNotExists - Whether to create a new record if it doesn't exist.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) PartialUpdateObjectWithHTTPInfo(indexName string, objectID string, attributesToUpdate map[string]any, createIfNotExists *bool, opts ...RequestOption) (*http.Response, []byte, error) {
...
func (c *APIClient) RemoveUserId(userID string, opts ...RequestOption) (*RemoveUserIdResponse, error) {
	var returnValue *RemoveUserIdResponse

	res, resBody, err := c.RemoveUserIdWithHTTPInfo(userID, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//
// Deprecated: RemoveUserId is deprecated.
func (c *APIClient) RemoveUserIdWithHTTPInfo(userID string, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/clusters/mapping/{userID}"
	requestPath = strings.ReplaceAll(requestPath, "{userID}", url.PathEscape(utils.ParameterToString(userID)))
...
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) ReplaceSources(source []Source, opts ...RequestOption) (*ReplaceSourceResponse, error) {
	var returnValue *ReplaceSourceResponse

	res, resBody, err := c.ReplaceSourcesWithHTTPInfo(source, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - source - Allowed sources.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) ReplaceSourcesWithHTTPInfo(source []Source, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/security/sources"
...
//   - key - API key.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) RestoreApiKey(key string, opts ...RequestOption) (*AddApiKeyResponse, error) {
	var returnValue *AddApiKeyResponse

	res, resBody, err := c.RestoreApiKeyWithHTTPInfo(key, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - key - API key.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) RestoreApiKeyWithHTTPInfo(key string, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - body - The record. A schemaless object with attributes that are useful in the context of search and discovery.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) SaveObject(indexName string, body map[string]any, opts ...RequestOption) (*SaveObjectResponse, error) {
	var returnValue *SaveObjectResponse

	res, resBody, err := c.SaveObjectWithHTTPInfo(indexName, body, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - body - The record. A schemaless object with attributes that are useful in the context of search and discovery.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) SaveObjectWithHTTPInfo(indexName string, body map[string]any, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/indexes/{indexName}"
	requestPath = strings.ReplaceAll(requestPath, "{indexName}", url.PathEscape(utils.ParameterToString(indexName)))
...
//   - forwardToReplicas - Whether changes are applied to replica indices.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) SaveRule(indexName string, objectID string, rule *Rule, forwardToReplicas *bool, opts ...RequestOption) (*UpdatedAtResponse, error) {
	var returnValue *UpdatedAtResponse

	res, resBody, err := c.SaveRuleWithHTTPInfo(indexName, objectID, rule, forwardToReplicas, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - forwardToReplicas - Whether changes are applied to replica indices.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) SaveRuleWithHTTPInfo(indexName string, objectID string, rule *Rule, forwardToReplicas *bool, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/indexes/{indexName}/rules/{objectID}"
	requestPath = strings.ReplaceAll(requestPath, "{indexName}", url.PathEscape(utils.ParameterToString(indexName)))
	requestPath = strings.ReplaceAll(requestPath, "{objectID}", url.PathEscape(utils.ParameterToString(objectID)))
...
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) SaveRules(indexName string, rules []Rule, optionalParams *SaveRulesOptions, opts ...RequestOption) (*UpdatedAtResponse, error) {
	var returnValue *UpdatedAtResponse

	res, resBody, err := c.SaveRulesWithHTTPInfo(indexName, rules, optionalParams, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - clearExistingRules - Whether existing rules should be deleted before adding this batch. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) SaveRulesWithHTTPInfo(indexName string, rules []Rule, optionalParams *SaveRulesOptions, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - forwardToReplicas - Whether changes are applied to replica indices.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) SaveSynonym(indexName string, objectID string, synonymHit *SynonymHit, forwardToReplicas *bool, opts ...RequestOption) (*SaveSynonymResponse, error) {
	var returnValue *SaveSynonymResponse

	res, resBody, err := c.SaveSynonymWithHTTPInfo(indexName, objectID, synonymHit, forwardToReplicas, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - forwardToReplicas - Whether changes are applied to replica indices.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) SaveSynonymWithHTTPInfo(indexName string, objectID string, synonymHit *SynonymHit, forwardToReplicas *bool, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/indexes/{indexName}/synonyms/{objectID}"
	requestPath = strings.ReplaceAll(requestPath, "{indexName}", url.PathEscape(utils.ParameterToString(indexName)))
	requestPath = strings.ReplaceAll(requestPath, "{objectID}", url.PathEscape(utils.ParameterToString(objectID)))
...
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) SaveSynonyms(indexName string, synonymHit []SynonymHit, optionalParams *SaveSynonymsOptions, opts ...RequestOption) (*UpdatedAtResponse, error) {
	var returnValue *UpdatedAtResponse

	res, resBody, err := c.SaveSynonymsWithHTTPInfo(indexName, synonymHit, optionalParams, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - replaceExistingSynonyms - Whether to replace all synonyms in the index with the ones sent with this request. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) SaveSynonymsWithHTTPInfo(indexName string, synonymHit []SynonymHit, optionalParams *SaveSynonymsOptions, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - strategy
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) Search(requests []SearchQuery, strategy *SearchStrategy, opts ...RequestOption) (*SearchResponses, error) {
	var returnValue *SearchResponses

	res, resBody, err := c.SearchWithHTTPInfo(requests, strategy, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - strategy
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) SearchWithHTTPInfo(requests []SearchQuery, strategy *SearchStrategy, opts ...RequestOption) (*http.Response, []byte, error) {
...
func (o *SearchDictionaryEntriesOptions) WithPage(page int32) *SearchDictionaryEntriesOptions {
	o.Page = &page
	return o
}

// WithHitsPerPage Number of hits per page.
func (o *SearchDictionaryEntriesOptions) WithHitsPerPage(hitsPerPage int32) *SearchDictionaryEntriesOptions {
	o.HitsPerPage = &hitsPerPage
	return o
}
...
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) SearchDictionaryEntries(dictionaryName DictionaryType, query string, optionalParams *SearchDictionaryEntriesOptions, opts ...RequestOption) (*SearchDictionaryEntriesResponse, error) {
	var returnValue *SearchDictionaryEntriesResponse

	res, resBody, err := c.SearchDictionaryEntriesWithHTTPInfo(dictionaryName, query, optionalParams, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - language  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) SearchDictionaryEntriesWithHTTPInfo(dictionaryName DictionaryType, query string, optionalParams *SearchDictionaryEntriesOptions, opts ...RequestOption) (*http.Response, []byte, error) {
...
func (o *SearchForFacetValuesOptions) WithMaxFacetHits(maxFacetHits int32) *SearchForFacetValuesOptions {
...
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) SearchForFacetValues(indexName string, facetName string, optionalParams *SearchForFacetValuesOptions, opts ...RequestOption) (*SearchForFacetValuesResponse, error) {
	var returnValue *SearchForFacetValuesResponse

	res, resBody, err := c.SearchForFacetValuesWithHTTPInfo(indexName, facetName, optionalParams, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - maxFacetHits - Maximum number of facet values to return when [searching for facet values](https://www.algolia.com/doc/guides/managing-results/refine-results/faceting/#search-for-facet-values). (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) SearchForFacetValuesWithHTTPInfo(indexName string, facetName string, optionalParams *SearchForFacetValuesOptions, opts ...RequestOption) (*http.Response, []byte, error) {
...
func (o *SearchRulesOptions) WithPage(page int32) *SearchRulesOptions {
	o.Page = &page
	return o
}
...
func (o *SearchRulesOptions) WithHitsPerPage(hitsPerPage int32) *SearchRulesOptions {
	o.HitsPerPage = &hitsPerPage
	return o
}
...
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) SearchRules(indexName string, optionalParams *SearchRulesOptions, opts ...RequestOption) (*SearchRulesResponse, error) {
	var returnValue *SearchRulesResponse

	res, resBody, err := c.SearchRulesWithHTTPInfo(indexName, optionalParams, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - enabled - If `true`, return only enabled rules. If `false`, return only inactive rules. By default, _all_ rules are returned.  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) SearchRulesWithHTTPInfo(indexName string, optionalParams *SearchRulesOptions, opts ...RequestOption) (*http.Response, []byte, error) {
...
// SearchSingleIndex Searches a single index and returns matching search results (_hits_).
//
...
//   - searchParams
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) SearchSingleIndex(indexName string, searchParams *SearchParams, opts ...RequestOption) (*SearchResponse, error) {
	var returnValue *SearchResponse

	res, resBody, err := c.SearchSingleIndexWithHTTPInfo(indexName, searchParams, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - searchParams
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) SearchSingleIndexWithHTTPInfo(indexName string, searchParams *SearchParams, opts ...RequestOption) (*http.Response, []byte, error) {
...
// WithPage Page of search results to retrieve.
func (o *SearchSynonymsOptions) WithPage(page int32) *SearchSynonymsOptions {
	o.Page = &page
	return o
}

// WithHitsPerPage Number of hits per page.
func (o *SearchSynonymsOptions) WithHitsPerPage(hitsPerPage int32) *SearchSynonymsOptions {
	o.HitsPerPage = &hitsPerPage
	return o
}
...
//   - hitsPerPage - Number of hits per page. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) SearchSynonyms(indexName string, optionalParams *SearchSynonymsOptions, opts ...RequestOption) (*SearchSynonymsResponse, error) {
	var returnValue *SearchSynonymsResponse

	res, resBody, err := c.SearchSynonymsWithHTTPInfo(indexName, optionalParams, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - hitsPerPage - Number of hits per page. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) SearchSynonymsWithHTTPInfo(indexName string, optionalParams *SearchSynonymsOptions, opts ...RequestOption) (*http.Response, []byte, error) {
...
// WithPage Page of search results to retrieve.
func (o *SearchUserIdsOptions) WithPage(page int32) *SearchUserIdsOptions {
	o.Page = &page
	return o
}

// WithHitsPerPage Number of hits per page.
func (o *SearchUserIdsOptions) WithHitsPerPage(hitsPerPage int32) *SearchUserIdsOptions {
	o.HitsPerPage = &hitsPerPage
	return o
}
...
//
// Parameters:
//   - query - Query to search. The search is a prefix search with [typo tolerance](https://www.algolia.com/doc/guides/managing-results/optimize-search-results/typo-tolerance/) enabled. An empty query will retrieve all users.
...
func (c *APIClient) SearchUserIds(query string, optionalParams *SearchUserIdsOptions, opts ...RequestOption) (*SearchUserIdsResponse, error) {
	var returnValue *SearchUserIdsResponse

	res, resBody, err := c.SearchUserIdsWithHTTPInfo(query, optionalParams, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//
// Deprecated: SearchUserIds is deprecated.
func (c *APIClient) SearchUserIdsWithHTTPInfo(query string, optionalParams *SearchUserIdsOptions, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) SetDictionarySettings(disableStandardEntries *StandardEntries, opts ...RequestOption) (*UpdatedAtResponse, error) {
	var returnValue *UpdatedAtResponse

	res, resBody, err := c.SetDictionarySettingsWithHTTPInfo(disableStandardEntries, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - disableStandardEntries
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) SetDictionarySettingsWithHTTPInfo(disableStandardEntries *StandardEntries, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/dictionaries/*/settings"
...
//   - forwardToReplicas - Whether changes are applied to replica indices.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) SetSettings(indexName string, indexSettings *IndexSettings, forwardToReplicas *bool, opts ...RequestOption) (*UpdatedAtResponse, error) {
	var returnValue *UpdatedAtResponse

	res, resBody, err := c.SetSettingsWithHTTPInfo(indexName, indexSettings, forwardToReplicas, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - forwardToReplicas - Whether changes are applied to replica indices.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) SetSettingsWithHTTPInfo(indexName string, indexSettings *IndexSettings, forwardToReplicas *bool, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/indexes/{indexName}/settings"
	requestPath = strings.ReplaceAll(requestPath, "{indexName}", url.PathEscape(utils.ParameterToString(indexName)))
...
// WithMaxHitsPerQuery Maximum number of results this API key can retrieve in one query. By default, there's no limit.
func (o *UpdateApiKeyOptions) WithMaxHitsPerQuery(maxHitsPerQuery int32) *UpdateApiKeyOptions {
	o.MaxHitsPerQuery = &maxHitsPerQuery
	return o
}

// WithMaxQueriesPerIPPerHour Maximum number of API requests allowed per IP address or [user token](https://www.algolia.com/doc/guides/sending-events/concepts/usertoken/) per hour.  If this limit is reached, the API returns an error with status code `429`. By default, there's no limit.
func (o *UpdateApiKeyOptions) WithMaxQueriesPerIPPerHour(maxQueriesPerIPPerHour int32) *UpdateApiKeyOptions {
	o.MaxQueriesPerIPPerHour = &maxQueriesPerIPPerHour
	return o
}
...
// WithValidity Duration (in seconds) after which the API key expires. By default, API keys don't expire.
func (o *UpdateApiKeyOptions) WithValidity(validity int32) *UpdateApiKeyOptions {
	o.Validity = &validity
	return o
}
...
//   - validity - Duration (in seconds) after which the API key expires. By default, API keys don't expire.  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) UpdateApiKey(key string, acl []Acl, optionalParams *UpdateApiKeyOptions, opts ...RequestOption) (*UpdateApiKeyResponse, error) {
	var returnValue *UpdateApiKeyResponse

	res, resBody, err := c.UpdateApiKeyWithHTTPInfo(key, acl, optionalParams, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - validity - Duration (in seconds) after which the API key expires. By default, API keys don't expire.  (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) UpdateApiKeyWithHTTPInfo(key string, acl []Acl, optionalParams *UpdateApiKeyOptions, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/keys/{key}"
	requestPath = strings.ReplaceAll(requestPath, "{key}", url.PathEscape(utils.ParameterToString(key)))
