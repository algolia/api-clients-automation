...
func NewSearchDictionaryEntriesResponse(hits []DictionaryEntry, page int, nbHits int, nbPages int) *SearchDictionaryEntriesResponse {
...
func (o *SearchDictionaryEntriesResponse) GetPage() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *SearchDictionaryEntriesResponse) GetPageOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *SearchDictionaryEntriesResponse) SetPage(v int) *SearchDictionaryEntriesResponse {
	o.Page = v
...
func (o *SearchDictionaryEntriesResponse) GetNbHits() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *SearchDictionaryEntriesResponse) GetNbHitsOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *SearchDictionaryEntriesResponse) SetNbHits(v int) *SearchDictionaryEntriesResponse {
	o.NbHits = v
...
func (o *SearchDictionaryEntriesResponse) GetNbPages() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *SearchDictionaryEntriesResponse) GetNbPagesOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *SearchDictionaryEntriesResponse) SetNbPages(v int) *SearchDictionaryEntriesResponse {
	o.NbPages = v
