...
func WithSearchForFacetValuesResponseProcessingTimeMS(val int) SearchForFacetValuesResponseOption {
...
func (o *SearchForFacetValuesResponse) GetProcessingTimeMS() int {
...
// and a boolean to check if the value has been set.
func (o *SearchForFacetValuesResponse) GetProcessingTimeMSOk() (*int, bool) {
	if o == nil || o.ProcessingTimeMS == nil {
		return nil, false
	}
...
func (o *SearchForFacetValuesResponse) SetProcessingTimeMS(v int) *SearchForFacetValuesResponse {
