...
func NewSearchUserIdsResponse(hits []UserHit, nbHits int, page int, hitsPerPage int, updatedAt string) *SearchUserIdsResponse {
...
func (o *SearchUserIdsResponse) GetNbHits() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *SearchUserIdsResponse) GetNbHitsOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *SearchUserIdsResponse) SetNbHits(v int) *SearchUserIdsResponse {
	o.NbHits = v
...
func (o *SearchUserIdsResponse) GetPage() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *SearchUserIdsResponse) GetPageOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *SearchUserIdsResponse) SetPage(v int) *SearchUserIdsResponse {
	o.Page = v
...
func (o *SearchUserIdsResponse) GetHitsPerPage() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *SearchUserIdsResponse) GetHitsPerPageOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *SearchUserIdsResponse) SetHitsPerPage(v int) *SearchUserIdsResponse {
	o.HitsPerPage = v
