...
type DictionaryLanguage struct {
	...
	NbCustomEntries *int `json:"nbCustomEntries,omitempty"`
}

type DictionaryLanguageOption func(f *DictionaryLanguage)

func WithDictionaryLanguageNbCustomEntries(val int) DictionaryLanguageOption {
...
func (o *DictionaryLanguage) GetNbCustomEntries() int {
...
func (o *DictionaryLanguage) GetNbCustomEntriesOk() (*int, bool) {
	if o == nil || o.NbCustomEntries == nil {
		return nil, false
	}
...
// SetNbCustomEntries gets a reference to the given int and assigns it to the NbCustomEntries field.
func (o *DictionaryLanguage) SetNbCustomEntries(v int) *DictionaryLanguage {
	o.NbCustomEntries = &v
