...
func WithMatchedGeoLocationDistance(val int) MatchedGeoLocationOption {
	return func(f *MatchedGeoLocation) {
		f.Distance = &val
	}
}
...
func (o *MatchedGeoLocation) GetDistance() int {
...
// and a boolean to check if the value has been set.
func (o *MatchedGeoLocation) GetDistanceOk() (*int, bool) {
	if o == nil || o.Distance == nil {
		return nil, false
	}
...
// SetDistance gets a reference to the given int and assigns it to the Distance field.
func (o *MatchedGeoLocation) SetDistance(v int) *MatchedGeoLocation {
	o.Distance = &v
