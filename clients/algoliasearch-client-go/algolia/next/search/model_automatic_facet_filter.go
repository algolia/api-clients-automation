...
func WithAutomaticFacetFilterScore(val int) AutomaticFacetFilterOption {
...
func (o *AutomaticFacetFilter) GetScore() int {
...
// and a boolean to check if the value has been set.
func (o *AutomaticFacetFilter) GetScoreOk() (*int, bool) {
	if o == nil || o.Score == nil {
		return nil, false
	}
...
func (o *AutomaticFacetFilter) SetScore(v int) *AutomaticFacetFilter {
	o.Score = &v
