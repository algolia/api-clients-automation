...
func NewPromoteObjectIDs(objectIDs []string, position int) *PromoteObjectIDs {
...
func (o *PromoteObjectIDs) GetPosition() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *PromoteObjectIDs) GetPositionOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PromoteObjectIDs) SetPosition(v int) *PromoteObjectIDs {
	o.Position = v
