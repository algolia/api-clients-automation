...
func NewFacetHits(value string, highlighted string, count int) *FacetHits {
	this := &FacetHits{}
	this.Value = value
...
// and a boolean to check if the value has been set.
func (o *FacetHits) GetCountOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *FacetHits) SetCount(v int) *FacetHits {
	o.Count = v
