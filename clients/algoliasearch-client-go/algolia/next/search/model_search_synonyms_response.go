...
func NewSearchSynonymsResponse(hits []SynonymHit, nbHits int) *SearchSynonymsResponse {
...
func (o *SearchSynonymsResponse) GetNbHits() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *SearchSynonymsResponse) GetNbHitsOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *SearchSynonymsResponse) SetNbHits(v int) *SearchSynonymsResponse {
	o.NbHits = v
