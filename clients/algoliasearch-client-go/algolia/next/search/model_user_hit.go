...
func NewUserHit(userID string, clusterName string, nbRecords int, dataSize int, objectID string, highlightResult UserHighlightResult) *UserHit {
	this := &UserHit{}
	this.UserID = userID
...
func (o *UserHit) GetNbRecords() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *UserHit) GetNbRecordsOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *UserHit) SetNbRecords(v int) *UserHit {
	o.NbRecords = v
...
func (o *UserHit) GetDataSize() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *UserHit) GetDataSizeOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *UserHit) SetDataSize(v int) *UserHit {
	o.DataSize = v
