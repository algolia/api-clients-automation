...
func NewPromoteObjectID(objectID string, position int) *PromoteObjectID {
...
func (o *PromoteObjectID) GetPosition() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *PromoteObjectID) GetPositionOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PromoteObjectID) SetPosition(v int) *PromoteObjectID {
	o.Position = v
