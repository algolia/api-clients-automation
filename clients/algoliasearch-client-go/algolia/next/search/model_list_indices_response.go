...
func WithListIndicesResponseNbPages(val int) ListIndicesResponseOption {
...
func (o *ListIndicesResponse) GetNbPages() int {
...
// and a boolean to check if the value has been set.
func (o *ListIndicesResponse) GetNbPagesOk() (*int, bool) {
	if o == nil || o.NbPages == nil {
		return nil, false
	}
...
func (o *ListIndicesResponse) SetNbPages(v int) *ListIndicesResponse {
	o.NbPages = &v
