...
func WithTrendingFacetsQueryMaxRecommendations(val int) TrendingFacetsQueryOption {
...
func (o *TrendingFacetsQuery) GetMaxRecommendations() int {
...
// and a boolean to check if the value has been set.
func (o *TrendingFacetsQuery) GetMaxRecommendationsOk() (*int, bool) {
	if o == nil || o.MaxRecommendations == nil {
		return nil, false
	}
...
func (o *TrendingFacetsQuery) SetMaxRecommendations(v int) *TrendingFacetsQuery {
