...
func WithBoughtTogetherQueryMaxRecommendations(val int) BoughtTogetherQueryOption {
...
func (o *BoughtTogetherQuery) GetMaxRecommendations() int {
...
// and a boolean to check if the value has been set.
func (o *BoughtTogetherQuery) GetMaxRecommendationsOk() (*int, bool) {
	if o == nil || o.MaxRecommendations == nil {
		return nil, false
	}
...
// SetMaxRecommendations gets a reference to the given int and assigns it to the MaxRecommendations field.
func (o *BoughtTogetherQuery) SetMaxRecommendations(v int) *BoughtTogetherQuery {
