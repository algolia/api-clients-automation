...
func WithTrendingItemsQueryMaxRecommendations(val int) TrendingItemsQueryOption {
...
func (o *TrendingItemsQuery) GetMaxRecommendations() int {
...
// and a boolean to check if the value has been set.
func (o *TrendingItemsQuery) GetMaxRecommendationsOk() (*int, bool) {
	if o == nil || o.MaxRecommendations == nil {
		return nil, false
	}
...
func (o *TrendingItemsQuery) SetMaxRecommendations(v int) *TrendingItemsQuery {
