...
func (c *APIClient) BatchRecommendRules(ctx context.Context, indexName string, model RecommendModels, recommendRule *[]RecommendRule, opts ...RequestOption) (*RecommendUpdatedAtResponse, error) {
...
//   - recommendRule
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) BatchRecommendRulesWithHTTPInfo(ctx context.Context, indexName string, model RecommendModels, recommendRule *[]RecommendRule, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) DeleteRecommendRule(ctx context.Context, indexName string, model RecommendModels, objectID string, opts ...RequestOption) (*DeletedAtResponse, error) {
...
//   - objectID - Unique record identifier.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) DeleteRecommendRuleWithHTTPInfo(ctx context.Context, indexName string, model RecommendModels, objectID string, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - objectID - Unique record identifier.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) GetRecommendRule(ctx context.Context, indexName string, model RecommendModels, objectID string, opts ...RequestOption) (*RecommendRule, error) {
...
//   - objectID - Unique record identifier.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) GetRecommendRuleWithHTTPInfo(ctx context.Context, indexName string, model RecommendModels, objectID string, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/1/indexes/{indexName}/{model}/recommend/rules/{objectID}"
	requestPath = strings.ReplaceAll(requestPath, "{indexName}", url.PathEscape(utils.ParameterToString(indexName)))
	requestPath = strings.ReplaceAll(requestPath, "{model}", url.PathEscape(utils.ParameterToString(model)))
	requestPath = strings.ReplaceAll(requestPath, "{objectID}", url.PathEscape(utils.ParameterToString(objectID)))
...
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) GetRecommendStatus(ctx context.Context, indexName string, model RecommendModels, taskID int64, opts ...RequestOption) (*GetRecommendTaskResponse, error) {
...
//   - taskID - Unique task identifier.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) GetRecommendStatusWithHTTPInfo(ctx context.Context, indexName string, model RecommendModels, taskID int64, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) GetRecommendations(ctx context.Context, requests []RecommendationsRequest, opts ...RequestOption) (*GetRecommendationsResponse, error) {
...
//   - requests - Recommendation request with parameters depending on the requested model.
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) GetRecommendationsWithHTTPInfo(ctx context.Context, requests []RecommendationsRequest, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) SearchRecommendRules(ctx context.Context, indexName string, model RecommendModels, optionalParams *SearchRecommendRulesOptions, opts ...RequestOption) (*SearchRecommendRulesResponse, error) {
...
//   - maxValuesPerFacet - Maximum number of values to return for each facet. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithHeaderParam, WithReadTimeout...)
func (c *APIClient) SearchRecommendRulesWithHTTPInfo(ctx context.Context, indexName string, model RecommendModels, optionalParams *SearchRecommendRulesOptions, opts ...RequestOption) (*http.Response, []byte, error) {
