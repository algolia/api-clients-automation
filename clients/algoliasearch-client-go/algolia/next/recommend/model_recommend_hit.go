...
type RecommendHit struct {
	...
	DistinctSeqID *int                      `json:"_distinctSeqID,omitempty"`
...
func WithRecommendHitDistinctSeqID(val int) RecommendHitOption {
	return func(f *RecommendHit) {
		f.DistinctSeqID = &val
	}
}
...
func (o *RecommendHit) GetDistinctSeqID() int {
...
// and a boolean to check if the value has been set.
func (o *RecommendHit) GetDistinctSeqIDOk() (*int, bool) {
	if o == nil || o.DistinctSeqID == nil {
		return nil, false
	}
...
// SetDistinctSeqID gets a reference to the given int and assigns it to the DistinctSeqID field.
func (o *RecommendHit) SetDistinctSeqID(v int) *RecommendHit {
	o.DistinctSeqID = &v
