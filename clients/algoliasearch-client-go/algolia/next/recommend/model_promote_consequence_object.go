...
func WithPromoteConsequenceObjectPosition(val int) PromoteConsequenceObjectOption {
	return func(f *PromoteConsequenceObject) {
		f.Position = &val
	}
}
...
func (o *PromoteConsequenceObject) GetPosition() int {
...
// and a boolean to check if the value has been set.
func (o *PromoteConsequenceObject) GetPositionOk() (*int, bool) {
	if o == nil || o.Position == nil {
		return nil, false
	}
...
func (o *PromoteConsequenceObject) SetPosition(v int) *PromoteConsequenceObject {
	o.Position = &v
