...
func WithRelatedQueryMaxRecommendations(val int) RelatedQueryOption {
...
func (o *RelatedQuery) GetMaxRecommendations() int {
...
// and a boolean to check if the value has been set.
func (o *RelatedQuery) GetMaxRecommendationsOk() (*int, bool) {
	if o == nil || o.MaxRecommendations == nil {
		return nil, false
	}
...
func (o *RelatedQuery) SetMaxRecommendations(v int) *RelatedQuery {
