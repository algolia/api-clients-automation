...
func WithLookingSimilarQueryMaxRecommendations(val int) LookingSimilarQueryOption {
...
func (o *LookingSimilarQuery) GetMaxRecommendations() int {
...
// and a boolean to check if the value has been set.
func (o *LookingSimilarQuery) GetMaxRecommendationsOk() (*int, bool) {
	if o == nil || o.MaxRecommendations == nil {
		return nil, false
	}
...
func (o *LookingSimilarQuery) SetMaxRecommendations(v int) *LookingSimilarQuery {
