...
func WithModelRangeFrom(val int) ModelRangeOption {
	return func(f *ModelRange) {
		f.From = &val
	}
}

func WithModelRangeValue(val int) ModelRangeOption {
	return func(f *ModelRange) {
		f.Value = &val
	}
}
...
func (o *ModelRange) GetFromOk() (*int, bool) {
	if o == nil || o.From == nil {
		return nil, false
	}
...
func (o *ModelRange) SetFrom(v int) *ModelRange {
	o.From = &v
...
func (o *ModelRange) GetValue() int {
...
// and a boolean to check if the value has been set.
func (o *ModelRange) GetValueOk() (*int, bool) {
	if o == nil || o.Value == nil {
		return nil, false
	}
...
// SetValue gets a reference to the given int and assigns it to the Value field.
func (o *ModelRange) SetValue(v int) *ModelRange {
	o.Value = &v
