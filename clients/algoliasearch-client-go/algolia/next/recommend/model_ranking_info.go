...
func WithRankingInfoFilters(val int) RankingInfoOption {
	return func(f *RankingInfo) {
		f.Filters = &val
	}
}

func WithRankingInfoGeoPrecision(val int) RankingInfoOption {
	return func(f *RankingInfo) {
		f.GeoPrecision = &val
	}
}
...
func WithRankingInfoProximityDistance(val int) RankingInfoOption {
	return func(f *RankingInfo) {
		f.ProximityDistance = &val
	}
}

func WithRankingInfoWords(val int) RankingInfoOption {
	return func(f *RankingInfo) {
		f.Words = &val
	}
}
...
func NewRankingInfo(firstMatchedWord int, geoDistance int, nbExactWords int, nbTypos int, userScore int, opts ...RankingInfoOption) *RankingInfo {
	this := &RankingInfo{}
...
func (o *RankingInfo) GetFilters() int {
...
func (o *RankingInfo) GetFiltersOk() (*int, bool) {
	if o == nil || o.Filters == nil {
		return nil, false
	}
...
// SetFilters gets a reference to the given int and assigns it to the Filters field.
func (o *RankingInfo) SetFilters(v int) *RankingInfo {
	o.Filters = &v
...
func (o *RankingInfo) GetFirstMatchedWord() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *RankingInfo) GetFirstMatchedWordOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *RankingInfo) SetFirstMatchedWord(v int) *RankingInfo {
...
func (o *RankingInfo) GetGeoDistance() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *RankingInfo) GetGeoDistanceOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *RankingInfo) SetGeoDistance(v int) *RankingInfo {
	o.GeoDistance = v
...
func (o *RankingInfo) GetGeoPrecision() int {
...
// and a boolean to check if the value has been set.
func (o *RankingInfo) GetGeoPrecisionOk() (*int, bool) {
	if o == nil || o.GeoPrecision == nil {
		return nil, false
	}
...
// SetGeoPrecision gets a reference to the given int and assigns it to the GeoPrecision field.
func (o *RankingInfo) SetGeoPrecision(v int) *RankingInfo {
	o.GeoPrecision = &v
...
func (o *RankingInfo) GetNbExactWords() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *RankingInfo) GetNbExactWordsOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *RankingInfo) SetNbExactWords(v int) *RankingInfo {
	o.NbExactWords = v
...
func (o *RankingInfo) GetNbTypos() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *RankingInfo) GetNbTyposOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *RankingInfo) SetNbTypos(v int) *RankingInfo {
	o.NbTypos = v
...
func (o *RankingInfo) GetProximityDistance() int {
...
// and a boolean to check if the value has been set.
func (o *RankingInfo) GetProximityDistanceOk() (*int, bool) {
	if o == nil || o.ProximityDistance == nil {
		return nil, false
	}
...
// SetProximityDistance gets a reference to the given int and assigns it to the ProximityDistance field.
func (o *RankingInfo) SetProximityDistance(v int) *RankingInfo {
...
func (o *RankingInfo) GetUserScore() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *RankingInfo) GetUserScoreOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *RankingInfo) SetUserScore(v int) *RankingInfo {
	o.UserScore = v
...
func (o *RankingInfo) GetWords() int {
...
// and a boolean to check if the value has been set.
func (o *RankingInfo) GetWordsOk() (*int, bool) {
	if o == nil || o.Words == nil {
		return nil, false
	}
...
// SetWords gets a reference to the given int and assigns it to the Words field.
func (o *RankingInfo) SetWords(v int) *RankingInfo {
	o.Words = &v
