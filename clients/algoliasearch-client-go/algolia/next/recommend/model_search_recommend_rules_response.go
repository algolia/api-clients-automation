...
func NewSearchRecommendRulesResponse(hits []RecommendRule, nbHits int, page int, nbPages int) *SearchRecommendRulesResponse {
...
func (o *SearchRecommendRulesResponse) GetNbHits() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *SearchRecommendRulesResponse) GetNbHitsOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *SearchRecommendRulesResponse) SetNbHits(v int) *SearchRecommendRulesResponse {
	o.NbHits = v
...
func (o *SearchRecommendRulesResponse) GetPage() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *SearchRecommendRulesResponse) GetPageOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *SearchRecommendRulesResponse) SetPage(v int) *SearchRecommendRulesResponse {
	o.Page = v
...
func (o *SearchRecommendRulesResponse) GetNbPages() int {
	if o == nil {
		var ret int
...
// and a boolean to check if the value has been set.
func (o *SearchRecommendRulesResponse) GetNbPagesOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *SearchRecommendRulesResponse) SetNbPages(v int) *SearchRecommendRulesResponse {
	o.NbPages = v
