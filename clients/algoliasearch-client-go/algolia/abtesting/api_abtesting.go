...
func (c *APIClient) AddABTests(name string, variants []AddABTestsVariant, endAt string, opts ...RequestOption) (*ABTestResponse, error) {
	var returnValue *ABTestResponse

	res, resBody, err := c.AddABTestsWithHTTPInfo(name, variants, endAt, opts...)
	if err != nil {
...
//   - endAt - End date and time of the A/B test, in RFC 3339 format.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) AddABTestsWithHTTPInfo(name string, variants []AddABTestsVariant, endAt string, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) DeleteABTest(id int32, opts ...RequestOption) (*ABTestResponse, error) {
	var returnValue *ABTestResponse

	res, resBody, err := c.DeleteABTestWithHTTPInfo(id, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - id - Unique A/B test identifier.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) DeleteABTestWithHTTPInfo(id int32, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - variants - A/B test variants.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) EstimateABTest(configuration *EstimateConfiguration, variants []AddABTestsVariant, opts ...RequestOption) (*EstimateABTestResponse, error) {
	var returnValue *EstimateABTestResponse

	res, resBody, err := c.EstimateABTestWithHTTPInfo(configuration, variants, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - variants - A/B test variants.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) EstimateABTestWithHTTPInfo(configuration *EstimateConfiguration, variants []AddABTestsVariant, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - id - Unique A/B test identifier.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetABTest(id int32, opts ...RequestOption) (*ABTest, error) {
	var returnValue *ABTest

	res, resBody, err := c.GetABTestWithHTTPInfo(id, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - id - Unique A/B test identifier.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) GetABTestWithHTTPInfo(id int32, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/2/abtests/{id}"
	requestPath = strings.ReplaceAll(requestPath, "{id}", url.PathEscape(utils.ParameterToString(id)))
...
func (o *ListABTestsOptions) WithOffset(offset int32) *ListABTestsOptions {
	o.Offset = &offset
	return o
}

// WithLimit Number of items to return.
func (o *ListABTestsOptions) WithLimit(limit int32) *ListABTestsOptions {
	o.Limit = &limit
	return o
}
...
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) ListABTests(optionalParams *ListABTestsOptions, opts ...RequestOption) (*ListABTestsResponse, error) {
	var returnValue *ListABTestsResponse

	res, resBody, err := c.ListABTestsWithHTTPInfo(optionalParams, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - indexSuffix - Index name suffix. Only A/B tests for indices ending with this string are included in the response. (in optionalParams)
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) ListABTestsWithHTTPInfo(optionalParams *ListABTestsOptions, opts ...RequestOption) (*http.Response, []byte, error) {
	requestPath := "/2/abtests"
...
//   - endAt - End date and time of the A/B test, in RFC 3339 format.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) ScheduleABTest(name string, variants []AddABTestsVariant, scheduledAt string, endAt string, opts ...RequestOption) (*ScheduleABTestResponse, error) {
	var returnValue *ScheduleABTestResponse

	res, resBody, err := c.ScheduleABTestWithHTTPInfo(name, variants, scheduledAt, endAt, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - endAt - End date and time of the A/B test, in RFC 3339 format.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) ScheduleABTestWithHTTPInfo(name string, variants []AddABTestsVariant, scheduledAt string, endAt string, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - id - Unique A/B test identifier.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) StopABTest(id int32, opts ...RequestOption) (*ABTestResponse, error) {
	var returnValue *ABTestResponse

	res, resBody, err := c.StopABTestWithHTTPInfo(id, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - id - Unique A/B test identifier.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) StopABTestWithHTTPInfo(id int32, opts ...RequestOption) (*http.Response, []byte, error) {
