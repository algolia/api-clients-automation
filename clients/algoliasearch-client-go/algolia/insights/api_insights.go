...
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) DeleteUserToken(userToken string, opts ...RequestOption) error {
	res, resBody, err := c.DeleteUserTokenWithHTTPInfo(userToken, opts...)
	if err != nil {
		return err
	}
	if res == nil {
...
//   - userToken - User token for which to delete all associated events.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) DeleteUserTokenWithHTTPInfo(userToken string, opts ...RequestOption) (*http.Response, []byte, error) {
...
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) PushEvents(events []EventsItems, opts ...RequestOption) (*EventsResponse, error) {
	var returnValue *EventsResponse

	res, resBody, err := c.PushEventsWithHTTPInfo(events, opts...)
	if err != nil {
		return returnValue, err
	}
	if res == nil {
...
//   - events - Click and conversion events.  **All** events must be valid, otherwise the API returns an error.
//   - opts - Optional parameters for the API call (e.g. WithContext, WithHeaderParam...)
func (c *APIClient) PushEventsWithHTTPInfo(events []EventsItems, opts ...RequestOption) (*http.Response, []byte, error) {
