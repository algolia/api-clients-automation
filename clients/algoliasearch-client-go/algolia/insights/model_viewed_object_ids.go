...
func WithViewedObjectIDsAgent(val Agent) ViewedObjectIDsOption {
	return func(f *ViewedObjectIDs) {
		f.Agent = &val
	}
}
...
func (o *ViewedObjectIDs) GetAgent() Agent {
...
// and a boolean to check if the value has been set.
func (o *ViewedObjectIDs) GetAgentOk() (*Agent, bool) {
	if o == nil || o.Agent == nil {
		return nil, false
	}
...
func (o *ViewedObjectIDs) HasAgent() bool {
	if o != nil && o.Agent != nil {
		return true
	}
...
func (o *ViewedObjectIDs) SetAgent(v *Agent) *ViewedObjectIDs {
	o.Agent = v
