...
func WithConvertedObjectIDsAfterSearchAgent(val Agent) ConvertedObjectIDsAfterSearchOption {
	return func(f *ConvertedObjectIDsAfterSearch) {
		f.Agent = &val
	}
}
...
func (o *ConvertedObjectIDsAfterSearch) GetAgent() Agent {
...
// and a boolean to check if the value has been set.
func (o *ConvertedObjectIDsAfterSearch) GetAgentOk() (*Agent, bool) {
	if o == nil || o.Agent == nil {
		return nil, false
	}
...
func (o *ConvertedObjectIDsAfterSearch) HasAgent() bool {
	if o != nil && o.Agent != nil {
		return true
	}
...
func (o *ConvertedObjectIDsAfterSearch) SetAgent(v *Agent) *ConvertedObjectIDsAfterSearch {
	o.Agent = v
