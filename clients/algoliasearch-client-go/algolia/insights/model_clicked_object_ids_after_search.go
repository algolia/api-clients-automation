...
func WithClickedObjectIDsAfterSearchAgent(val Agent) ClickedObjectIDsAfterSearchOption {
	return func(f *ClickedObjectIDsAfterSearch) {
		f.Agent = &val
	}
}
...
func (o *ClickedObjectIDsAfterSearch) GetAgent() Agent {
...
// and a boolean to check if the value has been set.
func (o *ClickedObjectIDsAfterSearch) GetAgentOk() (*Agent, bool) {
	if o == nil || o.Agent == nil {
		return nil, false
	}
...
func (o *ClickedObjectIDsAfterSearch) HasAgent() bool {
	if o != nil && o.Agent != nil {
		return true
	}
...
func (o *ClickedObjectIDsAfterSearch) SetAgent(v *Agent) *ClickedObjectIDsAfterSearch {
	o.Agent = v
