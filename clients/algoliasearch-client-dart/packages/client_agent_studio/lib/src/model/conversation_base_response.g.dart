...
part of 'conversation_base_response.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ConversationBaseResponse _$ConversationBaseResponseFromJson(
        Map<String, dynamic> json) =>
    $checkedCreate(
      'ConversationBaseResponse',
      json,
      ($checkedConvert) {
        final val = ConversationBaseResponse(
...
Map<String, dynamic> _$ConversationBaseResponseToJson(
    ConversationBaseResponse instance) {
