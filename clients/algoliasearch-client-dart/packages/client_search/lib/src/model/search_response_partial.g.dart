...
part of 'search_response_partial.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

SearchResponsePartial _$SearchResponsePartialFromJson(
        Map<String, dynamic> json) =>
    $checkedCreate(
      'SearchResponsePartial',
      json,
      ($checkedConvert) {
        final val = SearchResponsePartial(
...
Map<String, dynamic> _$SearchResponsePartialToJson(
    SearchResponsePartial instance) {
