...
part 'destination_input.g.dart';

@JsonSerializable()
final class DestinationInput {
  /// Returns a new [DestinationInput] instance.
  ...
  factory DestinationInput.fromJson(Map<String, dynamic> json) =>
      _$DestinationInputFromJson(json);

  Map<String, dynamic> toJson() => _$DestinationInputToJson(this);
