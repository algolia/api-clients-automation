...
part of 'fallback_params.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

FallbackParams _$FallbackParamsFromJson(Map<String, dynamic> json) =>
    $checkedCreate(
      'FallbackParams',
      json,
      ($checkedConvert) {
...
Map<String, dynamic> _$FallbackParamsToJson(FallbackParams instance) {
