...
part 'search_response_partial.g.dart';

@JsonSerializable()
final class SearchResponsePartial {
  /// Returns a new [SearchResponsePartial] instance.
  const SearchResponsePartial({
    this.abTestID,
  ...
  bool operator ==(Object other) =>
      ...
      other is SearchResponsePartial &&
  ...
  factory SearchResponsePartial.fromJson(Map<String, dynamic> json) =>
      _$SearchResponsePartialFromJson(json);

  Map<String, dynamic> toJson() => _$SearchResponsePartialToJson(this);
