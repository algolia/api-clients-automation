...
enum AttributeCriteriaComputedBy {
  minProximity(r'minProximity'),
  best(r'best'),
  sum(r'sum');

  const AttributeCriteriaComputedBy(this.raw);
  final dynamic raw;

  dynamic toJson() => raw;

  static AttributeCriteriaComputedBy fromJson(dynamic json) {
