...
part of 'recommended_for_you_query_parameters.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

RecommendedForYouQueryParameters _$RecommendedForYouQueryParametersFromJson(
        Map<String, dynamic> json) =>
    $checkedCreate(
      'RecommendedForYouQueryParameters',
      json,
      ($checkedConvert) {
        final val = RecommendedForYouQueryParameters(
...
Map<String, dynamic> _$RecommendedForYouQueryParametersToJson(
    RecommendedForYouQueryParameters instance) {
