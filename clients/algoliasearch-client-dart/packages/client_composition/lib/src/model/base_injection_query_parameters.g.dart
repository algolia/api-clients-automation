...
part of 'base_injection_query_parameters.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

BaseInjectionQueryParameters _$BaseInjectionQueryParametersFromJson(
        Map<String, dynamic> json) =>
    $checkedCreate(
      'BaseInjectionQueryParameters',
      json,
      ($checkedConvert) {
        final val = BaseInjectionQueryParameters(
...
Map<String, dynamic> _$BaseInjectionQueryParametersToJson(
    BaseInjectionQueryParameters instance) {
