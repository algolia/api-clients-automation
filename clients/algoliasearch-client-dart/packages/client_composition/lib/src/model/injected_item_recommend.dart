...
part 'injected_item_recommend.g.dart';

@JsonSerializable()
final class InjectedItemRecommend {
  /// Returns a new [InjectedItemRecommend] instance.
  const InjectedItemRecommend({
  ...
  bool operator ==(Object other) =>
      ...
      other is InjectedItemRecommend &&
  ...
  factory InjectedItemRecommend.fromJson(Map<String, dynamic> json) =>
      _$InjectedItemRecommendFromJson(json);

  Map<String, dynamic> toJson() => _$InjectedItemRecommendToJson(this);
