...
export function createAbtestingV3Client({
  ...
  return {
     ...
     *  - analytics
     *  - editSettings
     * @param completeABTest - The completeABTest object.
     * @param completeABTest.id - Unique A/B test identifier.
     * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
     */
    completeABTest({ id }: CompleteABTestProps, requestOptions?: RequestOptions): Promise<ABTestResponse> {
      validateRequired('id', 'completeABTest', id);

      const requestPath = '/3/abtests/{id}/complete'.replace('{id}', encodeURIComponent(id));
      const headers: Headers = {};
      const queryParameters: QueryParameters = {};
     ...
     * @param completeABTest.id - Unique A/B test identifier.
     * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
     * @see completeABTest for the plain version.
     */
    completeABTestWithHTTPInfo(
      { id }: CompleteABTestProps,
      requestOptions?: RequestOptions,
    ): Promise<AlgoliaHttpResponse<ABTestResponse>> {
      validateRequired('id', 'completeABTestWithHTTPInfo', id);
