...
```bash
yarn add @algolia/abtesting@2.0.0
# or
npm install @algolia/abtesting@2.0.0
# or
pnpm add @algolia/abtesting@2.0.0
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/abtesting@2.0.0/dist/builds/browser.umd.js"></script>
```
