...
```bash
yarn add @algolia/ingestion@2.0.0
# or
npm install @algolia/ingestion@2.0.0
# or
pnpm add @algolia/ingestion@2.0.0
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/ingestion@2.0.0/dist/builds/browser.umd.js"></script>
```
