...
export function createIngestionClient({
  ...
  return {
     ...
     * @param listTasks.withNotifications - If specified, the response only includes tasks with notifications.email.enabled set to this value.
    ...
    listTasks(
      ...
      if (withNotifications !== undefined) {
        queryParameters['withNotifications'] = withNotifications.toString();
      }
