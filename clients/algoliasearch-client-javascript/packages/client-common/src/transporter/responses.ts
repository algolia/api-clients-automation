 ...
 * Only a positive whole-number-of-seconds string is honored, capped at 60 seconds so a
 * misbehaving intermediary cannot park requests for hours; anything else (missing, `0`,
 * HTTP-date, junk) waits 1s.
 */
