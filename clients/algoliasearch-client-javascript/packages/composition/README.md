...
```bash
yarn add @algolia/composition@2.0.0
# or
npm install @algolia/composition@2.0.0
# or
pnpm add @algolia/composition@2.0.0
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/composition@2.0.0/dist/builds/browser.umd.js"></script>
```
