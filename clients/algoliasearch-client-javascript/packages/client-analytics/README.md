...
```bash
yarn add @algolia/client-analytics@5.56.1
# or
npm install @algolia/client-analytics@5.56.1
# or
pnpm add @algolia/client-analytics@5.56.1
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/client-analytics@5.56.1/dist/builds/browser.umd.js"></script>
```
