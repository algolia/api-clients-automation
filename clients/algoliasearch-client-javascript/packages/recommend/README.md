...
```bash
yarn add @algolia/recommend@6.0.0
# or
npm install @algolia/recommend@6.0.0
# or
pnpm add @algolia/recommend@6.0.0
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/recommend@6.0.0/dist/builds/browser.umd.js"></script>
```
