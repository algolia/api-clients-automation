...
import type { AgentCompletionRequestUnion } from '../model/agentCompletionRequestUnion';
...
import type { TaskRequest } from '../model/taskRequest';
...
/**
 * Properties for the `createAgentTask` method.
 */
export type CreateAgentTaskProps = {
  /**
   * The agentId.
   */
  agentId: string;
  ...
  cache?: boolean | undefined;
  /**
   * Set to false to skip endpoint-specific analytics for this task call (default: true). Disables the task analytics event; operational metrics and traces are always emitted.
   */
  analytics?: boolean | undefined;
};
...
export type GetConversationProps = {
   ...
   */
  includeMessageEvents?: boolean | undefined;
  /**
   * Include outcome signals (hasView, hasClick, hasConversion) for the conversation.
   */
  includeImpactAnalytics?: boolean | undefined;
  /**
   * The X-Algolia-Secure-User-Token.
   */
  xAlgoliaSecureUserToken?: string | undefined;
...
export type ListAgentConversationsProps = {
   ...
   */
  hasAlgoliaSearch?: boolean | undefined;
  /**
   * The X-Algolia-Secure-User-Token.
   */
  xAlgoliaSecureUserToken?: string | undefined;
