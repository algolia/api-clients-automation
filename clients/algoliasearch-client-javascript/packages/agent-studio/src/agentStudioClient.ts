...
export function createAgentStudioClient({
  ...
  return {
    ...
    createAgentCompletionStream(
      ...
      if (!agentId) {
        throw new Error('Parameter `agentId` is required when calling `createAgentCompletionStream`.');
      }

      if (!compatibilityMode) {
        throw new Error('Parameter `compatibilityMode` is required when calling `createAgentCompletionStream`.');
      }

      if (!agentCompletionRequest) {
        throw new Error('Parameter `agentCompletionRequest` is required when calling `createAgentCompletionStream`.');
      }

      if (!agentCompletionRequest.messages) {
        throw new Error(
          'Parameter `agentCompletionRequest.messages` is required when calling `createAgentCompletionStream`.',
        );
      }
