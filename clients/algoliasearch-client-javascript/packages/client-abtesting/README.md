...
```bash
yarn add @algolia/client-abtesting@5.45.1
# or
npm install @algolia/client-abtesting@5.45.1
# or
pnpm add @algolia/client-abtesting@5.45.1
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/client-abtesting@5.45.1/dist/builds/browser.umd.js"></script>
```
