...
import { PostIngestUrlResponse } from './postIngestUrlResponse';
import { PostURLJob } from './postURLJob';
import { PostURLJobAuth } from './postURLJobAuth';
import { PostURLJobInput } from './postURLJobInput';
import { PostURLJobTarget } from './postURLJobTarget';
...
const enumsMap: { [index: string]: any } = {
  'PostURLJob.TypeEnum': PostURLJob.TypeEnum,
  'PostURLJobAuth.TypeEnum': PostURLJobAuth.TypeEnum,
  'PostURLJobInput.MethodEnum': PostURLJobInput.MethodEnum,
  'PostURLJobTarget.TypeEnum': PostURLJobTarget.TypeEnum,
  'PostURLJobTarget.OperationEnum': PostURLJobTarget.OperationEnum,
  'Task.TypeEnum': Task.TypeEnum,
};

const typeMap: { [index: string]: any } = {
  ErrorBase,
  PostIngestUrlResponse,
  PostURLJob,
  PostURLJobAuth,
  PostURLJobInput,
  PostURLJobTarget,
