...
/**
 * The crawler configuration object represented as valid JSON.  Function needs to be espaced as such ```javascript myProp: {   \"___type\": \"function\"   \"source\": \"function() { ... }\" } ```.
 */
export type Config = {
  appId: string;
  apiKey: string;
  ...
  /**
   * Defines a hostname key that will be transformed as the value specified. The keys are exact match only. Applied to: - All URLs found - Canonical - Redirection.  Not applied to: - props: startUrls, extraUrls, pathsToMatch, etc... - URLs in your code. @example ```javascript hostnameAliases: {    \'algolia.com\': \'dev.algolia.com\' } ```.
   */
  ...
  cache?: ConfigCache;
  /**
   * Defines the list of External Data you want to use for this configuration. Every External Data declared here can be accessed in your `recordExtractor` through the `dataSources` object.  @example ```javascript {   externalData: [\'unique_name\'], } ```.
   */
  externalData?: string[];
  /**
