...
case class SearchParametersOutput(
    ...
    typoTolerance: Option[TypoToleranceUnionSearchParametersOutput] = scala.None,
    ...
    removeStopWords: Option[RemoveStopWordsUnionSearchParametersOutput] = scala.None,
    ignorePlurals: Option[IgnorePluralsUnionSearchParametersOutput] = scala.None,
