...
import algoliasearch.search.CategoryPredictionBin._
...
/** CategoryPrediction
  ...
  */
case class CategoryPrediction(
    bin: Option[CategoryPredictionBin] = scala.None,
    hierarchyPath: Option[Seq[HierarchyPathEntry]] = scala.None
)
