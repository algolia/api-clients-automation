...
import algoliasearch.search.QueryCategorizationType._
...
/** Query Categorization prediction returned by the AI model. This field is empty when the model cannot categorize the
  ...
  */
case class QueryCategorization(
    normalizedQuery: Option[String] = scala.None,
    count: Option[Int] = scala.None,
    `type`: Option[QueryCategorizationType] = scala.None,
    categories: Option[Seq[CategoryPrediction]] = scala.None,
    autofiltering: Option[AutoFilteringResult] = scala.None
)
