...
object AdvancedSyntaxFeatures extends Enumeration {
  type AdvancedSyntaxFeatures = AdvancedSyntaxFeatures.Value
  val ExactPhrase = Value("exactPhrase")
  val ExcludeWords = Value("excludeWords")
}
