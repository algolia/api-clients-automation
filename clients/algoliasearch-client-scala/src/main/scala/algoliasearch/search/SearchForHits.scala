...
import algoliasearch.search.AttributeCriteriaComputedBy
...
import algoliasearch.search.SearchExtensions
import algoliasearch.search.SearchTypeDefault
...
/** SearchForHits
  ...
  *   expresses the same two behaviors and adds the `sum` strategy. If you set both, `attributeCriteriaComputedBy` takes
  *   precedence.
...
case class SearchForHits(
    ...
    attributeCriteriaComputedBy: Option[AttributeCriteriaComputedBy] = scala.None,
