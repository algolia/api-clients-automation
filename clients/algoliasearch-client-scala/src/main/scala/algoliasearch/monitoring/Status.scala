...
object Status extends Enumeration {
  ...
  val Operational = Value("operational")
  val DegradedPerformance = Value("degraded_performance")
  val PartialOutage = Value("partial_outage")
  val MajorOutage = Value("major_outage")
}
