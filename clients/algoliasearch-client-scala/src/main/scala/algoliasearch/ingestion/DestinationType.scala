...
/** Destination type. <dl> <dt><code>search</code></dt> <dd>Data is stored in an Algolia index.</dd>
  * <dt><code>insights</code></dt> <dd>Data is recorded as user events in the Insights API.</dd> </dl>.
  */
