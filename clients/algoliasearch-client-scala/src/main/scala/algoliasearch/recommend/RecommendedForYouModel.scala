...
object RecommendedForYouModel {
  case object RecommendedForYou extends RecommendedForYouModel {
    override def toString = "recommended-for-you"
  }
  val values: Seq[RecommendedForYouModel] = Seq(RecommendedForYou)

  def withName(name: String): RecommendedForYouModel = RecommendedForYouModel.values
    .find(_.toString == name)
    .getOrElse(throw new MappingException(s"Unknown RecommendedForYouModel value: $name"))
}

class RecommendedForYouModelSerializer
    extends CustomSerializer[RecommendedForYouModel](_ =>
      (
        {
          case JString(value) => RecommendedForYouModel.withName(value)
          case JNull          => null
        },
        { case value: RecommendedForYouModel =>
