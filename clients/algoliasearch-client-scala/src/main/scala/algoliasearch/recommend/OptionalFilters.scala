...
/** Filters to promote or demote records in the search results. Optional filters work like facet filters, but they don't
  ...
  * Optional filters are applied _after_ sort-by attributes. - On virtual replicas, optional filters are applied _after_
  * the replica's [relevant
  * sort](https://www.algolia.com/doc/guides/managing-results/refine-results/sorting/in-depth/relevant-sort). - Optional
  * filters are applied _before_ custom ranking attributes (in the default
