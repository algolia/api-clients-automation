...
public class AbtestingClient extends ApiClient {
   ...
   * @throws AlgoliaRuntimeException If it fails to process the API call
   */
  public ScheduledABTestResponse scheduleABTest(@Nonnull ScheduleABTestsRequest scheduleABTestsRequest, RequestOptions requestOptions)
    throws AlgoliaRuntimeException {
   ...
   * @throws AlgoliaRuntimeException If it fails to process the API call
   */
  public ScheduledABTestResponse scheduleABTest(@Nonnull ScheduleABTestsRequest scheduleABTestsRequest) throws AlgoliaRuntimeException {
   ...
   * @throws AlgoliaRuntimeException If it fails to process the API call
   */
  public CompletableFuture<ScheduledABTestResponse> scheduleABTestAsync(
    ...
    return executeAsync(request, requestOptions, new TypeReference<ScheduledABTestResponse>() {});
  }
   ...
   * @throws AlgoliaRuntimeException If it fails to process the API call
   */
  public CompletableFuture<ScheduledABTestResponse> scheduleABTestAsync(@Nonnull ScheduleABTestsRequest scheduleABTestsRequest)
    throws AlgoliaRuntimeException {
