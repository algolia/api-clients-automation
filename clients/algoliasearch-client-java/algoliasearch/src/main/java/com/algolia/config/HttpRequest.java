...
public class HttpRequest {
    ...
    public static class Builder {
        ...
        public Builder addQueryParameter(String key, Object param) {
            ...
            String value = param instanceof Collection ? String.join(",", (Collection) param) : String.valueOf(param);
        ...
        public Builder setPath(String template, String... values) {
